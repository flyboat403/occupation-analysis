...
**Quick Facts:**
- SOC Code: 13-1041.04
- Also called: Airport Operations Officer, Housing Inspector, Housing Management Representative, Housing Quality Standard Inspector (HQS Inspector), Neighborhood Conservation Officer, Quality Assurance Specialist, Rehabilitation Construction Specialist
...
|------------|----------|------|
| 81 | Core | Prepare correspondence, reports of inspections or investigations, or recommendations for action. |
| 77 | Core | Examine records, reports, or other documents to establish facts or detect discrepancies. |
| 74 | Core | Inspect government property, such as construction sites or public housing, to ensure compliance with contract specifications or legal requirements. |
| 79 | Supplemental | Investigate alleged license or permit violations. |
| 72 | Supplemental | Inspect manufactured or processed products to ensure compliance with contract specifications or legal requirements. |
| 71 | Supplemental | Collect, identify, evaluate, or preserve case evidence. |
| 70 | Supplemental | Submit samples of products to government laboratories for testing, as required. |
| 68 | Supplemental | Inspect government-owned equipment or materials in the possession of private contractors to ensure compliance with contracts or regulations or to prevent misuse. |
| 65 | Supplemental | Investigate applications for special licenses or permits. |
| 65 | Supplemental | Recommend legal or administrative action to protect government property. |
| 63 | Supplemental | Testify in court or at administrative proceedings concerning investigation findings. |
| 59 | Supplemental | Coordinate with or assist law enforcement agencies in matters of mutual concern. |
...
| Computer aided design CAD software | Autodesk AutoCAD Hot Technology ; Autodesk AutoCAD Civil 3D Hot Technology ; Bentley MicroStation Hot Technology |
| Data base user interface and query software | BrioQuery; Database software; Microsoft Access Hot Technology ; Unique Identification UID system databases |
| Desktop publishing software | Adobe InDesign Hot Technology |
| Document management software | Adobe Acrobat Hot Technology ; Records management software |
...
| Office suite software | Google Workspace software ; Microsoft Office software Hot Technology |
| Operating system software | Apple iOS ; Microsoft Windows Hot Technology |
...
- Public Risk Management Association external site

- American Concrete Institute external site
- Municipal Construction Inspectors Association external site
- National Center for Housing Management external site
