...
|------------|----------|------|
| 92 | Core | Move hand and foot levers of hoisting equipment to position piling leads, hoist piling into leads, and position hammers over pilings. |
| 90 | Core | Move levers and turn valves to activate power hammers, or to raise and lower drophammers that drive piles to required depths. |
| 89 | Core | Drive pilings to provide support for buildings or other structures, using heavy equipment with a pile driver head. |
| 87 | Core | Conduct pre-operational checks on equipment to ensure proper functioning. |
| 82 | Core | Clean, lubricate, and refill equipment. |
