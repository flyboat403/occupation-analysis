...
|------------|----------|------|
| 84 | Core | Evaluate the safety, efficiency, and effectiveness of biomedical equipment. |
| 82 | Core | Prepare technical reports, data summary documents, or research articles for scientific publication, regulatory submissions, or patent applications. |
| 80 | Core | Design or develop medical diagnostic or clinical instrumentation, equipment, or procedures, using the principles of engineering and biobehavioral sciences. |
| 78 | Core | Conduct research, along with life scientists, chemists, and medical scientists, on the engineering aspects of the biological systems of humans and animals. |
| 77 | Core | Adapt or design computer hardware or software for medical science uses. |
| 73 | Core | Maintain databases of experiment characteristics or results. |
| 73 | Core | Develop statistical models or simulations, using statistical or modeling software. |
| 72 | Core | Read current scientific or trade literature to stay abreast of scientific, industrial, or technological advances. |
| 72 | Core | Manage teams of engineers by creating schedules, tracking inventory, creating or using budgets, or overseeing contract obligations or deadlines. |
| 72 | Core | Develop models or computer simulations of human biobehavioral systems to obtain data for measuring or controlling life processes. |
| 68 | Core | Design or conduct follow-up experimentation, based on generated data, to meet established process objectives. |
| 66 | Core | Write documents describing protocols, policies, standards for use, maintenance, and repair of medical equipment. |
| 64 | Core | Communicate with bioregulatory authorities regarding licensing or compliance responsibilities. |
| 64 | Core | Develop methodologies for transferring procedures or biological processes from laboratories to commercial-scale manufacturing production. |
| 63 | Core | Collaborate with manufacturing or quality assurance staff to prepare product specification or safety sheets, standard operating procedures, user manuals, or qualification and validation reports. |
| 60 | Core | Research new materials to be used for products, such as implanted artificial organs. |
| 59 | Core | Prepare project plans for equipment or facility improvements, including time lines, budgetary estimates, or capital spending requests. |
| 59 | Core | Consult with chemists or biologists to develop or evaluate novel technologies. |
| 56 | Core | Confer with research and biomanufacturing personnel to ensure the compatibility of design and production. |
| 55 | Core | Recommend process formulas, instrumentation, or equipment specifications, based on results of bench or pilot experimentation. |
| 52 | Core | Communicate with suppliers regarding the design or specifications of bioproduction equipment, instrumentation, or materials. |
| 51 | Core | Conduct training or in-services to educate clinicians and other personnel on proper use of equipment. |
| 50 | Core | Advise hospital administrators on the planning, acquisition, and use of medical equipment. |
| 62 | Supplemental | Analyze new medical procedures to forecast likely outcomes. |
| 59 | Supplemental | Design and deliver technology, such as prosthetic devices, to assist people with disabilities. |
| 50 | Supplemental | Advise manufacturing staff regarding problems with fermentation, filtration, or other bioproduction processes. |
| 47 | Supplemental | Review existing manufacturing processes to identify opportunities for yield improvement or reduced process variation. |
| 44 | Supplemental | Develop bioremediation processes to reduce pollution, protect the environment, or treat waste products. |
| 44 | Supplemental | Lead studies to examine or recommend changes in process sequences or operation protocols. |
| 41 | Supplemental | Design or direct bench or pilot production experiments to determine the scale of production methods that optimize product yield and minimize production costs. |

## Technology Skills

| Hot Technology | Examples |
|----------------|----------|
| Analytical or scientific software | Minitab; SAS Hot Technology ; The MathWorks MATLAB ; Three-dimensional motion capture software ; 51 more |
| Charting software |  |
...
| Computer aided design CAD software | Autodesk AutoCAD Hot Technology ; Dassault Systemes SolidWorks Hot Technology ; Mathsoft Mathcad; Zuken electrical design software ; 9 more |
...
| Data base user interface and query software | Microsoft Access Hot Technology ; Oracle Database Hot Technology ; Structured query language SQL Hot Technology ; Thomson Reuters EndNote ; 1 more |
| Development environment software | Integrated development environment IDE software; Microsoft Azure software Hot Technology ; Microsoft Visual Basic Hot Technology ; National Instruments LabVIEW ; 7 more |
| Electronic mail software | Microsoft Outlook Hot Technology |
| Enterprise application integration software | Extensible markup language XML Hot Technology ; Microsoft Teams Hot Technology ; Rapid application development RAD software |
| Enterprise resource planning ERP software | Ab Initio; ERP software; SAP software Hot Technology |
| Expert system software | NeuroSolutions for MatLab |
| Graphics or photo imaging software | Adobe Illustrator Hot Technology ; Adobe Photoshop Hot Technology ; ImageJ |
...
| Object or component oriented development software | C++ Hot Technology ; Oracle Java Hot Technology ; Python ; R |
| Office suite software | Microsoft Office software |
| Operating system software | Linux Hot Technology ; Microsoft Windows Hot Technology ; Red Hat Enterprise Linux Hot Technology ; UNIX Hot Technology |
| Pattern design software | Diagramming software |
| Presentation software | Microsoft PowerPoint |
| Process mapping and design software | Lucidchart; Microsoft Visio Hot Technology |
...
| Web platform development software | Hypertext markup language HTML Hot Technology ; Hypertext preprocessor PHP; JavaScript Hot Technology |
...
- Estimate time requirements for development or production projects. Related occupations
...
- Association for the Advancement of Medical Instrumentation external site
- Biomedical Engineering Society external site
- International Society for Pharmaceutical Engineering external site
- National Fire Protection Association external site
- Society for Biomaterials external site
- Society for Industrial Microbiology and Biotechnology external site
