...
**Quick Facts:**
- SOC Code: 23-2011.00
- Also called: Immigration Paralegal, Law Associate, Legal Analyst, Legal Assistant, Legal Clerk, Legal Processing Assistant, Litigation Paralegal, Paralegal, Paralegal Specialist, Real Estate Paralegal
...
|------------|----------|------|
| 85 | Core | Prepare affidavits or other documents, such as legal correspondence, and organize and maintain documents in paper or electronic filing system. |
| 83 | Core | Prepare, edit, or review legal documents, including legislation, briefs, pleadings, appeals, wills, contracts, and real estate closing statements. |
| 77 | Core | Investigate facts and law of cases and search pertinent sources, such as public records and internet sources, to determine causes of action and to prepare cases. |
| 74 | Core | Prepare for trial by performing tasks such as organizing exhibits. |
| 73 | Core | Meet with clients and other professionals to discuss details of cases. |
| 72 | Core | Gather and analyze research data, such as statutes, decisions, and legal articles, codes, and documents. |
| 72 | Supplemental | File pleadings with court clerks. |
| 58 | Supplemental | Direct and coordinate law office activity, including delivery of subpoenas. |
| 50 | Supplemental | Call upon witnesses to testify at hearings. |
| 50 | Supplemental | Arbitrate disputes between parties and assist in the real estate closing process, such as by reviewing title searches. |
| 48 | Supplemental | Appraise and inventory real and personal property for estate planning. |
| 42 | Supplemental | Keep and monitor legal volumes to ensure that the law library is up-to-date. |
...
| Data base user interface and query software | Database software; Microsoft Access Hot Technology ; Relational database software; TrialWorks ; 10 more |
...
| Document management software | Adobe Acrobat Hot Technology ; Microsoft SharePoint Hot Technology ; Microsoft SharePoint Server; Summation Blaze ; 17 more |
| Electronic mail software | IBM Notes; Microsoft Outlook |
| File versioning software | Zylab ZyImage |
| Information retrieval or search software | LawManager; LexisNexis; Thomson CompuMark SAEGIS; Thomson Reuters Westlaw In Demand ; 14 more |
...
| Word processing software | Google Docs Hot Technology ; Legal document software; Microsoft Word ; The Sackett Group MacPac for Legal ; 1 more |
...
- National Federation of Paralegal Associations external site
- Paralegal Career external site
