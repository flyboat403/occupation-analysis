...
**Quick Facts:**
- SOC Code: 53-2011.00
- Also called: Airbus Captain, Airline Captain, Airline Pilot, Captain, Check Airman, Co-Pilot, Commercial Airline Pilot, First Officer (FO), Line Pilot, Pilot
...
|------------|----------|------|
| 98 | Core | Use instrumentation to guide flights when visibility is poor. |
| 97 | Core | Start engines, operate controls, and pilot airplanes to transport passengers, mail, or freight, adhering to flight plans, regulations, and procedures. |
| 97 | Core | Work as part of a flight team with other crew members, especially during takeoffs and landings. |
| 97 | Core | Respond to and report in-flight emergencies and malfunctions. |
| 96 | Core | Inspect aircraft for defects and malfunctions, according to pre-flight checklists. |
| 95 | Core | Contact control towers for takeoff clearances, arrival instructions, and other information, using radio equipment. |
| 93 | Core | Monitor engine operation, fuel consumption, and functioning of aircraft systems during flights. |
| 93 | Core | Monitor gauges, warning devices, and control panels to verify aircraft performance and to regulate engine speed. |
| 92 | Core | Steer aircraft along planned routes, using autopilot and flight management computers. |
| 90 | Core | Check passenger and cargo distributions and fuel amounts to ensure that weight and balance specifications are met. |
| 85 | Core | Confer with flight dispatchers and weather forecasters to keep abreast of flight conditions. |
| 81 | Core | Order changes in fuel supplies, loads, routes, or schedules to ensure safety of flights. |
| 81 | Core | Brief crews about flight details, such as destinations, duties, and responsibilities. |
| 74 | Core | Choose routes, altitudes, and speeds that will provide the fastest, safest, and smoothest flights. |
| 74 | Core | Direct activities of aircraft crews during flights. |
| 68 | Core | Record in log books information, such as flight times, distances flown, and fuel consumption. |
| 68 | Core | Instruct other pilots and student pilots in aircraft operations and the principles of flight. |
| 55 | Core | Make announcements regarding flights, using public address systems. |
| 83 | Supplemental | Coordinate flight activities with ground crews and air traffic control and inform crew members of flight and test procedures. |
...
| 77 | Supplemental | File instrument flight plans with air traffic control to ensure that flights are coordinated with other air traffic. |
| 76 | Supplemental | Perform minor maintenance work, or arrange for major maintenance. |
| 71 | Supplemental | Evaluate other pilots or pilot-license applicants for proficiency. |
| 52 | Supplemental | Plan and formulate flight activities and test schedules and prepare flight evaluation reports. |
...
| Object or component oriented development software | Document Object Model DOM Scripting; R |
...
|---|---|
| 97 | Identifying Objects, Actions, and Events — Identifying information by categorizing, estimating, recognizing differences or similarities, and detecting changes in circumstances or events. |
...
- Pilot aircraft. Related occupations
...
- Test performance of aircraft equipment. Related occupations
- Arrange maintenance activities. Related occupations
- Maintain locomotives or other rail equipment in good working condition. Related occupations
...
| Importance | Skill |
|---|---|
| 97 | Operation and Control — Controlling operations of equipment or systems. |
| 91 | Operations Monitoring — Watching gauges, dials, or other indicators to make sure a machine is working properly. |
...
|---|---|
| 95 | Transportation — Knowledge of principles and methods for moving people or goods by air, rail, sea, or road, including the relative costs and benefits. |
...
| Importance | Ability |
|---|---|
| 97 | Response Orientation — The ability to choose quickly between two or more movements in response to two or more different signals (lights, sounds, pictures). It includes the speed with which the correct response is started with the hand, foot, or other body part. |
...
| 91 | Control Precision — The ability to quickly and repeatedly adjust the controls of a machine or a vehicle to exact positions. |
...
| 81 | Reaction Time — The ability to quickly respond (with the hand, finger, or foot) to a signal (sound, light, picture) when it appears. |
| 78 | Deductive Reasoning — The ability to apply general rules to specific problems to produce answers that make sense. |
| 78 | Depth Perception — The ability to judge which of several objects is closer or farther away from you, or to judge the distance between you and an object. |
...
| 78 | Rate Control — The ability to time your movements or the movement of a piece of equipment in anticipation of changes in the speed and/or direction of a moving object or scene. |
...
| 75 | Spatial Orientation — The ability to know your location in relation to the environment or to know where other objects are in relation to you. |
| 75 | Time Sharing — The ability to shift back and forth between two or more activities or sources of information (such as speech, sounds, touch, or other sources). |
| 75 | Written Comprehension — The ability to read and understand information and ideas presented in writing. |
| 72 | Peripheral Vision — The ability to see objects or movement of objects to one's side when the eyes are looking ahead. |
...
| 66 | Glare Sensitivity — The ability to see objects in the presence of a glare or bright lighting. |
...
| 60 | Night Vision — The ability to see under low-light conditions. |
...
| 62 | Realistic — Work involves designing, building, or repairing of equipment, materials, or structures, engaging in physical activity, or working outdoors. Realistic occupations are often associated with engineering, mechanics and electronics, construction, woodworking, transportation, machine operation, agriculture, animal services, physical or manual labor, athletics, or protective services. Related occupations |
...
- Coalition of Airline Pilots Associations external site
- Helicopter Association International external site
- National Agricultural Aviation Association external site

- Air Line Pilots Association, International external site
