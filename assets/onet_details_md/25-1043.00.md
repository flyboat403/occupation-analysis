...
**Quick Facts:**
- SOC Code: 25-1043.00
- Also called: Assistant Professor, Associate Professor, Conservation Biology Professor, Extension Professor, Forest Technology Professor, Forestry Professor, Lecturer, Natural Resources Professor, Professor, Research Professor
...
| 90 | Core | Prepare and deliver lectures to undergraduate or graduate students on topics, such as forest resource policy, forest pathology, and mapping. |
...
| 81 | Core | Collaborate with colleagues to address teaching and research issues. |
...
| 78 | Core | Write grant proposals to procure external research funding. |
| 76 | Core | Maintain regularly scheduled office hours to advise and assist students. |
| 70 | Core | Conduct research in a particular field of knowledge and publish findings in books, professional journals, or electronic media. |
| 62 | Core | Act as advisers to student organizations. |
| 62 | Core | Participate in student recruitment, registration, and placement activities. |
| 57 | Core | Select and obtain materials and supplies, such as textbooks and laboratory equipment. |
...
| 53 | Core | Review papers for colleagues and scientific journals. |
| 51 | Core | Provide information to the public by leading workshops and training programs and by developing educational materials. |
| 64 | Supplemental | Perform administrative duties, such as serving as department head. |
| 47 | Supplemental | Participate in campus and community events. |
| 46 | Supplemental | Provide professional consulting services to government or industry. |
| 43 | Supplemental | Compile bibliographies of specialized materials for outside reading assignments. |
...
| Data base user interface and query software | MySQL Hot Technology ; Oracle Database Hot Technology ; Structure query language SQL |
...
| Web platform development software | Apache Struts; Google Angular Hot Technology ; JavaScript Hot Technology |
...
| 79 | Estimating the Quantifiable Characteristics of Products, Events, or Information — Estimating sizes, distances, and quantities; or determining time, costs, resources, or materials needed to perform a work activity. |
...
- Association for Fire Ecology external site
- Council of Graduate Schools external site
- Ecological Society of America external site
- Forest Products Society external site
- International Association for Society and Natural Resources external site
