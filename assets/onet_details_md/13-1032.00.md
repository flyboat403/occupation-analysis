...
**Quick Facts:**
- SOC Code: 13-1032.00
- Also called: Appraiser, Automobile Appraiser (Auto Appraiser), Automobile Damage Appraiser (Auto Damage Appraiser), Damage Appraiser, Field Appraiser, Field Inspector, Insurance Appraiser, Material Damage Appraiser, Outside Physical Damage Appraiser, Physical Damage Appraiser
...
|------------|----------|------|
| 94 | Core | Evaluate practicality of repair as opposed to payment of market value of vehicle before accident. |
| 93 | Core | Review repair cost estimates with automobile repair shop to secure agreement on cost of repairs. |
| 93 | Core | Examine damaged vehicle to determine extent of structural, body, mechanical, electrical, or interior damage. |
| 92 | Core | Prepare insurance forms to indicate repair cost estimates and recommendations. |
| 91 | Core | Estimate parts and labor to repair damage, using standard automotive labor and parts cost manuals and knowledge of automotive repair. |
| 77 | Core | Determine salvage value on total-loss vehicle. |
| 61 | Core | Arrange to have damage appraised by another appraiser to resolve disagreement with shop on repair cost. |

## Technology Skills

| Hot Technology | Examples |
|----------------|----------|
| Billing and invoicing software | NCH Software Express Invoice |
...
- Independent Automotive Damage Appraisers Association external site
