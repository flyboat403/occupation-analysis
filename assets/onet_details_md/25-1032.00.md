...
**Quick Facts:**
- SOC Code: 25-1032.00
- Also called: Assistant Professor, Associate Professor, Chemical Engineering Professor, Electrical Engineering Professor, Engineering Instructor, Engineering Professor, Environmental Engineering Professor, Instructor, Mechanical Engineering Professor, Professor
...
|------------|----------|------|
| 87 | Core | Conduct research in a particular field of knowledge and publish findings in professional journals, books, or electronic media. |
| 85 | Core | Prepare course materials, such as syllabi, homework assignments, and handouts. |
| 82 | Core | Evaluate and grade students' class work, laboratory work, assignments, and papers. |
| 82 | Core | Write grant proposals to procure external research funding. |
...
| 78 | Core | Initiate, facilitate, and moderate class discussions. |
| 77 | Core | Supervise students' laboratory work. |
| 74 | Core | Compile, administer, and grade examinations, or assign this work to others. |
| 74 | Core | Collaborate with colleagues to address teaching and research issues. |
| 71 | Core | Plan, evaluate, and revise curricula, course content, and course materials and methods of instruction. |
| 70 | Core | Maintain student attendance records, grades, and other required records. |
...
| 60 | Core | Advise students on academic and vocational curricula and on career issues. |
| 55 | Core | Serve on academic or administrative committees that deal with institutional policies, departmental matters, and academic issues. |
| 56 | Supplemental | Perform administrative duties, such as serving as department head. |
| 48 | Supplemental | Review manuscripts for professional journals. |
| 46 | Supplemental | Participate in campus and community events. |
| 45 | Supplemental | Act as advisers to student organizations. |
| 43 | Supplemental | Provide professional consulting services to government or industry. |
| 40 | Supplemental | Compile bibliographies of specialized materials for outside reading assignments. |

## Technology Skills

| Hot Technology | Examples |
|----------------|----------|
| Analytical or scientific software | Finite element analysis software; The MathWorks MATLAB Hot Technology |
| Calendar and scheduling software |  |
| Computer aided design CAD software | Autodesk AutoCAD Hot Technology ; Autodesk Revit Hot Technology ; Dassault Systemes CATIA; Dassault Systemes SolidWorks Hot Technology ; 1 more |
...
- Electrical and Computer Engineering Department Heads Association external site
