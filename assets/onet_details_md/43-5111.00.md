...
**Quick Facts:**
- SOC Code: 43-5111.00
- Also called: Cycle Counter, Fluid Operator, Inventory Specialist, Quality Assurance Inspector (QA Inspector), Scale Operator, Supply Clerk, Temperature Taker
...
|------------|----------|------|
| 86 | Core | Document quantity, quality, type, weight, test result data, and value of materials or products to maintain shipping, receiving, and production records and files. |
| 85 | Core | Weigh or measure materials, equipment, or products to maintain relevant records, using volume meters, scales, rules, or calipers. |
| 84 | Core | Collect or prepare measurement, weight, or identification labels and attach them to products. |
| 82 | Core | Examine products or materials, parts, subassemblies, and packaging for damage, defects, or shortages, using specification sheets, gauges, and standards charts. |
| 76 | Core | Signal or instruct other workers to weigh, move, or check products. |
| 69 | Core | Collect product samples and prepare them for laboratory analysis or testing. |
| 63 | Core | Maintain, monitor, and clean work areas, such as recycling collection sites, drop boxes, counters and windows, and areas around scale houses. |
| 86 | Supplemental | Compare product labels, tags, or tickets, shipping manifests, purchase orders, and bills of lading to verify accuracy of shipment contents, quality specifications, or weights. |
| 84 | Supplemental | Remove from stock products or loads not meeting quality standards, and notify supervisors or appropriate departments of discrepancies or shortages. |
| 83 | Supplemental | Inspect products and examination records to determine the number of defects per worker and the reasons for examiners' rejections. |
| 82 | Supplemental | Store samples of finished products in labeled cartons and record their location. |
| 74 | Supplemental | Count or estimate quantities of materials, parts, or products received or shipped. |
| 74 | Supplemental | Communicate with customers and vendors to exchange information regarding products, materials, and services. |
| 73 | Supplemental | Fill orders for products and samples, following order tickets, and forward or mail items. |
| 70 | Supplemental | Operate scalehouse computers to obtain weight information about incoming shipments such as those from waste haulers. |
| 68 | Supplemental | Sort products or materials into predetermined sequences or groupings for display, packing, shipping, or storage. |
| 67 | Supplemental | Transport materials, products, or samples to processing, shipping, or storage areas, manually or using conveyors, pumps, or hand trucks. |
| 57 | Supplemental | Unload or unpack incoming shipments. |
...
| Enterprise resource planning ERP software | Infor XA; NetSuite ERP; Oracle JD Edwards EnterpriseOne; SAP software Hot Technology ; 2 more |
| Inventory management software | Inventory management systems In Demand ; Inventory software |
...
- Prepare products for testing. Related occupations
