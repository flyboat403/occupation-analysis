...
**Quick Facts:**
- SOC Code: 27-1012.00
- Also called: Artist, Ceramic Artist, Decorative Arts Production Artist, Fiber Artist, Fine Craft Artist, Glass Artist, Goldsmith, Hand-Weaver, Tapestry Artist, Textile Artist
...
|------------|----------|------|
| 98 | Core | Select materials for use based on strength, color, texture, balance, weight, size, malleability and other characteristics. |
| 93 | Core | Create functional or decorative objects by hand, using a variety of methods and materials. |
| 91 | Core | Develop concepts or creative ideas for craft objects. |
| 85 | Core | Apply finishes to objects being crafted. |
| 84 | Core | Cut, shape, fit, join, mold, or otherwise process materials, using hand tools, power tools, or machinery. |
| 77 | Core | Set specifications for materials, dimensions, and finishes. |
| 76 | Core | Advertise products and work, using media such as internet advertising and brochures. |
| 74 | Core | Sketch or draw objects to be crafted. |
| 72 | Core | Pack products for shipping. |
| 67 | Core | Fabricate patterns or templates to guide craft production. |
| 63 | Core | Create prototypes or models of objects to be crafted. |
| 60 | Core | Develop product packaging, display, and pricing strategies. |
| 58 | Core | Confer with customers to assess customer needs or obtain feedback. |
| 55 | Core | Plan and attend craft shows to market products. |
| 52 | Supplemental | Develop designs using specialized computer software. |
| 49 | Supplemental | Research craft trends, venues, and customer buying patterns to inspire designs and marketing strategies. |
...
| 32 | Dependability — A tendency to be reliable, responsible, and consistent in meeting work-related obligations. |
...
| 5 | Stress Tolerance — A tendency to cope and function effectively in stressful situations at work. |
| 3 | Cooperation — A tendency to be pleasant, helpful, and willing to assist others at work. |

### Professional Associations

- Craft Industry Alliance external site
- Society of North American Goldsmiths external site
- American Craft Council external site
- Association of Medical Illustrators external site
- Glass Art Society external site
- Handweavers Guild of America external site
- Indian Arts and Crafts Association external site
- National Association of Schools of Art and Design external site
- Surface Design Association external site
