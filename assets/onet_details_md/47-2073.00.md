...
**Quick Facts:**
- SOC Code: 47-2073.00
- Also called: Back Hoe Operator, Engineering Equipment Operator, Equipment Operator (EO), Forklift Operator, Heavy Equipment Operator (HEO), Hot Mix Asphalt Operator, Machine Operator, Motor Grader Operator, Operating Engineer, Track Hoe Operator
...
|------------|----------|------|
| 97 | Core | Learn and follow safety regulations. |
| 92 | Core | Take actions to avoid potential hazards or obstructions, such as utility lines, other equipment, other workers, or falling objects. |
| 90 | Core | Start engines, move throttles, switches, or levers, or depress pedals to operate machines, such as bulldozers, trench excavators, road graders, or backhoes. |
| 88 | Core | Coordinate machine actions with other activities, positioning or moving loads in response to hand or audio signals from crew members. |
| 87 | Core | Align machines, cutterheads, or depth gauge makers with reference stakes and guidelines or ground or position equipment, following hand signals of other workers. |
| 87 | Core | Locate underground services, such as pipes or wires, prior to beginning work. |
| 85 | Core | Signal operators to guide movement of tractor-drawn machines. |
| 85 | Core | Repair and maintain equipment, making emergency adjustments or assisting with major repairs as necessary. |
| 83 | Core | Load and move dirt, rocks, equipment, or other materials, using trucks, crawler tractors, power cranes, shovels, graders, or related equipment. |
| 82 | Core | Drive and maneuver equipment equipped with blades in successive passes over working areas to remove topsoil, vegetation, or rocks or to distribute and level earth or terrain. |
| 82 | Core | Operate tractors or bulldozers to perform such tasks as clearing land, mixing sludge, trimming backfills, or building roadways or parking lots. |
| 80 | Core | Monitor operations to ensure that health and safety standards are met. |
| 78 | Core | Connect hydraulic hoses, belts, mechanical linkages, or power takeoff shafts to tractors. |
| 78 | Core | Select and fasten bulldozer blades or other attachments to tractors, using hitches. |
| 75 | Core | Operate loaders to pull out stumps, rip asphalt or concrete, rough-grade properties, bury refuse, or perform general cleanup. |
| 71 | Core | Operate equipment to demolish or remove debris or to remove snow from streets, roads, or parking lots. |
| 71 | Core | Keep records of material or equipment usage or problems encountered. |
| 71 | Core | Adjust handwheels and depress pedals to control attachments, such as blades, buckets, scrapers, or swing booms. |
| 92 | Supplemental | Check fuel supplies at sites to ensure adequate availability. |
| 81 | Supplemental | Talk to clients and study instructions, plans, or diagrams to establish work requirements. |
| 70 | Supplemental | Drive tractor-trailer trucks to move equipment from site to site. |
| 65 | Supplemental | Push other equipment when extra traction or assistance is required. |
| 61 | Supplemental | Operate road watering, oiling, or rolling equipment, or street sealing equipment, such as chip spreaders. |
| 58 | Supplemental | Operate compactors, scrapers, or rollers to level, compact, or cover refuse at disposal grounds. |
| 56 | Supplemental | Test atmosphere for adequate oxygen or explosive conditions when working in confined spaces. |
| 52 | Supplemental | Turn valves to control air or water output of compressors or pumps. |
...
| 49 | Attention to Detail — A tendency to be detail-oriented, organized, and thorough in completing work. |
