...
**Quick Facts:**
- SOC Code: 51-9151.00
- Also called: Digital Printer Operator, Film Processor, Film Technician, Lab Technician, Photo Lab Specialist, Photo Lab Technician (Photographic Laboratory Technician), Photo Printer, Photo Specialist, Photo Technician
...
|------------|----------|------|
| 91 | Core | Select digital images for printing, specify number of images to be printed, and direct to printer, using computer software. |
| 89 | Core | Create prints according to customer specifications and laboratory protocols. |
| 88 | Core | Produce color or black-and-white photographs, negatives, or slides, applying standard photographic reproduction techniques and procedures. |
| 86 | Core | Set or adjust machine controls, according to specifications, type of operation, or material requirements. |
| 85 | Core | Review computer-processed digital images for quality. |
| 84 | Core | Operate scanners or related computer equipment to digitize negatives, photographic prints, or other images. |
| 83 | Core | Fill tanks of processing machines with solutions such as developer, dyes, stop-baths, fixers, bleaches, or washes. |
| 82 | Core | Measure and mix chemicals to prepare solutions for processing, according to formulas. |
| 81 | Core | Load digital images onto computers directly from cameras or from storage devices, such as flash memory cards or universal serial bus (USB) devices. |
| 80 | Core | Operate special equipment to perform tasks such as transferring film to videotape or producing photographic enlargements. |
| 79 | Core | Examine developed prints for defects, such as broken lines, spots, or blurs. |
| 79 | Core | Read work orders to determine required processes, techniques, materials, or equipment. |
| 74 | Core | Load circuit boards, racks or rolls of film, negatives, or printing paper into processing or printing machines. |
| 73 | Core | Insert processed negatives and prints into envelopes for delivery to customers. |
| 73 | Core | Reprint originals for enlargement or in sections to be pieced together. |
| 73 | Core | Clean or maintain photoprocessing or darkroom equipment, using ultrasonic equipment or cleaning and rinsing solutions. |
| 72 | Core | Monitor equipment operation to detect malfunctions. |
| 65 | Core | Maintain records, such as quantities or types of processing completed, materials used, or customer charges. |
| 76 | Supplemental | Immerse film, negatives, paper, or prints in developing solutions, fixing solutions, and water to complete photographic development processes. |
| 73 | Supplemental | Examine quality of film fades or dissolves for potential color corrections, using color analyzers. |
| 72 | Supplemental | Thread filmstrips through densitometers or sensitometers and expose film to light to determine density of film, necessary color corrections, or light sensitivity. |
| 70 | Supplemental | Examine drawings, negatives, or photographic prints to determine coloring, shading, accenting, or other changes required for retouching or restoration. |
| 69 | Supplemental | Place sensitized paper in frames of projection printers, photostats, or other reproduction machines. |
| 66 | Supplemental | Upload digital images onto Web sites for customers. |
| 61 | Supplemental | Produce timed prints with separate densities or color settings for each scene of a production. |
| 52 | Supplemental | Splice broken or separated film and mount film on reels. |
| 49 | Supplemental | Retouch photographic negatives or original prints to correct defects. |
...
| Data base user interface and query software | Amazon Web Services AWS software Hot Technology ; Microsoft Access Hot Technology ; MySQL Hot Technology ; Structured query language SQL Hot Technology |
...
| Graphics or photo imaging software | Adobe Creative Cloud software Hot Technology ; Adobe Illustrator Hot Technology ; Adobe Photoshop Hot Technology ; Camera Bits Photo Mechanic ; 3 more |
| Object or component oriented development software | TypeScript Hot Technology |
| Office suite software | Microsoft Office software Hot Technology |
| Presentation software | Microsoft PowerPoint Hot Technology |
| Spreadsheet software | Microsoft Excel |
| Web platform development software | Cascading style sheets CSS Hot Technology ; RESTful API |
...
- Apply decorative coloring to photographs or printed materials. Related occupations
