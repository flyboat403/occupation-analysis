...
**Quick Facts:**
- SOC Code: 31-2011.00
- Also called: Acute Care Occupational Therapy Assistant (Acute Care OT Assistant), Certified Occupational Assistant, Certified Occupational Therapist Assistant (COTA), Certified Occupational Therapy Assistant (COTA), Licensed Occupational Therapist Assistant (LOTA), Licensed Occupational Therapy Assistant (LOTA), Occupational Therapist Assistant (OTA), Occupational Therapy Assistant (OTA), Registered Therapist Assistant, School Based Certified Occupational Therapy Assistant (School Based COTA)
...
|------------|----------|------|
| 95 | Core | Instruct, or assist in instructing, patients and families in home programs, basic living skills, or the care and use of adaptive equipment. |
| 95 | Core | Maintain and promote a positive attitude toward clients and their treatment programs. |
| 94 | Core | Report to supervisors, verbally or in writing, on patients' progress, attitudes, and behavior. |
| 94 | Core | Implement, or assist occupational therapists with implementing, treatment plans designed to help clients function independently. |
| 94 | Core | Monitor patients' performance in therapy activities, providing encouragement. |
| 93 | Core | Observe and record patients' progress, attitudes, and behavior and maintain this information in client records. |
| 93 | Core | Select therapy activities to fit patients' needs and capabilities. |
| 92 | Core | Attend continuing education classes. |
| 92 | Core | Aid patients in dressing and grooming themselves. |
| 90 | Core | Evaluate the daily living skills or capacities of clients with physical, developmental, or mental health disabilities. |
| 89 | Core | Communicate and collaborate with other healthcare professionals involved with the care of a patient. |
| 89 | Core | Work under the direction of occupational therapists to plan, implement, or administer educational, vocational, or recreational programs that restore or enhance performance in individuals with functional impairments. |
| 87 | Core | Alter treatment programs to obtain better results if treatment is not having the intended effect. |
| 87 | Core | Assemble, clean, or maintain equipment or materials for patient use. |
| 84 | Core | Transport patients to and from the occupational therapy work area. |
| 84 | Core | Design, fabricate, or repair assistive devices or make adaptive changes to equipment or environments. |
| 83 | Core | Attend care plan meetings to review patient progress and update care plans. |
| 80 | Core | Demonstrate therapy techniques, such as manual or creative arts or games. |
| 80 | Core | Teach patients how to deal constructively with their emotions. |
| 74 | Core | Order any needed educational or treatment supplies. |
| 69 | Core | Perform clerical duties, such as scheduling appointments, collecting data, or documenting health insurance billings. |
| 67 | Supplemental | Assist educational specialists or clinical psychologists in administering situational or diagnostic tests to measure client's abilities or progress. |

## Technology Skills

| Hot Technology | Examples |
|----------------|----------|
| Accounting software | Bookkeeping software; Financial record software |
| Action games | BrainTrain SmartDriver |
| Billing and invoicing software | Billing software; Fifth Walk BillingTracker |
...
| Data base user interface and query software | Database software; dBASE; FileMaker Pro; Microsoft Access Hot Technology |
...
| Medical software | BrainTrain Captain's Log; eClinicalWorks EHR software Hot Technology ; Laboratory information system LIS; Visual Health Information VHI PC-Kits ; 4 more |
...
- Professional Association of Therapeutic Horsemanship International external site
