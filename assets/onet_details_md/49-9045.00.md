...
**Quick Facts:**
- SOC Code: 49-9045.00
- Also called: Cell Reliner, Cupola Repairer, Furnace Repairer, Hot Repairman, Ladle Liner, Ladle Repairman, Refractory Bricklayer, Refractory Technician, Refractory Worker
...
|------------|----------|------|
| 80 | Core | Reline or repair ladles and pouring spouts with refractory clay, using trowels. |
| 69 | Core | Chip slag from linings of ladles or remove linings when beyond repair, using hammers and chisels. |
| 66 | Core | Mix specified amounts of sand, clay, mortar powder, and water to form refractory clay or mortar, using shovels or mixing machines. |
| 83 | Supplemental | Measure furnace walls to determine dimensions and cut required number of sheets from plastic block, using saws. |
| 74 | Supplemental | Dry and bake new linings by placing inverted linings over burners, building fires in ladles, or by using blowtorches. |
| 72 | Supplemental | Remove worn or damaged plastic block refractory linings of furnaces, using hand tools. |
| 67 | Supplemental | Climb scaffolding, carrying hoses, and spray surfaces of cupolas with refractory mixtures, using spray equipment. |
| 64 | Supplemental | Spread mortar on stopper heads and rods, using trowels, and slide brick sleeves over rods to form refractory jackets. |
| 58 | Supplemental | Dump and tamp clay in molds, using tamping tools. |
| 55 | Supplemental | Transfer clay structures to curing ovens, melting tanks, and drawing kilns, using forklifts. |
