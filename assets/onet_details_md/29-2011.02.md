...
|------------|----------|------|
| 100 | Core | Examine cell samples to detect abnormalities in the color, shape, or size of cellular components and patterns. |
| 100 | Core | Document specimens by verifying patients' and specimens' information. |
| 99 | Core | Submit slides with abnormal cell structures to pathologists for further examination. |
| 97 | Core | Prepare and analyze samples, such as Papanicolaou (PAP) smear body fluids and fine needle aspirations (FNAs), to detect abnormal conditions. |
| 96 | Core | Examine specimens, using microscopes, to evaluate specimen quality. |
| 94 | Core | Maintain effective laboratory operations by adhering to standards of specimen collection, preparation, or laboratory safety. |
| 93 | Core | Provide patient clinical data or microscopic findings to assist pathologists in the preparation of pathology reports. |
| 92 | Core | Assist pathologists or other physicians to collect cell samples by fine needle aspiration (FNA) biopsy or other method. |
| 82 | Core | Prepare cell samples by applying special staining techniques, such as chromosomal staining, to differentiate cells or cell components. |
| 79 | Core | Adjust, maintain, or repair laboratory equipment, such as microscopes. |
| 75 | Core | Assign tasks or coordinate task assignments to ensure adequate performance of laboratory activities. |
| 68 | Core | Attend continuing education programs that address laboratory issues. |
| 35 | Supplemental | Examine specimens to detect abnormal hormone conditions. |
...
| Medical software | Aspyra CyberLAB; Fortius Lab Systems Clinical LIS; MEDITECH software Hot Technology ; Prognosis Innovation Healthcare ChartAccess ; 31 more |
...
- International Academy of Cytology external site
