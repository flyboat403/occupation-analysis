...
|------------|----------|------|
| 97 | Core | Monitor patient before, during, and after anesthesia and counteract adverse reactions or complications. |
| 96 | Core | Record type and amount of anesthesia and patient condition throughout procedure. |
| 96 | Core | Provide and maintain life support and airway management and help prepare patients for emergency surgery. |
| 95 | Core | Administer anesthetic or sedation during medical procedures, using local, intravenous, spinal, or caudal methods. |
| 95 | Core | Examine patient, obtain medical history, and use diagnostic tests to determine risk during surgical, obstetrical, and other medical procedures. |
| 93 | Core | Position patient on operating table to maximize patient comfort and surgical accessibility. |
| 91 | Core | Coordinate administration of anesthetics with surgeons during operation. |
| 91 | Core | Decide when patients have recovered or stabilized enough to be sent to another room or ward or to be sent home following outpatient surgery. |
| 88 | Core | Confer with other medical professionals to determine type and method of anesthetic or sedation to render patient insensible to pain. |
| 80 | Core | Order laboratory tests, x-rays, and other diagnostic procedures. |
| 80 | Core | Inform students and staff of types and methods of anesthesia administration, signs of complications, and emergency methods to counteract reactions. |
| 78 | Core | Provide medical care and consultation in many settings, prescribing medication and treatment and referring patients for surgery. |
| 78 | Core | Manage anesthesiological services, coordinating them with other medical activities and formulating plans and procedures. |
| 77 | Core | Diagnose illnesses, using examinations, tests, and reports. |
| 75 | Core | Coordinate and direct work of nurses, medical technicians, and other health care providers. |
| 62 | Core | Instruct individuals and groups on ways to preserve health and prevent disease. |
| 63 | Supplemental | Schedule and maintain use of surgical suite, including operating, wash-up, waiting rooms, or anesthetic and sterilizing equipment. |
| 62 | Supplemental | Conduct medical research to aid in controlling and curing disease, to investigate new medications, and to develop and test new medical techniques. |

## Technology Skills

| Hot Technology | Examples |
|----------------|----------|
| Billing and invoicing software | Healthpac Medical Billing |
| Calendar and scheduling software | AtStaff Physician Scheduler |
| Data base user interface and query software | Microsoft Access Hot Technology |
| Electronic mail software | Microsoft Outlook Hot Technology |
| Internet browser software | Web browser software |
| Medical software | EDImis Anesthesia Manager; Electronic medical record EMR software; Epic Systems ; MEDITECH software Hot Technology ; 6 more |
...
- Schedule medical facility use. Related occupations
...
|---|---|
| 97 | Medicine and Dentistry — Knowledge of the information and techniques needed to diagnose and treat human injuries, diseases, and deformities. This includes symptoms, treatment alternatives, drug properties and interactions, and preventive health-care measures. |
...
- American Osteopathic College of Anesthesiologists external site
...
- National Medical Association external site
- Society for Ambulatory Anesthesia external site
- Society for Education in Anesthesia external site
