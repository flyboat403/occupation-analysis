...
**Quick Facts:**
- SOC Code: 51-4023.00
- Also called: Breakdown Mill Operator, Calender Operator, Cold Mill Operator, Machine Operator, Mill Operator, Rolling Mill Operator, Roughing Mill Operator, Temper Mill Operator, Tube Mill Operator, Weld Mill Operator
...
|------------|----------|------|
| 89 | Core | Monitor machine cycles and mill operation to detect jamming and to ensure that products conform to specifications. |
| 89 | Core | Adjust and correct machine set-ups to reduce thicknesses, reshape products, and eliminate product defects. |
| 87 | Core | Start operation of rolling and milling machines to flatten, temper, form, and reduce sheet metal sections and to produce steel strips. |
| 85 | Core | Examine, inspect, and measure raw materials and finished products to verify conformance to specifications. |
| 84 | Core | Read rolling orders, blueprints, and mill schedules to determine setup specifications, work sequences, product dimensions, and installation procedures. |
| 82 | Core | Manipulate controls and observe dial indicators to monitor, adjust, and regulate speeds of machine mechanisms. |
| 79 | Core | Set distance points between rolls, guides, meters, and stops, according to specifications. |
| 78 | Core | Calculate draft space and roll speed for each mill stand to plan rolling sequences and specified dimensions and tempers. |
| 78 | Core | Install equipment such as guides, guards, gears, cooling equipment, and rolls, using hand tools. |
| 76 | Core | Position, align, and secure arbors, spindles, coils, mandrels, dies, and slitting knives. |
| 72 | Core | Fill oil cups, adjust valves, and observe gauges to control flow of metal coolants and lubricants onto workpieces. |
| 71 | Core | Activate shears and grinders to trim workpieces. |
| 71 | Core | Signal and assist other workers to remove and position equipment, fill hoppers, and feed materials into machines. |
| 70 | Core | Record mill production on schedule sheets. |
| 68 | Core | Direct and train other workers to change rolls, operate mill equipment, remove coils and cobbles, and band and load material. |
| 82 | Supplemental | Thread or feed sheets or rods through rolling mechanisms, or start and control mechanisms that automatically feed steel into rollers. |
| 77 | Supplemental | Select rolls, dies, roll stands, and chucks from data charts to form specified contours and to fabricate products. |
| 69 | Supplemental | Remove scratches and polish roll surfaces, using polishing stones and electric buffers. |
| 66 | Supplemental | Disassemble sizing mills removed from rolling lines, and sort and store parts. |
