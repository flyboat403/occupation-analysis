...
|------------|----------|------|
| 80 | Core | Check the forms that hold the concrete to see that they are properly constructed. |
| 78 | Core | Set the forms that hold concrete to the desired pitch and depth, and align them. |
| 77 | Core | Spread, level, and smooth concrete, using rake, shovel, hand or power trowel, hand or power screed, and float. |
| 75 | Core | Monitor how the wind, heat, or cold affect the curing of the concrete throughout the entire process. |
| 72 | Core | Mold expansion joints and edges, using edging tools, jointers, and straightedge. |
| 72 | Core | Signal truck driver to position truck to facilitate pouring concrete, and move chute to direct concrete on forms. |
| 71 | Core | Direct the casting of the concrete and supervise laborers who use shovels or special tools to spread it. |
| 70 | Core | Produce rough concrete surface, using broom. |
| 69 | Core | Apply hardening and sealing compounds to cure surface of concrete, and waterproof or restore surface. |
| 67 | Core | Operate power vibrator to compact concrete. |
| 66 | Core | Install anchor bolts, steel plates, door sills and other fixtures in freshly poured concrete or pattern or stamp the surface to provide a decorative finish. |
| 66 | Core | Wet surface to prepare for bonding, fill holes and cracks with grout or slurry, and smooth, using trowel. |
| 64 | Core | Waterproof or restore concrete surfaces, using appropriate compounds. |
| 62 | Core | Mix cement, sand, and water to produce concrete, grout, or slurry, using hoe, trowel, tamper, scraper, or concrete-mixing machine. |
| 58 | Core | Chip, scrape, and grind high spots, ridges, and rough projections to finish concrete, using pneumatic chisels, power grinders, or hand tools. |
| 57 | Core | Cut out damaged areas, drill holes for reinforcing rods, and position reinforcing rods to repair concrete, using power saw and drill. |
| 57 | Core | Wet concrete surface, and rub with stone to smooth surface and obtain specified finish. |
| 54 | Core | Clean chipped area, using wire brush, and feel and observe surface to determine if it is rough or uneven. |
| 54 | Core | Build wooden molds, and clamp molds around area to be repaired, using hand tools. |
| 58 | Supplemental | Sprinkle colored marble or stone chips, powdered steel, or coloring powder over surface to produce prescribed finish. |
| 56 | Supplemental | Fabricate concrete beams, columns, and panels. |
| 55 | Supplemental | Polish surface, using polishing or surfacing machine. |
| 53 | Supplemental | Cut metal division strips, and press them into terrazzo base so that top edges form desired design or pattern. |
| 50 | Supplemental | Push roller over surface to embed chips in surface. |
| 47 | Supplemental | Apply muriatic acid to clean surface, and rinse with water. |
| 45 | Supplemental | Spread roofing paper on surface of foundation, and spread concrete onto roofing paper with trowel to form terrazzo base. |
...
| 56 | Dynamic Strength — The ability to exert muscle force repeatedly or continuously over time. This involves muscular endurance and resistance to muscle fatigue. |
...
- Portland Cement Association external site
