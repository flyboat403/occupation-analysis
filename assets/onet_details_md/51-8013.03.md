...
**Quick Facts:**
- SOC Code: 51-8013.03
- Also called: Auxiliary Operator, Central Heating Plant Operator, Fuel Handler, Fuel Quality Technician (Fuel Quality Tech), Heating Plant Operator, Operations Technician (Operations Tech), Plant Operator, Plant Technician, Steam Plant Operator
...
|------------|----------|------|
| 94 | Core | Operate biomass fuel-burning boiler or biomass fuel gasification system equipment in accordance with specifications or instructions. |
| 91 | Core | Perform tests of water chemistry in boilers. |
| 90 | Core | Operate high-pressure steam boiler or water chiller equipment for electrical cogeneration operations. |
| 88 | Core | Operate equipment to heat biomass, using knowledge of controls, combustion, and firing mechanisms. |
| 88 | Core | Operate equipment to start, stop, or regulate biomass-fueled generators, generator units, boilers, engines, or auxiliary systems. |
| 86 | Core | Inspect biomass power plant or processing equipment, recording or reporting damage and mechanical problems. |
| 86 | Core | Record or report operational data, such as readings on meters, instruments, and gauges. |
| 84 | Core | Operate valves, pumps, engines, or generators to control and adjust production of biofuels or biomass-fueled power. |
| 83 | Core | Calculate, measure, load, or mix biomass feedstock for power generation. |
| 79 | Core | Clean work areas to ensure compliance with safety regulations. |
| 78 | Core | Perform routine maintenance or make minor repairs to mechanical, electrical, or electronic equipment in biomass plants. |
| 73 | Core | Measure and monitor raw biomass feedstock, including wood, waste, or refuse materials. |
| 72 | Core | Calibrate liquid flow devices or meters, including fuel, chemical, and water meters. |
| 68 | Core | Assess quality of biomass feedstock. |
| 68 | Core | Read and interpret instruction manuals or technical drawings related to biomass-fueled power or biofuels production equipment or processes. |
| 65 | Core | Operate heavy equipment, such as bulldozers and front-end loaders. |
| 72 | Supplemental | Preprocess feedstock to prepare for biochemical or thermochemical production processes. |
| 61 | Supplemental | Manage parts and supply inventories for biomass plants. |
