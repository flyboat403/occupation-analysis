...
**Quick Facts:**
- SOC Code: 53-5011.00
- Also called: Able Bodied Seaman (AB Seaman), Able Bodied Watchman (AB Watchman), Able Seaman, Boat Crew Deck Hand, Bosun, Deck Hand, Deckhand, Deckhand Engineer, Oiler, Tankerman
...
|------------|----------|------|
| 89 | Core | Tie barges together into tow units for tugboats to handle, inspecting barges periodically during voyages and disconnecting them when destinations are reached. |
| 87 | Core | Attach hoses and operate pumps to transfer substances to and from liquid cargo tanks. |
| 86 | Core | Handle lines to moor vessels to wharfs, to tie up vessels to other vessels, or to rig towing lines. |
| 82 | Core | Read pressure and temperature gauges or displays and record data in engineering logs. |
| 81 | Core | Stand watch in ships' bows or bridge wings to look for obstructions in a ship's path or to locate navigational aids, such as buoys or lighthouses. |
| 80 | Core | Maintain government-issued certifications, as required. |
| 80 | Core | Examine machinery to verify specified pressures or lubricant flows. |
| 79 | Core | Maintain a ship's engines under the direction of the ship's engineering officers. |
| 76 | Core | Break out, rig, and stow cargo-handling gear, stationary rigging, or running gear. |
| 76 | Core | Lubricate machinery, equipment, or engine parts, such as gears, shafts, or bearings. |
| 74 | Core | Lower and man lifeboats when emergencies occur. |
| 70 | Core | Sweep, mop, and wash down decks to remove oil, dirt, and debris, using brooms, mops, brushes, and hoses. |
| 68 | Core | Splice and repair ropes, wire cables, or cordage, using marlinespikes, wire cutters, twine, and hand tools. |
| 64 | Core | Load or unload materials, vehicles, or passengers from vessels. |
| 64 | Core | Chip and clean rust spots on decks, superstructures, or sides of ships, using wire brushes and hand or air chipping machines. |
| 61 | Core | Provide engineers with assistance in repairing or adjusting machinery. |
| 61 | Core | Operate, maintain, or repair ship equipment, such as winches, cranes, derricks, or weapons system. |
| 60 | Core | Paint or varnish decks, superstructures, lifeboats, or sides of ships. |
| 53 | Core | Give directions to crew members engaged in cleaning wheelhouses or quarterdecks. |
| 76 | Supplemental | Stand by wheels when ships are on automatic pilot, and verify accuracy of courses, using magnetic compasses. |
| 75 | Supplemental | Steer ships under the direction of commanders or navigating officers or direct helmsmen to steer, following designated courses. |
| 72 | Supplemental | Relay specified signals to other ships, using visual signaling devices, such as blinker lights or semaphores. |
| 69 | Supplemental | Overhaul lifeboats or lifeboat gear and lower or raise lifeboats with winches or falls. |
| 64 | Supplemental | Stand gangway watches to prevent unauthorized persons from boarding ships while in port. |
| 63 | Supplemental | Record data in ships' logs, such as weather conditions or distances traveled. |
| 47 | Supplemental | Measure depth of water in shallow or unfamiliar waters, using leadlines, and telephone or shout depth information to vessel bridges. |
| 41 | Supplemental | Clean and polish wood trim, brass, or other metal parts. |
...
- Secure watercraft to docks, wharves or other vessels. Related occupations
...
- Set up material handling gear or equipment, such as rigging, packaging, or temporary structures. Related occupations
...
- Clean vessels or marine equipment. Related occupations
