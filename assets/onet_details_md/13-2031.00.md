...
**Quick Facts:**
- SOC Code: 13-2031.00
- Also called: Budget Analyst, Budget and Policy Analyst, Budget Coordinator, Budget Officer, Budget Planning Analyst, Cost Analyst, Financial Services Officer, Fiscal Analyst, Fiscal Budget Analyst
...
|------------|----------|------|
| 84 | Core | Analyze monthly department budgeting and accounting reports to maintain expenditure controls. |
| 84 | Core | Provide advice and technical assistance with cost analysis, fiscal allocation, and budget preparation. |
| 79 | Core | Review operating budgets to analyze trends affecting budget needs. |
| 78 | Core | Compile and analyze accounting records and other data to determine the financial resources required to implement a program. |
| 77 | Core | Examine budget estimates for completeness, accuracy, and conformance with procedures and regulations. |
| 77 | Core | Summarize budgets and submit recommendations for the approval or disapproval of funds requests. |
| 77 | Core | Consult with managers to ensure that budget adjustments are made in accordance with program changes. |
| 76 | Core | Direct the preparation of regular and special budget reports. |
| 75 | Core | Interpret budget directives and establish policies for carrying out directives. |
| 68 | Core | Perform cost-benefit analyses to compare operating programs, review financial requests, or explore alternative financing methods. |
| 62 | Core | Match appropriations for specific programs with appropriations for broader programs, including items for emergency funds. |
| 59 | Core | Seek new ways to improve efficiency and increase profits. |
| 70 | Supplemental | Testify before examining and fund-granting authorities, clarifying and promoting the proposed budgets. |
...
| Business intelligence and data analysis software | IBM Cognos Business Intelligence; Microsoft Power BI |
| Data base reporting software | SAP BusinessObjects Crystal Reports |
| Data base user interface and query software | Microsoft Access ; Online analytical processing OLAP software; Relational database software; Structured query language SQL Hot Technology |
| Development environment software | Business Objects Data Integrator; Microsoft Visual Basic Hot Technology |
| Document management software | Microsoft SharePoint Hot Technology |
| Electronic mail software | Email software; Microsoft Outlook |
| Enterprise resource planning ERP software | Microsoft Dynamics GP; Oracle Hyperion; Sage Active Planner; SAP software ; 18 more |
...
|---|---|
| 86 | Economics and Accounting — Knowledge of economic and accounting principles and practices, the financial markets, banking, and the analysis and reporting of financial data. |
...
- Financial Managers Society external site
- Government Finance Officers Association external site
- National Association of State Budget Officers external site
