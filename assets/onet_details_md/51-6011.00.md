...
**Quick Facts:**
- SOC Code: 51-6011.00
- Also called: Dry Cleaner, Laundry Aide, Laundry Assistant, Laundry Attendant, Laundry Housekeeper, Laundry Technician, Laundry Worker, Personal Clothing Laundry Aide, Spotter
...
|------------|----------|------|
| 84 | Core | Load articles into washers or dry-cleaning machines, or direct other workers to perform loading. |
| 83 | Core | Start washers, dry cleaners, driers, or extractors, and turn valves or levers to regulate machine processes and the volume of soap, detergent, water, bleach, starch, and other additives. |
| 81 | Core | Operate extractors and driers, or direct their operation. |
| 80 | Core | Remove items from washers or dry-cleaning machines, or direct other workers to do so. |
| 80 | Core | Sort and count articles removed from dryers, and fold, wrap, or hang them. |
| 79 | Core | Clean machine filters, and lubricate equipment. |
| 78 | Core | Examine and sort into lots articles to be cleaned, according to color, fabric, dirt content, and cleaning technique required. |
| 77 | Core | Receive and mark articles for laundry or dry cleaning with identifying code numbers or names, using hand or machine markers. |
| 83 | Supplemental | Apply bleaching powders to spots and spray them with steam to remove stains from fabrics that do not respond to other cleaning solvents. |
| 77 | Supplemental | Determine spotting procedures and proper solvents, based on fabric and stain types. |
| 77 | Supplemental | Spray steam, water, or air over spots to flush out chemicals, dry material, raise naps, or brighten colors. |
| 75 | Supplemental | Pre-soak, sterilize, scrub, spot-clean, and dry contaminated or stained articles, using neutralizer solutions and portable machines. |
| 75 | Supplemental | Mix bleaching agents with hot water in vats, and soak material until it is bleached. |
| 72 | Supplemental | Mix and add detergents, dyes, bleaches, starches, and other solutions and chemicals to clean, color, dry, or stiffen articles. |
| 72 | Supplemental | Sprinkle chemical solvents over stains, and pat areas with brushes or sponges to remove stains. |
| 71 | Supplemental | Match sample colors, applying knowledge of bleaching agent and dye properties, and types, construction, conditions, and colors of articles. |
| 71 | Supplemental | Inspect soiled articles to determine sources of stains, to locate color imperfections, and to identify items requiring special treatment. |
| 70 | Supplemental | Operate machines that comb, dry and polish furs, clean, sterilize and fluff feathers and blankets, or roll and package towels. |
| 68 | Supplemental | Iron or press articles, fabrics, and furs, using hand irons or pressing machines. |
| 67 | Supplemental | Hang curtains, drapes, blankets, pants, and other garments on stretch frames to dry. |
| 61 | Supplemental | Identify articles' fabrics and original dyes by sight and touch, or by testing samples with fire or chemical reagents. |
| 60 | Supplemental | Immerse articles in bleaching baths to strip colors. |
| 58 | Supplemental | Spread soiled articles on work tables, and position stained portions over vacuum heads or on marble slabs. |

## Technology Skills

| Hot Technology | Examples |
|----------------|----------|
| Data base user interface and query software | Property management system PMS software |
...
| 28 | Updating and Using Relevant Knowledge — Keeping up-to-date technically and applying new knowledge to your job. |
...
- Coin Laundry Association external site
- Drycleaning and Laundry Institute International external site
