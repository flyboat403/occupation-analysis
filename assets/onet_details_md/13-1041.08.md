...
|------------|----------|------|
| 96 | Core | Prepare and process import and export documentation according to customs regulations, laws, or procedures. |
| 96 | Core | Clear goods through customs and to their destinations for clients. |
| 94 | Core | Pay, or arrange for payment of, taxes and duties on shipments. |
| 94 | Core | Calculate duty and tariff payments owed on shipments. |
| 91 | Core | Request or compile necessary import documentation, such as customs invoices, certificates of origin, and cargo-control documents. |
| 90 | Core | Classify goods according to tariff coding system. |
| 86 | Core | Stay abreast of changes in import or export laws or regulations by reading current literature, attending meetings or conferences, or conferring with colleagues. |
| 86 | Core | Sign documents on behalf of clients, using powers of attorney. |
| 81 | Core | Advise customers on import and export restrictions, tariff systems, insurance requirements, quotas, or other customs-related matters. |
| 79 | Core | Post bonds for the products being imported or assist clients in obtaining bonds. |
| 78 | Core | Quote duty and tax rates on goods to be imported, based on federal tariffs and excise taxes. |
| 76 | Core | Arrange for transportation, warehousing, or product distribution of imported or exported products. |
| 76 | Core | Monitor or trace the location of goods. |
| 75 | Core | Confer with officials in various agencies to facilitate clearance of goods through customs and quarantine. |
| 70 | Core | Inform importers and exporters of steps to reduce duties and taxes. |
| 62 | Core | Obtain line releases for frequent shippers of low-risk commodities, high-volume entries, or multiple-container loads. |
| 62 | Core | Provide advice on transportation options, types of carriers, or shipping routes. |
| 60 | Core | Contract with freight forwarders for destination services. |
| 58 | Core | Apply for tariff concessions or for duty drawbacks and other refunds. |
| 57 | Core | Insure cargo against loss, damage, or pilferage. |
| 50 | Core | Prepare papers for shippers to appeal duty charges. |
| 49 | Supplemental | Suggest best methods of packaging or labeling products. |
| 46 | Supplemental | Maintain relationships with customs brokers in other ports to expedite clearing of cargo. |
...
| Data base user interface and query software | Automated commercial environment software ACE; Customs records databases; Microsoft Access Hot Technology ; Tariff databases ; 1 more |
...
|---|---|
| 79 | Transportation — Knowledge of principles and methods for moving people or goods by air, rail, sea, or road, including the relative costs and benefits. |
...
- American Association of Exporters and Importers external site
- National Customs Brokers and Forwarders Association of America external site
- United Shipping external site
