...
|------------|----------|------|
| 95 | Core | Translate nursing practice information between nurses and systems engineers, analysts, or designers, using object-oriented models or other techniques. |
| 93 | Core | Use informatics science to design or implement health information technology applications for resolution of clinical or health care administrative problems. |
| 86 | Core | Develop or implement policies or practices to ensure the privacy, confidentiality, or security of patient information. |
| 83 | Core | Analyze and interpret patient, nursing, or information systems data to improve nursing services. |
| 81 | Core | Identify, collect, record, or analyze data relevant to the nursing care of patients. |
| 80 | Core | Apply knowledge of computer science, information science, nursing, and informatics theory to nursing practice, education, administration, or research, in collaboration with other health informatics specialists. |
| 79 | Core | Develop, implement, or evaluate health information technology applications, tools, processes, or structures to assist nurses with data management. |
| 79 | Core | Design, develop, select, test, implement, and evaluate new or modified informatics solutions, data structures, and decision-support mechanisms to support patients, health care professionals, and their information management and human-computer and human-technology interactions within health care contexts. |
| 75 | Core | Disseminate information about nursing informatics science and practice to the profession, other health care professions, nursing students, and the public. |
| 73 | Core | Analyze computer and information technologies to determine applicability to nursing practice, education, administration, and research. |
| 70 | Core | Develop strategies, policies or procedures for introducing, evaluating, or modifying information technology applied to nursing practice, administration, education, or research. |
| 68 | Core | Read current literature, talk with colleagues, and participate in professional organizations or conferences to keep abreast of developments in informatics. |
| 68 | Core | Develop or deliver training programs for health information technology, creating operating manuals as needed. |
| 68 | Core | Design, conduct, or provide support to nursing informatics research. |
| 67 | Core | Inform local, state, national, and international health policies related to information management and communication, confidentiality and security, patient safety, infrastructure development, and economics. |
| 61 | Core | Provide consultation to nurses regarding hardware or software configuration. |
| 44 | Supplemental | Plan, install, repair, or troubleshoot telehealth technology applications or systems in homes. |

## Technology Skills

| Hot Technology | Examples |
|----------------|----------|
| Analytical or scientific software | IBM SPSS Statistics Hot Technology ; SAS |
...
| Medical software | eClinicalWorks EHR software Hot Technology ; Epic Systems Hot Technology ; GE Healthcare Centricity EMR; MEDITECH software Hot Technology ; 25 more |
| Object or component oriented development software | Microsoft SQL Server Reporting Services SSRS Hot Technology ; Perl Hot Technology ; Python ; R ; 1 more |
...
| Web platform development software | JavaScript Hot Technology ; LAMP Stack |
...
- Design healthcare-related software applications. Related occupations
