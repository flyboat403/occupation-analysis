...
**Quick Facts:**
- SOC Code: 43-5032.00
- Also called: Aircraft Dispatcher, Charter Coordinator, City Dispatcher, Dispatcher (Dispatch), Mine Dispatcher, Paratransit Dispatcher, School Bus Dispatcher, Taxi Dispatcher, Train Dispatcher, Truck Dispatcher
...
|------------|----------|------|
| 95 | Core | Schedule or dispatch workers, work crews, equipment, or service vehicles to appropriate locations, according to customer requests, specifications, or needs, using radios or telephones. |
| 92 | Core | Prepare daily work and run schedules. |
| 91 | Core | Confer with customers or supervising personnel to address questions, problems, or requests for service or equipment. |
| 91 | Core | Relay work orders, messages, or information to or from work crews, supervisors, or field inspectors, using telephones or two-way radios. |
| 87 | Core | Receive or prepare work orders. |
| 85 | Core | Record and maintain files or records of customer requests, work or services performed, charges, expenses, inventory, or other dispatch information. |
| 85 | Core | Arrange for necessary repairs to restore service and schedules. |
| 84 | Core | Monitor personnel or equipment locations and utilization to coordinate service and schedules. |
| 79 | Core | Determine types or amounts of equipment, vehicles, materials, or personnel required, according to work orders or specifications. |
| 68 | Core | Advise personnel about traffic problems, such as construction areas, accidents, congestion, weather conditions, or other hazards. |
| 88 | Supplemental | Oversee all communications within specifically assigned territories. |
| 64 | Supplemental | Order supplies or equipment and issue them to personnel. |
...
| Data base user interface and query software | Database software; Microsoft Access Hot Technology ; Tangier Sky Scheduler View |
| Electronic mail software | Email software; Microsoft Outlook |
| Enterprise resource planning ERP software | Microsoft Dynamics; SAP software Hot Technology ; TMW PowerSuite |
...
- Airline Dispatchers Federation external site
