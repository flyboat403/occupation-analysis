...
**Quick Facts:**
- SOC Code: 51-2051.00
- Also called: Boat Builder, Boat Carpenter, Chopper Gun Operator, Fiberglass Laminator, Fiberglass Technician, Fiberglasser, Gel-Coater, Lamination Technician, Laminator, Roller
...
|------------|----------|------|
| 89 | Core | Release air bubbles and smooth seams, using rollers. |
| 87 | Core | Spray chopped fiberglass, resins, and catalysts onto prepared molds or dies using pneumatic spray guns with chopper attachments. |
| 86 | Core | Mix catalysts into resins, and saturate cloth and mats with mixtures, using brushes. |
| 85 | Core | Check completed products for conformance to specifications and for defects by measuring with rulers or micrometers, by checking them visually, or by tapping them to detect bubbles or dead spots. |
| 82 | Core | Pat or press layers of saturated mat or cloth into place on molds, using brushes or hands, and smooth out wrinkles and air bubbles with hands or squeegees. |
| 81 | Core | Select precut fiberglass mats, cloth, and wood-bracing materials as required by projects being assembled. |
| 76 | Core | Bond wood reinforcing strips to decks and cabin structures of watercraft, using resin-saturated fiberglass. |
| 71 | Core | Trim excess materials from molds, using hand shears or trimming knives. |
| 86 | Supplemental | Apply layers of plastic resin to mold surfaces prior to placement of fiberglass mats, repeating layers until products have the desired thicknesses and plastics have jelled. |
| 82 | Supplemental | Inspect, clean, and assemble molds before beginning work. |
| 80 | Supplemental | Cure materials by letting them set at room temperature, placing them under heat lamps, or baking them in ovens. |
| 77 | Supplemental | Apply lacquers and waxes to mold surfaces to facilitate assembly and removal of laminated parts. |
| 76 | Supplemental | Repair or modify damaged or defective glass-fiber parts, checking thicknesses, densities, and contours to ensure a close fit after repair. |
| 76 | Supplemental | Mask off mold areas not to be laminated, using cellophane, wax paper, masking tape, or special sprays containing mold-release substances. |
| 72 | Supplemental | Check all dies, templates, and cutout patterns to be used in the manufacturing process to ensure that they conform to dimensional data, photographs, blueprints, samples, or customer specifications. |
| 67 | Supplemental | Trim cured materials by sawing them with diamond-impregnated cutoff wheels. |
