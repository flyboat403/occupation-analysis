...
**Quick Facts:**
- SOC Code: 13-1161.01
- Also called: Digital Marketing Strategist, Digital Media Planner, Internet Marketing Specialist, Marketing Consultant, Online Marketing Consultant, Paid Search Consultant, Paid Search Strategist, Search Engine Optimization Consultant (SEO Consultant), SEO Strategist (Search Engine Optimization Strategist), Social Media Specialist
...
|------------|----------|------|
| 88 | Core | Manage tracking and reporting of search-related activities and provide analyses to marketing executives. |
| 88 | Core | Optimize digital assets, such as text, graphics, or multimedia assets, for search engine optimization (SEO) or for display and usability on internet-connected devices. |
| 88 | Core | Collect and analyze Web metrics, such as visits, time on site, page views per visit, transaction volume and revenue, traffic mix, click-through rates, conversion rates, cost per acquisition, or cost per click. |
| 88 | Core | Participate in the development or implementation of online marketing strategy. |
| 82 | Core | Optimize Web site exposure by analyzing search engine patterns to direct online placement of keywords or other content. |
| 82 | Core | Coordinate with developers to optimize Web site architecture, server configuration, or page construction for search engine consumption and optimal visibility. |
| 79 | Core | Assist in setting up or optimizing analytics tools for tracking visitors' behaviors. |
| 79 | Core | Identify appropriate Key Performance Indicators (KPIs) and report key metrics from digital campaigns. |
| 79 | Core | Create content strategies for digital media. |
| 77 | Core | Combine secondary data sources with keyword research to more accurately profile and satisfy user intent. |
| 72 | Core | Collaborate with other marketing staff to integrate and complement marketing strategies across multiple sales channels. |
| 72 | Core | Optimize shopping cart experience or Web site conversion rates against Key Performance Indicators (KPIs). |
| 71 | Core | Improve search-related activities through ongoing analysis, experimentation, or optimization tests, using A/B or multivariate methods. |
| 68 | Core | Conduct online marketing initiatives, such as paid ad placement, affiliate programs, sponsorship programs, email promotions, or viral marketing campaigns on social media Web sites. |
| 65 | Core | Conduct market research analysis to identify search query trends, real-time search and news media activity, popular social media topics, electronic commerce trends, market opportunities, or competitor performance. |
| 63 | Core | Propose online or multiple-sales-channel campaigns to marketing executives. |
| 62 | Core | Evaluate new emerging media or technologies and make recommendations for their application within Internet marketing or search marketing campaigns. |
| 62 | Core | Communicate and collaborate with merchants, Webmasters, bloggers, or online editors to strategically place hyperlinks. |
| 61 | Core | Identify, evaluate, or procure hardware or software for implementing online marketing campaigns. |
| 60 | Core | Collaborate with Web, multimedia, or art design staffs to create multimedia Web sites or other internet content that conforms to brand and company visual format. |
| 57 | Core | Keep abreast of government regulations and emerging Web technology to ensure regulatory compliance by reviewing current literature, talking with colleagues, participating in educational programs, attending meetings or workshops, or participating in professional organizations or conferences. |
| 56 | Core | Purchase or negotiate placement of listings in local search engines, directories, or digital mapping technologies. |
| 53 | Core | Coordinate sales or other promotional strategies with merchandising, operations, or inventory control staff to ensure product catalogs are current, accurate, and organized for best findability against user intent. |
| 51 | Core | Execute or manage social media campaigns to inform search marketing tactics. |
| 50 | Core | Conduct financial modeling for online marketing programs or Web site revenue forecasting. |
| 61 | Supplemental | Implement online customer service processes to ensure positive and consistent user experiences. |
| 53 | Supplemental | Develop transactional Web applications, using Web programming software and knowledge of programming languages, such as hypertext markup language (HTML) and extensible markup language (XML). |
| 50 | Supplemental | Identify and develop commercial or technical specifications, such as usability, pricing, checkout, or data security, to promote transactional internet-enabled commerce functionality. |
| 49 | Supplemental | Define product requirements, based on market research analysis, in collaboration with user interface design and engineering staff. |
| 47 | Supplemental | Execute or manage banner, video, or other non-text link ad campaigns. |
| 46 | Supplemental | Assist in the evaluation or negotiation of contracts with vendors or online partners. |
| 46 | Supplemental | Prepare electronic commerce designs or prototypes, such as storyboards, mock-ups, or other content, using graphics design software. |
| 44 | Supplemental | Assist in the development of online transaction or security policies. |
| 44 | Supplemental | Execute and manage communications with digital journalists or bloggers. |
| 42 | Supplemental | Resolve product availability problems in collaboration with customer service staff. |
| 33 | Supplemental | Identify methods for interfacing Web application technologies with enterprise resource planning or other system software. |

## Technology Skills

| Hot Technology | Examples |
|----------------|----------|
| Analytical or scientific software | Adobe Analytics In Demand |
| Business intelligence and data analysis software | BrightEdge; IBM Digital Analytics; Searchmetrics Suite; Tableau Hot Technology ; 2 more |
| Customer relationship management CRM software | Customer information databases; Oracle Eloqua |
| Data base management system software | Apache Solr; Elasticsearch Hot Technology ; MySQL Hot Technology |
| Data base user interface and query software | Microsoft Access Hot Technology ; Microsoft SQL Server Hot Technology ; Online databases; Structured query language SQL Hot Technology ; 3 more |
| Data mining software | Google Analytics |
| Document management software | Open Source Matters Joomla! |
| Electronic mail software | Email software; Microsoft Outlook Hot Technology ; Yahoo! Email |
...
| Object or component oriented development software | Oracle Java Hot Technology ; Python |
| Office suite software | Microsoft Office software |
| Presentation software | Microsoft PowerPoint |
| Process mapping and design software | Microsoft Visio Hot Technology |
| Project management software | Microsoft Project Hot Technology |
| Sales and marketing software | Google Ads In Demand ; Google Tag Manager In Demand ; HubSpot software Hot Technology ; Marketo Marketing Automation Hot Technology ; 2 more |
| Spreadsheet software | Microsoft Excel |
| Video creation and editing software | YouTube |
| Web page creation and editing software | Adobe Dreamweaver; Facebook Hot Technology ; Google Webmaster Tools; WordPress ; 2 more |
| Web platform development software | AJAX Hot Technology ; Cascading style sheets CSS ; Microsoft ASP.NET Hot Technology ; PHP Hot Technology ; 10 more |
...
| 86 | Developing Objectives and Strategies — Establishing long-range objectives and specifying the strategies and actions to achieve them. |
...
|---|---|
| 90 | Sales and Marketing — Knowledge of principles and methods for showing, promoting, and selling products or services. This includes marketing strategy and tactics, product demonstration, sales techniques, and sales control systems. |
| 83 | Computers and Electronics — Knowledge of circuit boards, processors, chips, electronic equipment, and computer hardware and software, including applications and programming. |
...
| 72 | Communications and Media — Knowledge of media production, communication, and dissemination techniques and methods. This includes alternative ways to inform and entertain via written, oral, and visual media. |
