...
**Quick Facts:**
- SOC Code: 35-9031.00
- Also called: Buffet Hostess, Dining Coordinator, General Teller, Greeter, Hospitality Coordinator, Host, Host Coordinator, Hostess, Maitre D' (Maitre d'hotel), Seater
...
| 92 | Core | Greet guests and seat them at tables or in waiting areas. |
| 90 | Core | Maintain contact with kitchen staff, management, serving staff, and customers to ensure that dining details are handled properly and customers' concerns are addressed. |
| 86 | Core | Assign patrons to tables suitable for their needs and according to rotation so that servers receive an appropriate number of seatings. |
| 84 | Core | Speak with patrons to ensure satisfaction with food and service, to respond to complaints, or to make conversation. |
| 83 | Core | Inspect dining and serving areas to ensure cleanliness and proper setup. |
| 82 | Core | Supervise and coordinate activities of dining room staff to ensure that patrons receive prompt and courteous service. |
| 82 | Core | Answer telephone calls and respond to inquiries or transfer calls. |
| 81 | Core | Assist other restaurant workers by serving food and beverages, or by bussing tables. |
| 80 | Core | Inspect restrooms for cleanliness and availability of supplies, and clean restrooms when necessary. |
| 77 | Core | Take and prepare to-go orders. |
| 74 | Core | Inform patrons of establishment specialties and features. |
| 73 | Core | Receive and record patrons' dining reservations. |
| 83 | Supplemental | Operate cash registers to accept payments for food and beverages. |
| 79 | Supplemental | Direct patrons to coatrooms and waiting areas, such as lounges. |
| 78 | Supplemental | Prepare cash receipts after establishments close, and make bank deposits. |
| 64 | Supplemental | Order or requisition supplies and equipment for tables and serving stations. |
| 61 | Supplemental | Hire, train, and supervise food and beverage service staff. |
| 61 | Supplemental | Confer with other staff to help plan establishments' menus. |
| 49 | Supplemental | Perform marketing and advertising services. |
...
| 35 | Integrity — A tendency to be honest and ethical at work. |
