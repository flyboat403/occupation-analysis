...
|------------|----------|------|
| 93 | Core | Analyze research data to determine its significance, using computers. |
| 91 | Core | Present research findings at scientific conferences and in papers written for scientific journals. |
| 88 | Core | Study celestial phenomena, using a variety of ground-based and space-borne telescopes and scientific instruments. |
| 85 | Core | Collaborate with other astronomers to carry out research projects. |
| 85 | Core | Mentor graduate students and junior colleagues. |
| 80 | Core | Supervise students' research on celestial and astronomical phenomena. |
| 79 | Core | Teach astronomy or astrophysics. |
| 77 | Core | Develop theories based on personal observations or on observations and theories of other astronomers. |
| 74 | Core | Measure radio, infrared, gamma, and x-ray emissions from extraterrestrial sources. |
| 74 | Core | Develop instrumentation and software for astronomical observation and analysis. |
| 71 | Core | Review scientific proposals and research papers. |
| 69 | Core | Raise funds for scientific research. |
| 63 | Core | Develop and modify astronomy-related programs for public presentation. |
| 58 | Core | Serve on professional panels and committees. |
| 58 | Core | Calculate orbits and determine sizes, shapes, brightness, and motions of different celestial bodies. |
| 56 | Core | Conduct question-and-answer presentations on astronomy topics with public audiences. |
| 39 | Supplemental | Direct the operations of a planetarium. |

## Technology Skills

| Hot Technology | Examples |
|----------------|----------|
| Analytical or scientific software | IBM SPSS Statistics Hot Technology ; SAS Hot Technology ; The MathWorks MATLAB ; Visual Numerics PV-WAVE ; 12 more |
| Data base management system software | Apache Hadoop Hot Technology |
| Data base user interface and query software | Spectroscopy databases; Structured query language SQL Hot Technology |
| Development environment software | Abstraction plus reference plus synthesis A++; C ; Formula translation/translator FORTRAN; National Instruments LabVIEW ; 2 more |
| Graphics or photo imaging software | Avis Fits Viewer; IRIS |
| Internet browser software | Web browser software |
| Object or component oriented development software | C++ ; Oracle Java Hot Technology ; Python ; R ; 1 more |
...
| 97 | Analyzing Data or Information — Identifying the underlying principles, reasons, or facts of information by breaking down information or data into separate parts. |
...
|---|---|
| 99 | Physics — Knowledge and prediction of physical principles, laws, their interrelationships, and applications to understanding fluid, material, and atmospheric dynamics, and mechanical, electrical, atomic and sub-atomic structures and processes. |
...
| 19 | Customer and Personal Service — Knowledge of principles and processes for providing customer and personal services. This includes customer needs assessment, meeting quality standards for services, and evaluation of customer satisfaction. |
...
- Universities Space Research Association external site
