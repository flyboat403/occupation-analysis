...
**Quick Facts:**
- SOC Code: 27-1025.00
- Also called: Certified Kitchen Designer, Color and Materials Designer, Commercial Interior Designer, Decorating Consultant, Designer, Interior Decorator, Interior Design Consultant, Interior Design Coordinator, Interior Designer, Registered Interior Designer
...
|------------|----------|------|
| 94 | Core | Design plans to be safe and to be compliant with the American Disabilities Act (ADA). |
| 94 | Core | Use computer-aided drafting (CAD) and related software to produce construction documents. |
| 92 | Core | Research health and safety code requirements to inform design. |
| 89 | Core | Confer with client to determine factors affecting planning of interior environments, such as budget, architectural preferences, purpose, and function. |
| 88 | Core | Advise client on interior design factors, such as space planning, layout and use of furnishings or equipment, and color coordination. |
| 87 | Core | Coordinate with other professionals, such as contractors, architects, engineers, and plumbers, to ensure job success. |
| 86 | Core | Review and detail shop drawings for construction plans. |
| 86 | Core | Inspect construction work on site to ensure its adherence to the design plans. |
| 83 | Core | Render design ideas in form of paste-ups or drawings. |
| 76 | Core | Subcontract fabrication, installation, and arrangement of carpeting, fixtures, accessories, draperies, paint and wall coverings, art work, furniture, and related items. |
| 74 | Core | Select or design, and purchase furnishings, art work, and accessories. |
| 72 | Core | Estimate material requirements and costs, and present design to client for approval. |
| 69 | Core | Research and explore the use of new materials, technologies, and products to incorporate into designs. |
| 68 | Core | Design spaces to be environmentally friendly, using sustainable, recycled materials when feasible. |
| 67 | Core | Formulate environmental plan to be practical, esthetic, and conducive to intended purposes, such as raising productivity or selling merchandise. |
| 37 | Supplemental | Plan and design interior environments for boats, planes, buses, trains, and other enclosed spaces. |

## Technology Skills

| Hot Technology | Examples |
|----------------|----------|
| Computer aided design CAD software | Autodesk AutoCAD ; Autodesk Revit ; Computer aided design and drafting software CADD; Trimble SketchUp Pro ; 9 more |
...
| 69 | Sales and Marketing — Knowledge of principles and methods for showing, promoting, and selling products or services. This includes marketing strategy and tactics, product demonstration, sales techniques, and sales control systems. |
...
| 58 | Fine Arts — Knowledge of the theory and techniques required to compose, produce, and perform works of music, dance, visual arts, drama, and sculpture. |
...
- National Kitchen and Bath Association external site
- USGBC external site

- American Academy of Healthcare Interior Designers external site
- Council for Interior Design Accreditation external site
- Council for Interior Design Qualification external site
