...
|------------|----------|------|
| 70 | Core | Locate grain line patterns to determine how rocks will split when cut. |
| 68 | Core | Remove pieces of stone from larger masses, using jackhammers, wedges, and other tools. |
| 67 | Core | Insert wedges and feathers into holes, and drive wedges with sledgehammers to split stone sections from masses. |
| 60 | Core | Mark dimensions or outlines on stone prior to cutting, using rules and chalk lines. |
| 73 | Supplemental | Cut slabs of stone into sheets that will be used for floors or counters. |
| 70 | Supplemental | Set charges of explosives to split rock. |
| 70 | Supplemental | Drill holes along outlines, using jackhammers. |
| 69 | Supplemental | Drill holes into sides of stones broken from masses, insert dogs or attach slings, and direct removal of stones. |
| 57 | Supplemental | Cut grooves along outlines, using chisels. |
...
- Examine physical characteristics of natural stone or stone products. Related occupations
...
| 7 | Integrity — A tendency to be honest and ethical at work. |
