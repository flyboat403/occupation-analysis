...
**Quick Facts:**
- SOC Code: 51-7021.00
- Also called: Finish Repair Worker, Finisher, Furniture Finisher, Hand Sander, Lacquer Sprayer, Sander, Sealer Sander, Sprayer, Stain Sprayer, Stain Wiper
...
|------------|----------|------|
| 82 | Core | Brush, spray, or hand-rub finishing ingredients, such as paint, oil, stain, or wax, onto and into wood grain and apply lacquer or other sealers. |
| 82 | Core | Fill and smooth cracks or depressions, remove marks and imperfections, and repair broken parts, using plastic or wood putty, glue, nails, or screws. |
| 81 | Core | Smooth, shape, and touch up surfaces to prepare them for finishing, using sandpaper, pumice stones, steel wool, chisels, sanders, or grinders. |
| 80 | Core | Remove accessories prior to finishing, and mask areas that should not be exposed to finishing processes or substances. |
| 79 | Core | Remove old finishes and damaged or deteriorated parts, using hand tools, stripping tools, sandpaper, steel wool, abrasives, solvents, or dip baths. |
| 77 | Core | Treat warped or stained surfaces to restore original contours and colors. |
| 77 | Core | Select appropriate finishing ingredients such as paint, stain, lacquer, shellac, or varnish, depending on factors such as wood hardness and surface type. |
| 76 | Core | Mix finish ingredients to obtain desired colors or shades. |
| 75 | Core | Remove excess solvent, using cloths soaked in paint thinner. |
| 73 | Core | Examine furniture to determine the extent of damage or deterioration, and to decide on the best method for repair or restoration. |
| 72 | Core | Distress surfaces with woodworking tools or abrasives before staining to create an antique appearance, or rub surfaces to bring out highlights and shadings. |
| 72 | Core | Stencil, gild, emboss, mark, or paint designs or borders to reproduce the original appearance of restored pieces, or to decorate new pieces. |
| 71 | Core | Disassemble items to prepare them for finishing, using hand tools. |
| 84 | Supplemental | Confer with customers to determine furniture colors or finishes. |
| 78 | Supplemental | Recommend woods, colors, finishes, and furniture styles, using knowledge of wood products, fashions, and styles. |
| 76 | Supplemental | Wash surfaces to prepare them for finish application. |
| 75 | Supplemental | Follow blueprints to produce specific designs. |
| 74 | Supplemental | Paint metal surfaces electrostatically, or by using a spray gun or other painting equipment. |
| 71 | Supplemental | Replace or refurbish upholstery of items, using tacks, adhesives, softeners, solvents, stains, or polish. |
| 70 | Supplemental | Design, create, and decorate entire pieces or specific parts of furniture, such as draws for cabinets. |
| 70 | Supplemental | Spread graining ink over metal portions of furniture to simulate wood-grain finish. |
| 65 | Supplemental | Brush bleaching agents on wood surfaces to restore natural color. |
...
- The Furniture Society external site
