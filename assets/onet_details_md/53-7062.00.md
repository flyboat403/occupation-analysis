...
**Quick Facts:**
- SOC Code: 53-7062.00
- Also called: Laborer, Loader, Material Handler, Merchandise Pick Up Associate, Merchandise Receiving Associate, Receiver, Receiving Associate, Shipping and Receiving Materials Handler, Warehouse Worker
...
|------------|----------|------|
| 87 | Core | Maintain equipment storage areas to ensure that inventory is protected. |
| 78 | Core | Read work orders or receive oral instructions to determine work assignments or material or equipment needs. |
| 76 | Core | Move freight, stock, or other materials to and from storage or production areas, loading docks, delivery vehicles, ships, or containers, by hand or using trucks, tractors, or other equipment. |
| 88 | Supplemental | Install protective devices, such as bracing, padding, or strapping, to prevent shifting or damage to items being transported. |
| 82 | Supplemental | Sort cargo before loading and unloading. |
| 79 | Supplemental | Attach identifying tags to containers or mark them with identifying information. |
| 76 | Supplemental | Record numbers of units handled or moved, using daily production sheets or work tickets. |
| 74 | Supplemental | Attach slings, hooks, or other devices to lift cargo and guide loads. |
| 65 | Supplemental | Carry needed tools or supplies from storage or trucks and return them after use. |
| 57 | Supplemental | Pack containers and re-pack damaged containers. |
| 56 | Supplemental | Assemble product containers or crates, using hand tools and precut lumber. |
| 53 | Supplemental | Adjust controls to guide, position, or move equipment, such as cranes, booms, or cameras. |
| 47 | Supplemental | Connect electrical equipment to power sources so that it can be tested before use. |
...
| Data base user interface and query software | Data entry software; Oracle Database Hot Technology |
...
- Sort materials or objects for processing or transport. Related occupations
