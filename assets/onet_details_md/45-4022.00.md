...
**Quick Facts:**
- SOC Code: 45-4022.00
- Also called: Delimber Operator, Feller Buncher Operator, Harvester Operator, Loader Operator, Log Processor Operator, Logging Equipment Operator, Logging Shovel Operator, Skidder Driver, Skidder Operator, Yarder Operator
...
|------------|----------|------|
| 89 | Core | Inspect equipment for safety prior to use, and perform necessary basic maintenance tasks. |
| 85 | Core | Control hydraulic tractors equipped with tree clamps and booms to lift, swing, and bunch sheared trees. |
| 82 | Core | Grade logs according to characteristics such as knot size and straightness, and according to established industry or company standards. |
| 79 | Core | Drive straight or articulated tractors equipped with accessories such as bulldozer blades, grapples, logging arches, cable winches, and crane booms to skid, load, unload, or stack logs, pull stumps, or clear brush. |
| 71 | Core | Drive crawler or wheeled tractors to drag or transport logs from felling sites to log landing areas for processing and loading. |
| 65 | Core | Fill out required job or shift report forms. |
| 56 | Core | Drive tractors for building or repairing logging and skid roads. |
| 81 | Supplemental | Drive and maneuver tractors and tree harvesters to shear the tops off of trees, cut and limb the trees, and cut the logs into desired lengths. |
| 62 | Supplemental | Calculate total board feet, cordage, or other wood measurement units, using conversion tables. |
...
| 2 | Administrative — Knowledge of administrative and office procedures and systems such as word processing, managing files and records, stenography and transcription, designing forms, and workplace terminology. |
