...
**Quick Facts:**
- SOC Code: 47-2161.00
- Also called: Applicator, Artisan Plasterer, Plaster and Stucco Worker, Plaster Applicator, Plaster Mechanic, Plasterer, Plasterer Journeyman, Plastering Contractor
...
|------------|----------|------|
| 84 | Core | Cover surfaces such as windows, doors, or sidewalks to protect from splashing. |
| 81 | Core | Clean job sites. |
| 78 | Core | Mix mortar and plaster to desired consistency or direct workers who perform mixing. |
| 77 | Core | Apply coats of plaster or stucco to walls, ceilings, or partitions of buildings, using trowels, brushes, or spray guns. |
| 77 | Core | Set up scaffolds. |
| 77 | Core | Determine materials needed to complete the job and place orders accordingly. |
| 74 | Core | Apply weatherproof, decorative coverings to exterior surfaces of buildings, such as by troweling or spraying on coats of stucco. |
| 72 | Core | Clean and prepare surfaces for applications of plaster, cement, stucco, or similar materials, such as by drywall taping. |
| 71 | Core | Create decorative textures in finish coat, using brushes or trowels, sand, pebbles, or stones. |
| 68 | Core | Apply insulation to building exteriors by installing prefabricated insulation systems over existing walls or by covering the outer wall with insulation board, reinforcing mesh, and a base coat. |
| 67 | Core | Rough the undercoat surface with a scratcher so the finish coat will adhere. |
| 77 | Supplemental | Cure freshly plastered surfaces. |
| 75 | Supplemental | Install guide wires on exterior surfaces of buildings to indicate thickness of plaster or stucco and nail wire mesh, lath, or similar materials to the outside surface to hold stucco in place. |
| 64 | Supplemental | Spray acoustic materials or texture finish over walls or ceilings. |
| 64 | Supplemental | Mold or install ornamental plaster pieces, panels, or trim. |
...
- EIFS Industry Members Association external site
