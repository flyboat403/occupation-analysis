...
**Quick Facts:**
- SOC Code: 53-7061.00
- Also called: Aircraft Cleaner, Automotive Detailer (Auto Detailer), Bus Cleaner, Car Detailer, Car Washer, Cleaner, Detail Technician (Detail Tech), Detailer, Reconditioner, Sanitation Truck Cleaner
...
|------------|----------|------|
| 75 | Core | Rinse objects and place them on drying racks or use cloth, squeegees, or air compressors to dry surfaces. |
| 74 | Core | Apply paints, dyes, polishes, reconditioners, waxes, or masking materials to vehicles to preserve, protect, or restore color or condition. |
| 74 | Core | Clean and polish vehicle windows. |
| 73 | Core | Drive vehicles to or from workshops or customers' workplaces or homes. |
| 73 | Core | Scrub, scrape, or spray machine parts, equipment, or vehicles, using scrapers, brushes, clothes, cleaners, disinfectants, insecticides, acid, abrasives, vacuums, or hoses. |
| 72 | Core | Inspect parts, equipment, or vehicles for cleanliness, damage, and compliance with standards or regulations. |
| 69 | Core | Mix cleaning solutions, abrasive compositions, or other compounds, according to formulas. |
| 68 | Core | Maintain inventories of supplies. |
| 67 | Core | Pre-soak or rinse machine parts, equipment, or vehicles by immersing objects in cleaning solutions or water, manually or using hoists. |
| 66 | Core | Turn valves or disconnect hoses to eliminate water, cleaning solutions, or vapors from machinery or tanks. |
| 66 | Core | Turn valves or handles on equipment to regulate pressure or flow of water, air, steam, or abrasives from sprayer nozzles. |
| 65 | Core | Sweep, shovel, or vacuum loose debris or salvageable scrap into containers and remove containers from work areas. |
| 65 | Core | Monitor operation of cleaning machines and stop machines or notify supervisors when malfunctions occur. |
| 63 | Core | Press buttons to activate cleaning equipment or machines. |
| 59 | Core | Connect hoses or lines to pumps or other equipment. |
| 73 | Supplemental | Clean the plastic work inside cars, using paintbrushes. |
| 68 | Supplemental | Disassemble and reassemble machines or equipment or remove and reattach vehicle parts or trim, using hand tools. |
| 63 | Supplemental | Lubricate machinery, vehicles, or equipment or perform minor repairs or adjustments, using hand tools. |
| 58 | Supplemental | Transport materials, equipment, or supplies to or from work areas, using carts or hoists. |
| 46 | Supplemental | Fit boot spoilers, side skirts, or mud flaps to cars. |
...
- Shovel materials. Related occupations
...
| 31 | Critical Thinking — Using logic and reasoning to identify the strengths and weaknesses of alternative solutions, conclusions, or approaches to problems. |
...
| 12 | Stress Tolerance — A tendency to cope and function effectively in stressful situations at work. |
...
- Cleaning Equipment Trade Association external site
