...
|------------|----------|------|
| 99 | Core | Position imaging equipment and adjust controls to set exposure time and distance, according to specification of examination. |
| 99 | Core | Position patient on examining table and set up and adjust equipment to obtain optimum view of specific body area as requested by physician. |
| 98 | Core | Monitor patients' conditions and reactions, reporting abnormal signs to physician. |
| 98 | Core | Explain procedures and observe patients to ensure safety and comfort during scan. |
| 97 | Core | Use radiation safety measures and protection devices to comply with government regulations and to ensure safety of patients and staff. |
| 97 | Core | Review and evaluate developed x-rays, video tape, or computer-generated information to determine if images are satisfactory for diagnostic purposes. |
| 97 | Core | Determine patients' x-ray needs by reading requests or instructions from physicians. |
| 95 | Core | Prepare contrast material, radiopharmaceuticals, or anesthetic or antispasmodic drugs under the direction of a radiologist. |
| 94 | Core | Process exposed radiographs using film processors or computer generated methods. |
| 94 | Core | Operate mobile x-ray equipment in operating room, emergency room, or at patient's bedside. |
| 93 | Core | Make exposures necessary for the requested procedures, rejecting and repeating work that does not meet established standards. |
| 93 | Core | Operate or oversee operation of radiologic or magnetic imaging equipment to produce images of the body for diagnostic purposes. |
| 92 | Core | Operate digital picture archiving communications systems. |
| 91 | Core | Perform procedures, such as linear tomography, mammography, sonograms, joint and cyst aspirations, routine contrast studies, routine fluoroscopy, or examinations of the head, trunk, or extremities under supervision of physician. |
| 90 | Core | Provide assistance to physicians or other technologists in the performance of more complex procedures. |
| 90 | Core | Record, process, and maintain patient data or treatment records and prepare reports. |
| 88 | Core | Take thorough and accurate patient medical histories. |
| 87 | Core | Key commands and data into computer to document and specify scan sequences, adjust transmitters and receivers, or photograph certain images. |
| 86 | Core | Operate fluoroscope to aid physician to view and guide wire or catheter through blood vessels to area of interest. |
| 85 | Core | Set up examination rooms, ensuring that all necessary equipment is ready. |
| 84 | Core | Transport patients to or from exam rooms. |
| 82 | Core | Assist with on-the-job training of new employees or students or provide input to supervisors regarding training performance. |
| 81 | Core | Maintain a current file of examination protocols. |
| 80 | Core | Perform general administrative tasks, such as answering phones, scheduling patient appointments, or pulling and filing films. |
| 79 | Core | Complete quality control activities, monitor equipment operation, and report malfunctioning equipment to supervisor. |
| 72 | Core | Assign duties to radiologic staff to maintain patient flows and achieve production goals. |
| 71 | Core | Provide assistance in dressing or changing seriously ill or injured patients or patients with disabilities. |
...
| Medical software | eClinicalWorks EHR software Hot Technology ; Medical procedure coding software; MEDITECH software Hot Technology ; Virtual reality computed tomography CT imaging software ; 10 more |
...
| 69 | Empathy — A tendency to show concern for others and be sensitive to others' needs and feelings at work. |
...
| 52 | Social Orientation — A tendency to seek out, enjoy, and be energized by social interaction at work. |
...
| 38 | Intellectual Curiosity — A tendency to seek out and acquire new work-related knowledge and obtain a deep understanding of work-related subjects. |
...
- The International Society for Clinical Densitometry external site
