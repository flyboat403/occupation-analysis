...
**Quick Facts:**
- SOC Code: 39-9011.01
- Also called: Family Assistant, Family Manager, Governess, House Manager, Household Manager, Nanny, Special Needs Nanny, Travel Nanny
...
|------------|----------|------|
| 98 | Core | Instruct children in safe behavior, such as seeking adult assistance when crossing the street and avoiding contact with unsafe objects. |
| 97 | Core | Remove hazards and develop appropriate boundaries and rules to create a safe environment for children. |
| 97 | Core | Perform first aid or cardiopulmonary resuscitation (CPR) when required. |
| 96 | Core | Instruct and assist children in the development of health and personal habits, such as eating, resting, and toilet behavior. |
| 96 | Core | Regulate children's rest periods and nap schedules. |
| 94 | Core | Teach and perform age-appropriate activities, such as lap play, reading, and arts and crafts, to encourage intellectual development of children. |
| 93 | Core | Help prepare and serve nutritionally balanced meals and snacks for children. |
| 92 | Core | Model appropriate social behaviors and encourage concern for others to cultivate development of interpersonal relationships and communication skills. |
| 89 | Core | Organize and conduct age-appropriate recreational activities, such as games, arts and crafts, sports, walks, and play dates. |
| 88 | Core | Assign appropriate chores and praise targeted behaviors to encourage development of self-control, self-confidence, and responsibility. |
| 88 | Core | Observe children's behavior for irregularities, take temperature, transport children to doctor, or administer medications, as directed, to maintain children's health. |
| 87 | Core | Work with parents to develop and implement discipline programs to promote desirable child behavior. |
| 78 | Core | Perform housekeeping and cleaning duties related to children's care. |
| 78 | Core | Meet regularly with parents to discuss children's activities and development. |
| 77 | Core | Supervise and assist with homework. |
| 77 | Core | Transport children to schools, social outings, and medical appointments. |
| 70 | Core | Keep records of play, meal schedules, and bill payment. |
| 64 | Core | Help develop or monitor family schedule. |
| 47 | Supplemental | Shop for groceries, clothing, and other items needed for children's care. |
...
| 38 | Food Production — Knowledge of techniques and equipment for planting, growing, and harvesting food products (both plant and animal) for consumption, including storage/handling techniques. |
...
- National Domestic Workers Alliance external site
