...
**Quick Facts:**
- SOC Code: 51-4194.00
- Also called: Cutter Grinder, Finisher, Grinder, Grinder Operator, OD Grinder Operator (Outer Diameter Grinder Operator), Saw Filer, Tool and Cutter Grinder, Tool Grinder
...
|------------|----------|------|
| 89 | Core | Monitor machine operations to determine whether adjustments are necessary, stopping machines when problems occur. |
| 88 | Core | Inspect, feel, and measure workpieces to ensure that surfaces and dimensions meet specifications. |
| 85 | Core | Study blueprints or layouts of metal workpieces to determine grinding procedures, and to plan machine setups and operational sequences. |
| 85 | Core | Select and mount grinding wheels on machines, according to specifications, using hand tools and applying knowledge of abrasives and grinding procedures. |
| 85 | Core | Compute numbers, widths, and angles of cutting tools, micrometers, scales, and gauges, and adjust tools to produce specified cuts. |
| 84 | Core | Turn valves to direct flow of coolant against cutting wheels and workpieces during grinding. |
| 84 | Core | Set up and operate grinding or polishing machines to grind metal workpieces, such as dies, parts, and tools. |
| 81 | Core | Dress grinding wheels, according to specifications. |
| 79 | Core | File or finish surfaces of workpieces, using prescribed hand tools. |
| 79 | Core | Perform basic maintenance, such as cleaning and lubricating machine parts. |
| 79 | Core | Remove finished workpieces from machines and place them in boxes or on racks, setting aside pieces that are defective. |
| 75 | Core | Remove and replace worn or broken machine parts, using hand tools. |
| 79 | Supplemental | Fit parts together in pre-assembly to ensure that dimensions are accurate. |
| 76 | Supplemental | Attach workpieces to grinding machines and form specified sections and repair cracks, using welding or brazing equipment. |
| 75 | Supplemental | Duplicate workpiece contours, using tracer attachments. |
| 75 | Supplemental | Inspect dies to detect defects, assess wear, and verify specifications, using micrometers, steel gauge pins, and loupes. |
| 74 | Supplemental | Place workpieces in electroplating solutions or apply pigments to surfaces of workpieces to highlight ridges and grooves. |
| 58 | Supplemental | Straighten workpieces and remove dents, using straightening presses and hammers. |
...
| Computer aided manufacturing CAM software | ANCA ToolRoom; Dassault Systemes SolidWorks Hot Technology |
...
| 0 | Cooperation — A tendency to be pleasant, helpful, and willing to assist others at work. |
