...
**Quick Facts:**
- SOC Code: 11-9041.00
- Also called: Civil Engineering Manager, Electrical Engineering Manager, Engineering Director, Engineering Group Manager, Engineering Program Manager, Mechanical Engineering Manager, Process Engineering Manager, Project Engineering Manager, Project Manager
...
|------------|----------|------|
| 82 | Core | Manage the coordination and overall integration of technical activities in architecture or engineering projects. |
| 75 | Core | Direct, review, or approve project design changes. |
| 71 | Core | Consult or negotiate with clients to prepare project specifications. |
| 62 | Core | Prepare budgets, bids, or contracts. |
| 62 | Core | Present and explain proposals, reports, or findings to clients. |
| 60 | Core | Confer with management, production, or marketing staff to discuss project specifications or procedures. |
| 60 | Core | Assess project feasibility by analyzing technology, resource needs, or market demand. |
| 60 | Core | Review, recommend, or approve contracts or cost estimates. |
| 58 | Core | Develop or implement policies, standards, or procedures for engineering and technical work. |
| 54 | Core | Establish scientific or technical goals within broad outlines provided by top management. |
| 54 | Core | Direct recruitment, placement, and evaluation of architecture or engineering project staff. |
| 54 | Core | Perform administrative functions, such as reviewing or writing reports, approving expenditures, enforcing rules, or purchasing of materials or services. |
| 53 | Core | Develop or implement programs to improve sustainability or reduce the environmental impacts of engineering or architecture activities or operations. |
| 51 | Core | Evaluate the environmental impacts of engineering, architecture, or research and development activities. |
| 57 | Supplemental | Plan or direct the installation, testing, operation, maintenance, or repair of facilities or equipment. |
| 57 | Supplemental | Identify environmental threats or opportunities associated with the development and launch of new technologies. |
| 54 | Supplemental | Plan, direct, or coordinate survey work with other project activities. |
| 48 | Supplemental | Evaluate environmental regulations or social pressures related to environmental issues to inform strategic or operational decision-making. |
| 47 | Supplemental | Solicit project support by conferring with officials or providing information to the public. |
...
| Analytical or scientific software | IBM SPSS Statistics Hot Technology ; Minitab; The MathWorks MATLAB Hot Technology ; Water surface pressure gradient WSPG software ; 2 more |
| Application server software | Docker Hot Technology ; GitHub Hot Technology |
...
| Computer aided design CAD software | Autodesk AutoCAD Civil 3D Hot Technology ; Autodesk Revit Hot Technology ; Bentley MicroStation Hot Technology ; Dassault Systemes SolidWorks Hot Technology ; 7 more |
...
| Content workflow software | Atlassian JIRA Hot Technology ; Workflow software |
| Data base management system software | Amazon DynamoDB Hot Technology ; Apache Hive Hot Technology ; Elasticsearch Hot Technology ; MongoDB Hot Technology ; 8 more |
| Data base user interface and query software | Amazon Elastic Compute Cloud EC2 Hot Technology ; Amazon Redshift Hot Technology ; Amazon Web Services AWS software Hot Technology ; Microsoft SQL Server Hot Technology ; 2 more |
| Development environment software | Apache Kafka Hot Technology ; Apache Maven Hot Technology ; Go Hot Technology ; Ruby Hot Technology ; 5 more |
...
| Enterprise resource planning ERP software | Agile Product Lifecyle Management PLM; Microsoft Dynamics; Oracle JD Edwards EnterpriseOne; SAP software Hot Technology ; 2 more |
...
| Operating system software | Apple macOS Hot Technology ; Bash Hot Technology ; Shell script Hot Technology ; UNIX Hot Technology ; 4 more |
| Presentation software | Microsoft PowerPoint |
| Process mapping and design software | Microsoft Visio Hot Technology |
| Program testing software | Hewlett Packard LoadRunner |
| Project management software | Atlassian Confluence Hot Technology ; Microsoft Project Hot Technology ; Oracle Primavera Enterprise Project Portfolio Management Hot Technology ; Realization Streamliner ; 1 more |
| Spreadsheet software | Microsoft Excel |
| Time accounting software | Kronos Workforce Timekeeper Hot Technology |
| Transaction server software | Customer information control system CICS |
| Web platform development software | Django Hot Technology ; JavaScript Object Notation JSON Hot Technology ; Node.js Hot Technology ; React Hot Technology ; 5 more |
...
- Estimate demand for products or services. Related occupations
...
- American Society for Engineering Management external site
