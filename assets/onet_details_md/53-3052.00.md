...
**Quick Facts:**
- SOC Code: 53-3052.00
- Also called: Bus Driver, Bus Operator, Charter Bus Driver, Coach Operator, Motor Coach Driver, Motor Coach Operator, Transit Bus Driver, Transit Coach Operator, Transit Driver, Transit Operator
...
|------------|----------|------|
| 93 | Core | Drive vehicles over specified routes or to specified destinations according to time schedules, complying with traffic regulations to ensure that passengers have a smooth and safe ride. |
| 89 | Core | Park vehicles at loading areas so that passengers can board. |
| 89 | Core | Inspect vehicles and check gas, oil, and water levels prior to departure. |
| 88 | Core | Announce stops to passengers. |
| 84 | Core | Assist passengers, such as elderly or individuals with disabilities, on and off bus, ensure they are seated properly, help carry baggage, and answer questions about bus schedules or routes. |
| 82 | Core | Collect tickets or cash fares from passengers. |
| 81 | Core | Handle passenger emergencies or disruptions. |
| 81 | Core | Report delays or accidents. |
| 80 | Core | Advise passengers to be seated and orderly while on vehicles. |
| 78 | Core | Regulate heating, lighting, and ventilating systems for passenger comfort. |
| 77 | Core | Record information, such as cash receipts and ticket fares, and maintain log book. |
| 74 | Core | Maintain cleanliness of bus or motor coach. |
| 80 | Supplemental | Read maps to plan bus routes. |
| 67 | Supplemental | Load and unload baggage in baggage compartments. |
