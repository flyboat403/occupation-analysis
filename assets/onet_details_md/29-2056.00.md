...
|------------|----------|------|
| 96 | Core | Administer anesthesia to animals, under the direction of a veterinarian, and monitor animals' responses to anesthetics so that dosages can be adjusted. |
| 94 | Core | Care for and monitor the condition of animals recovering from surgery. |
| 93 | Core | Maintain controlled drug inventory and related log books. |
| 93 | Core | Perform laboratory tests on blood, urine, or feces, such as urinalyses or blood counts, to assist in the diagnosis and treatment of animal health problems. |
| 92 | Core | Prepare and administer medications, vaccines, serums, or treatments, as prescribed by veterinarians. |
| 92 | Core | Restrain animals during exams or procedures. |
| 91 | Core | Administer emergency first aid, such as performing emergency resuscitation or other life saving procedures. |
| 90 | Core | Clean and sterilize instruments, equipment, or materials. |
| 89 | Core | Provide veterinarians with the correct equipment or instruments, as needed. |
| 89 | Core | Perform dental work, such as cleaning, polishing, or extracting teeth. |
| 88 | Core | Observe the behavior and condition of animals and monitor their clinical symptoms. |
| 87 | Core | Give enemas and perform catheterizations, ear flushes, intravenous feedings, or gavages. |
| 87 | Core | Fill prescriptions, measuring medications and labeling containers. |
| 86 | Core | Collect, prepare, and label samples for laboratory testing, culture, or microscopic examination. |
| 86 | Core | Prepare animals for surgery, performing such tasks as shaving surgical areas. |
| 86 | Core | Take and develop diagnostic radiographs, using x-ray equipment. |
| 86 | Core | Discuss medical health of pets with clients, such as post-operative status. |
| 85 | Core | Clean kennels, animal holding areas, surgery suites, examination rooms, or animal loading or unloading facilities to control the spread of disease. |
| 85 | Core | Take animals into treatment areas and assist with physical examinations by performing such duties as obtaining temperature, pulse, or respiration data. |
| 85 | Core | Prepare treatment rooms for surgery. |
| 83 | Core | Maintain laboratory, research, or treatment records, as well as inventories of pharmaceuticals, equipment, or supplies. |
| 83 | Core | Maintain instruments, equipment, or machinery to ensure proper working condition. |
| 81 | Core | Dress and suture wounds and apply splints or other protective devices. |
| 80 | Core | Provide assistance with animal euthanasia and the disposal of remains. |
| 78 | Core | Schedule appointments and procedures for animals. |
| 77 | Core | Provide information or counseling regarding issues such as animal health care, behavior problems, or nutrition. |
| 75 | Core | Monitor medical supplies and place orders when inventory is low. |
| 74 | Core | Supervise or train veterinary students or other staff members. |
| 72 | Core | Perform a variety of office, clerical, or accounting duties, such as reception, billing, bookkeeping, or selling products. |
| 65 | Core | Bathe animals, clip nails or claws, and brush or cut animals' hair. |
| 56 | Supplemental | Conduct specialized procedures, such as animal branding or tattooing or hoof trimming. |

## Technology Skills

| Hot Technology | Examples |
|----------------|----------|
| Data base user interface and query software | FileMaker Pro; Microsoft Access Hot Technology ; Practice management software PMS |
