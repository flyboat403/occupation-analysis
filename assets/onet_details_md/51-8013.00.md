...
**Quick Facts:**
- SOC Code: 51-8013.00
- Also called: Auxiliary Operator, Control Operator, Control Room Operator, Multicraft Operator (MCO), Operations and Maintenance Technician (O and M Tech), Plant Control Operator, Plant Operator, Power Plant Operator, Station Operator, Unit Operator
...
|------------|----------|------|
| 92 | Core | Control generator output to match the phase, frequency, or voltage of electricity supplied to panels. |
| 89 | Core | Take regulatory action, based on readings from charts, meters and gauges, at established intervals. |
| 89 | Core | Control power generating equipment, including boilers, turbines, generators, or reactors, using control boards or semi-automatic equipment. |
| 88 | Core | Start or stop generators, auxiliary pumping equipment, turbines, or other power plant equipment as necessary. |
| 88 | Core | Monitor power plant equipment and indicators to detect evidence of operating problems. |
| 88 | Core | Operate or maintain distributed power generation equipment, including fuel cells or microturbines, to produce energy on-site for manufacturing or other commercial purposes. |
| 86 | Core | Open and close valves and switches in sequence to start or shut down auxiliary units. |
| 86 | Core | Control or maintain auxiliary equipment, such as pumps, fans, compressors, condensers, feedwater heaters, filters, or chlorinators, to supply water, fuel, lubricants, air, or auxiliary power. |
| 85 | Core | Regulate equipment operations and conditions, such as water levels, based on instrument data or from computers. |
| 85 | Core | Inspect records or log book entries or communicate with plant personnel to assess equipment operating status. |
| 83 | Core | Clean, lubricate, or maintain equipment, such as generators, turbines, pumps, or compressors, to prevent failure or deterioration. |
| 79 | Core | Record and compile operational data by completing and maintaining forms, logs, or reports. |
| 63 | Core | Make adjustments or minor repairs, such as tightening leaking gland or pipe joints. |
| 87 | Supplemental | Adjust controls to generate specified electrical power or to regulate the flow of power between generating stations and substations. |
| 86 | Supplemental | Operate, control, or monitor equipment, such as acid or gas carbon dioxide removal units, carbon dioxide compressors, or pipelines, to capture, store, or transport carbon dioxide exhaust. |
| 85 | Supplemental | Operate, control, or monitor gasifiers or related equipment, such as coolers, water quenches, water gas shifts reactors, or sulfur recovery units, to produce syngas or electricity from coal. |
| 83 | Supplemental | Communicate with systems operators to regulate and coordinate line voltages and transmission loads and frequencies. |
| 78 | Supplemental | Operate, control, or monitor integrated gasification combined cycle (IGCC) or related equipment, such as air separation units, to generate electricity from coal. |
| 73 | Supplemental | Receive outage calls and request necessary personnel during power outages or emergencies. |
| 73 | Supplemental | Collect oil, water, or electrolyte samples for laboratory analysis. |
| 73 | Supplemental | Examine and test electrical power distribution machinery and equipment, using testing devices. |
| 72 | Supplemental | Place standby emergency electrical generators on line in emergencies and monitor the temperature, output, and lubrication of the system. |
...
| Data base user interface and query software | Microsoft Access Hot Technology ; Operational Data Store ODS software |
...
- Monitor conditions at energy-producing landfills. Related occupations
- Monitor operational procedures in technical environments to ensure conformance to standards. Related occupations
- Operate natural gas generation equipment. Related occupations
