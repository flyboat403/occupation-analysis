...
**Quick Facts:**
- SOC Code: 29-1291.00
- Also called: Acupuncture Doctor, Acupuncture Physician, Acupuncture Provider, Acupuncturist, Chinese Medical Doctor (Chinese MD), Chinese Medicine Doctor, Herbalist, Licensed Acupuncturist (LAC), Oriental Medicine Provider, Traditional Chinese Medicine Doctor
...
|------------|----------|------|
| 99 | Core | Maintain and follow standard quality, safety, environmental, and infection control policies and procedures. |
| 98 | Core | Treat patients using tools, such as needles, cups, ear balls, seeds, pellets, or nutritional supplements. |
| 98 | Core | Adhere to local, state, and federal laws, regulations, and statutes. |
| 98 | Core | Identify correct anatomical and proportional point locations based on patients' anatomy and positions, contraindications, and precautions related to treatments, such as intradermal needles, moxibustion, electricity, guasha, or bleeding. |
| 97 | Core | Develop individual treatment plans and strategies. |
| 97 | Core | Insert needles to provide acupuncture treatment. |
| 93 | Core | Evaluate treatment outcomes and recommend new or altered treatments as necessary to further promote, restore, or maintain health. |
| 93 | Core | Collect medical histories and general health and lifestyle information from patients. |
| 91 | Core | Maintain detailed and complete records of health care plans and prognoses. |
| 87 | Core | Educate patients on topics, such as meditation, ergonomics, stretching, exercise, nutrition, the healing process, breathing, or relaxation techniques. |
| 85 | Core | Assess patients' general physical appearance to make diagnoses. |
| 85 | Core | Analyze physical findings and medical histories to make diagnoses according to Oriental medicine traditions. |
| 82 | Core | Consider Western medical procedures in health assessment, health care team communication, and care referrals. |
| 74 | Core | Dispense herbal formulas and inform patients of dosages and frequencies, treatment duration, possible side effects, and drug interactions. |
| 71 | Core | Apply heat or cold therapy to patients using materials, such as heat pads, hydrocollator packs, warm compresses, cold compresses, heat lamps, or vapor coolants. |
| 68 | Core | Formulate herbal preparations to treat conditions considering herbal properties, such as taste, toxicity, effects of preparation, contraindications, and incompatibilities. |
| 66 | Core | Treat medical conditions, using techniques such as acupressure, shiatsu, or tuina. |
| 65 | Core | Apply moxibustion directly or indirectly to patients using Chinese, non-scarring, stick, or pole moxa. |
...
| 47 | Communicating with Supervisors, Peers, or Subordinates — Providing information to supervisors, co-workers, and subordinates by telephone, in written form, e-mail, or in person. |
...
- American Association of Acupuncture and Oriental Medicine external site
- American Society of Acupuncturists external site

- National Acupuncture Detoxification Association external site
- National Certification Commission for Acupuncture and Oriental Medicine external site
