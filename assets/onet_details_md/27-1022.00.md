...
**Quick Facts:**
- SOC Code: 27-1022.00
- Also called: Apparel and Accessories Designer, Apparel Designer, Costume Designer, Designer, Fashion Design Contractor, Fashion Designer, Fashion Graphic Designer, Fashion Stylist, Handbag Designer, Product Developer
...
|------------|----------|------|
| 95 | Core | Sketch rough and detailed drawings of apparel or accessories, and write specifications such as color schemes, construction, material types, and accessory requirements. |
| 83 | Core | Examine sample garments on and off models, modifying designs to achieve desired effects. |
| 78 | Core | Confer with sales and management executives or with clients to discuss design ideas. |
| 77 | Core | Select materials and production techniques to be used for products. |
| 75 | Core | Provide sample garments to agents and sales representatives, and arrange for showings of sample garments at sales meetings or fashion shows. |
| 74 | Core | Direct and coordinate workers involved in drawing and cutting patterns and constructing samples or finished garments. |
| 73 | Core | Identify target markets for designs, looking at factors such as age, gender, and socioeconomic status. |
| 69 | Core | Collaborate with other designers to coordinate special products and designs. |
| 67 | Core | Attend fashion shows and review garment magazines and manuals to gather information about fashion trends and consumer preferences. |
| 66 | Core | Purchase new or used clothing and accessory items as needed to complete designs. |
| 62 | Core | Visit textile showrooms to keep up-to-date on the latest fabrics. |
| 62 | Core | Adapt other designers' ideas for the mass market. |
| 59 | Core | Test fabrics or oversee testing so that garment care labels can be created. |
| 81 | Supplemental | Determine prices for styles. |
| 74 | Supplemental | Develop a group of products or accessories, and market them through venues such as boutiques or mail-order catalogs. |
| 71 | Supplemental | Draw patterns for articles designed, cut patterns, and cut material according to patterns, using measuring instruments and scissors. |
| 66 | Supplemental | Sew together sections of material to form mockups or samples of garments or articles, using sewing equipment. |
| 66 | Supplemental | Design custom clothing and accessories for individuals, retailers, or theatrical, television, or film productions. |
| 63 | Supplemental | Research the styles and periods of clothing needed for film or theatrical productions. |
| 59 | Supplemental | Read scripts and consult directors and other production staff to develop design concepts and plan productions. |
...
| Computer aided design CAD software | Autodesk Revit Hot Technology ; Computer aided design and drafting software CADD; StartingAClothingLine.com Digital Fashion Pro; Trimble SketchUp Pro Hot Technology ; 6 more |
...
| Impact | Work Style |
|---|---|
| 88 | Innovation — A tendency to be inventive, to be imaginative, and to adopt new perspectives on ways to accomplish work. |
...
| 56 | Dependability — A tendency to be reliable, responsible, and consistent in meeting work-related obligations. |
...
- Council of Fashion Designers of America external site
- Fashion Group International external site
- National Association of Schools of Art and Design external site
- The Underfashion Club external site

- Costume Designers Guild external site
