...
**Quick Facts:**
- SOC Code: 29-1224.00
- Also called: Attending Physician, Diagnostic Radiologist, Interventional Neuroradiologist, Interventional Radiologist, Musculoskeletal Specialty Radiologist (MSK Specialty Radiologist), Neuroradiologist, Nuclear Medicine Physician, Nuclear Medicine Specialist, Physician, Radiologist
...
|------------|----------|------|
| 100 | Core | Prepare comprehensive interpretive reports of findings. |
| 98 | Core | Perform or interpret the outcomes of diagnostic imaging procedures including magnetic resonance imaging (MRI), computer tomography (CT), positron emission tomography (PET), nuclear cardiology treadmill studies, mammography, or ultrasound. |
| 97 | Core | Document the performance, interpretation, or outcomes of all procedures performed. |
| 96 | Core | Communicate examination results or diagnostic information to referring physicians, patients, or families. |
| 96 | Core | Obtain patients' histories from electronic records, patient interviews, dictated reports, or by communicating with referring clinicians. |
| 96 | Core | Review or transmit images and information using picture archiving or communications systems. |
| 95 | Core | Confer with medical professionals regarding image-based diagnoses. |
| 94 | Core | Recognize or treat complications during and after procedures, including blood pressure problems, pain, oversedation, or bleeding. |
| 90 | Core | Develop or monitor procedures to ensure adequate quality control of images. |
| 88 | Core | Provide counseling to radiologic patients to explain the processes, risks, benefits, or alternative treatments. |
| 87 | Core | Establish or enforce standards for protection of patients or personnel. |
| 86 | Core | Coordinate radiological services with other medical activities. |
| 86 | Core | Instruct radiologic staff in desired techniques, positions, or projections. |
| 81 | Core | Participate in continuing education activities to maintain and develop expertise. |
| 79 | Core | Participate in quality improvement activities including discussions of areas where risk of error is high. |
| 93 | Supplemental | Perform interventional procedures such as image-guided biopsy, percutaneous transluminal angioplasty, transhepatic biliary drainage, or nephrostomy catheter placement. |
| 82 | Supplemental | Develop treatment plans for radiology patients. |
...
| Medical software | eClinicalWorks EHR software Hot Technology ; Epic Systems ; GE Healthcare Centricity EMR; MEDITECH software Hot Technology ; 46 more |
