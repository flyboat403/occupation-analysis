...
**Quick Facts:**
- SOC Code: 15-1255.01
- Also called: Design Director, Designer, Environmental Artist, Game Design Consultant, Game Designer, Gamemaster, Level Designer, World Designer
...
|------------|----------|------|
| 91 | Core | Balance and adjust gameplay experiences to ensure the critical and commercial success of the product. |
| 86 | Core | Devise missions, challenges, or puzzles to be encountered in game play. |
| 86 | Core | Create core game features, including storylines, role-play mechanics, and character biographies for a new video game or game franchise. |
| 85 | Core | Solicit, obtain, and integrate feedback from design and technical staff into original game design. |
| 85 | Core | Conduct regular design reviews throughout the game development process. |
| 84 | Core | Develop and maintain design level documentation, including mechanics, guidelines, and mission outlines. |
| 81 | Core | Document all aspects of formal game design, using mock-up screenshots, sample menu layouts, gameplay flowcharts, and other graphical devices. |
| 80 | Core | Provide feedback to designers and other colleagues regarding game design features. |
| 80 | Core | Create and manage documentation, production schedules, prototyping goals, and communication plans in collaboration with production staff. |
| 78 | Core | Provide feedback to production staff regarding technical game qualities or adherence to original design. |
| 75 | Core | Create gameplay prototypes for presentation to creative and technical staff and management. |
| 75 | Core | Guide design discussions between development teams. |
| 74 | Core | Oversee gameplay testing to ensure intended gaming experience and game adherence to original vision. |
| 74 | Core | Present new game design concepts to management and technical colleagues, including artists, animators, and programmers. |
| 70 | Core | Prepare two-dimensional concept layouts or three-dimensional mock-ups. |
| 66 | Core | Keep abreast of game design technology and techniques, industry trends, or audience interests, reactions, and needs by reviewing current literature, talking with colleagues, participating in educational programs, attending meetings or workshops, or participating in professional organizations or conferences. |
| 65 | Core | Review or evaluate competitive products, film, music, television, and other art forms to generate new game design ideas. |
| 65 | Core | Collaborate with artists to achieve appropriate visual style. |
| 65 | Core | Write or supervise the writing of game text and dialogue. |
| 65 | Core | Consult with multiple stakeholders to define requirements and implement online features. |
| 63 | Core | Determine supplementary virtual features, such as currency, item catalog, menu design, and audio direction. |
| 63 | Core | Prepare and revise initial game sketches using two- and three-dimensional graphical design software. |
| 57 | Core | Create gameplay test plans for internal and external test groups. |
| 51 | Core | Provide test specifications to quality assurance staff. |
...
| Data base user interface and query software | Blackboard software; Microsoft SQL Server Hot Technology ; Structured query language SQL Hot Technology |
| Development environment software | Adobe ActionScript; C Hot Technology ; Microsoft Visual Studio Hot Technology ; Simple DirectMedia Layer SDL ; 6 more |
...
| Graphics or photo imaging software | Adobe Creative Cloud software Hot Technology ; Adobe Illustrator Hot Technology ; Adobe Photoshop ; Autodesk Maya In Demand ; 3 more |
| Metadata management software | Perforce software |
| Object or component oriented development software | C# ; Oracle Java Hot Technology ; Perl Hot Technology ; TypeScript Hot Technology ; 5 more |
| Office suite software | Microsoft Office software Hot Technology |
| Operating system software | Job control language JCL; Linux Hot Technology ; Microsoft Windows Hot Technology |
...
| Video creation and editing software | Adobe After Effects Hot Technology ; Autodesk 3ds Max; Sound development software; Vulkan Graphics API |
| Web platform development software | Hypertext markup language HTML Hot Technology ; JavaScript Hot Technology ; PHP Hot Technology ; Ruby on Rails |
...
- Design video game features or details. Related occupations
...
|---|---|
| 82 | Design — Knowledge of design techniques, tools, and principles involved in production of precision technical plans, blueprints, drawings, and models. |
...
- Academy of the Interactive Arts and Sciences external site
- Association for Computing Machinery external site
- Computing Research Association external site
- Higher Education Video Game Alliance external site
...
- North American Simulation and Gaming Association external site
