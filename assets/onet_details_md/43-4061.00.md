...
**Quick Facts:**
- SOC Code: 43-4061.00
- Also called: Benefits Program Tech (Benefits Program Technician), Business and Employment Specialist, Case Manager, Eligibility Examiner, Eligibility Specialist, Eligibility Worker, Program Eligibility Specialist, Social Welfare Examiner (SWEX), Workforce Advisor, Workforce Services Representative (WSR)
...
|------------|----------|------|
| 93 | Core | Compute and authorize amounts of assistance for programs, such as grants, monetary payments, and food stamps. |
| 90 | Core | Keep records of assigned cases, and prepare required reports. |
| 89 | Core | Compile, record, and evaluate personal and financial data to verify completeness and accuracy, and to determine eligibility status. |
| 87 | Core | Interview and investigate applicants for public assistance to gather information pertinent to their applications. |
| 87 | Core | Interview benefits recipients at specified intervals to certify their eligibility for continuing benefits. |
| 86 | Core | Interpret and explain information such as eligibility requirements, application details, payment methods, and applicants' legal rights. |
| 85 | Core | Initiate procedures to grant, modify, deny, or terminate assistance, or refer applicants to other agencies for assistance. |
| 84 | Core | Check with employers or other references to verify answers and obtain further information. |
| 84 | Core | Answer applicants' questions about benefits and claim procedures. |
| 77 | Supplemental | Provide social workers with pertinent information gathered during applicant interviews. |
| 76 | Supplemental | Refer applicants to job openings or to interviews with other staff, in accordance with administrative guidelines or office procedures. |
| 76 | Supplemental | Schedule benefits claimants for adjudication interviews to address questions of eligibility. |
| 73 | Supplemental | Provide applicants with assistance in completing application forms, such as those for job referrals or unemployment compensation claims. |
| 73 | Supplemental | Prepare applications and forms for applicants for such purposes as school enrollment, employment, and medical services. |
| 72 | Supplemental | Investigate claimants for the possibility of fraud or abuse. |
| 68 | Supplemental | Conduct annual, interim, and special housing reviews and home visits to ensure conformance to regulations. |
| 66 | Supplemental | Monitor the payments of benefits throughout the duration of a claim. |
...
|---|---|
| 98 | Customer and Personal Service — Knowledge of principles and processes for providing customer and personal services. This includes customer needs assessment, meeting quality standards for services, and evaluation of customer satisfaction. |
