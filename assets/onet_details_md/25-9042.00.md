...
**Quick Facts:**
- SOC Code: 25-9042.00
- Also called: Classroom Aide, Educational Assistant, Instructional Assistant, Kindergarten Assistant, Paraeducator, Paraprofessional, Preschool Aide, TA (Teacher Assistant), TA (Teaching Assistant), Teacher Aide
...
|------------|----------|------|
| 90 | Core | Supervise students in classrooms, halls, cafeterias, school yards, and gymnasiums, or on field trips. |
| 87 | Core | Tutor and assist children individually or in small groups to help them master assignments and to reinforce learning concepts presented by teachers. |
| 83 | Core | Enforce administration policies and rules governing students. |
| 81 | Core | Teach social skills to students. |
| 81 | Core | Instruct and monitor students in the use and care of equipment and materials to prevent injuries and damage. |
| 80 | Core | Discuss assigned duties with classroom teachers to coordinate instructional efforts. |
| 80 | Core | Present subject matter to students under the direction and guidance of teachers, using lectures, discussions, supervised role-playing methods, or by reading aloud. |
| 77 | Core | Clean classrooms. |
| 77 | Core | Observe students' performance, and record relevant data to assess progress. |
| 74 | Core | Organize and label materials and display students' work in a manner appropriate for their eye levels and perceptual skills. |
| 74 | Core | Organize and supervise games and other recreational activities to promote physical, mental, and social development. |
| 73 | Core | Attend staff meetings and serve on committees, as required. |
| 72 | Core | Use computers, audio-visual aids, and other equipment and materials to supplement presentations. |
| 71 | Core | Prepare lesson materials, bulletin board displays, exhibits, equipment, and demonstrations. |
| 71 | Core | Conduct demonstrations to teach skills, such as sports, dancing, and handicrafts. |
| 69 | Core | Distribute teaching materials, such as textbooks, workbooks, papers, and pencils, to students. |
| 65 | Core | Type, file, and duplicate materials. |
| 62 | Core | Laminate teaching materials to increase their durability under repeated use. |
| 62 | Core | Requisition and stock teaching materials and supplies. |
| 84 | Supplemental | Take class attendance and maintain attendance records. |
| 78 | Supplemental | Participate in teacher-parent conferences regarding students' progress or problems. |
| 76 | Supplemental | Assist in bus loading and unloading. |
| 73 | Supplemental | Maintain computers in classrooms and laboratories, and assist students with hardware and software use. |
| 72 | Supplemental | Grade homework and tests, and compute and record results, using answer sheets or electronic marking devices. |
| 72 | Supplemental | Plan, prepare, and develop various teaching aids, such as bibliographies, charts, and graphs. |
| 68 | Supplemental | Operate and maintain audio-visual equipment. |
| 64 | Supplemental | Distribute tests and homework assignments and collect them when they are completed. |
| 62 | Supplemental | Collect money from students for school-related projects. |
...
- Southeastern Association of Educational Opportunity Program Personnel external site
