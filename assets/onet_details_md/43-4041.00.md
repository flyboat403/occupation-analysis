...
|------------|----------|------|
| 89 | Core | Keep records of customers' charges and payments. |
| 85 | Core | Compile and analyze credit information gathered by investigation. |
| 76 | Core | Obtain information about potential creditors from banks, credit bureaus, and other credit services, and provide reciprocal information if requested. |
| 76 | Core | Interview credit applicants by telephone or in person to obtain personal and financial data needed to complete credit report. |
| 90 | Supplemental | Evaluate customers' computerized credit records and payment histories to decide whether to approve new credit, based on predetermined standards. |
| 85 | Supplemental | File sales slips in customers' ledgers for billing purposes. |
| 74 | Supplemental | Receive charge slips or credit applications by mail, or receive information from salespeople or merchants by telephone. |
| 71 | Supplemental | Mail charge statements to customers. |
| 60 | Supplemental | Examine city directories and public records to verify residence property ownership, bankruptcies, liens, arrest record, or unpaid taxes of applicants. |
| 58 | Supplemental | Relay credit report information to subscribers by mail or by telephone. |
| 50 | Supplemental | Prepare credit cards or charge account plates. |
...
| 32 | Monitoring Processes, Materials, or Surroundings — Monitoring and reviewing information from materials, events, or the environment, to detect or assess problems. |
