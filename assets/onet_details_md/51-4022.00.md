...
**Quick Facts:**
- SOC Code: 51-4022.00
- Also called: Blacksmith, Cold Header Operator, Forge Operator, Forge Press Operator, Forger, Hammer Operator, Header Set-Up Operator, Machine Operator, Process Technician, Set Up Technician
...
|------------|----------|------|
| 89 | Core | Read work orders or blueprints to determine specified tolerances and sequences of operations for machine setup. |
| 86 | Core | Position and move metal wires or workpieces through a series of dies that compress and shape stock to form die impressions. |
| 86 | Core | Measure and inspect machined parts to ensure conformance to product specifications. |
| 85 | Core | Set up, operate, or tend presses and forging machines to perform hot or cold forging by flattening, straightening, bending, cutting, piercing, or other operations to taper, shape, or form metal. |
| 84 | Core | Turn handles or knobs to set pressures and depths of ram strokes and to synchronize machine operations. |
| 83 | Core | Install, adjust, and remove dies, synchronizing cams, forging hammers, and stop guides, using overhead cranes or other hoisting devices, and hand tools. |
| 82 | Core | Start machines to produce sample workpieces, and observe operations to detect machine malfunctions and to verify that machine setups conform to specifications. |
| 78 | Core | Confer with other workers about machine setups and operational specifications. |
| 78 | Core | Trim and compress finished forgings to specified tolerances. |
| 74 | Core | Remove dies from machines when production runs are finished. |
| 73 | Core | Repair, maintain, and replace parts on dies. |
| 71 | Supplemental | Select, align, and bolt positioning fixtures, stops, and specified dies to rams and anvils, forging rolls, or presses and hammers. |
| 63 | Supplemental | Sharpen cutting tools and drill bits, using bench grinders. |
...
- Forging Industry Association external site
