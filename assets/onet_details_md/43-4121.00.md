...
**Quick Facts:**
- SOC Code: 43-4121.00
- Also called: Acquisitions Assistant, Cataloging Assistant, Library Aide, Library Assistant, Library Associate, Library Circulation Assistant, Library Clerical Assistant, Library Clerk, Library Services Assistant
...
|------------|----------|------|
| 83 | Core | Sort books, publications, and other items according to established procedure and return them to shelves, files, or other designated storage areas. |
| 83 | Core | Open and close library during specified hours and secure library equipment, such as computers and audio-visual equipment. |
| 82 | Core | Locate library materials for patrons, including books, periodicals, tape cassettes, Braille volumes, and pictures. |
| 82 | Core | Enter and update patrons' records on computers. |
| 81 | Core | Answer routine inquiries and refer patrons in need of professional assistance to librarians. |
| 81 | Core | Manage reserve materials by placing items on reserve for library patrons, checking items in and out of library, and removing out-of-date items. |
| 77 | Core | Lend, reserve, and collect books, periodicals, videotapes, and other materials at circulation desks and process materials for inter-library loans. |
| 77 | Core | Instruct patrons on how to use reference sources, card catalogs, and automated information systems. |
| 77 | Core | Inspect returned books for condition and due-date status and compute any applicable fines. |
| 76 | Core | Maintain records of items received, stored, issued, and returned and file catalog cards according to system used. |
| 75 | Core | Perform clerical activities, such as answering phones, sorting mail, filing, typing, word processing, and photocopying and mailing out material. |
| 75 | Core | Register new patrons and issue borrower identification cards that permit patrons to borrow books and other materials. |
| 73 | Core | Process new materials including books, audio-visual materials, and computer software. |
| 71 | Core | Provide assistance to librarians in the maintenance of collections of books, periodicals, magazines, newspapers, and audio-visual and other materials. |
| 71 | Core | Review records, such as microfilm and issue cards, to identify titles of overdue materials and delinquent borrowers. |
| 71 | Core | Send out notices and accept fine payments for lost or overdue books. |
| 69 | Core | Maintain library equipment, such as photocopiers, scanners, and computers, and instruct patrons in proper use of such equipment. |
| 68 | Core | Schedule, supervise, and train clerical workers, volunteers, student assistants, and other library employees. |
| 68 | Core | Repair books using mending tape, paste, and brushes or prepare books to be sent to a bindery for repair. |
| 67 | Core | Take action to deal with disruptive or problem patrons. |
| 64 | Core | Prepare, store, and retrieve classification and catalog information, lecture notes, or other information related to stored documents, using computers. |
| 61 | Core | Select substitute titles when requested materials are unavailable, following criteria such as age, education, and interests. |
| 60 | Core | Prepare library statistics reports. |
| 58 | Core | Deliver and retrieve items to and from departments by hand or using push carts. |
| 53 | Core | Assist in the preparation of book displays. |
| 82 | Supplemental | Classify and catalog items according to content and purpose. |
| 74 | Supplemental | Operate small branch libraries, under the direction of off-site librarian supervisors. |
| 69 | Supplemental | Plan or participate in library events and programs, such as story time with children. |
| 68 | Supplemental | Perform accounting and bookkeeping activities, such as invoicing, maintaining financial records, budgeting, and handling cash. |
| 68 | Supplemental | Operate and maintain audio-visual equipment. |
| 65 | Supplemental | Design or maintain library web site and online catalogues. |
| 63 | Supplemental | Acquire books, pamphlets, periodicals, audio-visual materials, and other library supplies by checking prices, figuring costs, and preparing appropriate order forms and facilitating the ordering process by providing such information to others. |

## Technology Skills

| Hot Technology | Examples |
|----------------|----------|
| Data base user interface and query software | Database software; Microsoft Access Hot Technology ; Recordkeeping software |
...
- Sort materials or products. Related occupations
...
- Plan special events. Related occupations
- Prepare employee work schedules. Related occupations
- Repair books or other printed material. Related occupations
