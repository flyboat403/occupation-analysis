...
**Quick Facts:**
- SOC Code: 33-9031.00
- Also called: Casino Enforcement Agent, Gaming Investigator, Security Officer, Surveillance Agent, Surveillance Investigator, Surveillance Monitor, Surveillance Observer, Surveillance Officer, Surveillance Operator, Surveillance Technician
...
|------------|----------|------|
| 95 | Core | Monitor establishment activities to ensure adherence to all state gaming regulations and company policies and procedures. |
| 95 | Core | Observe casino or casino hotel operations for irregular activities, such as cheating or theft by employees or patrons, using audio and video equipment and one-way mirrors. |
| 95 | Core | Report all violations and suspicious behaviors to supervisors, verbally or in writing. |
| 93 | Core | Develop and maintain log of surveillance observations. |
| 91 | Core | Inspect and monitor audio or video surveillance equipment to ensure it is working appropriately. |
| 90 | Core | Review video surveillance footage. |
| 86 | Core | Act as oversight or security agents for management or customers. |
| 77 | Core | Supervise or train surveillance observers. |
