...
**Quick Facts:**
- SOC Code: 47-5012.00
- Also called: Daylight Driller, Drill Operator, Driller, Drilling Rig Operator, Motor Man, Oil Rig Driller, Oil Well Driller, Relief Driller, Tool Pusher
...
|------------|----------|------|
| 88 | Core | Train crews, and introduce procedures to make drill work more safe and effective. |
| 87 | Core | Observe pressure gauge and move throttles and levers to control the speed of rotary tables, and to regulate pressure of tools at bottoms of boreholes. |
| 86 | Core | Count sections of drill rod to determine depths of boreholes. |
| 85 | Core | Push levers and brake pedals to control gasoline, diesel, electric, or steam draw works that lower and raise drill pipes and casings in and out of wells. |
| 85 | Core | Connect sections of drill pipe, using hand tools and powered wrenches and tongs. |
| 84 | Core | Maintain records of footage drilled, location and nature of strata penetrated, materials and tools used, services rendered, and time required. |
| 83 | Core | Maintain and adjust machinery to ensure proper performance. |
| 82 | Core | Start and examine operation of slush pumps to ensure circulation and consistency of drilling fluid or mud in well. |
| 82 | Core | Locate and recover lost or broken bits, casings, and drill pipes from wells, using special tools. |
| 80 | Core | Weigh clay, and mix with water and chemicals to make drilling mud. |
| 80 | Core | Direct rig crews in drilling and other activities, such as setting up rigs and completing or servicing wells. |
| 80 | Core | Monitor progress of drilling operations, and select and change drill bits according to the nature of strata, using hand tools. |
| 77 | Core | Repair or replace defective parts of machinery, such as rotary drill rigs, water trucks, air compressors, and pumps, using hand tools. |
| 76 | Core | Clean and oil pulleys, blocks, and cables. |
| 74 | Core | Bolt together pump and engine parts, and connect tanks and flow lines. |
| 71 | Core | Remove core samples during drilling to determine the nature of the strata being drilled. |
| 77 | Supplemental | Cap wells with packers, or turn valves, to regulate outflow of oil from wells. |
| 75 | Supplemental | Line drilled holes with pipes, and install all necessary hardware, to prepare new wells. |
| 73 | Supplemental | Position and prepare truck-mounted derricks at drilling areas specified on field maps. |
| 62 | Supplemental | Plug observation wells, and restore sites. |
...
| 49 | Achievement Orientation — A tendency to establish and maintain personally challenging work-related goals, set high work-related standards, and exert high effort toward meeting those goals and standards. |
...
- American Association of Professional Landmen external site
...
- Southern Gas Association external site

- Southeastern Oil &amp; Gas Association external site
- Western States Petroleum Association external site

- International Union of Operating Engineers external site
- National Association of Energy Service Companies external site
