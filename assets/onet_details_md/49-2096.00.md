...
**Quick Facts:**
- SOC Code: 49-2096.00
- Also called: Automotive Technician, Car Audio Installer, Car Electronics Installer, Car Stereo Installer, Electronic Equipment Installer, Electronic Technician, Installation Technician, Installer, Mobile Electronics Installation Specialist, Mobile Electronics Installer
...
|------------|----------|------|
| 87 | Core | Install equipment and accessories, such as stereos, navigation equipment, communication equipment, and security systems. |
| 86 | Core | Inspect and test electrical or electronic systems to locate and diagnose malfunctions, using visual inspections and testing instruments, such as oscilloscopes and voltmeters. |
| 85 | Core | Cut openings and drill holes for fixtures and equipment, using electric drills and routers. |
| 83 | Core | Splice wires with knives or cutting pliers, and solder connections to fixtures and equipment. |
| 83 | Core | Diagnose or repair problems with electronic equipment, such as sound, navigation, communication, and security equipment, in motor vehicles. |
| 82 | Core | Run new speaker and electrical cables. |
| 82 | Core | Confer with customers to determine the nature of malfunctions. |
| 78 | Core | Remove seats, carpeting, and interiors of doors and add sound-absorbing material in empty spaces, reinstalling interior parts. |
| 76 | Core | Record results of diagnostic tests. |
| 75 | Core | Estimate costs of repairs, based on parts and labor charges. |
| 72 | Core | Replace and clean electrical or electronic components. |
| 68 | Core | Build fiberglass or wooden enclosures for sound components, and fit them to automobile dimensions. |
...
- The Mobile Electronics Certified Professional external site
