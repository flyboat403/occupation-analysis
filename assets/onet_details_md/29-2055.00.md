...
|------------|----------|------|
| 98 | Core | Maintain a proper sterile field during surgical procedures. |
| 97 | Core | Count sponges, needles, and instruments before and after operation. |
| 96 | Core | Scrub arms and hands and assist the surgical team to scrub and put on gloves, masks, and surgical clothing. |
| 95 | Core | Provide technical assistance to surgeons, surgical nurses, or anesthesiologists. |
| 95 | Core | Prepare patients for surgery, including positioning patients on the operating table and covering them with sterile surgical drapes to prevent exposure. |
| 94 | Core | Hand instruments and supplies to surgeons and surgeons' assistants, hold retractors and cut sutures, and perform other tasks as directed by surgeon during operation. |
| 93 | Core | Prepare, care for, and dispose of tissue specimens taken for laboratory analysis. |
| 93 | Core | Wash and sterilize equipment, using germicides and sterilizers. |
| 93 | Core | Monitor and continually assess operating room conditions, including patient and surgical team needs. |
| 92 | Core | Operate, assemble, adjust, or monitor sterilizers, lights, suction machines, or diagnostic equipment to ensure proper operation. |
| 92 | Core | Prepare dressings or bandages and apply or assist with their application following surgery. |
| 91 | Core | Clean and restock operating room, gathering and placing equipment and supplies and arranging instruments according to instructions, such as a preference card. |
| 86 | Core | Order surgical supplies. |
| 81 | Core | Observe patients' vital signs to assess physical condition. |
| 86 | Supplemental | Maintain supply of fluids, such as plasma, saline, blood, or glucose, for use during operations. |
| 76 | Supplemental | Maintain files and records of surgical procedures. |
...
- International Association of Healthcare Central Service Materiel Management external site
