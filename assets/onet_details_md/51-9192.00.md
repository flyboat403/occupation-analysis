...
**Quick Facts:**
- SOC Code: 51-9192.00
- Also called: Anodizer, Clean in Places Operator (CIP Operator), Filler Operator, Parts Cleaner, Sanitation Technician, Sanitation Worker, Sanitizer, Tub Wash Operator, Tub Washer, Wash Crew Person
...
|------------|----------|------|
| 81 | Core | Add specified amounts of chemicals to equipment at required times to maintain solution levels and concentrations. |
| 78 | Core | Observe machine operations, gauges, or thermometers, and adjust controls to maintain specified conditions. |
| 77 | Core | Set controls to regulate temperature and length of cycles, and start conveyors, pumps, agitators, and machines. |
| 74 | Core | Drain, clean, and refill machines or tanks at designated intervals, using cleaning solutions or water. |
| 74 | Core | Operate or tend machines to wash and remove impurities from items such as barrels or kegs, glass products, tin plate surfaces, dried fruit, pulp, animal stock, coal, manufactured articles, plastic, or rubber. |
| 71 | Core | Record gauge readings, materials used, processing times, or test results in production logs. |
| 70 | Core | Examine and inspect machines to detect malfunctions. |
| 66 | Core | Measure, weigh, or mix cleaning solutions, using measuring tanks, calibrated rods or suction tubes. |
| 77 | Supplemental | Draw samples for laboratory analysis, or test solutions for conformance to specifications, such as acidity or specific gravity. |
| 76 | Supplemental | Adjust, clean, and lubricate mechanical parts of machines, using hand tools and grease guns. |
| 70 | Supplemental | Load machines with objects to be processed and unload them after cleaning, placing them on conveyors or racks. |
