...
**Quick Facts:**
- SOC Code: 13-2022.00
- Also called: Accredited Appraiser, Aircraft Appraiser, Appraiser, Art Appraiser, Certified Appraiser, Gem and Jewelry Appraiser, Jewelry Appraiser, Personal Property Appraiser
...
|------------|----------|------|
| 98 | Core | Write descriptions of the property being appraised. |
| 98 | Core | Determine the appropriate type of valuation to make, such as fair market, replacement, or liquidation, based on the needs of the property owner. |
| 96 | Core | Document physical characteristics of property such as measurements, quality, and design. |
| 96 | Core | Calculate the value of property based on comparisons to recent sales, estimated cost to reproduce, and anticipated property income streams. |
| 93 | Core | Locate and record data on sales of comparable property using specialized software, internet searches, or personal records. |
| 93 | Core | Write and submit appraisal reports for property, such as jewelry, art, antiques, collectibles, and equipment. |
| 88 | Core | Inspect personal or business property. |
| 84 | Core | Create and maintain a database of completed appraisals. |
| 82 | Core | Take photographs of property. |
| 76 | Core | Verify that property matches legal descriptions or certifications. |
| 74 | Core | Update appraisals when property has been improved, damaged, or has otherwise changed. |
| 62 | Core | Testify in court as to the value of a piece of tangible property. |
| 55 | Core | Forecast the value of property. |
| 68 | Supplemental | Recommend loan amounts based on the value of property being used as collateral. |
...
| Data base user interface and query software | Ascend Property Assessment; Bruno Realty eNeighboorhoods; Microsoft Access Hot Technology ; Yardi software Hot Technology |
...
- Appraisers Association of America external site
- International Association of Assessing Officers external site
- National Association of Professional Appraisers external site
...
- New England Appraisers Association external site
