...
**Quick Facts:**
- SOC Code: 15-1243.00
- Also called: Data Architect, Data Engineer, Data Officer, Database Analyst, Database Architect, Database Consultant, Database Developer, Database Programmer, Enterprise Architect, Information Architect
...
|------------|----------|------|
| 88 | Core | Develop and document database architectures. |
| 87 | Core | Collaborate with system architects, software architects, design analysts, and others to understand business or industry requirements. |
| 86 | Core | Develop database architectural strategies at the modeling, design and implementation stages to address business or industry requirements. |
| 85 | Core | Design databases to support business applications, ensuring system scalability, security, performance, and reliability. |
| 78 | Core | Develop data models for applications, metadata tables, views or related database structures. |
| 78 | Core | Design database applications, such as interfaces, data transfer mechanisms, global temporary tables, data partitions, and function-based indexes to enable efficient access of the generic database structure. |
| 76 | Core | Develop methods for integrating different products so they work properly together, such as customizing commercial databases to fit specific needs. |
| 75 | Core | Create and enforce database development standards. |
| 74 | Core | Document and communicate database schemas, using accepted notations. |
| 74 | Core | Develop data model describing data elements and their use, following procedures and using pen, template or computer software. |
| 73 | Core | Work as part of a project team to coordinate database development and determine project scope and limitations. |
| 71 | Core | Identify and evaluate industry trends in database systems to serve as a source of information and advice for upper management. |
| 71 | Core | Set up database clusters, backup, or recovery processes. |
| 69 | Core | Demonstrate database technical functionality, such as performance, security and reliability. |
| 68 | Core | Develop load-balancing processes to eliminate down time for backup processes. |
| 68 | Core | Plan and install upgrades of database management system software to enhance database performance. |
| 67 | Core | Identify, evaluate and recommend hardware or software technologies to achieve desired database performance. |
| 65 | Core | Test programs or databases, correct errors, and make necessary modifications. |
| 64 | Core | Identify and correct deviations from database development standards. |
| 62 | Core | Review project requests describing database user needs to estimate time and cost required to accomplish project. |
| 61 | Core | Write and code logical and physical database descriptions, and specify identifiers of database to management system or direct others in coding descriptions. |
| 56 | Core | Develop or maintain archived procedures, procedural codes, or queries for applications. |
| 55 | Core | Provide technical support to junior staff or clients. |
| 54 | Core | Establish and calculate optimum values for database parameters, using manuals and calculators. |
| 38 | Supplemental | Train users and answer questions. |
...
| Cloud-based management software | Amazon Web Services AWS CloudFormation Hot Technology ; IBM WebSphere; Jitterbit; Splunk Enterprise Hot Technology |
...
| Data base management system software | Amazon DynamoDB Hot Technology ; Elasticsearch Hot Technology ; MongoDB Hot Technology ; Oracle PL/SQL Hot Technology ; 43 more |
...
| Data base user interface and query software | Apache Hive Hot Technology ; Blackboard software; IBM DB2 Hot Technology ; Transact-SQL Hot Technology ; 11 more |
| Data mining software | Google Analytics Hot Technology ; IBM InfoSphere Warehouse; Rapid-I RapidMiner; Snowflake |
| Desktop communications software | Skype |
| Desktop publishing software | Microsoft Publisher |
| Development environment software | Apache Kafka Hot Technology ; Apache Maven Hot Technology ; Go Hot Technology ; Oracle SQL Developer Hot Technology ; 19 more |
| Document management software | Adobe Acrobat Hot Technology ; IBM Content Manager; Microsoft SharePoint Hot Technology |
| Electronic mail software | IBM Notes; Microsoft Exchange; Microsoft Outlook Hot Technology |
| Enterprise application integration software | Extensible markup language XML Hot Technology ; IBM InfoSphere DataStage; Microsoft SQL Server Integration Services SSIS Hot Technology ; SAS Data Integration Studio ; 6 more |
...
| Metadata management software | Informatica software Hot Technology ; Quest Erwin Data Modeler; SAP PowerDesigner; Talend Data Fabric ; 16 more |
...
| Object or component oriented development software | Apache Spark ; jQuery Hot Technology ; Scala Hot Technology ; Swift Hot Technology ; 13 more |
| Object oriented data base management software | Hibernate ORM Hot Technology ; IBM Informix; Object database management system ODBMS; PostgreSQL Hot Technology |
| Office suite software | Microsoft Office software |
| Operating system software | Bash Hot Technology ; Microsoft Windows Server Hot Technology ; Red Hat Enterprise Linux Hot Technology ; UNIX Shell Hot Technology ; 15 more |
