...
**Quick Facts:**
- SOC Code: 35-2013.00
- Also called: Certified Personal Chef (CPC), Personal Chef, Personal Private Chef, Private Chef
...
|------------|----------|------|
| 95 | Core | Peel, wash, trim, and cook vegetables and meats, and bake breads and pastries. |
| 94 | Core | Cool, package, label, and freeze foods for later consumption and provide instructions for reheating. |
| 92 | Core | Plan menus according to employers' needs and diet restrictions. |
| 91 | Core | Shop for or order food and kitchen supplies and equipment. |
| 88 | Core | Prepare meals in private homes according to employers' recipes or tastes, handling all meals for the family and possibly for other household staff. |
| 87 | Core | Keep records pertaining to menus, finances, and other business-related issues. |
| 86 | Core | Stock, organize, and clean kitchens and cooking utensils. |
| 77 | Core | Direct the operation and organization of kitchens and all food-related activities, including the presentation and serving of food. |
| 77 | Core | Specialize in preparing fancy dishes or food for special diets. |
| 66 | Core | Plan and prepare food for parties, holiday meals, luncheons, special functions, and other social events. |
| 65 | Core | Create and explore new cuisines. |
| 55 | Core | Serve meals and snacks to employing families and their guests. |
| 30 | Supplemental | Travel with employers to vacation homes to provide meal preparation at those locations. |

## Technology Skills

| Hot Technology | Examples |
|----------------|----------|
| Accounting software | Cost tracking software; Intuit QuickBooks Hot Technology |
...
- United States Personal Chef Association external site
