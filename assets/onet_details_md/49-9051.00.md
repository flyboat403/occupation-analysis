...
**Quick Facts:**
- SOC Code: 49-9051.00
- Also called: Class Gloving Electrical Lineman, Class Rubber Gloving Lineman, Electrical Lineman, Electrical Lineworker, Lineworker, Power Lineman, Power Lineman Technician, Service Man, Third Step Lineman, Troubleman
...
|------------|----------|------|
| 94 | Core | Adhere to safety practices and procedures, such as checking equipment regularly and erecting barriers around work areas. |
| 94 | Core | Drive vehicles equipped with tools and materials to job sites. |
| 93 | Core | Open switches or attach grounding devices to remove electrical hazards from disturbed or fallen lines or to facilitate repairs. |
| 89 | Core | Climb poles or use truck-mounted buckets to access equipment. |
| 88 | Core | Install, maintain, and repair electrical distribution and transmission systems, including conduits, cables, wires, and related equipment, such as transformers, circuit breakers, and switches. |
| 88 | Core | Inspect and test power lines and auxiliary equipment to locate and identify problems, using reading and testing instruments. |
| 87 | Core | Coordinate work assignment preparation and completion with other workers. |
| 86 | Core | Replace or straighten damaged poles. |
| 86 | Core | String wire conductors and cables between poles, towers, trenches, pylons, and buildings, setting lines in place and using winches to adjust tension. |
| 84 | Core | Attach cross-arms, insulators, and auxiliary equipment to poles prior to installing them. |
| 84 | Core | Dig holes, using augers, and set poles, using cranes and power equipment. |
| 82 | Core | Travel in trucks, helicopters, and airplanes to inspect lines for freedom from obstruction and adequacy of insulation. |
| 81 | Core | Identify defective sectionalizing devices, circuit breakers, fuses, voltage regulators, transformers, switches, relays, or wiring, using wiring diagrams and electrical-testing instruments. |
| 80 | Core | Install watt-hour meters and connect service drops between power lines and consumers' facilities. |
| 79 | Core | Test conductors, according to electrical diagrams and specifications, to identify corresponding conductors and to prevent incorrect connections. |
| 76 | Core | Place insulating or fireproofing materials over conductors and joints. |
...
| 71 | Core | Trim trees that could be hazardous to the functioning of cables or wires. |
| 69 | Core | Pull up cable by hand from large reels mounted on trucks. |
| 59 | Core | Lay underground cable directly in trenches, or string it through conduit running through the trenches. |
| 57 | Core | Cut trenches for laying underground cables, using trenchers and cable plows. |
| 54 | Core | Cut and peel lead sheathing and insulation from defective or newly installed cables and conduits prior to splicing. |
| 69 | Supplemental | Clean, tin, and splice corresponding conductors by twisting ends together or by joining ends with metal clamps and soldering connections. |

## Technology Skills

| Hot Technology | Examples |
|----------------|----------|
| Computer aided design CAD software | Bentley MicroStation Hot Technology ; Computer aided design and drafting CADD software |
