...
**Quick Facts:**
- SOC Code: 51-4081.00
- Also called: Cell Technician, CNC Machine Setter (Computer Numerically Controlled Machine Setter), Fabrication Set-Up Person, Injection Molding Technician, Machine Operator, Machine Technician, Mold Setter, Production Operator, Shear Operator, Tooling Set-Up Person
...
|------------|----------|------|
| 89 | Core | Inspect workpieces for defects, and measure workpieces to determine accuracy of machine operation, using rules, templates, or other measuring instruments. |
| 84 | Core | Position, adjust, and secure stock material or workpieces against stops, on arbors, or in chucks, fixtures, or automatic feeding mechanisms, manually or using hoists. |
| 83 | Core | Read blueprints or job orders to determine product specifications and tooling instructions and to plan operational sequences. |
| 83 | Core | Select, install, and adjust alignment of drills, cutters, dies, guides, and holding devices, using templates, measuring instruments, and hand tools. |
| 81 | Core | Observe machine operation to detect workpiece defects or machine malfunctions, adjusting machines as necessary. |
| 80 | Core | Set up and operate machines, such as lathes, cutters, shears, borers, millers, grinders, presses, drills, or auxiliary machines, to make metallic and plastic workpieces. |
| 77 | Core | Change worn machine accessories, such as cutting tools or brushes, using hand tools. |
| 76 | Core | Set machine stops or guides to specified lengths as indicated by scales, rules, or templates. |
| 75 | Core | Select the proper coolants and lubricants and start their flow. |
| 74 | Core | Remove burrs, sharp edges, rust, or scale from workpieces, using files, hand grinders, wire brushes, or power tools. |
| 74 | Core | Perform minor machine maintenance, such as oiling or cleaning machines, dies, or workpieces, or adding coolant to machine reservoirs. |
| 73 | Core | Make minor electrical and mechanical repairs and adjustments to machines and notify supervisors when major service is required. |
| 72 | Core | Compute data, such as gear dimensions or machine settings, applying knowledge of shop mathematics. |
| 72 | Core | Start machines and turn handwheels or valves to engage feeding, cooling, and lubricating mechanisms. |
| 70 | Core | Move controls or mount gears, cams, or templates in machines to set feed rates and cutting speeds, depths, and angles. |
| 67 | Core | Instruct other workers in machine set-up and operation. |
| 65 | Core | Record operational data, such as pressure readings, lengths of strokes, feed rates, or speeds. |
| 62 | Core | Extract or lift jammed pieces from machines, using fingers, wire hooks, or lift bars. |
| 78 | Supplemental | Measure and mark reference points and cutting lines on workpieces, using traced templates, compasses, and rules. |
| 67 | Supplemental | Write programs for computer numerical control (CNC) machines to cut metal and plastic materials. |
| 62 | Supplemental | Align layout marks with dies or blades. |
