...
**Quick Facts:**
- SOC Code: 39-1013.00
- Also called: Casino Manager, Casino Shift Manager (CSM), Floor Supervisor, Pit Boss, Pit Supervisor, Slot Floor Person, Slot Shift Manager, Slot Shift Supervisor, Slot Supervisor, Table Games Supervisor
...
|------------|----------|------|
| 95 | Core | Monitor game operations to ensure that house rules are followed, that tribal, state, and federal regulations are adhered to, and that employees provide prompt and courteous service. |
| 94 | Core | Observe gamblers' behavior for signs of cheating, such as marking, switching, or counting cards, and notify security staff of suspected cheating. |
| 91 | Core | Perform paperwork required for monetary transactions. |
| 90 | Core | Respond to and resolve patrons' complaints. |
| 90 | Core | Greet customers and ask about the quality of service they are receiving. |
| 89 | Core | Perform minor repairs or make adjustments to slot machines, resolving problems such as machine tilts and coin jams. |
| 88 | Core | Maintain familiarity with the games at a facility and with strategies or tricks used by cheaters at such games. |
| 88 | Core | Monitor payment of hand-delivered jackpots to ensure promptness. |
| 88 | Core | Explain and interpret house rules, such as game rules or betting limits, for patrons. |
| 87 | Core | Establish and maintain banks and table limits for each game. |
| 86 | Core | Reset slot machines after payoffs. |
| 84 | Core | Answer patrons' questions about gaming machine functions and payouts. |
| 84 | Core | Record the specifics of malfunctioning machines and document malfunctions needing repair. |
| 83 | Core | Monitor patrons for signs of compulsive gambling, offering assistance if necessary. |
| 82 | Core | Supervise the distribution of complimentary meals, hotel rooms, discounts, or other items given to players, based on length of play and amount bet. |
| 82 | Core | Report customer-related incidents occurring in gaming areas to supervisors. |
| 80 | Core | Attach "out of order" signs to malfunctioning machines, and notify technicians when machines need to be repaired or removed. |
| 79 | Core | Enforce safety rules, and report or remove safety hazards as well as guests who are underage, intoxicated, disruptive, or cheating. |
| 78 | Core | Exchange currency for customers, converting currency into requested combinations of bills and coins. |
| 75 | Core | Evaluate workers' performance and prepare written performance evaluations. |
| 71 | Core | Monitor stations and games and move dealers from game to game to ensure adequate staffing. |
| 69 | Core | Clean and maintain slot machines and surrounding areas. |
| 83 | Supplemental | Monitor functioning of slot machine coin dispensers and fill coin hoppers when necessary. |
| 81 | Supplemental | Record, issue receipts for, and pay off bets. |
| 76 | Supplemental | Determine how many gaming tables to open each day and schedule staff accordingly. |
| 72 | Supplemental | Direct workers compiling summary sheets for each race or event to record amounts wagered and amounts to be paid to winners. |
| 55 | Supplemental | Review operational expenses, budget estimates, betting accounts, or collection reports for accuracy. |
...
- Association of Gaming Equipment Manufacturers external site
