...
**Quick Facts:**
- SOC Code: 13-1161.00
- Also called: Business Development Specialist, Communications Specialist, Demographic Analyst, Market Analyst, Market Research Analyst, Market Research Consultant, Market Research Specialist, Market Researcher
...
|------------|----------|------|
| 90 | Core | Prepare reports of findings, illustrating data graphically and translating complex findings into written text. |
| 84 | Core | Collect and analyze data on customer demographics, preferences, needs, and buying habits to identify potential markets and factors affecting product demand. |
| 84 | Core | Conduct research on consumer opinions and marketing strategies, collaborating with marketing professionals, statisticians, pollsters, and other professionals. |
| 83 | Core | Measure and assess customer and employee satisfaction. |
| 82 | Core | Devise and evaluate methods and procedures for collecting data, such as surveys, opinion polls, or questionnaires, or arrange to obtain existing data. |
| 78 | Core | Measure the effectiveness of marketing, advertising, and communications programs and strategies. |
| 74 | Core | Seek and provide information to help companies determine their position in the marketplace. |
| 74 | Core | Forecast and track marketing and sales trends, analyzing collected data. |
| 74 | Core | Gather data on competitors and analyze their prices, sales, and method of marketing and distribution. |
| 69 | Core | Monitor industry statistics and follow trends in trade literature. |
| 66 | Core | Attend staff conferences to provide management with information and proposals concerning the promotion, distribution, design, and pricing of company products or services. |
| 62 | Core | Direct trained survey interviewers. |
| 52 | Core | Develop and implement procedures for identifying advertising needs. |

## Technology Skills

| Hot Technology | Examples |
|----------------|----------|
| Analytical or scientific software | IBM SPSS Statistics Hot Technology ; Minitab; Sawtooth Composite Product Mapping CPM; The MathWorks MATLAB Hot Technology ; 18 more |
...
| Cloud-based data access and sharing software | Asana Hot Technology ; Dropbox; Google Drive; Slack Hot Technology |
...
| Data base user interface and query software | Airtable; Amazon Redshift Hot Technology ; Microsoft SQL Server Hot Technology ; MySQL Hot Technology ; 10 more |
| Data mining software | Cytel Software XLMiner; Google Analytics ; NCR Teradata Warehouse Miner; Oracle Darwin ; 1 more |
| Desktop publishing software | Adobe InDesign Hot Technology ; LogiXML Ad-HOC; Microsoft Publisher; Sawtooth SSI Web |
| Development environment software | Adobe ActionScript; Microsoft Visual Basic Hot Technology ; Microsoft Visual Basic for Applications VBA Hot Technology |
| Document management software | Adobe Acrobat Hot Technology ; Microsoft SharePoint Hot Technology |
| Electronic mail software | IBM Notes; Microsoft Outlook |
| Enterprise resource planning ERP software | Aprimo Marketing; Microsoft Dynamics; Oracle PeopleSoft Hot Technology ; SAP software Hot Technology ; 3 more |
...
| Graphics or photo imaging software | Adobe Creative Cloud software ; Adobe Illustrator Hot Technology ; Adobe Photoshop ; Canva ; 2 more |
...
| Operating system software | Apple macOS Hot Technology ; Red Hat Enterprise Linux Hot Technology |
...
| Project management software | Basecamp; ClassApps SelectSurveyASP; Microsoft Project Hot Technology ; Perseus SurveySolutions |
...
| Video creation and editing software | Adobe After Effects Hot Technology ; Loom; TikTok ; YouTube ; 2 more |
...
| Word processing software | 3M Post-it App; Evernote; Google Docs Hot Technology ; Microsoft Word Hot Technology |
...
| 63 | Communications and Media — Knowledge of media production, communication, and dissemination techniques and methods. This includes alternative ways to inform and entertain via written, oral, and visual media. |
...
| 31 | Cautiousness — A tendency to be careful, deliberate, and risk-avoidant when making work-related decisions or doing work. |
