...
**Quick Facts:**
- SOC Code: 43-5051.00
- Also called: Bulk Mail Technician, Clerk, Distribution Clerk, Part Time Flexible Clerk (PTF Clerk), Postal Clerk, Sales and Distribution Clerk, Sales and Service Associate (SSA), Window Clerk
...
|------------|----------|------|
| 91 | Core | Weigh letters and parcels, compute mailing costs based on type, weight, and destination, and affix correct postage. |
| 87 | Core | Check mail to ensure correct postage and that packages and letters are in proper condition for mailing. |
| 85 | Core | Sort incoming and outgoing mail, according to type and destination, by hand or by operating electronic mail-sorting and scanning devices. |
| 83 | Core | Obtain signatures from recipients of registered or special delivery mail. |
| 82 | Core | Answer questions regarding mail regulations and procedures, postage rates, and post office boxes. |
| 80 | Core | Transport mail from one work station to another. |
| 92 | Supplemental | Sell and collect payment for products such as stamps, prepaid mail envelopes, and money orders. |
| 91 | Supplemental | Keep money drawers in order, and record and balance daily transactions. |
| 86 | Supplemental | Register, certify, and insure letters and parcels. |
| 86 | Supplemental | Complete forms regarding changes of address, or theft or loss of mail, or for special services such as registered or priority mail. |
| 84 | Supplemental | Receive letters and parcels, and place mail into bags. |
| 84 | Supplemental | Put undelivered parcels away, retrieve them when customers come to claim them, and complete any related documentation. |
| 83 | Supplemental | Respond to complaints regarding mail theft, delivery problems, and lost or damaged mail, filling out forms and making appropriate referrals for investigation. |
| 81 | Supplemental | Provide assistance to the public in complying with federal regulations of Postal Service and other federal agencies. |
| 80 | Supplemental | Rent post office boxes to customers. |
| 77 | Supplemental | Provide customers with assistance in filing claims for mail theft, or lost or damaged mail. |
| 70 | Supplemental | Feed mail into postage canceling devices or hand stamp mail to cancel postage. |
| 69 | Supplemental | Cash money orders. |
| 69 | Supplemental | Order retail items and other supplies for office use. |
...
- Association for Postal Commerce external site
