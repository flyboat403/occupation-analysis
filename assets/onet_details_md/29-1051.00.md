...
**Quick Facts:**
- SOC Code: 29-1051.00
- Also called: Clinical Pharmacist, Hospital Pharmacist, Informatics Pharmacist, Pharm D (Pharmacy Doctor), Pharmacist in Charge (PIC), Pharmacy Coordinator, Pharmacy Informaticist, Pharmacy Services Clinical Coordinator, Registered Pharmacist, Retail Pharmacist
...
|------------|----------|------|
| 98 | Core | Review prescriptions to assure accuracy, to ascertain the needed ingredients, and to evaluate their suitability. |
| 93 | Core | Assess the identity, strength, or purity of medications. |
| 92 | Core | Provide information and advice regarding drug interactions, side effects, dosage, and proper medication storage. |
| 86 | Core | Analyze prescribing trends to monitor patient compliance and to prevent excessive usage or harmful interactions. |
| 84 | Core | Maintain records, such as pharmacy files, patient profiles, charge system files, inventories, control records for radioactive nuclei, or registries of poisons, narcotics, or controlled drugs. |
| 81 | Core | Collaborate with other health care professionals to plan, monitor, review, or evaluate the quality or effectiveness of drugs or drug regimens, providing advice on drug applications or characteristics. |
| 80 | Core | Plan, implement, or maintain procedures for mixing, packaging, or labeling pharmaceuticals, according to policy and legal requirements, to ensure quality, security, and proper disposal. |
| 80 | Core | Order and purchase pharmaceutical supplies, medical supplies, or drugs, maintaining stock and storing and handling it properly. |
| 79 | Core | Compound and dispense medications as prescribed by doctors and dentists, by calculating, weighing, measuring, and mixing ingredients, or oversee these activities. |
| 77 | Core | Contact insurance companies to resolve billing issues. |
| 75 | Core | Advise customers on the selection of medication brands, medical equipment, or healthcare supplies. |
| 69 | Core | Teach pharmacy students serving as interns in preparation for their graduation or licensure. |
| 67 | Core | Provide specialized services to help patients manage conditions, such as diabetes, asthma, smoking cessation, or high blood pressure. |
| 61 | Core | Refer patients to other health professionals or agencies when appropriate. |
| 75 | Supplemental | Work in hospitals or clinics or for Health Management Organizations (HMOs), dispensing prescriptions, serving as a medical team consultant, or specializing in specific drug therapy areas, such as oncology or nuclear pharmacotherapy. |
| 74 | Supplemental | Update or troubleshoot pharmacy information databases. |
| 72 | Supplemental | Manage pharmacy operations, hiring or supervising staff, performing administrative duties, or buying or selling non-pharmaceutical merchandise. |
| 71 | Supplemental | Prepare sterile solutions or infusions for use in surgical procedures, emergency rooms, or patients' homes. |
| 68 | Supplemental | Offer health promotion or prevention activities, such as training people to use blood pressure devices or diabetes monitors. |
| 45 | Supplemental | Publish educational information for other pharmacists, doctors, or patients. |
...
| Medical software | eClinicalWorks EHR software Hot Technology ; Epic Systems Hot Technology ; MEDITECH software Hot Technology |
...
- National Community Pharmacists Association external site
- The American Society of Consultant Pharmacists external site

- Accreditation Council for Pharmacy Education external site
- Certification Board for Diabetes Care and Education external site
