...
|------------|----------|------|
| 81 | Core | Analyze problems to develop solutions involving computer hardware and software. |
| 72 | Core | Apply theoretical expertise and innovation to create or apply new technology, such as adapting principles for applying computers to new uses. |
| 69 | Core | Assign or schedule tasks to meet work priorities and goals. |
| 66 | Core | Meet with managers, vendors, and others to solicit cooperation and resolve problems. |
| 66 | Core | Design computers and the software that runs them. |
| 65 | Core | Conduct logical analyses of business, scientific, engineering, and other technical problems, formulating mathematical models of problems for solution by computers. |
| 62 | Core | Evaluate project plans and proposals to assess feasibility issues. |
| 59 | Core | Participate in multidisciplinary projects in areas such as virtual reality, human-computer interaction, or robotics. |
| 59 | Core | Consult with users, management, vendors, and technicians to determine computing needs and system requirements. |
| 55 | Core | Develop and interpret organizational goals, policies, and procedures. |
| 54 | Core | Develop performance standards, and evaluate work in light of established standards. |
| 67 | Supplemental | Maintain network hardware and software, direct network security measures, and monitor networks to ensure availability to system users. |
| 58 | Supplemental | Direct daily operations of departments, coordinating project activities with other departments. |
| 49 | Supplemental | Participate in staffing decisions and direct training of subordinates. |
| 44 | Supplemental | Approve, prepare, monitor, and adjust operational budgets. |

## Technology Skills

| Hot Technology | Examples |
|----------------|----------|
| Analytical or scientific software | IBM SPSS Statistics Hot Technology ; SAS Hot Technology ; TensorFlow ; The MathWorks MATLAB Hot Technology ; 15 more |
| Application server software | Docker ; GitHub ; GitLab Hot Technology ; Kubernetes |
| Business intelligence and data analysis software | Apache Spark ; IBM Cognos Impromptu; Microsoft Power BI Hot Technology ; Tableau Hot Technology ; 3 more |
| Cloud-based management software | Amazon Web Services AWS CloudFormation Hot Technology ; Amazon Web Services AWS SageMaker In Demand ; Splunk Enterprise |
...
| Configuration management software | Chef Hot Technology ; IBM Rational Apex; IBM Terraform ; Puppet Hot Technology ; 1 more |
| Data base management system software | Amazon DynamoDB Hot Technology ; Elasticsearch Hot Technology ; Oracle Database Hot Technology ; Redis Hot Technology ; 11 more |
| Data base user interface and query software | Amazon Elastic Compute Cloud EC2 Hot Technology ; Apache Hive Hot Technology ; PyTorch ; Transact-SQL Hot Technology ; 5 more |
| Data mining software | Google Analytics Hot Technology |
| Development environment software | Apache Kafka Hot Technology ; Eclipse IDE Hot Technology ; Go ; Oracle Java 2 Platform Enterprise Edition J2EE Hot Technology ; 27 more |
| Enterprise application integration software | Extensible markup language XML Hot Technology ; IBM InfoSphere DataStage; Jenkins CI |
...
| Graphical user interface development software | Grafana Labs Grafana Cloud In Demand ; Waikato Environment for Knowledge Analysis Weka |
...
| Object or component oriented development software | C# Hot Technology ; Oracle Java ; Perl Hot Technology ; Scala ; 10 more |
| Object oriented data base management software | PostgreSQL Hot Technology |
| Office suite software | Business software applications; Microsoft Office software Hot Technology |
| Operating system software | Bash ; Shell script Hot Technology ; UNIX Hot Technology ; UNIX Shell Hot Technology ; 5 more |
| Portal server software | Apache HTTP Server |
| Presentation software | Microsoft PowerPoint Hot Technology |
| Procedure management software | Apache Airflow Hot Technology |
| Program testing software | System testing software |
...
| Web platform development software | Django Hot Technology ; JavaScript ; Node.js Hot Technology ; PHP Hot Technology ; 1 more |
...
| 94 | Innovation — A tendency to be inventive, to be imaginative, and to adopt new perspectives on ways to accomplish work. |
