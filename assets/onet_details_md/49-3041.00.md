...
|------------|----------|------|
| 91 | Core | Reassemble machines and equipment following repair, testing operation and making adjustments, as necessary. |
| 89 | Core | Maintain, repair, and overhaul farm machinery and vehicles, such as tractors, harvesters, and irrigation systems. |
| 89 | Core | Examine and listen to equipment, read inspection reports, and confer with customers to locate and diagnose malfunctions. |
| 87 | Core | Record details of repairs made and parts used. |
| 87 | Core | Dismantle defective machines for repair, using hand tools. |
| 86 | Core | Clean and lubricate parts. |
| 86 | Core | Repair or replace defective parts, using hand tools, milling and woodworking machines, lathes, welding equipment, grinders, or saws. |
| 83 | Core | Test and replace electrical components and wiring, using test meters, soldering equipment, and hand tools. |
| 76 | Core | Tune or overhaul engines. |
| 74 | Core | Drive trucks to haul tools and equipment for on-site repair of large machinery. |
| 66 | Core | Fabricate new metal parts, using drill presses, engine lathes, and other machine tools. |
| 55 | Core | Repair bent or torn sheet metal. |
| 75 | Supplemental | Calculate bills according to record of repairs made, labor time, and parts used. |
| 62 | Supplemental | Install and repair agricultural irrigation, plumbing, and sprinkler systems. |
...
|---|---|
| 90 | Repairing and Maintaining Mechanical Equipment — Servicing, repairing, adjusting, and testing machines, devices, moving parts, and equipment that operate primarily on the basis of mechanical (not electronic) principles. |
