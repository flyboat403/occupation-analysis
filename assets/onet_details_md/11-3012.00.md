...
**Quick Facts:**
- SOC Code: 11-3012.00
- Also called: Administrative Coordinator, Administrative Director, Administrative Manager, Administrative Officer, Administrator, Business Administrator, Business Manager
...
| 68 | Core | Set goals and deadlines for the department. |
| 60 | Core | Acquire, distribute and store supplies. |
| 58 | Core | Analyze internal processes and recommend and implement procedural or policy changes to improve operations, such as supply changes or the disposal of records. |
| 55 | Core | Conduct classes to teach procedures to staff. |
| 77 | Supplemental | Plan, administer, and control budgets for contracts, equipment, and supplies. |
| 74 | Supplemental | Hire and terminate clerical and administrative personnel. |
| 73 | Supplemental | Direct or coordinate the supportive services department of a business, agency, or organization. |
...
| Data base user interface and query software | Database software; Microsoft Access Hot Technology ; Sage 300 Construction and Real Estate; Yardi software Hot Technology ; 1 more |
