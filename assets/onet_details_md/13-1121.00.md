...
**Quick Facts:**
- SOC Code: 13-1121.00
- Also called: Catering Director, Conference Planner, Conference Planning Manager, Conference Services Director, Conference Services Manager, Convention Services Director, Convention Services Manager (CSM), Event Coordinator, Events Manager, Special Events Coordinator
...
|------------|----------|------|
| 90 | Core | Consult with customers to determine objectives and requirements for events, such as meetings, conferences, and conventions. |
| 89 | Core | Review event bills for accuracy and approve payment. |
| 85 | Core | Coordinate services for events, such as accommodation and transportation for participants, facilities, catering, signage, displays, special needs requirements, printing and event security. |
| 84 | Core | Arrange the availability of audio-visual equipment, transportation, displays, and other event needs. |
| 84 | Core | Confer with staff at a chosen event site to coordinate details. |
| 83 | Core | Inspect event facilities to ensure that they conform to customer requirements. |
| 82 | Core | Maintain records of event aspects, including financial details. |
| 79 | Core | Monitor event activities to ensure compliance with applicable regulations and laws, satisfaction of participants, and resolution of any problems that arise. |
| 77 | Core | Negotiate contracts with such service providers and suppliers as hotels, convention centers, and speakers. |
| 77 | Core | Evaluate and select providers of services according to customer requirements. |
| 76 | Core | Plan and develop programs, agendas, budgets, and services according to customer requirements. |
| 75 | Core | Hire, train, and supervise volunteers and support staff required for events. |
| 75 | Core | Conduct post-event evaluations to determine how future events could be improved. |
| 71 | Core | Direct administrative details, such as financial operations, dissemination of promotional materials, and responses to inquiries. |
| 69 | Core | Meet with sponsors and organizing committees to plan scope and format of events, to establish and monitor budgets, or to review administrative procedures and event progress. |
| 58 | Core | Read trade publications, attend seminars, and consult with other meeting professionals to keep abreast of meeting management standards and trends. |
| 70 | Supplemental | Organize registration of event participants. |
| 68 | Supplemental | Develop event topics and choose featured speakers. |
| 64 | Supplemental | Promote conference, convention and trades show services by performing tasks such as meeting with professional and trade associations, and producing brochures and other publications. |
| 52 | Supplemental | Design and implement efforts to publicize events and promote sponsorships. |
| 51 | Supplemental | Obtain permits from fire and health departments to erect displays and exhibits and serve food at events. |
...
| Data base user interface and query software | Dean Evans &amp; Associates EMS Professional; FileMaker Pro; Microsoft Access Hot Technology ; NSF Hospitality Rendezvous Events ; 2 more |
...
| Graphics or photo imaging software | Adobe Creative Cloud software Hot Technology ; Adobe Photoshop Hot Technology ; SmugMug Flickr; Trimble SketchUp Pro Hot Technology |
| Internet browser software | Web browser software |
| Network conferencing software | LogMeIn GoToWebinar |
| Office suite software | Microsoft Office software |
| Presentation software | Mentimeter; Microsoft PowerPoint |
| Project management software | Active Network EventRegister; Microsoft Project Hot Technology ; Oracle Primavera Enterprise Project Portfolio Management Hot Technology ; Planstone ; 3 more |
...
- Association of Bridal Consultants external site
- Association of Certified Professional Wedding Consultants external site
- Association of Collegiate Conference and Events Directors-International external site
- Event Service Professionals Association external site
- Events Industry Council external site
- International Association of Exhibitions and Events external site
- International Live Events Association external site
- International Society of Meeting Planners external site
...
- Society of Government Meeting Professionals external site

- American Association of Certified Wedding Planners external site
