...
|------------|----------|------|
| 89 | Core | Adjust machine components to regulate speeds, pressures, and temperatures, and amounts, dimensions, and flow of materials or ingredients. |
| 88 | Core | Press control buttons to activate machinery and equipment. |
| 88 | Core | Examine, measure, and weigh materials or products to verify conformance to standards, using measuring devices such as templates, micrometers, or scales. |
| 86 | Core | Monitor machine operations and observe lights and gauges to detect malfunctions. |
| 85 | Core | Clear jams, and remove defective or substandard materials or products. |
| 85 | Core | Notify supervisors when extruded filaments fail to meet standards. |
| 85 | Core | Record and maintain production data, such as meter readings, and quantities, types, and dimensions of materials produced. |
| 84 | Core | Review work orders, specifications, or instructions to determine materials, ingredients, procedures, components, settings, and adjustments for extruding, forming, pressing, or compacting machines. |
| 83 | Core | Turn controls to adjust machine functions, such as regulating air pressure, creating vacuums, and adjusting coolant flow. |
| 83 | Core | Clean dies, arbors, compression chambers, and molds, using swabs, sponges, or air hoses. |
| 80 | Core | Synchronize speeds of sections of machines when producing products involving several steps or processes. |
| 75 | Core | Move materials, supplies, components, and finished products between storage and work areas, using work aids such as racks, hoists, and handtrucks. |
| 87 | Supplemental | Activate machines to shape or form products, such as candy bars, light bulbs, balloons, or insulation panels. |
| 84 | Supplemental | Select and install machine components, such as dies, molds, and cutters, according to specifications, using hand tools and measuring devices. |
| 83 | Supplemental | Send product samples to laboratories for analysis. |
| 79 | Supplemental | Couple air and gas lines to machines to maintain plasticity of material and to regulate solidification of final products. |
| 77 | Supplemental | Pour, scoop, or dump specified ingredients, metal assemblies, or mixtures into sections of machine prior to starting machines. |
| 76 | Supplemental | Measure, mix, cut, shape, soften, and join materials and ingredients, such as powder, cornmeal, or rubber to prepare them for machine processing. |
| 76 | Supplemental | Remove materials or products from molds or from extruding, forming, pressing, or compacting machines, and stack or store them for additional processing. |
| 75 | Supplemental | Feed products into machines by hand or conveyor. |
| 75 | Supplemental | Measure arbors and dies to verify sizes specified on work tickets. |
| 73 | Supplemental | Complete work tickets, and place them with products. |
| 72 | Supplemental | Disassemble equipment to repair it or to replace parts, such as nozzles, punches, and filters. |
| 72 | Supplemental | Remove molds, mold components, and feeder tubes from machinery after production is complete. |
| 72 | Supplemental | Swab molds with solutions to prevent products from sticking. |
| 56 | Supplemental | Install, align, and adjust neck rings, press plungers, and feeder tubes. |
