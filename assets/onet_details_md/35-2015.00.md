...
**Quick Facts:**
- SOC Code: 35-2015.00
- Also called: Broiler Cook, Cook, Deli Cook (Delicatessen Cook), Food and Beverage Attendant, Grill Cook, Line Cook, Pizza Maker, Prep Cook (Preparation Cook), Short Order Cook, Snack Bar Cook
...
|------------|----------|------|
| 96 | Core | Clean food preparation equipment, work areas, and counters or tables. |
| 92 | Core | Restock kitchen supplies, rotate food, and stamp the time and date on food in coolers. |
| 90 | Core | Complete orders from steam tables, placing food on plates and serving customers at tables or counters. |
| 90 | Core | Plan work on orders so that items served together are finished at the same time. |
| 89 | Core | Grill, cook, and fry foods such as french fries, eggs, and pancakes. |
| 86 | Core | Perform food preparation tasks, such as making sandwiches, carving meats, making soups or salads, baking breads or desserts, and brewing coffee or tea. |
| 84 | Core | Perform general cleaning activities in kitchen and dining areas. |
| 80 | Core | Take orders from customers and cook foods requiring short preparation times, according to customer requirements. |
| 93 | Supplemental | Grill and garnish hamburgers or other meats, such as steaks and chops. |
| 69 | Supplemental | Order supplies and stock them on shelves. |
| 52 | Supplemental | Accept payments, and make change or write charge slips as necessary. |
...
| 14 | Education and Training — Knowledge of principles and methods for curriculum and training design, teaching and instruction for individuals and groups, and the measurement of training effects. |
...
| 13 | Administration and Management — Knowledge of business and management principles involved in strategic planning, resource allocation, human resources modeling, leadership technique, production methods, and coordination of people and resources. |
...
| 9 | Administrative — Knowledge of administrative and office procedures and systems such as word processing, managing files and records, stenography and transcription, designing forms, and workplace terminology. |
