...
**Quick Facts:**
- SOC Code: 45-4023.00
- Also called: Log Buyer, Log Check Scaler, Log Grader, Log Scaler, Lumber Grader, Scaler, Timber Buyer
...
|------------|----------|------|
| 93 | Core | Evaluate log characteristics and determine grades, using established criteria. |
| 89 | Core | Record data about individual trees or load volumes into tally books or hand-held collection terminals. |
| 87 | Core | Measure felled logs or loads of pulpwood to calculate volume, weight, dimensions, and marketable value, using measuring devices and conversion tables. |
| 85 | Core | Paint identification marks of specified colors on logs to identify grades or species, using spray cans, or call out grades to log markers. |
| 83 | Core | Jab logs with metal ends of scale sticks, and inspect logs to ascertain characteristics or defects such as water damage, splits, knots, broken ends, rotten areas, twists, and curves. |
| 82 | Core | Identify logs of substandard or special grade so that they can be returned to shippers, regraded, recut, or transferred for other processing. |
| 81 | Supplemental | Arrange for hauling of logs to appropriate mill sites. |
| 81 | Supplemental | Weigh log trucks before and after unloading, and record load weights and supplier identities. |
| 78 | Supplemental | Measure log lengths and mark boles for bucking into logs, according to specifications. |
| 77 | Supplemental | Communicate with coworkers by signals to direct log movement. |
| 74 | Supplemental | Drive to sawmills, wharfs, or skids to inspect logs or pulpwood. |
| 73 | Supplemental | Saw felled trees into lengths. |
...
| Data base user interface and query software | AS/400 Database; Microsoft Access Hot Technology |
