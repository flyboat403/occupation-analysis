...
**Quick Facts:**
- SOC Code: 53-7063.00
- Also called: Cotton Tipper, Dryer Feeder, Feeder, Lug Loader, Machine Feeder, Offbearer, Sawmill Worker, Sewing Line Baler, Tube Puller
...
|------------|----------|------|
| 85 | Core | Inspect materials and products for defects, and to ensure conformance to specifications. |
| 85 | Core | Record production and operational data, such as amount of materials processed. |
| 82 | Core | Push dual control buttons and move controls to start, stop, or adjust machinery and equipment. |
| 81 | Core | Weigh or measure materials or products to ensure conformance to specifications. |
| 80 | Core | Identify and mark materials, products, and samples, following instructions. |
| 78 | Core | Clean and maintain machinery, equipment, and work areas to ensure proper functioning and safe working conditions. |
| 76 | Core | Load materials and products into machines and equipment, or onto conveyors, using hand tools and moving devices. |
| 74 | Core | Transfer materials and products to and from machinery and equipment, using industrial trucks or hand trucks. |
| 71 | Core | Fasten, package, or stack materials and products, using hand tools and fastening equipment. |
| 76 | Supplemental | Remove materials and products from machines and equipment, and place them in boxes, trucks or conveyors, using hand tools and moving devices. |
| 73 | Supplemental | Shovel or scoop materials into containers, machines, or equipment for processing, storage, or transport. |
| 72 | Supplemental | Open and close gates of belt and pneumatic conveyors on machines that are fed directly from preceding machines. |
| 66 | Supplemental | Add chemicals, solutions, or ingredients to machines or equipment as required by the manufacturing process. |
