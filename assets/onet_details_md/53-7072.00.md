...
**Quick Facts:**
- SOC Code: 53-7072.00
- Also called: Boom Pump Operator, Chemical Pumper, Day Light Relief Operator, Outside Operator, Pipeline Dispatch Operator, Pipeline Operator, Pump Operator, Pump Station Operator, Pumper, Tank Farm Operator
...
|------------|----------|------|
| 87 | Core | Monitor gauges and flowmeters and inspect equipment to ensure that tank levels, temperatures, chemical amounts, and pressures are at specified levels, reporting abnormalities as necessary. |
| 85 | Core | Record operating data such as products and quantities pumped, stocks used, gauging results, and operating times. |
| 85 | Core | Plan movement of products through lines to processing, storage, and shipping units, using knowledge of interconnections and capacities of pipelines, valve manifolds, pumps, and tankage. |
| 84 | Core | Turn valves and start pumps to start or regulate flows of substances such as gases, liquids, slurries, or powdered materials. |
| 84 | Core | Communicate with other workers, using signals, radios, or telephones, to start and stop flows of materials or substances. |
| 81 | Core | Connect hoses and pipelines to pumps and vessels prior to material transfer, using hand tools. |
| 80 | Core | Tend vessels that store substances such as gases, liquids, slurries, or powdered materials, checking levels of substances by using calibrated rods or by reading mercury gauges and tank charts. |
| 79 | Core | Clean, lubricate, and repair pumps and vessels, using hand tools and equipment. |
| 76 | Core | Read operating schedules or instructions or receive verbal orders to determine amounts to be pumped. |
| 71 | Core | Test materials and solutions, using testing equipment. |
| 75 | Supplemental | Tend auxiliary equipment such as water treatment and refrigeration units, and heat exchangers. |
| 74 | Supplemental | Add chemicals and solutions to tanks to ensure that specifications are met. |
| 74 | Supplemental | Collect and deliver sample solutions for laboratory analysis. |
| 73 | Supplemental | Pump two or more materials into one tank to blend mixtures. |
...
- International Slurry Surfacing Association external site
- Petroleum Equipment Institute external site
