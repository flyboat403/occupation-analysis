...
|------------|----------|------|
| 89 | Core | Inspect derricks, or order their inspection, prior to being raised or lowered. |
| 89 | Core | Inspect derricks for flaws, and clean and oil derricks to maintain proper working conditions. |
| 88 | Core | Control the viscosity and weight of the drilling fluid. |
| 85 | Core | Repair pumps, mud tanks, and related equipment. |
| 85 | Core | Set and bolt crown blocks to posts at tops of derricks. |
| 84 | Core | Listen to mud pumps and check regularly for vibration and other problems to ensure that rig pumps and drilling mud systems are working properly. |
| 81 | Core | Start pumps that circulate mud through drill pipes and boreholes to cool drill bits and flush out drill cuttings. |
| 80 | Core | Position and align derrick elements, using harnesses and platform climbing devices. |
| 80 | Core | Supervise crew members, and provide assistance in training them. |
| 79 | Core | Guide lengths of pipe into and out of elevators. |
| 78 | Core | Prepare mud reports, and instruct crews about the handling of any chemical additives. |
| 75 | Core | Clamp holding fixtures on ends of hoisting cables. |
| 74 | Core | Weigh clay, and mix with water and chemicals to make drilling mud, using portable mixers. |
| 74 | Core | String cables through pulleys and blocks. |
| 70 | Core | Steady pipes during connection to or disconnection from drill or casing strings. |
