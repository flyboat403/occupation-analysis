...
**Quick Facts:**
- SOC Code: 49-9012.00
- Also called: Control Valve Mechanic, Control Valve Technician, Electric Meter Technician, Instrument and Electrical Technician (I and E Technician), Instrument Technician, Measurement Technician, Meter Technician, Service Technician, Valve Technician, Water Plant Maintenance Mechanic
...
|------------|----------|------|
| 78 | Core | Record maintenance information, including test results, material usage, and repairs made. |
| 72 | Core | Disassemble and repair mechanical control devices or valves, such as regulators, thermostats, or hydrants, using power tools, hand tools, and cutting torches. |
| 69 | Core | Lubricate wearing surfaces of mechanical parts, using oils or other lubricants. |
| 75 | Supplemental | Calibrate instrumentation, such as meters, gauges, and regulators, for pressure, temperature, flow, and level. |
| 75 | Supplemental | Install, inspect and test electric meters, relays, and power sources to detect causes of malfunctions and inaccuracies, using hand tools and testing equipment. |
| 74 | Supplemental | Test valves and regulators for leaks and accurate temperature and pressure settings, using precision testing equipment. |
| 74 | Supplemental | Record meter readings and installation data on meter cards, work orders, or field service orders, or enter data into hand-held computers. |
| 74 | Supplemental | Turn meters on or off to establish or close service. |
| 73 | Supplemental | Shut off service and notify repair crews when major repairs are required, such as the replacement of underground pipes or wiring. |
| 72 | Supplemental | Install regulators and related equipment such as gas meters, odorization units, and gas pressure telemetering equipment. |
| 72 | Supplemental | Cut seats to receive new orifices, tap inspection ports, and perform other repairs to salvage usable materials, using hand tools and machine tools. |
| 72 | Supplemental | Turn valves to allow measured amounts of air or gas to pass through meters at specified flow rates. |
| 71 | Supplemental | Report hazardous field situations and damaged or missing meters. |
| 71 | Supplemental | Vary air pressure flowing into regulators and turn handles to assess functioning of valves and pistons. |
| 71 | Supplemental | Examine valves or mechanical control device parts for defects, dents, or loose attachments, and mark malfunctioning areas of defective units. |
| 71 | Supplemental | Mount and install meters and other electric equipment such as time clocks, transformers, and circuit breakers, using electricians' hand tools. |
| 70 | Supplemental | Connect regulators to test stands, and turn screw adjustments until gauges indicate that inlet and outlet pressures meet specifications. |
| 70 | Supplemental | Investigate instances of illegal tapping into service lines. |
| 70 | Supplemental | Trace and tag meters or house lines. |
| 69 | Supplemental | Repair electric meters and components, such as transformers and relays, and replace metering devices, dial glasses, and faulty or incorrect wiring, using hand tools. |
| 69 | Supplemental | Replace defective parts, such as bellows, range springs, and toggle switches, and reassemble units according to blueprints, using cam presses and hand tools. |
| 68 | Supplemental | Measure tolerances of assembled and salvageable parts for conformance to standards or specifications, using gauges, micrometers, and calipers. |
| 67 | Supplemental | Clean internal compartments and moving parts, using rags and cleaning compounds. |
| 67 | Supplemental | Dismantle meters, and replace or adjust defective parts such as cases, shafts, gears, disks, and recording mechanisms, using soldering irons and hand tools. |
| 67 | Supplemental | Disconnect or remove defective or unauthorized meters, using hand tools. |
| 66 | Supplemental | Attach air hoses to meter inlets, plug outlets, and observe gauges for pressure losses to test internal seams for leaks. |
| 64 | Supplemental | Make adjustments to meter components, such as setscrews or timing mechanisms, so that they conform to specifications. |
| 62 | Supplemental | Repair leaks in valve seats or bellows of automotive heater thermostats, using soft solder, flux, and acetylene torches. |
| 60 | Supplemental | Splice and connect cables from meters or current transformers to pull boxes or switchboards, using hand tools. |
| 59 | Supplemental | Advise customers on proper installation of valves or regulators and related equipment. |
| 54 | Supplemental | Clean plant growth, scale, paint, soil, or rust from meter housings, using wire brushes, scrapers, buffers, sandblasters, or cleaning compounds. |
| 53 | Supplemental | Connect hoses from provers to meter inlets and outlets, and raise prover bells until prover gauges register zero. |
...
| Enterprise resource planning ERP software | IBM Maximo Asset Management; SAP software Hot Technology |
...
| Project management software | Maintenance record software; Oracle Primavera Enterprise Project Portfolio Management Hot Technology |
...
- Install metering equipment. Related occupations
...
- Adjust the tension of nuts or bolts. Related occupations
