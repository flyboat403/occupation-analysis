...
**Quick Facts:**
- SOC Code: 17-3029.08
- Also called: Fiber Optics Instructor, Fiber Optics Technician (Fiber Optics Tech), Laser Technician (Laser Tech), Optics Technician (Optics Tech), Optomechanical Technician (Optomechanical Tech), Photonics Laboratory Technician (Photonics Lab Tech), Photonics Technician (Photonics Tech), Ruling Technician (Ruling Tech)
...
|------------|----------|------|
| 83 | Core | Compute or record photonic test data. |
| 81 | Core | Maintain clean working environments, according to clean room standards. |
| 80 | Core | Adjust or maintain equipment, such as lasers, laser systems, microscopes, oscilloscopes, pulse generators, power meters, beam analyzers, or energy measurement devices. |
| 72 | Core | Document procedures, such as calibration of optical or fiber optic equipment. |
| 71 | Core | Set up or operate assembly or processing equipment, such as lasers, cameras, die bonders, wire bonders, dispensers, reflow ovens, soldering irons, die shears, wire pull testers, temperature or humidity chambers, or optical spectrum analyzers. |
| 71 | Core | Assist scientists or engineers in the conduct of photonic experiments. |
| 68 | Core | Test or perform failure analysis for optomechanical or optoelectrical products, according to test plans. |
| 66 | Core | Assist engineers in the development of new products, fixtures, tools, or processes. |
| 65 | Core | Recommend optical or optic equipment design or material changes to reduce costs or processing times. |
| 62 | Core | Set up or operate prototype or test apparatus, such as control consoles, collimators, recording equipment, or cables. |
| 50 | Core | Monitor inventory levels and order supplies as necessary. |
| 73 | Supplemental | Assemble fiber optical, optoelectronic, or free-space optics components, subcomponents, assemblies, or subassemblies. |
| 73 | Supplemental | Optimize photonic process parameters by making prototype or production devices. |
| 71 | Supplemental | Splice fibers, using fusion splicing or other techniques. |
| 68 | Supplemental | Build prototype optomechanical devices for use in equipment such as aerial cameras, gun sights, or telescopes. |
| 67 | Supplemental | Terminate, cure, polish, or test fiber cables with mechanical connectors. |
| 61 | Supplemental | Perform diagnostic analyses of processing steps, using analytical or metrological tools, such as microscopy, profilometry, or ellipsometry devices. |
| 61 | Supplemental | Assemble or adjust parts or related electrical units of prototypes to prepare for testing. |
| 61 | Supplemental | Repair or calibrate products, such as surgical lasers. |
| 60 | Supplemental | Design, build, or modify fixtures used to assemble parts. |
| 54 | Supplemental | Assemble components of energy-efficient optical communications systems involving photonic switches, optical backplanes, or optoelectronic interfaces. |
| 54 | Supplemental | Lay out cutting lines for machining, using drafting tools. |
| 52 | Supplemental | Mix, pour, or use processing chemicals or gases according to safety standards or established operating procedures. |
| 50 | Supplemental | Fabricate devices, such as optoelectronic or semiconductor devices. |
...
| Computer aided design CAD software | Autodesk AutoCAD Hot Technology ; Dassault Systemes SolidWorks Hot Technology ; ZEMAX Optical Design Program |
...
|---|---|
| 73 | Engineering and Technology — Knowledge of the practical application of engineering science and technology. This includes applying principles, techniques, procedures, and equipment to the design and production of various goods and services. |
