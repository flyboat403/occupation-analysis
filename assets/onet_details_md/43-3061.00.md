...
**Quick Facts:**
- SOC Code: 43-3061.00
- Also called: Buyer, Procurement Assistant, Procurement Officer, Procurement Specialist, Purchasing Assistant, Purchasing Associate, Purchasing Clerk, Purchasing Coordinator, Purchasing Specialist, Warehouse Clerk
...
|------------|----------|------|
| 86 | Core | Track the status of requisitions, contracts, and orders. |
| 86 | Core | Perform buying duties when necessary. |
| 84 | Core | Prepare purchase orders and send copies to suppliers and to departments originating requests. |
| 84 | Core | Calculate costs of orders, and charge or forward invoices to appropriate accounts. |
| 83 | Core | Compare prices, specifications, and delivery dates to determine the best bid among potential suppliers. |
| 82 | Core | Approve and pay bills. |
| 81 | Core | Maintain knowledge of all organizational and governmental rules affecting purchases, and provide information about these rules to organization staff members and to vendors. |
| 81 | Core | Determine if inventory quantities are sufficient for needs, ordering more materials when necessary. |
| 81 | Core | Check shipments when they arrive to ensure that orders have been filled correctly and that goods meet specifications. |
| 79 | Core | Contact suppliers to schedule or expedite deliveries and to resolve shortages, missed or late deliveries, and other problems. |
| 79 | Core | Prepare, maintain, and review purchasing files, reports and price lists. |
| 79 | Core | Review requisition orders to verify accuracy, terminology, and specifications. |
| 78 | Core | Respond to customer and supplier inquiries about order status, changes, or cancellations. |
| 76 | Core | Monitor in-house inventory movement and complete inventory transfer forms for bookkeeping purposes. |
| 74 | Core | Compare suppliers' bills with bids and purchase orders to verify accuracy. |
| 73 | Core | Locate suppliers, using sources such as catalogs and the internet, and interview them to gather information about products to be ordered. |
| 69 | Supplemental | Monitor contractor performance, recommending contract modifications when necessary. |
| 69 | Supplemental | Prepare invitation-of-bid forms, and mail forms to supplier firms or distribute forms for public posting. |
| 62 | Supplemental | Train and supervise subordinates and other staff. |
...
| Enterprise resource planning ERP software | Oracle JD Edwards EnterpriseOne; Oracle PeopleSoft Hot Technology ; Radiant Systems CounterPoint; SAP software ; 3 more |
