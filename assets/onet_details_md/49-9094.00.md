...
**Quick Facts:**
- SOC Code: 49-9094.00
- Also called: Certified Professional Safe Technician (CPS), CML (Certified Master Locksmith), CMS (Certified Master Safecracker), Forensic Locksmith, Lock Technician (Lock Tech), Locksmith, Road Service Locksmith, RST (Registered Safe Technician), Safe Technician (Safe Tech), Vault Technician (Vault Tech)
...
|------------|----------|------|
| 94 | Core | Cut new or duplicate keys, using impressions or code key machines. |
| 90 | Core | Insert new or repaired tumblers into locks to change combinations. |
| 89 | Core | Move picklocks in cylinders to open door locks without keys. |
| 88 | Core | Cut new or duplicate keys, using key cutting machines. |
| 86 | Core | Open safe locks by drilling. |
| 83 | Core | Set up and maintain master key systems. |
| 82 | Core | Install door hardware, such as locks and closers. |
| 79 | Core | Keep records of company locks and keys. |
| 78 | Core | Disassemble mechanical or electrical locking devices, and repair or replace worn tumblers, springs, and other parts, using hand tools. |
| 74 | Core | Repair and adjust safes, vault doors, and vault components, using hand tools, lathes, drill presses, and welding and acetylene cutting apparatus. |
| 72 | Core | Install alarm and electronic access systems. |
| 65 | Core | Install safes, vault doors, and deposit boxes according to blueprints, using equipment such as power drills, taps, dies, truck cranes, and dollies. |
| 57 | Core | Unlock cars and other vehicles. |
| 19 | Supplemental | Remove interior and exterior finishes on safes and vaults, and spray on new finishes. |
...
- Disable door locks. Related occupations
...
- Associated Locksmiths of America external site
- Door and Hardware Institute external site
- Safe and Vault Technicians Association external site
- Society of Professional Locksmiths external site
- The National Safeman's Organization external site

- The Institutional Locksmith's Association external site
