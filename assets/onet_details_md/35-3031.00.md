...
**Quick Facts:**
- SOC Code: 35-3031.00
- Also called: Banquet Server, Busser, Cocktail Server, Food Runner, Food Server, Restaurant Server, Room Service Server, Server, Waiter, Waitress
...
|------------|----------|------|
| 97 | Core | Collect payments from customers. |
| 97 | Core | Check patrons' identification to ensure that they meet minimum age requirements for consumption of alcoholic beverages. |
| 96 | Core | Write patrons' food orders on order slips, memorize orders, or enter orders into computers for transmittal to kitchen staff. |
| 95 | Core | Check with customers to ensure that they are enjoying their meals, and take action to correct any problems. |
| 94 | Core | Take orders from patrons for food or beverages. |
| 93 | Core | Prepare checks that itemize and total meal costs and sales taxes. |
| 93 | Core | Remove dishes and glasses from tables or counters, and take them to kitchen for cleaning. |
| 92 | Core | Clean tables or counters after patrons have finished dining. |
| 90 | Core | Serve food or beverages to patrons, and prepare or serve specialty dishes at tables as required. |
| 89 | Core | Perform cleaning duties, such as sweeping and mopping floors, vacuuming carpet, tidying up server station, taking out trash, or checking and cleaning bathroom. |
| 88 | Core | Present menus to patrons and answer questions about menu items, making recommendations upon request. |
| 84 | Core | Prepare tables for meals, including setting up items such as linens, silverware, and glassware. |
| 84 | Core | Stock service areas with supplies such as coffee, food, tableware, and linens. |
| 84 | Core | Roll silverware, set up food stations, or set up dining areas to prepare for the next shift or for large parties. |
| 83 | Core | Inform customers of daily specials. |
| 81 | Core | Explain how various menu items are prepared, describing ingredients and cooking methods. |
| 78 | Core | Assist host or hostess by answering phones to take reservations or to-go orders, and by greeting, seating, and thanking guests. |
| 77 | Core | Fill salt, pepper, sugar, cream, condiment, and napkin containers. |
| 75 | Core | Perform food preparation duties, such as preparing salads, appetizers, and cold dishes, portioning desserts, and brewing coffee. |
| 75 | Core | Prepare hot, cold, and mixed drinks for patrons, and chill bottles of wine. |
| 70 | Core | Escort customers to their tables. |
| 61 | Core | Provide guests with information about local areas, including directions. |
| 76 | Supplemental | Garnish and decorate dishes in preparation for serving. |
| 69 | Supplemental | Bring wine selections to tables with appropriate glasses, and pour the wines for customers. |
| 69 | Supplemental | Describe and recommend wines to customers. |
...
| 14 | Cautiousness — A tendency to be careful, deliberate, and risk-avoidant when making work-related decisions or doing work. |
...
- Court of Master Sommeliers external site
- Federation of Dining Room Professionals external site
