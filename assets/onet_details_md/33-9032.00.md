...
**Quick Facts:**
- SOC Code: 33-9032.00
- Also called: Armed Security Officer, Campus Security Officer (CSO), Custom Protection Officer (CPO), Customer Service Security Officer, Hotel Security Officer, Loss Prevention Officer, Safety and Security Officer, Security Agent, Security Guard, Security Officer
...
|------------|----------|------|
| 98 | Core | Lock doors and gates of entrances and exits to secure buildings. |
| 94 | Core | Patrol industrial or commercial premises to prevent and detect signs of intrusion and ensure security of doors, windows, and gates. |
| 94 | Core | Respond to medical emergencies by administering basic first aid or by obtaining assistance from paramedics. |
| 93 | Core | Answer alarms and investigate disturbances. |
| 93 | Core | Circulate among visitors, patrons, or employees to preserve order and protect property. |
| 92 | Core | Monitor and authorize entrance and departure of employees, visitors, and other persons to guard against theft and maintain security of premises. |
| 90 | Core | Write reports of daily activities and irregularities, such as equipment or property damage, theft, presence of unauthorized persons, or unusual occurrences. |
| 89 | Core | Warn persons of rule infractions or violations, and apprehend or evict violators from premises, using force when necessary. |
| 87 | Core | Answer telephone calls to take messages, answer questions, and provide information during non-business hours or when switchboard is closed. |
| 86 | Core | Call police or fire departments in cases of emergency, such as fire or presence of unauthorized persons. |
| 85 | Core | Operate detecting devices to screen individuals and prevent passage of prohibited articles into restricted areas. |
| 79 | Core | Inspect and adjust security systems, equipment, or machinery to ensure operational use and to detect evidence of tampering. |
| 67 | Core | Escort or drive motor vehicle to transport individuals to specified locations or to provide personal protection. |
| 46 | Supplemental | Monitor and adjust controls that regulate building systems, such as air conditioning, furnace, or boiler. |
