...
**Quick Facts:**
- SOC Code: 33-3021.02
- Also called: Crime Lab Analyst (Crime Laboratory Analyst), Crime Scene Investigator (CSI), Crime Scene Technician, Criminalist, Evidence Technician (Evidence Tech), Field Identification Specialist, Forensic Specialist, Identification Technician (Identification Tech), Latent Fingerprint Examiner, Police Officer
...
|------------|----------|------|
| 89 | Core | Photograph crime or accident scenes for evidence records. |
| 87 | Core | Maintain records of evidence and write and review reports. |
| 86 | Core | Submit evidence to supervisors, crime labs, or court officials for legal proceedings. |
| 86 | Core | Testify in court and present evidence. |
| 83 | Core | Look for trace evidence, such as fingerprints, hairs, fibers, or shoe impressions, using alternative light sources when necessary. |
| 81 | Core | Dust selected areas of crime scene and lift latent fingerprints, adhering to proper preservation procedures. |
| 81 | Core | Analyze and process evidence at crime scenes, during autopsies, or in the laboratory, wearing protective equipment and using powders and chemicals. |
| 80 | Core | Package, store and retrieve evidence. |
| 77 | Core | Process film and prints from crime or accident scenes. |
| 74 | Core | Take fingerprints. |
| 72 | Core | Perform emergency work during off-hours. |
| 67 | Core | Serve as technical advisor and coordinate with other law enforcement workers or legal personnel to exchange information on crime scene collection activities. |
| 66 | Core | Create sketches and diagrams, by hand or computer software, to depict crime scenes. |
| 60 | Core | Coordinate or conduct instructional classes or in-services, such as citizen police academy classes and crime scene training for other officers. |
| 82 | Supplemental | Identify, compare, classify, and file fingerprints, using systems such as Automated Fingerprint Identification System (AFIS) or the Henry Classification System. |
| 70 | Supplemental | Interview survivors, witnesses, suspects, and other law enforcement personnel. |

## Technology Skills

| Hot Technology | Examples |
|----------------|----------|
| Data base user interface and query software | DataWorks Plus Digital CrimeScene; Integrated Automated Fingerprint Identification System IAFIS; Microsoft Access Hot Technology ; National Crime Information Center (NCIC) database ; 2 more |
