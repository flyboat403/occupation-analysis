...
**Quick Facts:**
- SOC Code: 15-2041.00
- Also called: Database Analyst, Demographer, Education Research Analyst, Mathematical Statistician, Psychometric Consultant, Quantitative Methodologist, Statistical Analyst, Statistical Consultant, Statistical Reporting Analyst, Statistician
...
|------------|----------|------|
| 92 | Core | Analyze and interpret statistical data to identify significant differences in relationships among sources of information. |
| 92 | Core | Evaluate the statistical methods and procedures used to obtain data to ensure validity, applicability, efficiency, and accuracy. |
| 88 | Core | Report results of statistical analyses, including information in the form of graphs, charts, and tables. |
| 88 | Core | Determine whether statistical methods are appropriate, based on user needs or research questions of interest. |
| 87 | Core | Prepare data for processing by organizing information, checking for inaccuracies, and adjusting and weighting the raw data. |
| 85 | Core | Develop and test experimental designs, sampling techniques, and analytical methods. |
| 83 | Core | Identify relationships and trends in data, as well as any factors that could affect the results of research. |
| 82 | Core | Present statistical and nonstatistical results, using charts, bullets, and graphs, in meetings or conferences to audiences such as clients, peers, and students. |
| 82 | Core | Design research projects that apply valid scientific techniques, and use information obtained from baselines or historical data to structure uncompromised and efficient analyses. |
| 81 | Core | Adapt statistical methods to solve specific problems in many fields, such as economics, biology, and engineering. |
| 78 | Core | Evaluate sources of information to determine any limitations, in terms of reliability or usability. |
| 76 | Core | Process large amounts of data for statistical modeling and graphic analysis, using computers. |
| 74 | Core | Develop software applications or programming for statistical modeling and graphic analysis. |
| 71 | Core | Report results of statistical analyses in peer-reviewed papers and technical manuals. |
| 70 | Core | Plan data collection methods for specific projects, and determine the types and sizes of sample groups to be used. |
| 70 | Core | Apply sampling techniques, or use complete enumeration bases to determine and define groups to be surveyed. |
| 61 | Core | Examine theories, such as those of probability and inference, to discover mathematical bases for new or improved methods of obtaining and evaluating numerical data. |
| 50 | Core | Supervise and provide instructions for workers collecting and tabulating data. |
| 57 | Supplemental | Prepare and structure data warehouses for storing data. |

## Technology Skills

| Hot Technology | Examples |
|----------------|----------|
| Analytical or scientific software | IBM SPSS Statistics ; Minitab; SAS ; The MathWorks MATLAB Hot Technology ; 32 more |
| Business intelligence and data analysis software | Apache Spark Hot Technology ; Qlik Tech QlikView; Tableau |
| Data base management system software | Apache Hadoop Hot Technology ; Apache Pig; Teradata Database Hot Technology |
| Data base user interface and query software | Amazon Redshift Hot Technology ; Amazon Web Services AWS software ; IBM DB2 Hot Technology ; Microsoft SQL Server Hot Technology ; 2 more |
| Data mining software | Angoss KnowledgeSEEKER; NCR Teradata Warehouse Miner; SAS Enterprise Miner |
| Development environment software | Common business oriented language COBOL; Formula translation/translator FORTRAN; Microsoft Visual Basic Hot Technology ; Microsoft Visual Basic for Applications VBA Hot Technology |
| Enterprise application integration software | Extensible markup language XML Hot Technology ; SAS/CONNECT |
| Enterprise resource planning ERP software | SAP software Hot Technology |
| Object or component oriented development software | C++ Hot Technology ; Python ; R ; Sun Microsystems Java ; 1 more |
...
| 1 | Handling and Moving Objects — Using hands and arms in handling, installing, positioning, and moving materials, and manipulating things. |
...
| 85 | Number Facility — The ability to add, subtract, multiply, or divide quickly and correctly. |
...
- American Academy of Actuaries external site
...
- National Council on Measurement in Education external site
- SAS Users Groups external site
- Society for Industrial and Applied Mathematics external site
- Society of Actuaries external site
