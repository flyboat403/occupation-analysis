...
|------------|----------|------|
| 78 | Core | Design or conduct applied biodiesel or biofuels research projects on topics, such as transport, thermodynamics, mixing, filtration, distillation, fermentation, extraction, and separation. |
| 74 | Core | Analyze data from biofuels studies, such as fluid dynamics, water treatments, or solvent extraction and recovery processes. |
| 73 | Core | Prepare, or oversee the preparation of, experimental plans for biofuels research or development. |
| 71 | Core | Provide technical or scientific guidance to technical staff in the conduct of biofuels research or development. |
| 70 | Core | Propose new biofuels products, processes, technologies or applications based on findings from applied biofuels or biomass research projects. |
| 68 | Core | Conduct experiments on biomass or pretreatment technologies. |
| 67 | Core | Prepare biofuels research and development reports for senior management or technical professionals. |
| 66 | Core | Develop lab scale models of industrial scale processes, such as fermentation. |
| 65 | Core | Oversee biodiesel/biofuels prototyping or development projects. |
| 63 | Core | Conduct experiments to test new or alternate feedstock fermentation processes. |
| 63 | Supplemental | Develop methods to estimate the efficiency of biomass pretreatments. |
| 60 | Supplemental | Perform protein functional analysis and engineering for processing of feedstock and creation of biofuels. |
| 60 | Supplemental | Conduct research to breed or develop energy crops with improved biomass yield, environmental adaptability, pest resistance, production efficiency, bioprocessing characteristics, or reduced environmental impacts. |
| 59 | Supplemental | Develop computational tools or approaches to improve biofuels research and development activities. |
| 56 | Supplemental | Develop separation processes to recover biofuels. |
| 54 | Supplemental | Design chemical conversion processes, such as etherification, esterification, interesterification, transesterification, distillation, hydrogenation, oxidation or reduction of fats and oils, and vegetable oil refining. |
| 51 | Supplemental | Design or execute solvent or product recovery experiments in laboratory or field settings. |
| 50 | Supplemental | Develop methods to recover ethanol or other fuels from complex bioreactor liquid and gas streams. |
...
| Enterprise resource planning ERP software | Ab Initio; Microsoft Dynamics; SAP software Hot Technology |
| Graphics or photo imaging software | Adobe Illustrator Hot Technology |
| Internet browser software | Web browser software |
| Medical software | Epic Systems Hot Technology |
| Object or component oriented development software | Microsoft SQL Server Reporting Services SSRS Hot Technology ; Oracle Java Hot Technology ; Perl Hot Technology ; Python Hot Technology |
...
- Develop technical processes to improve the efficiency of biofuel production. Related occupations
...
- Biotechnology Innovation Organization external site
- Clean Fuels Alliance America external site
- Process Industry Practices external site
- Renewable Fuels Association external site
