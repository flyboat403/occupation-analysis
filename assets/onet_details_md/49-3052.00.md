...
**Quick Facts:**
- SOC Code: 49-3052.00
- Also called: All Terrain Vehicle Technician (ATV Technician), Custom Bike Builder, Motorcycle Mechanic, Motorcycle Service Technician, Motorcycle Technician, Motorsports Technician, Scooter Mechanic, Service Technician
...
|------------|----------|------|
| 94 | Core | Mount, balance, change, or check condition or pressure of tires. |
| 91 | Core | Replace defective parts, using hand tools, arbor presses, flexible power presses, or power tools. |
| 90 | Core | Dismantle engines and repair or replace defective parts, such as magnetos, carburetors, or generators. |
| 89 | Core | Connect test panels to engines and measure generator output, ignition timing, or other engine performance indicators. |
| 88 | Core | Listen to engines, examine vehicle frames, or confer with customers to determine nature and extent of malfunction or damage. |
| 87 | Core | Repair or replace other parts, such as headlights, horns, handlebar controls, gasoline or oil tanks, starters, or mufflers. |
| 87 | Core | Disassemble subassembly units and examine condition, movement, or alignment of parts, visually or using gauges. |
| 85 | Core | Repair or adjust motorcycle subassemblies, such as forks, transmissions, brakes, or drive chains, according to specifications. |
| 85 | Core | Reassemble frames and reinstall engines after repairs. |
| 84 | Core | Remove cylinder heads and grind valves to scrape off carbon and replace defective valves, pistons, cylinders, or rings, using hand and power tools. |
| 84 | Core | Install motorcycle accessories. |
| 83 | Core | Reassemble and test subassembly units. |
| 50 | Supplemental | Hammer out dents and bends in frames and weld tears and breaks. |
...
- Motorcycle Industry Council external site
