...
**Quick Facts:**
- SOC Code: 25-1082.00
- Also called: Assistant Professor, Associate Professor, Classification Instructor, Information Science Professor, Instructor, Lecturer, Library Instructor, Library Science Professor, Library Technology Instructor, Professor
...
|------------|----------|------|
| 92 | Core | Conduct research in a particular field of knowledge and present findings in professional journals, books, electronic media, or at professional conferences. |
| 92 | Core | Evaluate and grade students' class work, assignments, and papers. |
| 92 | Core | Keep abreast of developments in the field by reading current literature, talking with colleagues, giving presentations at conferences, and serving on committees in professional associations. |
| 91 | Core | Prepare and deliver lectures to undergraduate or graduate students on topics such as collection development, archival methods, and indexing and abstracting. |
| 90 | Core | Prepare course materials, such as syllabi, homework assignments, and handouts. |
| 88 | Core | Plan, evaluate, and revise curricula, course content, course materials, and methods of instruction. |
| 85 | Core | Initiate, facilitate, and moderate classroom discussions. |
| 81 | Core | Compile, administer, and grade examinations, or assign this work to others. |
| 80 | Core | Maintain student attendance records, grades, and other required records. |
| 80 | Core | Advise students on academic and vocational curricula and on career issues. |
| 80 | Core | Select and obtain materials and supplies, such as textbooks. |
| 79 | Core | Supervise undergraduate or graduate teaching, internship, and research work. |
| 79 | Core | Develop and teach online courses. |
| 76 | Core | Collaborate with colleagues to address teaching and research issues. |
| 73 | Core | Compile bibliographies of specialized materials for outside reading assignments. |
| 71 | Core | Edit manuscripts for professional journals. |
| 69 | Core | Serve on academic or administrative committees that deal with institutional policies, departmental matters, and academic issues. |
| 69 | Core | Maintain regularly scheduled office hours to advise and assist students. |
| 67 | Core | Write grant proposals to procure external research funding. |
...
| 61 | Core | Participate in campus and community events. |
| 50 | Supplemental | Act as advisers to student organizations. |
| 47 | Supplemental | Select and invite guest speakers to speak to classes. |
| 29 | Supplemental | Provide professional consulting services to government or industry. |
...
| Data base user interface and query software | Amazon Elastic Compute Cloud EC2 Hot Technology ; Association for Computing Machinery Digital Library; MySQL Hot Technology ; Structured query language SQL Hot Technology ; 1 more |
| Document management software | Hyland OnBase Enterprise Content Management; Microsoft SharePoint Hot Technology |
...
| Web platform development software | Extensible stylesheet language transformations XSLT; JavaScript Hot Technology ; PHP Hot Technology |
...
| 89 | Education and Training — Knowledge of principles and methods for curriculum and training design, teaching and instruction for individuals and groups, and the measurement of training effects. |
...
| 25 | Cautiousness — A tendency to be careful, deliberate, and risk-avoidant when making work-related decisions or doing work. |
...
- Children's Literature Association external site
- Council of Graduate Schools external site
- International Association of School Librarianship external site
- Medical Library Association external site
- Public Library Association external site
- Society for the History of Authorship, Reading and Publishing external site
