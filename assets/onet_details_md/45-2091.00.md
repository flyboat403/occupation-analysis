...
**Quick Facts:**
- SOC Code: 45-2091.00
- Also called: Baler Operator, Cutter Operator, Equipment Operator, Farm Equipment Operator, Hay Baler, Loader Operator, Packing Tractor Machine Operator, Rake Operator, Sprayer, Windrower Operator
...
|------------|----------|------|
| 88 | Core | Load and unload crops or containers of materials, manually or using conveyors, handtrucks, forklifts, or transfer augers. |
| 86 | Core | Mix specified materials or chemicals, and dump solutions, powders, or seeds into planter or sprayer machinery. |
| 83 | Core | Spray fertilizer or pesticide solutions to control insects, fungus and weed growth, and diseases, using hand sprayers. |
| 83 | Core | Observe and listen to machinery operation to detect equipment malfunctions. |
| 82 | Core | Manipulate controls to set, activate, and adjust mechanisms on machinery. |
| 79 | Core | Operate or tend equipment used in agricultural production, such as tractors, combines, and irrigation equipment. |
| 76 | Core | Adjust, repair, and service farm machinery and notify supervisors when machinery malfunctions. |
| 73 | Core | Attach farm implements such as plows, discs, sprayers, or harvesters to tractors, using bolts and hand tools. |
| 81 | Supplemental | Load hoppers, containers, or conveyors to feed machines with products, using forklifts, transfer augers, suction gates, shovels, or pitchforks. |
| 80 | Supplemental | Direct and monitor the activities of work crews engaged in planting, weeding, or harvesting activities. |
| 79 | Supplemental | Operate towed machines such as seed drills or manure spreaders to plant, fertilize, dust, and spray crops. |
| 76 | Supplemental | Weigh crop-filled containers, and record weights and other identifying information. |
| 76 | Supplemental | Walk beside or ride on planting machines while inserting plants in planter mechanisms at specified intervals. |
| 76 | Supplemental | Drive trucks to haul crops, supplies, tools, or farm workers. |
| 75 | Supplemental | Guide products on conveyors to regulate flow through machines, and to discard diseased or rotten products. |
| 74 | Supplemental | Position boxes or attach bags at discharge ends of machinery to catch products, removing and closing full containers. |
| 74 | Supplemental | Irrigate soil, using portable pipes or ditch systems, and maintain ditches or pipes and pumps. |

## Technology Skills

| Hot Technology | Examples |
|----------------|----------|
| Data base user interface and query software | Martens Farms Farm Trac; Microsoft Access Hot Technology |
...
- Apply chemical solutions to plants to protect against disease or insects or to enhance growth. Related occupations
