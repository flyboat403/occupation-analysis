...
**Quick Facts:**
- SOC Code: 19-1042.00
- Also called: Clinical Laboratory Scientist (Clinical Lab Scientist), Clinical Pharmacologist, Clinical Research Scientist, Medical Researcher, Physician Scientist, Research Scientist, Researcher, Scientist, Study Director, Toxicologist
...
|------------|----------|------|
| 92 | Core | Follow strict safety procedures when handling toxic materials to avoid contamination. |
| 91 | Core | Evaluate effects of drugs, gases, pesticides, parasites, and microorganisms at various levels. |
| 87 | Core | Plan and direct studies to investigate human or animal disease, preventive methods, and treatments for disease. |
| 87 | Core | Prepare and analyze organ, tissue, and cell samples to identify toxicity, bacteria, or microorganisms or to study cell structure. |
| 78 | Core | Conduct research to develop methodologies, instrumentation, and procedures for medical application, analyzing data and presenting findings to the scientific audience and general public. |
| 78 | Core | Teach principles of medicine and medical and laboratory procedures to physicians, residents, students, and technicians. |
| 75 | Core | Write and publish articles in scientific journals. |
| 75 | Core | Write applications for research grants. |
| 82 | Supplemental | Standardize drug dosages, methods of immunization, and procedures for manufacture of drugs and medicinal compounds. |
| 77 | Supplemental | Study animal and human health and physiological processes. |
| 73 | Supplemental | Investigate cause, progress, life cycle, or mode of transmission of diseases or parasites. |
| 70 | Supplemental | Use equipment such as atomic absorption spectrometers, electron microscopes, flow cytometers, or chromatography systems. |
| 67 | Supplemental | Confer with health departments, industry personnel, physicians, and others to develop health safety standards and public health improvement programs. |
| 60 | Supplemental | Consult with and advise physicians, educators, researchers, and others regarding medical applications of physics, biology, and chemistry. |

## Technology Skills

| Hot Technology | Examples |
|----------------|----------|
| Analytical or scientific software | BioArray Software Environment BASE; IBM SPSS Statistics Hot Technology ; Minitab; SAS Hot Technology ; 11 more |
| Data base user interface and query software | Database software; FileMaker Pro; Waters Empower 2 |
| Desktop publishing software | Microsoft Publisher |
| Development environment software | Integrated development environment IDE software; Microsoft Visual Basic Hot Technology ; National Instruments LabVIEW |
...
- American Federation for Medical Research external site
