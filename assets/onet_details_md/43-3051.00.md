...
**Quick Facts:**
- SOC Code: 43-3051.00
- Also called: Payroll Assistant, Payroll Clerk, Payroll Coordinator, Payroll Representative, Payroll Specialist, Payroll Technician, Personnel Assistant, Personnel Technician, Timekeeper
...
|------------|----------|------|
| 94 | Core | Verify attendance, hours worked, and pay adjustments, and post information onto designated records. |
| 93 | Core | Process and issue employee paychecks and statements of earnings and deductions. |
| 92 | Core | Compute wages and deductions, and enter data into computers. |
| 92 | Core | Process paperwork for new employees and enter employee information into the payroll system. |
| 91 | Core | Prepare and balance period-end reports, and reconcile issued payrolls to bank statements. |
| 90 | Core | Review time sheets, work charts, wage computation, and other information to detect and reconcile payroll discrepancies. |
| 90 | Core | Distribute and collect timecards each pay period. |
| 89 | Core | Record employee information, such as exemptions, transfers, and resignations, to maintain and update payroll records. |
| 89 | Core | Issue and record adjustments to pay related to previous errors or retroactive increases. |
| 86 | Core | Keep track of leave time, such as vacation, personal, and sick leave, for employees. |
| 84 | Core | Compile employee time, production, and payroll data from time sheets and other records. |
| 82 | Core | Keep informed about changes in tax and deduction laws that apply to the payroll process. |
| 81 | Core | Complete time sheets showing employees' arrival and departure times. |
| 75 | Core | Provide information to employees and managers on payroll matters, tax issues, benefit plans, and collective agreement provisions. |
| 63 | Core | Conduct verifications of employment. |
| 92 | Supplemental | Prepare and file payroll tax returns. |
| 87 | Supplemental | Compile statistical reports, statements, and summaries related to pay and benefits accounts, and submit them to appropriate departments. |
| 84 | Supplemental | Balance cash and payroll accounts. |
| 77 | Supplemental | Complete, verify, and process forms and documentation for administration of benefits, such as pension plans, and unemployment and medical insurance. |
| 70 | Supplemental | Train employees on organizations' timekeeping systems. |
| 52 | Supplemental | Coordinate special programs, such as United Way campaigns, that involve payroll deductions. |

## Technology Skills

| Hot Technology | Examples |
|----------------|----------|
| Accounting software | Fund accounting software; Intuit QuickBooks Hot Technology ; Sage 50 Accounting; Tax software ; 2 more |
...
| Data base user interface and query software | ADP Workforce Now In Demand ; Data entry software; Microsoft Access Hot Technology |
| Electronic mail software | Email software; IBM Notes; MicroFocus GroupWise; Microsoft Outlook |
| Enterprise resource planning ERP software | Microsoft Dynamics; Oracle PeopleSoft Hot Technology ; SAP software Hot Technology ; Workday software ; 4 more |
| Financial analysis software | Oracle E-Business Suite Financials |
| Human resources software | API Navigator; Human Resource MicroSystems HR Entre; Oracle HRIS In Demand ; Sage HRMS ; 4 more |
...
| 80 | Performing Administrative Activities — Performing day-to-day administrative tasks such as maintaining information files and processing paperwork. |
...
| 19 | Coaching and Developing Others — Identifying the developmental needs of others and coaching, mentoring, or otherwise helping others to improve their knowledge or skills. |
...
- Verify employee information. Related occupations
...
|---|---|
| 87 | Administrative — Knowledge of administrative and office procedures and systems such as word processing, managing files and records, stenography and transcription, designing forms, and workplace terminology. |
...
| 14 | Realistic — Work involves designing, building, or repairing of equipment, materials, or structures, engaging in physical activity, or working outdoors. Realistic occupations are often associated with engineering, mechanics and electronics, construction, woodworking, transportation, machine operation, agriculture, animal services, physical or manual labor, athletics, or protective services. Related occupations |
