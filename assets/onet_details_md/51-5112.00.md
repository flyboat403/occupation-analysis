...
**Quick Facts:**
- SOC Code: 51-5112.00
- Also called: Digital Press Operator, Flexographic Press Operator, Offset Press Operator, Offset Pressman, Press Operator, Pressman, Printer, Printing Press Operator, Printing Pressman, Web Press Operator
...
|------------|----------|------|
| 92 | Core | Start presses and pull proofs to check for ink coverage and density, alignment, and registration. |
| 91 | Core | Examine job orders to determine quantities to be printed, stock specifications, colors, or special printing instructions. |
| 90 | Core | Adjust ink fountain flow rates. |
| 89 | Core | Verify that paper and ink meet the specifications for a given job. |
| 89 | Core | Collect and inspect random samples during print runs to identify any necessary adjustments. |
| 88 | Core | Feed paper through press cylinders and adjust feed and tension controls. |
| 88 | Core | Monitor automated press operation systems and respond to fault, error, or alert messages. |
| 88 | Core | Load presses with paper and make necessary adjustments, according to paper size. |
| 88 | Core | Secure printing plates to printing units and adjust tolerances. |
| 85 | Core | Clean ink fountains, plates, or printing unit cylinders when press runs are completed. |
| 85 | Core | Change press plates, blankets, or cylinders, as required. |
| 84 | Core | Obtain or mix inks and fill ink fountains. |
| 83 | Core | Input production job settings into workstation terminals that control automated printing systems. |
| 80 | Core | Clean or oil presses or make minor repairs, using hand tools. |
| 76 | Core | Maintain time or production records. |
| 74 | Core | Monitor inventory levels on a regular basis, ordering or requesting additional supplies, as necessary. |
| 74 | Core | Monitor environmental factors, such as humidity and temperature, that may impact equipment performance and make necessary adjustments. |
| 87 | Supplemental | Download or scan files to be printed, using printing production software. |
| 83 | Supplemental | Adjust digital files to alter print elements, such as fonts, graphics, or color separations. |
| 79 | Supplemental | Direct or monitor work of press crews. |
| 76 | Supplemental | Download completed jobs to archive media so that questions can be answered or jobs replicated. |
| 75 | Supplemental | Control workflow scheduling or job tracking, using computer database software. |
| 66 | Supplemental | Set up or operate auxiliary equipment, such as cutting, folding, plate-making, drilling, or laminating machines. |
...
| Desktop publishing software | Adobe InDesign Hot Technology ; Adobe PageMaker; Enfocus PitStop Pro; QuarkXPress |
| Document management software | Adobe Acrobat Hot Technology ; Adobe LifeCycle Production Print ES3; Xerox FreeFlow Print Server |
| Electronic mail software | Email software; Microsoft Outlook Hot Technology |
| Enterprise resource planning ERP software | Electronics for Imaging EFI Monarch; Electronics for Imaging EFI Pace; SAP software Hot Technology |
| Financial analysis software | Xerox ProfitQuick |
| Graphics or photo imaging software | Adobe Illustrator Hot Technology ; Adobe Photoshop Hot Technology ; Graphics software; Image editing software ; 1 more |
...
- Download data. Related occupations
