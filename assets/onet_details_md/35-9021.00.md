...
**Quick Facts:**
- SOC Code: 35-9021.00
- Also called: Busser, Dish Machine Operator (DMO), Dish Room Worker, Dish Runner, Dish Technician (Dish Tech), Dishwasher, Kitchen Helper, Kitchen Steward, Steward, Utility Worker
...
|------------|----------|------|
| 87 | Core | Wash dishes, glassware, flatware, pots, or pans, using dishwashers or by hand. |
| 86 | Core | Maintain kitchen work areas, equipment, or utensils in clean and orderly condition. |
| 83 | Core | Place clean dishes, utensils, or cooking equipment in storage areas. |
| 80 | Core | Sweep or scrub floors. |
| 73 | Core | Stock supplies, such as food or utensils, in serving stations, cupboards, refrigerators, or salad bars. |
| 71 | Core | Clean or prepare various foods for cooking or serving. |
| 70 | Core | Sort and remove trash, placing it in designated pickup areas. |
| 68 | Core | Transfer supplies or equipment between storage and work areas, by hand or using hand trucks. |
| 66 | Core | Receive and store supplies. |
| 66 | Core | Clean garbage cans with water or steam. |
| 74 | Supplemental | Load or unload trucks that deliver or pick up food or supplies. |
| 55 | Supplemental | Prepare and package individual place settings. |
| 55 | Supplemental | Set up banquet tables. |
...
| 25 | Inductive Reasoning — The ability to combine pieces of information to form general rules or conclusions (includes finding a relationship among seemingly unrelated events). |
...
| 6 | Integrity — A tendency to be honest and ethical at work. |
| 5 | Cautiousness — A tendency to be careful, deliberate, and risk-avoidant when making work-related decisions or doing work. |
