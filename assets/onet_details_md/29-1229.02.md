...
**Quick Facts:**
- SOC Code: 29-1229.02
- Also called: Academic Hospitalist, Consultant Physician, Hospitalist, Hospitalist Medical Doctor (Hospitalist MD), MD (Medical Doctor), Physician
...
|------------|----------|------|
| 98 | Core | Diagnose, treat, or provide continuous care to hospital inpatients. |
| 98 | Core | Prescribe medications or treatment regimens to hospital inpatients. |
| 97 | Core | Order or interpret the results of tests such as laboratory tests and radiographs (x-rays). |
| 96 | Core | Admit patients for hospital stays. |
| 95 | Core | Conduct discharge planning and discharge patients. |
| 93 | Core | Write patient discharge summaries and send them to primary care physicians. |
| 91 | Core | Refer patients to medical specialists, social services, or other professionals as appropriate. |
| 90 | Core | Direct, coordinate, or supervise the patient care activities of nursing or support staff. |
| 85 | Core | Attend inpatient consultations in areas of specialty. |
| 84 | Core | Communicate with patients' primary care physicians upon admission, when treatment plans change, or at discharge to maintain continuity and quality of care. |
| 82 | Core | Participate in continuing education activities to maintain or enhance knowledge and skills. |
| 76 | Core | Direct or support quality improvement projects or safety programs. |
| 73 | Core | Direct the operations of short stay or specialty units. |
| 69 | Core | Train or supervise medical students, residents, or other health professionals. |
...
| Medical software | Epic Systems ; Medical decision support software; Medical procedure coding software; MEDITECH software Hot Technology ; 4 more |
...
| 96 | Stress Tolerance — A tendency to cope and function effectively in stressful situations at work. |
...
- Society of General Internal Medicine external site
- Society of Hospital Medicine external site

- American Board of Internal Medicine: Cardiovascular Disease external site
