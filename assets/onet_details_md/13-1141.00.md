...
**Quick Facts:**
- SOC Code: 13-1141.00
- Also called: Benefits Analyst, Benefits Consultant, Benefits Specialist, Compensation Analyst, Compensation and Benefits Analyst, Compensation and Benefits Specialist, Compensation Consultant, Compensation Specialist, Employee Benefits Specialist, Position Classification Specialist
...
|------------|----------|------|
| 86 | Core | Administer employee insurance, pension, and savings plans, working with insurance brokers and plan carriers. |
| 85 | Core | Ensure company compliance with federal and state laws, including reporting requirements. |
| 77 | Core | Research employee benefit and health and safety practices, and recommend changes or modifications to existing policies. |
| 69 | Core | Advise managers and employees on state and federal employment regulations, collective agreements, benefit and compensation policies, personnel procedures, and classification programs. |
| 50 | Core | Plan and develop curricula and materials for training programs and conduct training. |
| 50 | Core | Assist in preparing and maintaining personnel records and handbooks. |
| 81 | Supplemental | Develop and administer compensation programs, such as merit or incentive pay. |
| 73 | Supplemental | Evaluate job positions, determining classification, exempt or non-exempt status, and salary. |
| 73 | Supplemental | Prepare occupational classifications, job descriptions, and salary scales. |
| 73 | Supplemental | Consult with, or serve as, technical liaison between business, industry, government, and union officials. |
| 70 | Supplemental | Perform multifactor data and cost analyses that may be used in areas such as support of collective bargaining agreements. |
| 70 | Supplemental | Develop, implement, administer, and evaluate personnel and labor relations programs, including performance appraisal, affirmative action, and employment equity programs. |
| 58 | Supplemental | Provide advice on the resolution of classification and salary complaints. |
| 57 | Supplemental | Negotiate collective agreements on behalf of employers or workers, and mediate labor disputes and grievances. |
| 56 | Supplemental | Analyze organizational, occupational, and industrial data to facilitate organizational functions and provide technical information to business, industry, and government. |
| 55 | Supplemental | Assess need for and develop job analysis instruments and materials. |
| 52 | Supplemental | Observe, interview, and survey employees and conduct focus group meetings to collect job, organizational, and occupational information. |
| 48 | Supplemental | Plan, develop, evaluate, improve, and communicate methods and techniques for selecting, promoting, compensating, evaluating, and training workers. |
| 48 | Supplemental | Research job and worker requirements, structural and functional relationships among jobs and occupations, and occupational trends. |
| 47 | Supplemental | Prepare reports, such as organization and flow charts and career path reports, to summarize job analysis and evaluation and compensation analysis information. |
| 43 | Supplemental | Advise staff of individuals' qualifications. |
| 21 | Supplemental | Prepare research results for publication in form of journals, books, manuals, and film. |
...
| Data base user interface and query software | Microsoft Access Hot Technology ; Microsoft SQL Server Hot Technology ; O*NET OnLine; Structured query language SQL Hot Technology ; 2 more |
| Development environment software | Microsoft Visual Basic Hot Technology |
| Document management software | Actuarial Systems Corporation Document Generation and Management System; Document management system software; Microsoft SharePoint Hot Technology |
| Electronic mail software | Microsoft Outlook |
| Enterprise resource planning ERP software | Microsoft Dynamics; Oracle PeopleSoft Hot Technology ; SAP software Hot Technology ; Workday software ; 3 more |
...
| Project management software | Microsoft Project Hot Technology ; Project planning software |
| Spreadsheet software | Microsoft Excel |
| Time accounting software | ADP Enterprise eTIME; Kronos Workforce Timekeeper Hot Technology ; Sage HRMS |
...
|---|---|
| 81 | Personnel and Human Resources — Knowledge of principles and procedures for personnel recruitment, selection, training, compensation and benefits, labor relations and negotiation, and personnel information systems. |
...
- Employee Benefit Research Institute external site
