...
**Quick Facts:**
- SOC Code: 25-1121.00
- Also called: Art History Professor, Art Instructor, Art Professor, Assistant Professor, Associate Professor, Instructor, Music Instructor, Music Professor, Professor, Theater Professor
...
|------------|----------|------|
| 93 | Core | Explain and demonstrate artistic techniques. |
| 89 | Core | Evaluate and grade students' class work, performances, projects, assignments, and papers. |
| 88 | Core | Prepare students for performances, exams, or assessments. |
| 86 | Core | Initiate, facilitate, and moderate classroom discussions. |
| 84 | Core | Prepare and deliver lectures to undergraduate or graduate students on topics such as acting techniques, fundamentals of music, and art history. |
...
| 80 | Core | Plan, evaluate, and revise curricula, course content, course materials, and methods of instruction. |
| 78 | Core | Compile, administer, and grade examinations, or assign this work to others. |
| 78 | Core | Maintain regularly scheduled office hours to advise and assist students. |
| 72 | Core | Select and obtain materials and supplies, such as textbooks and performance pieces. |
...
| 65 | Core | Display students' work in schools, galleries, and exhibitions. |
| 63 | Core | Participate in campus and community events. |
| 62 | Core | Keep students informed of community events, such as plays and concerts. |
...
| 82 | Supplemental | Organize performance groups and direct their rehearsals. |
| 76 | Supplemental | Supervise undergraduate or graduate teaching, internship, and research work. |
| 72 | Supplemental | Perform administrative duties, such as serving as department head. |
| 70 | Supplemental | Maintain or repair studio facilities. |
...
| 51 | Supplemental | Write grant proposals to procure external research funding. |
| 49 | Supplemental | Compile bibliographies of specialized materials for outside reading assignments. |
| 34 | Supplemental | Provide professional consulting services to government or industry. |
...
| Computer based training software | Blackboard software; Learning management system LMS In Demand ; Moodle; Sakai CLE ; 3 more |
...
| Development environment software | Microsoft Visual Studio Hot Technology ; PhoneGap |
| Document management software | Adobe Acrobat Hot Technology |
| Electronic mail software | Email software; Microsoft Outlook Hot Technology |
| Graphics or photo imaging software | Adobe Creative Cloud software Hot Technology ; Adobe Illustrator Hot Technology ; Faux Labs Splashup; Next Limit Maxwell Render ; 3 more |
...
| Video creation and editing software | Adobe After Effects Hot Technology ; Apple DVD Studio Pro; Apple Final Cut Pro; The Foundry Nuke ; 2 more |
| Web page creation and editing software | Adobe Dreamweaver |
| Web platform development software | Cascading style sheets CSS Hot Technology ; Hypertext markup language HTML Hot Technology ; JavaScript Hot Technology ; PHP Hot Technology |
...
|---|---|
| 98 | Fine Arts — Knowledge of the theory and techniques required to compose, produce, and perform works of music, dance, visual arts, drama, and sculpture. |
...
| 43 | Foreign Language — Knowledge of the structure and content of a foreign (non-English) language including the meaning and spelling of words, rules of composition and grammar, and pronunciation. |
...
| 27 | Conventional — Work involves following procedures and regulations to organize information or data, typically in a business setting. Conventional occupations are often associated with office work, accounting, mathematics/statistics, information technology, finance, or human resources. Related occupations |
...
- American Musicological Society external site
- American Society for Theatre Research external site
- American String Teachers Association external site
- Association for Theatre in Higher Education external site
...
- Southeastern Theatre Conference external site
