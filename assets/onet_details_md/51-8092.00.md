...
**Quick Facts:**
- SOC Code: 51-8092.00
- Also called: Compressor Technician (Compressor Tech), Engine Room Operator, Gas Controller, Gas Dispatcher, Gas Plant Operator, Gas Resource Control Operator, Gas System Operator, Liquefied Natural Gas Technician (LNG Technician), Liquid Natural Gas Plant Operator (LNG Plant Operator), Plant Operator
...
|------------|----------|------|
| 92 | Core | Monitor equipment functioning, observe temperature, level, and flow gauges, and perform regular unit checks to ensure that all equipment is operating as it should. |
| 90 | Core | Distribute or process gas for utility companies or industrial plants, using panel boards, control boards, and semi-automatic equipment. |
| 88 | Core | Control operation of compressors, scrubbers, evaporators, and refrigeration equipment to liquefy, compress, or regasify natural gas. |
| 88 | Core | Control equipment to regulate flow and pressure of gas to feedlines of boilers, furnaces, and related steam-generating or heating equipment. |
| 86 | Core | Record, review, and compile operations records, test results, and gauge readings such as temperatures, pressures, concentrations, and flows. |
| 85 | Core | Determine causes of abnormal pressure variances, and make corrective recommendations, such as installation of pipes to relieve overloading. |
| 84 | Core | Adjust temperature, pressure, vacuum, level, flow rate, or transfer of gas to maintain processes at required levels or to correct problems. |
| 83 | Core | Collaborate with other operators to solve unit problems. |
| 82 | Core | Monitor transportation and storage of flammable and other potentially dangerous products to ensure that safety guidelines are followed. |
| 82 | Core | Start and shut down plant equipment. |
| 80 | Core | Read logsheets to determine product demand and disposition, or to detect malfunctions. |
| 76 | Core | Contact maintenance crews when necessary. |
| 76 | Core | Test gas, chemicals, and air during processing to assess factors such as purity and moisture content, and to detect quality problems or gas or chemical leaks. |
| 76 | Core | Clean, maintain, and repair equipment, using hand tools, or request that repair and maintenance work be performed. |
| 72 | Core | Signal or direct workers who tend auxiliary equipment. |
| 80 | Supplemental | Control fractioning columns, compressors, purifying towers, heat exchangers, and related equipment to extract nitrogen and oxygen from air. |
| 69 | Supplemental | Calculate gas ratios to detect deviations from specifications, using testing apparatus. |
| 60 | Supplemental | Operate construction equipment to install and maintain gas distribution systems. |
| 57 | Supplemental | Change charts in recording meters. |
...
- Operate natural gas distribution equipment. Related occupations
...
- American Gas Association external site
