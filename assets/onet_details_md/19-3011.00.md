...
**Quick Facts:**
- SOC Code: 19-3011.00
- Also called: Economic Advisor, Economic Analyst, Economic Consultant, Economic Development Specialist, Economist, Forensic Economist, Project Economist, Research Economist, Revenue Research Analyst, Tax Economist
...
|------------|----------|------|
| 90 | Core | Study economic and statistical data in area of specialization, such as finance, labor, or agriculture. |
| 81 | Core | Compile, analyze, and report data to explain economic phenomena and forecast market trends, applying mathematical models and statistical techniques. |
| 80 | Core | Study the socioeconomic impacts of new public policies, such as proposed legislation, taxes, services, and regulations. |
| 76 | Core | Explain economic impact of policies to the public. |
| 75 | Core | Review documents written by others. |
| 74 | Core | Provide advice and consultation on economic relationships to businesses, public and private agencies, and other employers. |
| 73 | Core | Formulate recommendations, policies, or plans to solve economic problems or to interpret markets. |
| 71 | Core | Supervise research projects and students' study projects. |
| 71 | Core | Conduct research on economic issues, and disseminate research findings through technical reports or scientific articles in journals. |
| 70 | Core | Develop economic guidelines and standards, and prepare points of view used in forecasting trends and formulating economic policy. |
| 63 | Core | Teach theories, principles, and methods of economics. |
| 57 | Core | Testify at regulatory or legislative hearings concerning the estimated effects of changes in legislation or public policy, and present recommendations based on cost-benefit analyses. |
| 55 | Core | Provide litigation support, such as writing reports for expert testimony or testifying as an expert witness. |
| 46 | Supplemental | Forecast production and consumption of renewable resources and supply, consumption, and depletion of non-renewable resources. |

## Technology Skills

| Hot Technology | Examples |
|----------------|----------|
| Analytical or scientific software | IBM SPSS Statistics Hot Technology ; Minitab; SAS ; The MathWorks MATLAB Hot Technology ; 16 more |
| Business intelligence and data analysis software | Microsoft Power BI ; Tableau |
| Data base management system software | MySQL Hot Technology ; Teradata Database Hot Technology |
...
| Development environment software | Formula translation/translator FORTRAN; Microsoft Visual Basic Hot Technology ; Microsoft Visual Basic for Applications VBA Hot Technology |
...
| Object or component oriented development software | C++ Hot Technology ; Oracle Java Hot Technology ; Python ; R ; 1 more |
| Office suite software | Corel WordPerfect Office Suite; Microsoft Office software |
| Operating system software | UNIX Hot Technology ; UNIX Shell Hot Technology |
...
|---|---|
| 98 | Analyzing Data or Information — Identifying the underlying principles, reasons, or facts of information by breaking down information or data into separate parts. |
...
| 87 | Economics and Accounting — Knowledge of economic and accounting principles and practices, the financial markets, banking, and the analysis and reporting of financial data. |
...
- American Law and Economics Association external site
...
- International Association for Feminist Economics external site
- International Economic Development Council external site
- National Association of Forensic Economics external site
- Society of Labor Economists external site
