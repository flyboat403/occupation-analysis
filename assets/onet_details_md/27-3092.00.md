...
**Quick Facts:**
- SOC Code: 27-3092.00
- Also called: Certified Shorthand Reporter (CSR), Court Monitor, Court Recording Monitor, Court Reporter, Court Stenographer, Deposition Reporter, Digital Court Reporter, Official Court Reporter, Realtime Court Reporter, Stenographer
...
|------------|----------|------|
| 96 | Core | Record verbatim proceedings of courts, legislative assemblies, committee meetings, and other proceedings, using computerized recording equipment, electronic stenograph machines, or stenomasks. |
| 96 | Core | Proofread transcripts for correct spelling of words. |
| 96 | Core | Ask speakers to clarify inaudible statements. |
| 95 | Core | Provide transcripts of proceedings upon request of judges, lawyers, or the public. |
| 95 | Core | Transcribe recorded proceedings in accordance with established formats. |
| 94 | Core | Log and store exhibits from court proceedings. |
| 94 | Core | File and store shorthand notes of court session. |
| 94 | Core | File a legible transcript of records of a court case with the court clerk's office. |
| 88 | Core | Verify accuracy of transcripts by checking copies against original records of proceedings and accuracy of rulings by checking with judges. |
| 88 | Core | Respond to requests during court sessions to read portions of the proceedings already recorded. |
| 96 | Supplemental | Record symbols on computer storage media and use computer aided transcription to translate and display them as text. |
| 96 | Supplemental | Take notes in shorthand or use a stenotype or shorthand machine that prints letters on a paper tape. |
| 92 | Supplemental | Type court orders for judges. |
| 80 | Supplemental | Record depositions and other proceedings for attorneys. |
...
| 24 | Judging the Qualities of Objects, Services, or People — Assessing the value, importance, or quality of things or people. |
...
| 10 | Mathematics — Knowledge of arithmetic, algebra, geometry, calculus, statistics, and their applications. |
...
- National Court Reporters Association external site
- National Verbatim Reporters Association external site
- Society for the Technological Advancement of Reporting external site
- United States Court Reporters Association external site

- American Association of Electronic Reporters and Transcribers external site
