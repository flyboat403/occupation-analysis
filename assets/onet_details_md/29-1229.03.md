...
**Quick Facts:**
- SOC Code: 29-1229.03
- Also called: Acute Care Physician, MD (Medical Doctor), Owner, Physician, Practicing Urologist, Surgeon, Urologic Surgeon, Urologist, Urology MD (Urology Medical Doctor)
...
|------------|----------|------|
| 97 | Core | Diagnose or treat diseases or disorders of genitourinary organs and tracts including erectile dysfunction (ED), infertility, incontinence, bladder cancer, prostate cancer, urethral stones, or premature ejaculation. |
| 95 | Core | Examine patients using equipment, such as radiograph (x-ray) machines or fluoroscopes, to determine the nature and extent of disorder or injury. |
| 94 | Core | Order and interpret the results of diagnostic tests, such as prostate specific antigen (PSA) screening, to detect prostate cancer. |
| 94 | Core | Document or review patients' histories. |
| 94 | Core | Prescribe or administer antibiotics, antiseptics, or compresses to treat infection or injury. |
| 93 | Core | Treat urologic disorders using alternatives to traditional surgery such as extracorporeal shock wave lithotripsy, laparoscopy, or laser techniques. |
| 92 | Core | Provide urology consultation to physicians or other health care professionals. |
| 92 | Core | Treat lower urinary tract dysfunctions using equipment such as diathermy machines, catheters, cystoscopes, or radium emanation tubes. |
| 91 | Core | Direct the work of nurses, residents, or other staff to provide patient care. |
| 91 | Core | Perform abdominal, pelvic, or retroperitoneal surgeries. |
| 88 | Core | Prescribe medications to treat patients with erectile dysfunction (ED), infertility, or ejaculation problems. |
| 83 | Core | Refer patients to specialists when condition exceeds experience, expertise, or scope of practice. |
| 81 | Core | Teach or train medical and clinical staff. |
| 72 | Core | Perform brachytherapy, cryotherapy, high intensity focused ultrasound (HIFU), or photodynamic therapy to treat prostate or other cancers. |
...
| Medical software | Bizmatics PrognoCIS EMR; eClinicalWorks EHR software Hot Technology ; Epic Systems ; MEDITECH software Hot Technology ; 22 more |
...
| 81 | Judging the Qualities of Objects, Services, or People — Assessing the value, importance, or quality of things or people. |
...
|------------------------|----------|
| 98 | Investigative — Work involves studying and researching non-living objects, living organisms, disease or other forms of impairment, or human behavior. Investigative occupations are often associated with physical, life, medical, or social sciences, and can be found in the fields of humanities, mathematics/statistics, information technology, or health care service. Related occupations |
...
- American Association of Clinical Urologists external site
