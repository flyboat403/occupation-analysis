...
|------------|----------|------|
| 94 | Core | Measure dimensions of finished workpieces to ensure conformance to specifications, using precision measuring instruments, templates, and fixtures. |
| 92 | Core | Set up and operate computer-controlled machines or robots to perform one or more machine functions on metal or plastic workpieces. |
| 91 | Core | Mount, install, align, and secure tools, attachments, fixtures, and workpieces on machines, using hand tools and precision measuring instruments. |
| 90 | Core | Review program specifications or blueprints to determine and set machine operations and sequencing, finished workpiece dimensions, or numerical control sequences. |
| 89 | Core | Stop machines to remove finished workpieces or to change tooling, setup, or workpiece placement, according to required machining sequences. |
| 89 | Core | Listen to machines during operation to detect sounds such as those made by dull cutting tools or excessive vibration, and adjust machines to compensate for problems. |
| 89 | Core | Implement changes to machine programs, and enter new specifications, using computers. |
| 89 | Core | Calculate machine speed and feed ratios and the size and position of cuts. |
| 88 | Core | Transfer commands from servers to computer numerical control (CNC) modules, using computer network links. |
| 87 | Core | Remove and replace dull cutting tools. |
| 86 | Core | Check to ensure that workpieces are properly lubricated and cooled during machine operation. |
| 85 | Core | Adjust machine feed and speed, change cutting tools, or adjust machine controls when automatic programming is faulty or if machines malfunction. |
| 85 | Core | Monitor machine operation and control panel displays, and compare readings to specifications to detect malfunctions. |
| 84 | Core | Maintain machines and remove and replace broken or worn machine tools, using hand tools. |
| 84 | Core | Insert control instructions into machine control units to start operation. |
| 82 | Core | Modify cutting programs to account for problems encountered during operation, and save modified programs. |
| 80 | Core | Write simple programs for computer-controlled machine tools. |
| 80 | Core | Lift workpieces to machines manually or with hoists or cranes. |
| 79 | Core | Input initial part dimensions into machine control panels. |
| 77 | Core | Set up future jobs while machines are operating. |
| 75 | Core | Confer with supervisors or programmers to resolve machine malfunctions or production errors or to obtain approval to continue production. |
| 73 | Core | Stack or load finished items, or place items on conveyor systems. |
| 73 | Core | Control coolant systems. |
| 71 | Core | Clean machines, tooling, or parts, using solvents or solutions and rags. |
| 79 | Supplemental | Enter commands or load control media, such as tapes, cards, or disks, into machine controllers to retrieve programmed instructions. |
| 62 | Supplemental | Lay out and mark areas of parts to be shot peened and fill hoppers with shot. |
| 51 | Supplemental | Examine electronic components for defects or completeness of laser-beam trimming, using microscopes. |
...
| Computer aided design CAD software | Autodesk AutoCAD Hot Technology ; Dassault Systemes SolidWorks Hot Technology ; KCD cabinet design software; UGS Solid Edge ; 1 more |
...
| 22 | Communicating with People Outside the Organization — Communicating with people outside the organization, representing the organization to customers, the public, government, and other external sources. This information can be exchanged in person, in writing, or by telephone or e-mail. |
...
| 78 | Operations Monitoring — Watching gauges, dials, or other indicators to make sure a machine is working properly. |
