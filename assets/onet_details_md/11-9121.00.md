...
**Quick Facts:**
- SOC Code: 11-9121.00
- Also called: Analytical Services Manager, Chemical Engineer Supervisor, Chemical Process Exploration Manager, Environmental Program Manager, Lab Manager (Laboratory Manager), Natural Sciences Manager, Research Administrator, Research and Development Director (R and D Director), Research Manager, Water Team Leader
...
|------------|----------|------|
| 83 | Core | Hire, supervise, or evaluate engineers, technicians, researchers, or other staff. |
| 81 | Core | Design or coordinate successive phases of problem analysis, solution proposals, or testing. |
| 80 | Core | Plan or direct research, development, or production activities. |
| 77 | Core | Review project activities and prepare and review research, testing, or operational reports. |
| 76 | Core | Confer with scientists, engineers, regulators, or others to plan or review projects or to provide technical assistance. |
| 74 | Core | Develop client relationships and communicate with clients to explain proposals, present research findings, establish specifications, or discuss project status. |
| 73 | Core | Determine scientific or technical goals within broad outlines provided by top management and make detailed plans to accomplish these goals. |
| 72 | Core | Prepare project proposals. |
| 68 | Core | Develop or implement policies, standards, or procedures for the architectural, scientific, or technical work performed to ensure regulatory compliance or operations enhancement. |
| 64 | Core | Recruit personnel or oversee the development or maintenance of staff competence. |
| 64 | Core | Prepare and administer budgets, approve and review expenditures, and prepare financial reports. |
| 63 | Core | Conduct own research in field of expertise. |
| 58 | Core | Develop innovative technology or train staff for its implementation. |
| 56 | Core | Make presentations at professional meetings to further knowledge in the field. |
| 79 | Supplemental | Provide for stewardship of plant or animal resources or habitats, studying land use, monitoring animal populations, or providing shelter, resources, or medical treatment for animals. |
| 51 | Supplemental | Advise or assist in obtaining patents or meeting other legal requirements. |

## Technology Skills

| Hot Technology | Examples |
|----------------|----------|
| Analytical or scientific software | IBM SPSS Statistics Hot Technology ; SAS Hot Technology ; StataCorp Stata; The MathWorks MATLAB Hot Technology ; 2 more |
| Data base management system software | Oracle Database Hot Technology |
| Data base reporting software | SAP Business Objects |
| Data base user interface and query software | Clinical trial management software; Microsoft Access Hot Technology ; Structured query language SQL Hot Technology |
...
| Graphics or photo imaging software | Adobe Photoshop Hot Technology ; Graphics software |
...
- Controlled Release Society external site
