...
**Quick Facts:**
- SOC Code: 53-6051.07
- Also called: Car Inspector, Carman, Emissions Inspector, Inspector, Quality Assurance Inspector, Railroad Track Inspector, Safety Officer, Smog Technician, Transit Vehicle Inspector
...
|------------|----------|------|
| 87 | Core | Inspect vehicles or other equipment for evidence of abuse, damage, or mechanical malfunction. |
| 77 | Core | Inspect vehicles or equipment to ensure compliance with rules, standards, or regulations. |
| 76 | Core | Inspect repairs to transportation vehicles or equipment to ensure that repair work was performed properly. |
| 82 | Supplemental | Identify modifications to engines, fuel systems, emissions control equipment, or other vehicle systems to determine the impact of modifications on inspection procedures or conclusions. |
| 81 | Supplemental | Conduct remote inspections of motor vehicles, using handheld controllers and remotely directed vehicle inspection devices. |
| 79 | Supplemental | Prepare reports on investigations or inspections and actions taken. |
| 74 | Supplemental | Issue notices and recommend corrective actions when infractions or problems are found. |
| 67 | Supplemental | Conduct visual inspections of emission control equipment and smoke emitted from gasoline or diesel vehicles. |
| 66 | Supplemental | Conduct vehicle or transportation equipment tests, using diagnostic equipment. |
| 64 | Supplemental | Investigate incidents or violations, such as delays, accidents, and equipment failures. |
| 63 | Supplemental | Review commercial vehicle logs, shipping papers, or driver and equipment records to detect any problems or to ensure compliance with regulations. |
| 61 | Supplemental | Attach onboard diagnostics (OBD) scanner cables to vehicles to conduct emissions inspections. |
| 60 | Supplemental | Investigate complaints regarding safety violations. |
| 59 | Supplemental | Examine carrier operating rules, employee qualification guidelines, or carrier training and testing programs for compliance with regulations or safety standards. |
...
| Data base user interface and query software | ASPEN; Commercial driver's license information system CDLIS; Inspection Selection System ISS; Structured query language SQL Hot Technology ; 4 more |
...
| 10 | Assisting and Caring for Others — Providing personal assistance, medical attention, emotional support, or other personal care to others such as coworkers, customers, or patients. |
