...
**Quick Facts:**
- SOC Code: 27-3011.00
- Also called: Anchor, Announcer, DJ (Disc Jockey), Host, Morning Show Host, On-Air Host, On-Air Personality, Radio Announcer, Sports Anchor, Television News Anchor (TV News Anchor)
...
|------------|----------|------|
| 90 | Core | Read news flashes to inform audiences of important events. |
| 90 | Core | Announce musical selections, station breaks, commercials, or public service information, and accept requests from listening audience. |
| 88 | Core | Operate control consoles. |
| 87 | Core | Identify stations, and introduce or close shows, ad-libbing or using memorized or read scripts. |
| 85 | Core | Study background information to prepare for programs or interviews. |
| 84 | Core | Prepare and deliver news, sports, or weather reports, gathering and rewriting material so that it will convey required information and fit specific time slots. |
| 84 | Core | Record commercials for later broadcast. |
| 83 | Core | Keep daily program logs to provide information on all elements aired during broadcast, such as musical selections and station promotions. |
| 80 | Core | Develop story lines for broadcasts. |
| 79 | Core | Select program content, in conjunction with producers and assistants, based on factors such as program specialties, audience tastes, or requests from the public. |
| 76 | Core | Write and edit video and scripts for broadcasts. |
| 76 | Core | Interview show guests about their lives, their work, or topics of current interest. |
| 73 | Core | Comment on music and other matters, such as weather or traffic conditions. |
| 69 | Core | Make promotional appearances at public or private events to represent their employers. |
| 67 | Core | Provide commentary and conduct interviews during sporting events, parades, conventions, or other events. |
| 62 | Core | Host civic, charitable, or promotional events broadcast over television or radio. |
| 61 | Core | Locate guests to appear on talk or interview shows. |
| 61 | Core | Coordinate games, contests, or other on-air competitions, performing such duties as asking questions and awarding prizes. |
| 56 | Core | Attend press conferences to gather information for broadcast. |
| 76 | Supplemental | Maintain organization of the music library. |
| 62 | Supplemental | Discuss various topics over the telephone with viewers or listeners. |
| 58 | Supplemental | Moderate panels or discussion shows on topics such as current affairs, art, or education. |
| 57 | Supplemental | Give network cues permitting selected stations to receive programs. |
| 54 | Supplemental | Describe or demonstrate products that viewers may purchase through specific shows or in stores. |
...
| Data base user interface and query software | Database software; Microsoft Access Hot Technology ; Program logging software |
...
| Word processing software | Burli Software Burli Newsroom System; Microsoft Word Hot Technology |
...
- Host events. Related occupations
...
| 94 | Speech Clarity — The ability to speak clearly so others can understand you. |
...
| 53 | Attention to Detail — A tendency to be detail-oriented, organized, and thorough in completing work. |
...
- National Association of Sports Public Address Announcers external site
