...
**Quick Facts:**
- SOC Code: 23-1023.00
- Also called: Circuit Court Judge, Circuit Judge, County Judge, Court of Appeals Judge, District Court Judge, Judge, Justice of the Peace, Magisterial District Judge, Magistrate, Superior Court Judge
...
|------------|----------|------|
| 95 | Core | Sentence defendants in criminal cases, on conviction by jury, according to applicable government statutes. |
| 93 | Core | Monitor proceedings to ensure that all applicable rules and procedures are followed. |
| 91 | Core | Instruct juries on applicable laws, direct juries to deduce the facts from the evidence presented, and hear their verdicts. |
| 90 | Core | Write decisions on cases. |
| 90 | Core | Read documents on pleadings and motions to ascertain facts and issues. |
| 90 | Core | Rule on admissibility of evidence and methods of conducting testimony. |
| 90 | Core | Preside over hearings and listen to allegations made by plaintiffs to determine whether the evidence supports the charges. |
| 89 | Core | Award compensation for damages to litigants in civil cases in relation to findings by juries or by the court. |
| 89 | Core | Advise attorneys, juries, litigants, and court personnel regarding conduct, issues, and proceedings. |
| 88 | Core | Research legal issues and write opinions on the issues. |
| 85 | Core | Interpret and enforce rules of procedure or establish new rules in situations where there are no procedures already established by law. |
| 83 | Core | Issue arrest warrants. |
| 79 | Core | Settle disputes between opposing attorneys. |
| 71 | Core | Impose restrictions upon parties in civil cases until trials can be held. |
| 68 | Core | Supervise other judges, court officers, and the court's administrative staff. |
| 94 | Supplemental | Rule on custody and access disputes, and enforce court orders regarding custody and support of children. |
| 89 | Supplemental | Conduct preliminary hearings to decide issues, such as whether there is reasonable and probable cause to hold defendants in felony cases. |
| 86 | Supplemental | Grant divorces and divide assets between spouses. |
| 84 | Supplemental | Participate in judicial tribunals to help resolve disputes. |
| 49 | Supplemental | Provide information regarding the judicial system or other legal issues through the media and public speeches. |
| 35 | Supplemental | Perform wedding ceremonies. |
...
| Document management software | Adobe Acrobat Hot Technology ; Hyland OnBase Enterprise Content Management |
...
| 97 | Critical Thinking — Using logic and reasoning to identify the strengths and weaknesses of alternative solutions, conclusions, or approaches to problems. |
...
| Importance | Ability |
|---|---|
| 91 | Deductive Reasoning — The ability to apply general rules to specific problems to produce answers that make sense. |
...
| 97 | Attention to Detail — A tendency to be detail-oriented, organized, and thorough in completing work. |
...
- American Judges Association external site
- National Association of Women Judges external site
- National Bar Association external site
- National Center for State Courts external site
- National Council of Juvenile and Family Court Judges external site
- National Judges Association external site
- The National Judicial College external site
