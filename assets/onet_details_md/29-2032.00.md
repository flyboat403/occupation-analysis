...
**Quick Facts:**
- SOC Code: 29-2032.00
- Also called: Cardiac Sonographer, Diagnostic Medical Sonographer, Medical Sonographer, Registered Diagnostic Medical Sonographer (RDMS), Sonographer, Staff Sonographer, Ultrasonographer, Ultrasound Technician (Ultrasound Tech), Ultrasound Technologist (Ultrasound Tech)
...
|------------|----------|------|
| 97 | Core | Observe screen during scan to ensure that image produced is satisfactory for diagnostic purposes, making adjustments to equipment as required. |
| 96 | Core | Observe and care for patients throughout examinations to ensure their safety and comfort. |
| 96 | Core | Provide sonogram and oral or written summary of technical findings to physician for use in medical diagnosis. |
| 96 | Core | Select appropriate equipment settings and adjust patient positions to obtain the best sites and angles. |
| 96 | Core | Operate ultrasound equipment to produce and record images of the motion, shape, and composition of blood, organs, tissues, or bodily masses, such as fluid accumulations. |
| 96 | Core | Decide which images to include, looking for differences between healthy and pathological areas. |
| 94 | Core | Prepare patient for exam by explaining procedure, transferring patient to ultrasound table, scrubbing skin and applying gel, and positioning patient properly. |
| 91 | Core | Determine whether scope of exam should be extended, based on findings. |
| 91 | Core | Obtain and record accurate patient history, including prior test results or information from physical examinations. |
| 90 | Core | Maintain records that include patient information, sonographs and interpretations, files of correspondence, publications and regulations, or quality assurance records, such as pathology, biopsy, or post-operative reports. |
| 89 | Core | Record and store suitable images, using camera unit connected to the ultrasound equipment. |
| 85 | Core | Coordinate work with physicians or other healthcare team members, including providing assistance during invasive procedures. |
| 82 | Core | Clean, check, and maintain sonographic equipment, submitting maintenance requests or performing minor repairs as necessary. |
| 77 | Core | Perform clerical duties, such as scheduling exams or special procedures, keeping records, or archiving computerized images. |
| 75 | Core | Perform legal and ethical duties, including preparing safety or accident reports, obtaining written consent from patient to perform invasive procedures, or reporting symptoms of abuse or neglect. |
| 74 | Core | Supervise or train students or other medical sonographers. |
| 73 | Core | Perform medical procedures, such as administering oxygen, inserting and removing airways, taking vital signs, or giving emergency treatment, such as first aid or cardiopulmonary resuscitation (CPR). |
| 73 | Core | Maintain stock and supplies, preparing supplies for special examinations and ordering supplies when necessary. |
| 87 | Supplemental | Process and code film from procedures and complete appropriate documentation. |
| 61 | Supplemental | Load and unload film cassettes used to record images from procedures. |
...
| Medical software | eClinicalWorks EHR software Hot Technology ; Medical procedure coding software; MEDITECH software Hot Technology ; Patient medical record software |
...
- Society of Radiologists in Ultrasound external site
...
- Gulf Coast Ultrasound Institute external site
- International Society of Ultrasound in Obstetrics and Gynecology external site
- Joint Review Committee on Education in Diagnostic Medical Sonography external site
