...
**Quick Facts:**
- SOC Code: 47-5041.00
- Also called: Bore Miner Operator, Continuous Miner, Continuous Miner Operator (CMO), Continuous Mining Machine Operator, Continuous Mining Operator (CMO), Heavy Equipment Operator, Loader Operator, Mine Technician, Mine Utility Operator, Miner Operator
...
|------------|----------|------|
| 94 | Core | Hang ventilation tubing and ventilation curtains to ensure that the mining face area is kept properly ventilated. |
| 94 | Core | Conduct methane gas checks to ensure breathing quality of air. |
| 93 | Core | Check the stability of roof and rib support systems before mining face areas. |
| 89 | Core | Operate mining machines to gather coal and convey it to floors or shuttle cars. |
| 88 | Core | Drive machines into position at working faces. |
| 87 | Core | Move controls to start and regulate movement of conveyors and to start and position drill cutters or torches. |
| 87 | Core | Reposition machines to make additional holes or cuts. |
| 86 | Core | Determine locations, boundaries, and depths of holes or channels to be cut. |
| 82 | Core | Observe and listen to equipment operation to detect binding or stoppage of tools or other equipment malfunctions. |
| 79 | Core | Repair, oil, and adjust machines, and change cutting teeth, using wrenches. |
| 85 | Supplemental | Install casings to prevent cave-ins. |
| 81 | Supplemental | Scrape or wash conveyors, using belt scrapers or belt washers, to minimize dust production. |
| 80 | Supplemental | Move levers to raise and lower hydraulic safety bars supporting roofs above machines until other workers complete framing. |
| 69 | Supplemental | Apply new technologies developed to minimize the environmental impact of coal mining. |
| 66 | Supplemental | Guide and assist crews laying track and resetting supports and blocking. |
