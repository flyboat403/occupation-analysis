...
**Quick Facts:**
- SOC Code: 17-2112.00
- Also called: Continuous Improvement Engineer, Engineer, Facilities Engineer, Industrial Engineer, Operations Engineer, Plant Engineer, Process Engineer, Project Engineer, Quality Engineer, Research and Development Engineer (R and D Engineer)
...
| 67 | Core | Evaluate precision and accuracy of production and testing equipment and engineering drawings to formulate corrective action plan. |
| 67 | Core | Recommend methods for improving utilization of personnel, material, and utilities. |
| 67 | Core | Record or oversee recording of information to ensure currency of engineering drawings and documentation of production problems. |
| 66 | Core | Draft and design layout of equipment, materials, and workspace to illustrate maximum efficiency using drafting tools and computer. |
| 65 | Core | Direct workers engaged in product measurement, inspection, and testing activities to ensure quality control and reliability. |
| 63 | Core | Develop manufacturing methods, labor utilization standards, and cost analysis systems to promote efficient staff and facility utilization. |
| 62 | Core | Review production schedules, engineering specifications, orders, and related information to obtain knowledge of manufacturing methods, procedures, and activities. |
| 61 | Core | Complete production reports, purchase orders, and material, tool, and equipment lists. |
| 61 | Core | Coordinate and implement quality control objectives, activities, or procedures to resolve production problems, maximize product reliability, or minimize costs. |
| 61 | Core | Implement methods and procedures for disposition of discrepant material and defective or damaged parts, and assess cost and responsibility. |
| 59 | Core | Apply statistical methods and perform mathematical calculations to determine manufacturing processes, staff requirements, and production standards. |
| 57 | Core | Study operations sequence, material flow, functional statements, organization charts, and project information to determine worker functions and responsibilities. |
| 53 | Core | Formulate sampling procedures and designs and develop forms and instructions for recording, evaluating, and reporting quality and reliability data. |
| 55 | Supplemental | Regulate and alter workflow schedules according to established manufacturing sequences and lead times to expedite production operations. |
| 53 | Supplemental | Schedule deliveries based on production forecasts, material substitutions, storage and handling facilities, and maintenance requirements. |

## Technology Skills

| Hot Technology | Examples |
|----------------|----------|
| Analytical or scientific software | Finite element method FEM software; Minitab; The MathWorks MATLAB Hot Technology ; Workcell simulation software ; 33 more |
| Application server software | GitHub Hot Technology |
| Computer aided design CAD software | Autodesk AutoCAD ; Bentley MicroStation Hot Technology ; Dassault Systemes CATIA; Dassault Systemes SolidWorks Hot Technology ; 8 more |
| Computer aided manufacturing CAM software | EGS FeatureCAM |
| Data base user interface and query software | Microsoft Access Hot Technology ; Microsoft SQL Server Hot Technology ; Structured query language SQL |
| Development environment software | Microsoft Visual Basic Hot Technology ; Microsoft Visual Basic for Applications VBA Hot Technology ; Microsoft Visual Studio Hot Technology ; National Instruments LabVIEW ; 2 more |
...
| Object or component oriented development software | C++ Hot Technology ; Python Hot Technology ; R Hot Technology ; Sun Microsystems Java |
| Office suite software | Microsoft Office software |
| Operating system software | Linux Hot Technology ; Shell script Hot Technology ; UNIX Shell Hot Technology |
| Presentation software | Microsoft PowerPoint |
| Process mapping and design software | Microsoft Visio Hot Technology ; ProModel |
| Program testing software | Hewlett Packard LoadRunner; JUnit Hot Technology ; Logic programming software; User interface design software ; 1 more |
| Project management software | Microsoft Project Hot Technology ; Process reengineering software; Yield management systems |
...
| 47 | Building and Construction — Knowledge of materials, methods, and the tools involved in the construction or repair of houses, buildings, or other structures such as highways and roads. |
