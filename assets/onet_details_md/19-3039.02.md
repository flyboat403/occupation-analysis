...
**Quick Facts:**
- SOC Code: 19-3039.02
- Also called: Aviation Neuropsychologist, Board Certified Neuropsychologist, Child and Adolescent Neuropsychologist, Forensic Neuropsychologist, Neuropsychologist, Neuropsychology Medical Consultant, Pediatric Neuropsychologist, Staff Psychologist
...
|------------|----------|------|
| 95 | Core | Conduct neuropsychological evaluations such as assessments of intelligence, academic ability, attention, concentration, sensorimotor function, language, learning, and memory. |
| 94 | Core | Write or prepare detailed clinical neuropsychological reports, using data from psychological or neuropsychological tests, self-report measures, rating scales, direct observations, or interviews. |
| 92 | Core | Interview patients to obtain comprehensive medical histories. |
| 92 | Core | Diagnose and treat conditions involving injury to the central nervous system, such as cerebrovascular accidents, neoplasms, infectious or inflammatory diseases, degenerative diseases, head traumas, demyelinating diseases, and various forms of dementing illnesses. |
| 85 | Core | Establish neurobehavioral baseline measures for monitoring progressive cerebral disease or recovery. |
| 85 | Core | Provide education or counseling to individuals and families. |
| 82 | Core | Diagnose and treat pediatric populations for conditions such as learning disabilities with developmental or organic bases. |
| 82 | Core | Read current literature, talk with colleagues, and participate in professional organizations or conferences to keep abreast of developments in neuropsychology. |
| 80 | Core | Participate in educational programs, in-service training, or workshops to remain current in methods and techniques. |
| 76 | Core | Consult with other professionals about patients' neurological conditions. |
| 74 | Core | Educate and supervise practicum students, psychology interns, or hospital staff. |
| 73 | Core | Design or implement rehabilitation plans for patients with cognitive dysfunction. |
| 63 | Core | Diagnose and treat conditions such as chemical dependency, alcohol dependency, Acquired Immune Deficiency Syndrome (AIDS) dementia, and environmental toxin exposure. |
| 61 | Core | Conduct research on neuropsychological disorders. |
...
|---|---|
| 96 | Processing Information — Compiling, coding, categorizing, calculating, tabulating, auditing, or verifying information or data. |
...
| 89 | Therapy and Counseling — Knowledge of principles, methods, and procedures for diagnosis, treatment, and rehabilitation of physical and mental dysfunctions, and for career counseling and guidance. |
...
| 72 | Medicine and Dentistry — Knowledge of the information and techniques needed to diagnose and treat human injuries, diseases, and deformities. This includes symptoms, treatment alternatives, drug properties and interactions, and preventive health-care measures. |
...
| 63 | Biology — Knowledge of plant and animal organisms, their tissues, cells, functions, interdependencies, and interactions with each other and the environment. |
