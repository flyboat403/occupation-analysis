...
**Quick Facts:**
- SOC Code: 41-3021.00
- Also called: Insurance Agent, Insurance Broker, Insurance Sales Agent, Sales Agent, Sales Associate, Sales Representative, Underwriting Sales Representative
...
|------------|----------|------|
| 86 | Core | Customize insurance programs to suit individual customers, often covering a variety of risks. |
| 84 | Core | Sell various types of insurance policies to businesses and individuals on behalf of insurance companies, including automobile, fire, life, property, medical and dental insurance, or specialized policies, such as marine, farm/crop, and medical malpractice. |
| 81 | Core | Explain features, advantages, and disadvantages of various policies to promote sale of insurance plans. |
| 80 | Core | Perform administrative tasks, such as maintaining records and handling policy renewals. |
| 79 | Core | Seek out new clients and develop clientele by networking to find new customers and generate lists of prospective clients. |
| 78 | Core | Call on policyholders to deliver and explain policy, to analyze insurance program and suggest additions or changes, or to change beneficiaries. |
| 77 | Core | Confer with clients to obtain and provide information when claims are made on a policy. |
| 77 | Core | Interview prospective clients to obtain data about their financial resources and needs, the physical condition of the person or property to be insured, and to discuss any existing coverage. |
| 76 | Core | Contact underwriter and submit forms to obtain binder coverage. |
| 75 | Core | Select company that offers type of coverage requested by client to underwrite policy. |
| 74 | Core | Ensure that policy requirements are fulfilled, including any necessary medical examinations and the completion of appropriate forms. |
| 73 | Core | Develop marketing strategies to compete with other individuals or companies who sell insurance. |
| 71 | Core | Calculate premiums and establish payment method. |
| 64 | Core | Attend meetings, seminars, and programs to learn about new products and services, learn new skills, and receive technical assistance in developing new accounts. |
| 73 | Supplemental | Monitor insurance claims to ensure they are settled equitably for both the client and the insurer. |
| 71 | Supplemental | Plan and oversee incorporation of insurance program into bookkeeping system of company. |
| 67 | Supplemental | Inspect property, examining its general condition, type of construction, age, and other characteristics, to decide if it is a good insurance risk. |
| 59 | Supplemental | Install bookkeeping systems and resolve system problems. |
| 58 | Supplemental | Explain necessary bookkeeping requirements for customer to implement and provide group insurance program. |
...
| Enterprise resource planning ERP software | AMS Services AMS Sagitta; Microsoft Dynamics; United Systems and Software Individual Life and Health Administration System; Vulcan Solutions Vulcan Insurance ; 24 more |
...
| Web page creation and editing software | Facebook Hot Technology ; LinkedIn |
...
| 91 | Sales and Marketing — Knowledge of principles and methods for showing, promoting, and selling products or services. This includes marketing strategy and tactics, product demonstration, sales techniques, and sales control systems. |
...
| Impact | Work Style |
|---|---|
| 91 | Social Orientation — A tendency to seek out, enjoy, and be energized by social interaction at work. |
...
- Million Dollar Round Table external site
