...
**Quick Facts:**
- SOC Code: 35-3023.00
- Also called: Cafe Server, Cafeteria Server, Cafeteria Worker, Counter Worker, Deli Worker (Delicatessen Worker), Dietary Aide, Food Server, Food Service Worker, Server, Snack Bar Attendant
...
|------------|----------|------|
| 85 | Core | Accept payment from customers, and make change as necessary. |
| 85 | Core | Serve customers in eating places that specialize in fast service and inexpensive carry-out food. |
| 84 | Core | Request and record customer orders, and compute bills, using cash registers, multi-counting machines, or pencil and paper. |
| 83 | Core | Balance receipts and payments in cash registers. |
| 83 | Core | Communicate with customers regarding orders, comments, and complaints. |
...
| 79 | Core | Monitor and order supplies or food items, and restock as necessary to maintain inventory. |
| 79 | Core | Perform cleaning duties, such as sweeping, mopping, and washing dishes, to keep equipment and facilities sanitary. |
| 79 | Core | Brew coffee and tea, and fill containers with requested beverages. |
| 78 | Core | Clean and organize eating, service, and kitchen areas. |
| 77 | Core | Prepare daily food items, and cook simple foods and beverages, such as sandwiches, salads, soups, pizza, or coffee, using proper safety precautions and sanitary measures. |
| 76 | Core | Prepare and serve cold drinks, frozen milk drinks, or desserts, using drink-dispensing, milkshake, or frozen-custard machines. |
| 75 | Core | Wrap menu items such as sandwiches, hot entrees, and desserts for serving or for takeout. |
| 72 | Core | Set up dining areas for meals, and clear them following meals. |
| 70 | Core | Collect and return dirty dishes to the kitchen for washing. |
| 70 | Core | Scrub and polish counters, steam tables, and other equipment, and clean glasses, dishes, and fountain equipment. |
| 68 | Core | Deliver orders to kitchens, and pick up and serve food when it is ready. |
| 85 | Supplemental | Perform personnel activities, such as supervising and training employees. |
| 83 | Supplemental | Add relishes and garnishes to food orders, according to instructions. |
| 79 | Supplemental | Distribute food to servers. |
| 79 | Supplemental | Select food items from serving or storage areas and place them in dishes, on serving trays, or in take-out bags. |
| 74 | Supplemental | Notify kitchen personnel of shortages or special orders. |
| 72 | Supplemental | Take customers' orders and write ordered items on tickets, giving ticket stubs to customers when needed to identify filled orders. |
| 71 | Supplemental | Plan, prepare, and deliver meals to individuals with special dietary needs. |
| 70 | Supplemental | Replenish foods at serving stations. |
| 70 | Supplemental | Wash dishes, glassware, and silverware after meals. |
| 64 | Supplemental | Arrange tables and decorations according to instructions. |
...
| 40 | Organizing, Planning, and Prioritizing Work — Developing specific goals and plans to prioritize, organize, and accomplish your work. |
...
| 36 | Identifying Objects, Actions, and Events — Identifying information by categorizing, estimating, recognizing differences or similarities, and detecting changes in circumstances or events. |
...
| 31 | Deductive Reasoning — The ability to apply general rules to specific problems to produce answers that make sense. |
...
| 1 | Cautiousness — A tendency to be careful, deliberate, and risk-avoidant when making work-related decisions or doing work. |
