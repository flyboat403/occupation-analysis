...
**Quick Facts:**
- SOC Code: 27-4011.00
- Also called: Audio Technician, Audio Visual Specialist (AV Specialist), AV Tech (Audio Visual Technician), Media Technician, Operations Technician, Stagehand, Video Technician
...
|------------|----------|------|
| 77 | Core | Notify supervisors when major equipment repairs are needed. |
| 71 | Core | Diagnose and resolve media system problems. |
| 68 | Core | Direct and coordinate activities of assistants and other personnel during production. |
| 68 | Core | Compress, digitize, duplicate, and store audio and video data. |
| 67 | Core | Install, adjust, and operate electronic equipment to record, edit, and transmit radio and television programs, motion pictures, video conferencing, or multimedia presentations. |
| 65 | Core | Control the lights and sound of events, such as live concerts, before and after performances, and during intermissions. |
| 62 | Core | Switch sources of video input from one camera or studio to another, from film to live programming, or from network to local programming. |
| 62 | Core | Record and edit audio material, such as movie soundtracks, using audio recording and editing equipment. |
| 60 | Core | Perform minor repairs and routine cleaning of audio and video equipment. |
| 59 | Core | Design layouts of audio and video equipment and perform upgrades and maintenance. |
| 53 | Core | Conduct training sessions on selection, use, and design of audio-visual materials and on operation of presentation equipment. |
| 66 | Supplemental | Monitor incoming and outgoing pictures and sound feeds to ensure quality and notify directors of any possible problems. |
| 65 | Supplemental | Mix and regulate sound inputs and feeds or coordinate audio feeds with television pictures. |
| 60 | Supplemental | Construct and position properties, sets, lighting equipment, and other equipment. |
| 60 | Supplemental | Reserve audio-visual equipment and facilities, such as meeting rooms. |
| 59 | Supplemental | Determine formats, approaches, content, levels, and mediums to effectively meet objectives within budgetary constraints, using research, knowledge, and training. |
| 58 | Supplemental | Edit videotapes by erasing and removing portions of programs and adding video or sound as required. |
| 57 | Supplemental | Obtain, set up, and load videotapes for scheduled productions or broadcasts. |
| 57 | Supplemental | Produce rough and finished graphics and graphic designs. |
| 56 | Supplemental | Locate and secure settings, properties, effects, and other production necessities. |
| 55 | Supplemental | Meet with directors and senior members of camera crews to discuss assignments and determine filming sequences, camera movements, and picture composition. |
| 53 | Supplemental | Maintain inventories of audio and videotapes and related supplies. |
| 53 | Supplemental | Obtain and preview musical performance programs prior to events to become familiar with the order and approximate times of pieces. |
| 51 | Supplemental | Perform narration of productions or present announcements. |
| 51 | Supplemental | Plan and develop pre-production ideas into outlines, scripts, story boards, and graphics, using own ideas or specifications of assignments. |
| 49 | Supplemental | Organize and maintain compliance, license, and warranty information related to audio and video facilities. |
| 49 | Supplemental | Inform users of audio and videotaping service policies and procedures. |
| 49 | Supplemental | Analyze and maintain data logs for audio-visual activities. |
| 48 | Supplemental | Develop manuals, texts, workbooks, or related materials for use in conjunction with production materials or for training. |
...
| Operating system software | Cisco IOS; Linux Hot Technology ; Microsoft Windows Hot Technology |
| Presentation software | Microsoft PowerPoint Hot Technology |
| Project management software | Microsoft Teams |
| Spreadsheet software | Microsoft Excel Hot Technology |
| Video conferencing software | Cisco Webex Hot Technology ; Zoom |
| Video creation and editing software | Adobe After Effects Hot Technology ; Apple Final Cut Pro; Corel Ulead DVD Workshop; YouTube ; 1 more |
...
- Notify others of equipment problems. Related occupations
...
- Monitor broadcasting operations to ensure proper functioning. Related occupations
- Operate control consoles for sound, lighting or video. Related occupations
- Mix sound inputs. Related occupations
...
- Maintain logs of production activities. Related occupations
...
| 68 | Telecommunications — Knowledge of transmission, broadcasting, switching, control, and operation of telecommunications systems. |
| 65 | Fine Arts — Knowledge of the theory and techniques required to compose, produce, and perform works of music, dance, visual arts, drama, and sculpture. |
