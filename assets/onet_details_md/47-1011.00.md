...
**Quick Facts:**
- SOC Code: 47-1011.00
- Also called: Coal Mine Production Foreman, Construction Foreman, Construction Supervisor, Electrical Supervisor, Field Operations Supervisor, Field Supervisor, Insulation Foreman, Roustabout Field Supervisor, Sheet Metal Foreman, Site Superintendent
...
|------------|----------|------|
| 87 | Core | Inspect work progress, equipment, or construction sites to verify safety or to ensure that specifications are met. |
| 84 | Core | Read specifications, such as blueprints, to determine construction requirements or to plan procedures. |
| 84 | Core | Supervise, coordinate, or schedule the activities of construction or extractive workers. |
| 81 | Core | Assign work to employees, based on material or worker requirements of specific jobs. |
| 79 | Core | Coordinate work activities with other construction project activities. |
| 79 | Core | Estimate material or worker requirements to complete jobs. |
| 78 | Core | Analyze worker or production problems and recommend solutions, such as improving production methods or implementing motivational plans. |
| 76 | Core | Order or requisition materials or supplies. |
| 75 | Core | Train workers in construction methods, operation of equipment, safety procedures, or company policies. |
| 73 | Core | Locate, measure, and mark site locations or placement of structures or equipment, using measuring and marking equipment. |
| 73 | Core | Confer with managerial or technical personnel, other departments, or contractors to resolve problems or to coordinate activities. |
| 71 | Core | Arrange for repairs of equipment or machinery. |
| 69 | Core | Provide assistance to workers engaged in construction or extraction activities, using hand tools or other equipment. |
| 66 | Core | Record information, such as personnel, production, or operational data on specified forms or reports. |
| 61 | Core | Suggest or initiate personnel actions, such as promotions, transfers, or hires. |

## Technology Skills

| Hot Technology | Examples |
|----------------|----------|
| Analytical or scientific software | Procore software Hot Technology |
...
| Project management software | Microsoft Project Hot Technology ; Oracle Primavera Enterprise Project Portfolio Management Hot Technology ; Oracle Primavera P6 Enterprise Portfolio Project Management; Oracle Primavera Systems ; 1 more |
