...
**Quick Facts:**
- SOC Code: 53-7071.00
- Also called: Compressor Operator, Compressor Station Operator, Compressor Technician, Fill Plant Operator, Filler, Liquefied Natural Gas Plant Operator (LNG Plant Operator), Pipeline Technician, Plant Operator, Terminal Operator
...
|------------|----------|------|
| 85 | Core | Monitor meters and pressure gauges to determine consumption rate variations, temperatures, and pressures. |
| 82 | Core | Respond to problems by adjusting control room equipment or instructing other personnel to adjust equipment at problem locations or in other control areas. |
| 82 | Core | Record instrument readings and operational changes in operating logs. |
| 82 | Core | Adjust valves and equipment to obtain specified performance. |
| 81 | Core | Move controls and turn valves to start compressor engines, pumps, and auxiliary equipment. |
| 78 | Core | Operate power-driven pumps that transfer liquids, semi-liquids, gases, or powdered materials. |
| 76 | Core | Submit daily reports on facility operations. |
| 75 | Core | Take samples of gases and conduct chemical tests to determine gas quality and sulfur or moisture content, or send samples to laboratories for analysis. |
| 74 | Core | Read gas meters, and maintain records of the amounts of gas received and dispensed from holders. |
| 70 | Core | Turn knobs or switches to regulate pressures. |
| 69 | Core | Clean, lubricate, and adjust equipment, and replace filters and gaskets, using hand tools. |
| 64 | Core | Maintain each station by performing general housekeeping duties such as painting, washing, and cleaning. |
| 55 | Core | Connect pipelines between pumps and containers that are being filled or emptied. |
...
|---|---|
| 90 | Production and Processing — Knowledge of raw materials, production processes, quality control, costs, and other techniques for maximizing the effective manufacture and distribution of goods. |
