...
**Quick Facts:**
- SOC Code: 43-6012.00
- Also called: Confidential Secretary, Legal Administrative Assistant (Legal Admin Assistant), Legal Administrator (Legal Admin), Legal Coordinator, Legal Management Assistant, Legal Office Support Assistant, Legal Practice Assistant, Legal Secretary, Litigation Secretary, Magistrate Assistant
...
|------------|----------|------|
| 84 | Core | Organize and maintain law libraries, documents, and case files. |
| 83 | Core | Mail, fax, or arrange for delivery of legal correspondence to clients, witnesses, and court officials. |
| 83 | Core | Prepare and distribute invoices to bill clients or pay account expenses. |
| 82 | Core | Prepare, proofread, or process legal documents, such as summonses, subpoenas, complaints, appeals, motions, or pretrial agreements. |
| 81 | Core | Make photocopies of correspondence, documents, and other printed matter. |
| 78 | Core | Assist attorneys in collecting information such as employment, medical, and other records. |
| 78 | Core | Complete various forms, such as accident reports, trial and courtroom requests, and applications for clients. |
| 78 | Core | Receive and place telephone calls. |
| 75 | Core | Schedule and make appointments. |
| 60 | Core | Draft and type office memos. |
| 71 | Supplemental | Submit articles and information from searches to attorneys for review and approval for use. |
| 70 | Supplemental | Make travel arrangements for attorneys. |
| 60 | Supplemental | Attend legal meetings, such as client interviews, hearings, or depositions, and take notes. |
| 58 | Supplemental | Review legal publications and perform database searches to identify laws and court decisions relevant to pending cases. |

## Technology Skills

| Hot Technology | Examples |
|----------------|----------|
| Accounting software | Intuit QuickBooks Hot Technology ; Quicken; Sage 50 Accounting; Vertican Technologies Collection Master ; 2 more |
| Analytical or scientific software | Litigation management software |
| Billing and invoicing software | Billing software; Thomson Reuters Elite Billing Manager |
...
| Data base user interface and query software | Database software; Electronic adjudication management systems EAM; LexisNexis Time Matters; Microsoft Access Hot Technology ; 1 more |
| Desktop publishing software |  |
| Document management software | AbacusNext HotDocs; Adobe Acrobat Hot Technology ; Filing system software; Microsoft SharePoint Server |
...
|---|---|
| 87 | Performing Administrative Activities — Performing day-to-day administrative tasks such as maintaining information files and processing paperwork. |
...
|------------------------|----------|
| 95 | Conventional — Work involves following procedures and regulations to organize information or data, typically in a business setting. Conventional occupations are often associated with office work, accounting, mathematics/statistics, information technology, finance, or human resources. Related occupations |
