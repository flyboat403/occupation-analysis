...
|------------|----------|------|
| 96 | Core | Train clients to use hearing aids or other augmentative communication devices. |
| 95 | Core | Counsel patients and families on communication strategies and the effects of hearing loss. |
| 94 | Core | Select and administer tests to evaluate hearing or related disabilities. |
| 93 | Core | Administer basic hearing tests including air conduction, bone conduction, or speech audiometry tests. |
| 91 | Core | Maintain or repair hearing aids or other communication devices. |
| 91 | Core | Perform basic screening procedures, such as pure tone screening, otoacoustic screening, immittance screening, and screening of ear canal status using otoscope. |
| 86 | Core | Create or modify impressions for earmolds and hearing aid shells. |
| 75 | Core | Read current literature, talk with colleagues, and participate in professional organizations or conferences to keep abreast of developments in audiology. |
| 67 | Core | Demonstrate assistive listening devices (ALDs) to clients. |
| 84 | Supplemental | Assist audiologists in performing aural procedures, such as real ear measurements, speech audiometry, auditory brainstem responses, electronystagmography, and cochlear implant mapping. |
| 82 | Supplemental | Diagnose and treat hearing or related disabilities under the direction of an audiologist. |
...
| 80 | Therapy and Counseling — Knowledge of principles, methods, and procedures for diagnosis, treatment, and rehabilitation of physical and mental dysfunctions, and for career counseling and guidance. |
...
| 64 | Economics and Accounting — Knowledge of economic and accounting principles and practices, the financial markets, banking, and the analysis and reporting of financial data. |
...
- National Board for Certification in Hearing Instrument Sciences external site
