...
|------------|----------|------|
| 96 | Core | Greet, register, and assign rooms to guests of hotels or motels. |
| 95 | Core | Contact housekeeping or maintenance staff when guests report problems. |
| 94 | Core | Issue room keys and escort instructions to bellhops. |
| 93 | Core | Make and confirm reservations. |
| 93 | Core | Verify customers' credit, and establish how the customer will pay for the accommodation. |
| 92 | Core | Keep records of room availability and guests' accounts, manually or using computers. |
| 92 | Core | Post charges, such as those for rooms, food, liquor, or telephone calls, to ledgers, manually or by using computers. |
| 90 | Core | Review accounts and charges with guests during the check out process. |
| 90 | Core | Record guest comments or complaints, referring customers to managers as necessary. |
| 88 | Core | Compute bills, collect payments, and make change for guests. |
| 88 | Core | Transmit and receive messages, using telephones or telephone switchboards. |
| 87 | Core | Answer inquiries pertaining to hotel services, guest registration, and travel directions, or make recommendations regarding shopping, dining, or entertainment. |
| 85 | Core | Advise housekeeping staff when rooms have been vacated and are ready for cleaning. |
| 85 | Core | Perform bookkeeping activities, such as balancing accounts and conducting nightly audits. |
| 77 | Core | Clean and maintain lobby and common areas, such as restocking supplies and watering plants. |
| 76 | Core | Prepare for basic food service, such as setting up continental breakfast or coffee and tea supplies. |
| 74 | Core | Date-stamp, sort, and rack incoming mail and messages. |
| 72 | Core | Arrange tours, taxis, or restaurant reservations for customers. |
| 71 | Core | Deposit guests' valuables in hotel safes or safe-deposit boxes. |
| 84 | Supplemental | Plan, schedule or supervise the work of other employees. |

## Technology Skills

| Hot Technology | Examples |
|----------------|----------|
| Data base user interface and query software | Incident tracking software; Property management system PMS software In Demand ; Yardi software Hot Technology |
