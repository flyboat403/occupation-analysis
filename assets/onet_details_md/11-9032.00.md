...
**Quick Facts:**
- SOC Code: 11-9032.00
- Also called: Athletic Director, Curriculum and Instruction Superintendent, Elementary Principal, High School Principal (HS Principal), Middle School Principal (MS Principal), Principal, School Administrator (School Admin), SPED Director (Special Education Director), Superintendent, Vice Principal
...
|------------|----------|------|
| 87 | Core | Counsel and provide guidance to students regarding personal, academic, vocational, or behavioral issues. |
| 86 | Core | Confer with parents and staff to discuss educational activities, policies, and student behavior or learning problems. |
| 86 | Core | Determine the scope of educational program offerings, and prepare drafts of course schedules and descriptions to estimate staffing and facility requirements. |
| 85 | Core | Observe teaching methods and examine learning materials to evaluate and standardize curricula and teaching techniques and to determine areas for improvement. |
| 83 | Core | Collaborate with teachers to develop and maintain curriculum standards, develop mission statements, and set performance goals and objectives. |
| 83 | Core | Enforce discipline and attendance rules. |
| 81 | Core | Recruit, hire, train, and evaluate primary and supplemental staff. |
| 79 | Core | Plan and lead professional development activities for teachers, administrators, and support staff. |
| 79 | Core | Direct and coordinate activities of teachers, administrators, and support staff at schools, public agencies, and institutions. |
| 79 | Core | Set educational standards and goals, and help establish policies and procedures to carry them out. |
| 77 | Core | Evaluate curricula, teaching methods, and programs to determine their effectiveness, efficiency, and use, and to ensure compliance with federal, state, and local regulations. |
| 75 | Core | Create school improvement plans, using student performance data. |
| 74 | Core | Determine allocations of funds for staff, supplies, materials, and equipment, and authorize purchases. |
| 74 | Core | Prepare and submit budget requests and recommendations, or grant proposals to solicit program funding. |
| 73 | Core | Plan and develop instructional methods and content for educational, vocational, or student activity programs. |
| 70 | Core | Participate in special education-related activities, such as attending meetings and providing support to special educators throughout the district. |
| 69 | Core | Recommend personnel actions related to programs and services. |
| 66 | Core | Prepare, maintain, or oversee the preparation and maintenance of attendance, activity, planning, or personnel reports and records. |
| 63 | Core | Teach classes or courses to students. |
| 61 | Core | Review and approve new programs, or recommend modifications to existing programs, submitting program proposals for school board approval as necessary. |
| 61 | Core | Meet with federal, state, and local agencies to stay abreast of policies and to discuss improvements for education programs. |
| 58 | Core | Write articles, manuals, and other publications, and assist in the distribution of promotional literature about facilities and programs. |
| 58 | Core | Coordinate and direct extracurricular activities and programs, such as after-school events and athletic contests. |
| 57 | Core | Organize and direct committees of specialists, volunteers, and staff to provide technical and advisory assistance for programs. |
| 73 | Supplemental | Establish, coordinate, and oversee particular programs across school districts, such as programs to evaluate student academic achievement. |
| 72 | Supplemental | Mentor and support administrative staff members, such as superintendents and principals. |
| 71 | Supplemental | Collect and analyze survey data, regulatory information, and data on demographic and employment trends to forecast enrollment patterns and curriculum change needs. |
| 70 | Supplemental | Advocate for new schools to be built, or for existing facilities to be repaired or remodeled. |
| 65 | Supplemental | Plan, coordinate, and oversee school logistics programs, such as bus and food services. |
| 65 | Supplemental | Review and interpret government codes, and develop programs to ensure adherence to codes and facility safety, security, and maintenance. |
| 64 | Supplemental | Develop partnerships with businesses, communities, and other organizations to help meet identified educational needs and to provide school-to-work programs. |
| 62 | Supplemental | Direct and coordinate school maintenance services and the use of school facilities. |

## Technology Skills

| Hot Technology | Examples |
|----------------|----------|
| Analytical or scientific software | Desmos; Geogebra; IBM SPSS Statistics Hot Technology ; The MathWorks MATLAB Hot Technology ; 3 more |
...
| Data base user interface and query software | Blackboard software; Microsoft Access Hot Technology ; School Attendance Keeper; Student information systems SIS software In Demand ; 3 more |
| Desktop communications software | Bloomz; ParentSquare |
| Desktop publishing software | Microsoft Publisher |
| Document management software | Microsoft SharePoint Hot Technology |
| Electronic mail software | Google Gmail; Microsoft Outlook Hot Technology |
...
| 90 | Coaching and Developing Others — Identifying the developmental needs of others and coaching, mentoring, or otherwise helping others to improve their knowledge or skills. |
...
| 77 | Staffing Organizational Units — Recruiting, interviewing, selecting, hiring, and promoting employees in an organization. |
...
| Importance | Skill |
|---|---|
| 97 | Speaking — Talking to others to convey information effectively. |
...
| 91 | Judgment and Decision Making — Considering the relative costs and benefits of potential actions to choose the most appropriate one. |
| 91 | Learning Strategies — Selecting and using training/instructional methods and procedures appropriate for the situation when learning or teaching new things. |
...
|---|---|
| 90 | Education and Training — Knowledge of principles and methods for curriculum and training design, teaching and instruction for individuals and groups, and the measurement of training effects. |
...
| 94 | Oral Comprehension — The ability to listen to and understand information and ideas presented through spoken words and sentences. |
...
- ACSD external site
- American Council on Education external site
...
- National Association of Elementary School Principals external site
- National Association of Secondary School Principals external site
- National Catholic Educational Association external site
- Phi Delta Kappa International external site
