...
**Quick Facts:**
- SOC Code: 43-9071.00
- Also called: Copy Center Operator, Copy Machine Operator, Copy Technician, Graphics Production Specialist, Key Operator, Machine Operator, Printing Services Coordinator, Reprographics Technician
...
|------------|----------|------|
| 87 | Core | Read job orders to determine the type of work to be done, the quantities to be produced, and the materials needed. |
| 84 | Core | Deliver completed work. |
| 84 | Core | Place original copies in feed trays, feed originals into feed rolls, or position originals on tables beneath camera lenses. |
| 82 | Core | Sort, assemble, and proof completed work. |
| 82 | Core | Operate office machines such as high speed business photocopiers, readers, scanners, addressing machines, stencil-cutting machines, microfilm readers or printers, folding and inserting machines, bursters, and binder machines. |
| 80 | Core | Complete records of production, including work volumes and outputs, materials used, and any backlogs. |
| 80 | Core | Compute prices for services and receive payment, or provide supervisors with billing information. |
| 79 | Core | Set up and adjust machines, regulating factors such as speed, ink flow, focus, and number of copies. |
| 78 | Core | Load machines with materials such as blank paper or film. |
| 78 | Core | Monitor machine operation, and make adjustments as necessary to ensure proper operation. |
| 74 | Core | Clean machines, perform minor repairs, and report major repair needs. |
| 73 | Core | File and store completed documents. |
| 72 | Core | Operate auxiliary machines such as collators, pad and tablet making machines, staplers, and paper punching, folding, cutting, and perforating machines. |
| 72 | Core | Maintain stock of supplies, and requisition any needed items. |
| 71 | Core | Prepare and process papers for use in scanning, microfilming, and microfiche. |
| 68 | Core | Clean and file master copies or plates. |
| 63 | Supplemental | Cut copies apart and write identifying information, such as page numbers or titles, on copies. |
| 41 | Supplemental | Move heat units and clamping frames over screen beds to form Braille impressions on pages, raising frames to release individual copies. |
...
| Not available | Chemistry — Knowledge of the chemical composition, structure, and properties of substances and of the chemical processes and transformations that they undergo. This includes uses of chemicals and their interactions, danger signs, production techniques, and disposal methods. |
