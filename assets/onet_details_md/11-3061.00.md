...
**Quick Facts:**
- SOC Code: 11-3061.00
- Also called: Category Purchasing Manager, Commodity Manager, Materials Director, Materials Manager, Procurement Director, Procurement Manager, Purchasing Director, Purchasing Manager, Purchasing Supervisor, Strategic Sourcing Director
...
|------------|----------|------|
| 89 | Core | Develop and implement purchasing and contract management instructions, policies, and procedures. |
| 88 | Core | Locate vendors of materials, equipment or supplies, and interview them to determine product availability and terms of sales. |
| 81 | Core | Prepare bid awards requiring board approval. |
| 80 | Core | Direct and coordinate activities of personnel engaged in buying, selling, and distributing materials, equipment, machinery, and supplies. |
| 80 | Core | Review purchase order claims and contracts for conformance to company policy. |
| 80 | Core | Review, evaluate, and approve specifications for issuing and awarding bids. |
| 78 | Core | Administer online purchasing systems. |
| 78 | Core | Prepare and process requisitions and purchase orders for supplies and equipment. |
| 78 | Core | Interview and hire staff, and oversee staff training. |
| 78 | Core | Develop cost reduction strategies and savings plans. |
| 78 | Core | Control purchasing department budgets. |
| 77 | Core | Resolve vendor or contractor grievances and claims against suppliers. |
| 76 | Core | Analyze market and delivery systems to assess present and future material availability. |
| 75 | Core | Participate in the development of specifications for equipment, products, or substitute materials. |
| 75 | Core | Maintain records of goods ordered and received. |
| 75 | Core | Represent companies in negotiating contracts and formulating policies with suppliers. |
| 56 | Core | Prepare reports regarding market conditions and merchandise costs. |
| 53 | Core | Arrange for disposal of surplus materials. |
...
| Data base user interface and query software | Corel Paradox; Database software; Microsoft Access Hot Technology ; Oracle Database Hot Technology |
| Document management software | Microsoft SharePoint Hot Technology |
| Electronic mail software | IBM Lotus Notes; Microsoft Outlook |
| Enterprise resource planning ERP software | Bowen &amp; Groves M1 ERP; Microsoft Dynamics; Oracle PeopleSoft Hot Technology ; SAP software ; 4 more |
...
| Procurement software | Automated purchase order software; Purchasing software In Demand ; PurchasingNet eProcurement; SAP Ariba ; 1 more |
| Project management software | Microsoft Project Hot Technology ; Oracle Primavera P6 Enterprise Portfolio Project Management |
