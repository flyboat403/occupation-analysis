...
|------------|----------|------|
| 91 | Core | Determine the quantity and orientation of cargo, and compute an aircraft's center of gravity. |
| 89 | Core | Direct ground crews in the loading, unloading, securing, or staging of aircraft cargo or baggage. |
| 88 | Core | Train new employees in areas such as safety procedures or equipment operation. |
| 84 | Core | Distribute cargo to maximize use of space. |
| 96 | Supplemental | Calculate load weights for different aircraft compartments, using charts and computers. |
| 79 | Supplemental | Accompany aircraft as a member of the flight crew to monitor and handle cargo in flight. |
...
| 85 | Public Safety and Security — Knowledge of relevant equipment, policies, procedures, and strategies to promote effective local, state, or national security operations for the protection of people, data, property, and institutions. |
| 83 | Transportation — Knowledge of principles and methods for moving people or goods by air, rail, sea, or road, including the relative costs and benefits. |
