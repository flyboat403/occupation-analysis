...
**Quick Facts:**
- SOC Code: 53-7121.00
- Also called: Load Out Person, Loader, Loader Operator, Loading Operator, Oil Movements Operator, PVC Loader (Polyvinyl Chloride Loader), Rail Car Loader, Tank Car Loader, Tankerman, Truck Loader
...
|------------|----------|------|
| 93 | Core | Seal outlet valves on tank cars, barges, and trucks. |
| 90 | Core | Verify tank car, barge, or truck load numbers to ensure car placement accuracy based on written or verbal instructions. |
| 87 | Core | Start pumps and adjust valves or cables to regulate the flow of products to vessels, using knowledge of loading procedures. |
| 87 | Core | Check conditions and weights of vessels to ensure cleanliness and compliance with loading procedures. |
| 87 | Core | Observe positions of cars passing loading spouts, and swing spouts into the correct positions at the appropriate times. |
| 86 | Core | Monitor product movement to and from storage tanks, coordinating activities with other workers to ensure constant product flow. |
| 84 | Core | Operate ship loading and unloading equipment, conveyors, hoists, and other specialized material handling equipment such as railroad tank car unloading equipment. |
| 82 | Core | Record operating data such as products and quantities pumped, gauge readings, and operating times, manually or using computers. |
| 81 | Core | Operate industrial trucks, tractors, loaders, and other equipment to transport materials to and from transportation vehicles and loading docks, and to store and retrieve materials in warehouses. |
| 90 | Supplemental | Connect ground cables to carry off static electricity when unloading tanker cars. |
| 86 | Supplemental | Copy and attach load specifications to loaded tanks. |
| 85 | Supplemental | Remove and replace tank car dome caps, or direct other workers in their removal and replacement. |
| 83 | Supplemental | Test samples for specific gravity, using hydrometers, or send samples to laboratories for testing. |
| 82 | Supplemental | Test vessels for leaks, damage, and defects, and repair or replace defective parts as necessary. |
| 77 | Supplemental | Unload cars containing liquids by connecting hoses to outlet plugs and pumping compressed air into cars to force liquids into storage tanks. |
| 76 | Supplemental | Clean interiors of tank cars or tank trucks, using mechanical spray nozzles. |
| 72 | Supplemental | Lower gauge rods into tanks or read meters to verify contents, temperatures, and volumes of liquid loads. |
| 72 | Supplemental | Operate conveyors and equipment to transfer grain or other materials from transportation vehicles. |
| 63 | Supplemental | Perform general warehouse activities, such as opening containers and crates, filling warehouse orders, assisting in taking inventory, and weighing and checking materials. |
...
|---|---|
| 91 | Monitoring Processes, Materials, or Surroundings — Monitoring and reviewing information from materials, events, or the environment, to detect or assess problems. |
