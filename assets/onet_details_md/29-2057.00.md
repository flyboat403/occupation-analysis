...
|------------|----------|------|
| 99 | Core | Take and document patients' medical histories. |
| 98 | Core | Conduct tonometry or tonography tests to measure intraocular pressure. |
| 98 | Core | Operate ophthalmic equipment, such as autorefractors, phoropters, tomographs, or retinoscopes. |
| 98 | Core | Take anatomical or functional ocular measurements of the eye or surrounding tissue, such as axial length measurements. |
| 98 | Core | Measure visual acuity, including near, distance, pinhole, or dynamic visual acuity, using appropriate tests. |
| 97 | Core | Measure and record lens power, using lensometers. |
| 94 | Core | Administer topical ophthalmic or oral medications. |
| 93 | Core | Conduct visual field tests to measure field of vision. |
| 93 | Core | Assist physicians in performing ophthalmic procedures, including surgery. |
| 91 | Core | Measure corneal curvature with keratometers or ophthalmometers to aid in the diagnosis of conditions, such as astigmatism. |
| 91 | Core | Conduct ocular motility tests to measure function of eye muscles. |
| 89 | Core | Clean or sterilize ophthalmic or surgical instruments. |
| 88 | Core | Maintain ophthalmic instruments or equipment. |
| 83 | Core | Instruct patients in the care and use of contact lenses. |
| 78 | Core | Assess refractive conditions of eyes, using retinoscopes. |
| 75 | Core | Call patients to inquire about their post-operative status or recovery. |
| 72 | Core | Assist patients to insert or remove contact lenses. |
| 64 | Core | Conduct binocular disparity tests to assess depth perception. |
| 43 | Supplemental | Adjust or make minor repairs to spectacles or eyeglasses. |
| 43 | Supplemental | Assist patients to select eyewear. |
...
| 80 | Medicine and Dentistry — Knowledge of the information and techniques needed to diagnose and treat human injuries, diseases, and deformities. This includes symptoms, treatment alternatives, drug properties and interactions, and preventive health-care measures. |
...
- Ophthalmic Photographers' Society external site
