...
**Quick Facts:**
- SOC Code: 31-1122.00
- Also called: Care Provider, Caregiver, Direct Care Worker, Home Care Aide, Medication Aide, Personal Care Aide, Personal Care Assistant (PCA), Personal Care Attendant (PCA), Resident Assistant, Resident Care Assistant (RCA)
...
|------------|----------|------|
| 91 | Core | Prepare and maintain records of client progress and services performed, reporting changes in client condition to manager or supervisor. |
| 91 | Core | Administer bedside or personal care, such as ambulation or personal hygiene assistance. |
| 87 | Core | Perform healthcare-related tasks, such as monitoring vital signs and medication, under the direction of registered nurses or physiotherapists. |
| 86 | Core | Participate in case reviews, consulting with the team caring for the client, to evaluate the client's needs and plan for continuing services. |
| 86 | Core | Instruct or advise clients on issues, such as household cleanliness, utilities, hygiene, nutrition, or infant care. |
| 85 | Core | Care for individuals or families during periods of incapacitation, family disruption, or convalescence, providing companionship, personal care, or help in adjusting to new lifestyles. |
| 80 | Core | Perform housekeeping duties, such as cooking, cleaning, washing clothes or dishes, or running errands. |
| 80 | Core | Provide clients with communication assistance, typing their correspondence or obtaining information for them. |
| 89 | Supplemental | Train family members to provide bedside care. |
| 76 | Supplemental | Plan, shop for, or prepare nutritious meals or assist families in planning, shopping for, or preparing nutritious meals. |
| 68 | Supplemental | Transport clients to locations outside the home, such as to physicians' offices or on outings, using a motor vehicle. |
