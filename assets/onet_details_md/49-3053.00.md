...
**Quick Facts:**
- SOC Code: 49-3053.00
- Also called: Chainsaw Technician, Golf Cart Mechanic, Lawnmower Repair Mechanic, Mechanic, Outdoor Power Equipment Service Technician, Service Technician (Service Tech), Shop Mechanic, Small Engine Mechanic, Small Engine Technician (Small Engine Tech)
...
|------------|----------|------|
| 91 | Core | Record repairs made, time spent, and parts used. |
| 89 | Core | Test and inspect engines to determine malfunctions, to locate missing and broken parts, and to verify repairs, using diagnostic instruments. |
| 87 | Core | Dismantle engines, using hand tools, and examine parts for defects. |
| 87 | Core | Repair and maintain gasoline engines used to power equipment such as portable saws, lawn mowers, generators, and compressors. |
| 87 | Core | Adjust points, valves, carburetors, distributors, and spark plug gaps, using feeler gauges. |
| 86 | Core | Repair or replace defective parts such as magnetos, water pumps, gears, pistons, and carburetors, using hand tools. |
| 84 | Core | Perform routine maintenance such as cleaning and oiling parts, honing cylinders, and tuning ignition systems. |
| 83 | Core | Reassemble engines after repair or maintenance work is complete. |
| 82 | Core | Replace motors. |
| 81 | Core | Obtain problem descriptions from customers, and prepare cost estimates for repairs. |
| 81 | Core | Show customers how to maintain equipment. |
| 79 | Core | Remove engines from equipment, and position and bolt engines to repair stands. |
| 76 | Core | Sell parts and equipment. |
| 74 | Core | Grind, ream, rebore, and re-tap parts to obtain specified clearances, using grinders, lathes, taps, reamers, boring machines, and micrometers. |
...
- Outdoor Power Equipment Aftermarket Association external site
- Outdoor Power Equipment Institute external site
