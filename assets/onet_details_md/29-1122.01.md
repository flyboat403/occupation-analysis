...
**Quick Facts:**
- SOC Code: 29-1122.01
- Also called: Certified Low Vision Therapist (CLVT), Certified Orientation and Mobility Specialist (COMS), Mobility Specialist, Orientation and Mobility Instructor (O and M Instructor), Orientation and Mobility Specialist (O and M Specialist), Rehabilitation Teacher, Rehabilitation Therapist, Students with Visual Impairments Teacher (TVI), Vision Rehabilitation Therapist (VRT), Visually Impaired Teacher (TVI)
...
|------------|----------|------|
| 93 | Core | Teach cane skills, including cane use with a guide, diagonal techniques, and two-point touches. |
| 92 | Core | Recommend appropriate mobility devices or systems, such as human guides, dog guides, long canes, electronic travel aids (ETAs), and other adaptive mobility devices (AMDs). |
| 89 | Core | Train clients with visual impairments to use mobility devices or systems, such as human guides, dog guides, electronic travel aids (ETAs), and other adaptive mobility devices (AMDs). |
| 86 | Core | Develop rehabilitation or instructional plans collaboratively with clients, based on results of assessments, needs, and goals. |
| 86 | Core | Write reports or complete forms to document assessments, training, progress, or follow-up outcomes. |
| 86 | Core | Train clients to use tactile, auditory, kinesthetic, olfactory, and proprioceptive information. |
| 83 | Core | Assess clients' functioning in areas such as vision, orientation and mobility skills, social and emotional issues, cognition, physical abilities, and personal goals. |
| 82 | Core | Teach clients to travel independently, using a variety of actual or simulated travel situations or exercises. |
| 81 | Core | Teach self-advocacy skills to clients. |
| 81 | Core | Provide consultation, support, or education to groups such as parents and teachers. |
| 80 | Core | Teach independent living skills or techniques, such as adaptive eating, medication management, diabetes management, and personal management. |
| 79 | Core | Monitor clients' progress to determine whether changes in rehabilitation plans are needed. |
| 78 | Core | Identify visual impairments related to basic life skills in areas such as self care, literacy, communication, health management, home management, and meal preparation. |
| 77 | Core | Design instructional programs to improve communication, using devices such as slates and styluses, braillers, keyboards, adaptive handwriting devices, talking book machines, digital books, and optical character readers (OCRs). |
| 75 | Core | Train clients to use adaptive equipment, such as large print, reading stands, lamps, writing implements, software, and electronic devices. |
| 74 | Core | Participate in professional development activities, such as reading literature, continuing education, attending conferences, and collaborating with colleagues. |
| 72 | Core | Obtain, distribute, or maintain low vision devices. |
| 70 | Core | Collaborate with specialists, such as rehabilitation counselors, speech pathologists, and occupational therapists, to provide client solutions. |
| 64 | Core | Refer clients to services, such as eye care, health care, rehabilitation, and counseling, to enhance visual and life functioning or when condition exceeds scope of practice. |
| 70 | Supplemental | Administer tests and interpret test results to develop rehabilitation plans for clients. |
| 68 | Supplemental | Train clients to read or write Braille. |
...
| Data base user interface and query software | Amazon Web Services AWS software Hot Technology ; Microsoft Access Hot Technology ; Oracle Database Hot Technology |
| Development environment software | Ruby Hot Technology |
...
| Enterprise resource planning ERP software | Oracle NetSuite; Oracle PeopleSoft Hot Technology ; SAP software Hot Technology ; Workday software Hot Technology |
