...
**Quick Facts:**
- SOC Code: 47-5071.00
- Also called: Field Service Roustabout, Floor Hand, Oil and Gas Roustabout, Oil Field Roustabout, Production Roustabout, Rig Hand, Roustabout, Roustabout Crew Pusher, Roustabout Hand, Roustabout Pusher
...
|------------|----------|------|
| 72 | Core | Unscrew or tighten pipes, casing, tubing, and pump rods, using hand and power wrenches and tongs. |
| 66 | Core | Dismantle and repair oil field machinery, boilers, and steam engine parts, using hand tools and power tools. |
| 64 | Core | Guide cranes to move loads about decks. |
| 63 | Core | Walk flow lines to locate leaks, using electronic detectors and by making visual inspections, and repair the leaks. |
| 62 | Core | Lay gas and oil pipelines. |
| 59 | Core | Bolt together pump and engine parts. |
| 59 | Core | Move pipes to and from trucks, using truck winches and motorized lifts, or by hand. |
| 57 | Core | Clean trucks used in the fields. |
| 61 | Supplemental | Dig holes, set forms, and mix and pour concrete into forms to make foundations for wood or steel derricks. |
| 57 | Supplemental | Supply equipment to rig floors as requested and provide assistance to roughnecks. |
| 54 | Supplemental | Clean up spilled oil by bailing it into barrels. |
| 50 | Supplemental | Dig drainage ditches around wells and storage tanks. |
| 46 | Supplemental | Cut down and remove trees and brush to clear drill sites, to reduce fire hazards, and to make way for roads to sites. |
...
| Enterprise resource planning ERP software | Maintenance software; SAP software Hot Technology |
...
| Operating system software | Microsoft Windows Hot Technology ; Microsoft Windows XP |
...
| 35 | English Language — Knowledge of the structure and content of the English language including the meaning and spelling of words, and rules of composition and grammar. |
