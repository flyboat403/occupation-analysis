...
**Quick Facts:**
- SOC Code: 41-1012.00
- Also called: Customer Service Department Supervisor, Customer Service Supervisor, Driver Sales Supervisor, Information Center Supervisor, Inside Sales Supervisor, Reservations Supervisor, Sales Department Supervisor, Sales Leader, Sales Supervisor, Sales Team Leader
...
|------------|----------|------|
| 82 | Core | Monitor sales staff performance to ensure that goals are met. |
| 77 | Core | Provide staff with assistance in performing difficult or complicated duties. |
| 74 | Core | Direct and supervise employees engaged in sales, inventory-taking, reconciling cash receipts, or performing specific services. |
| 72 | Core | Listen to and resolve customer complaints regarding services, products, or personnel. |
| 72 | Core | Keep records pertaining to purchases, sales, and requisitions. |
| 72 | Core | Hire, train, and evaluate personnel. |
| 70 | Core | Confer with company officials to develop methods and procedures to increase sales, expand markets, and promote business. |
| 69 | Core | Plan and prepare work schedules, and assign employees to specific duties. |
| 66 | Core | Attend company meetings to exchange product information and coordinate work activities with other departments. |
| 77 | Supplemental | Visit retailers and sales representatives to promote products and gather information. |
| 77 | Supplemental | Formulate pricing policies on merchandise according to profitability requirements. |
| 76 | Supplemental | Prepare sales and inventory reports for management and budget departments. |
| 73 | Supplemental | Examine products purchased for resale or received for storage to determine product condition. |
| 72 | Supplemental | Examine merchandise to ensure correct pricing and display, and that it functions as advertised. |
| 70 | Supplemental | Analyze details of sales territories to assess their growth potential and to set quotas. |
| 70 | Supplemental | Inventory stock and reorder when inventories drop to specified levels. |
| 69 | Supplemental | Coordinate sales promotion activities, such as preparing merchandise displays and advertising copy. |
| 57 | Supplemental | Prepare rental or lease agreements, specifying charges and payment procedures for use of machinery, tools, or other items. |
...
| Data base user interface and query software | Microsoft Access Hot Technology ; QuickBase business management software |
| Electronic mail software | Microsoft Outlook |
| Enterprise application integration software | Electronic data interchange EDI software |
| Enterprise resource planning ERP software | Microsoft Dynamics; NetSuite ERP; SAP software Hot Technology |
...
| Video conferencing software | Cisco Webex Hot Technology ; Fuze cloud communications and collaboration software; Online meeting software |
...
- Establish operational policies. Related occupations
