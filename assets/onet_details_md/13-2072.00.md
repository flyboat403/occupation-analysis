...
**Quick Facts:**
- SOC Code: 13-2072.00
- Also called: Commercial Banker, Commercial Loan Officer, Corporate Banking Officer, Financial Aid Advisor, Financial Aid Counselor, Financial Aid Officer, Financial Counselor, Loan Counselor, Loan Officer, Mortgage Loan Officer
...
|------------|----------|------|
| 90 | Core | Meet with applicants to obtain information for loan applications and to answer questions about the process. |
| 89 | Core | Analyze applicants' financial status, credit, and property evaluations to determine feasibility of granting loans. |
| 85 | Core | Approve loans within specified limits, and refer loan applications outside those limits to management for approval. |
| 83 | Core | Explain to customers the different types of loans and credit options that are available, as well as the terms of those services. |
| 80 | Core | Submit applications to credit analysts for verification and recommendation. |
| 79 | Core | Review loan agreements to ensure that they are complete and accurate according to policy. |
| 78 | Core | Review and update credit and loan files. |
| 78 | Core | Obtain and compile copies of loan applicants' credit histories, corporate financial statements, and other financial information. |
| 74 | Core | Work with clients to identify their financial goals and to find ways of reaching those goals. |
| 74 | Core | Handle customer complaints and take appropriate action to resolve them. |
| 72 | Core | Stay abreast of new types of loans and other financial services and products to better meet customers' needs. |
| 70 | Core | Market bank products to individuals and firms, promoting bank services that may meet customers' needs. |
| 69 | Core | Analyze potential loan markets and develop referral networks to locate prospects for loans. |
| 64 | Core | Compute payment schedules. |
| 73 | Supplemental | Supervise loan personnel. |
| 60 | Supplemental | Prepare reports to send to customers whose accounts are delinquent, and forward irreconcilable accounts for collector action. |
| 52 | Supplemental | Set credit policies, credit lines, procedures and standards in conjunction with senior managers. |
...
| Data base user interface and query software | FileMaker Pro; Microsoft Access Hot Technology ; Student information systems SIS software; Sungard Higher Education PowerFAIDS ; 5 more |
...
| Enterprise resource planning ERP software | Datatel Colleague; Oracle PeopleSoft Hot Technology ; SAP software Hot Technology |
