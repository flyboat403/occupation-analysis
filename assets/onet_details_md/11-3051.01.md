...
**Quick Facts:**
- SOC Code: 11-3051.01
- Also called: Product Quality Director, Quality and Food Safety Manager, Quality and Process Improvement Manager, Quality Assurance Director (QA Director), Quality Assurance Manager (QA Manager), Quality Control Manager (QC Manager), Quality Control Supervisor (QC Supervisor), Quality Director, Quality Manager, Quality Systems Director
...
|------------|----------|------|
| 90 | Core | Stop production if serious product defects are present. |
| 84 | Core | Review and update standard operating procedures or quality assurance manuals. |
| 83 | Core | Monitor performance of quality control systems to ensure effectiveness and efficiency. |
| 81 | Core | Review quality documentation necessary for regulatory submissions and inspections. |
| 81 | Core | Analyze quality control test results and provide feedback and interpretation to production management or staff. |
| 81 | Core | Verify that raw materials, purchased parts or components, in-process samples, and finished products meet established testing and inspection standards. |
| 80 | Core | Oversee workers including supervisors, inspectors, or laboratory workers engaged in testing activities. |
| 79 | Core | Direct product testing activities throughout production cycles. |
| 78 | Core | Instruct staff in quality control and analytical procedures. |
| 78 | Core | Direct the tracking of defects, test results, or other regularly reported quality control data. |
| 77 | Core | Participate in the development of product specifications. |
| 76 | Core | Identify quality problems or areas for improvement and recommend solutions. |
| 76 | Core | Collect and analyze production samples to evaluate quality. |
| 73 | Core | Produce reports regarding nonconformance of products or processes, daily production quality, root cause analyses, or quality trends. |
| 73 | Core | Communicate quality control information to all relevant organizational departments, outside vendors, or contractors. |
| 71 | Core | Monitor development of new products to help identify possible problems for mass production. |
| 71 | Core | Identify critical points in the manufacturing process and specify sampling procedures to be used at these points. |
| 70 | Core | Create and implement inspection and testing criteria or procedures. |
| 70 | Core | Document testing procedures, methodologies, or criteria. |
| 66 | Core | Review statistical studies, technological advances, or regulatory standards and trends to stay abreast of issues in the field of quality control. |
| 65 | Core | Coordinate the selection and implementation of quality control equipment, such as inspection gauges. |
| 64 | Core | Generate and maintain quality control operating budgets. |
| 63 | Core | Instruct vendors or contractors on quality guidelines, testing procedures, or ways to eliminate deficiencies. |
| 57 | Core | Confer with marketing and sales departments to define client requirements and expectations. |
| 57 | Core | Evaluate new testing and sampling methodologies or technologies to determine usefulness. |
| 56 | Core | Review and approve quality plans submitted by contractors. |
| 59 | Supplemental | Audit and inspect subcontractor facilities including external laboratories. |
...
| Data base user interface and query software | Database software; Microsoft Access Hot Technology ; Microsoft SQL Server Hot Technology ; Structured query language SQL Hot Technology ; 1 more |
...
| Program testing software | Hewlett Packard LoadRunner; Selenium Hot Technology |
