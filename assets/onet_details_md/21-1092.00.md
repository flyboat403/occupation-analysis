...
**Quick Facts:**
- SOC Code: 21-1092.00
- Also called: Adult Probation Officer, Correctional Counselor, Deputy Probation Officer (DPO), Juvenile Probation Officer, Parole Agent, Parole Officer (PO), Probation Agent, Probation and Parole Officer, Probation Counselor, Probation Officer
...
|------------|----------|------|
| 87 | Core | Prepare and maintain case folder for each assigned inmate or offender. |
| 85 | Core | Gather information about offenders' backgrounds by talking to offenders, their families and friends, and other people who have relevant information. |
| 85 | Core | Interview probationers and parolees regularly to evaluate their progress in accomplishing goals and maintaining the terms specified in their probation contracts and rehabilitation plans. |
| 85 | Core | Discuss with offenders how such issues as drug and alcohol abuse and anger management problems might have played roles in their criminal behavior. |
| 85 | Core | Supervise people on community-based sentences, such as electronically monitored home detention, and provide field supervision of probationers by conducting curfew checks or visits to home, work, or school. |
| 84 | Core | Investigate alleged parole violations, using interviews, surveillance, and search and seizure. |
| 84 | Core | Recommend remedial action or initiate court action in response to noncompliance with terms of probation or parole. |
| 84 | Core | Arrange for medical, mental health, or substance abuse treatment services according to individual needs or court orders. |
| 84 | Core | Develop liaisons and networks with other parole officers, community agencies, correctional institutions, psychiatric facilities, and aftercare agencies to plan for helping offenders with life adjustments. |
| 83 | Core | Administer drug and alcohol tests, including random drug screens of offenders, to verify compliance with substance abuse treatment programs. |
| 83 | Core | Inform offenders or inmates of requirements of conditional release, such as office visits, restitution payments, or educational and employment stipulations. |
| 81 | Core | Participate in decisions about whether cases should go before courts and which court should hear them. |
| 80 | Core | Write reports describing offenders' progress. |
| 80 | Core | Conduct prehearing and presentencing investigations and testify in court regarding offenders' backgrounds and recommended sentences and sentencing conditions. |
| 78 | Core | Arrange for postrelease services, such as employment, housing, counseling, education, and social activities. |
| 64 | Core | Provide offenders or inmates with assistance in matters concerning detainers, sentences in other jurisdictions, writs, and applications for social assistance. |
| 60 | Core | Develop and prepare packets containing information about social service agencies, assistance organizations, and programs that might be useful for inmates or offenders. |
| 80 | Supplemental | Develop rehabilitation programs for assigned offenders or inmates, establishing rules of conduct, goals, and objectives. |
| 76 | Supplemental | Recommend appropriate penitentiary for initial placement of an offender. |
| 67 | Supplemental | Assess the suitability of penitentiary inmates for release under parole and statutory release programs and submit recommendations to parole boards. |
| 64 | Supplemental | Identify and approve work placements for offenders with community service sentences. |
...
| Data base user interface and query software | Court records databases; Microsoft Access Hot Technology |
...
| 84 | Public Safety and Security — Knowledge of relevant equipment, policies, procedures, and strategies to promote effective local, state, or national security operations for the protection of people, data, property, and institutions. |
