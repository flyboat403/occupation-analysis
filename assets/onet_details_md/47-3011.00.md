...
|------------|----------|------|
| 89 | Core | Mix mortar, plaster, and grout, manually or using machines, according to standard formulas. |
| 83 | Core | Erect scaffolding or other installation structures. |
| 82 | Core | Cut materials to specified sizes for installation, using power saws or tile cutters. |
| 80 | Core | Modify material moving, mixing, grouting, grinding, polishing, or cleaning procedures, according to installation or material requirements. |
| 80 | Core | Transport materials, tools, or machines to installation sites, manually or using conveyance equipment. |
| 80 | Core | Provide assistance in the preparation, installation, repair, or rebuilding of tile, brick, or stone surfaces. |
| 79 | Core | Locate and supply materials to masons for installation, following drawings or numbered sequences. |
| 75 | Core | Arrange or store materials, machines, tools, or equipment. |
| 75 | Core | Clean installation surfaces, equipment, tools, work sites, or storage areas, using water, chemical solutions, oxygen lances, or polishing machines. |
| 72 | Core | Move or position materials such as marble slabs, using cranes, hoists, or dollies. |
| 71 | Core | Remove excess grout or residue from tile or brick joints, using sponges or trowels. |
| 65 | Core | Apply grout between joints of bricks or tiles, using grouting trowels. |
| 64 | Core | Apply caulk, sealants, or other agents to installed surfaces. |
| 64 | Core | Remove damaged tile, brick, or mortar, and clean or prepare surfaces, using pliers, hammers, chisels, drills, wire brushes, or metal wire anchors. |
| 63 | Core | Correct surface imperfections or fill chipped, cracked, or broken bricks or tiles, using fillers, adhesives, or grouting materials. |
...
| Computer aided design CAD software | Autodesk Revit Hot Technology ; Computer aided design and drafting CADD software; EasyCAD Iris 2D; TileGem |
| Data base user interface and query software | Aya Associates Comp-U-Floor; Microsoft Access Hot Technology |
...
- The Masonry Society external site

- Mid-Atlantic Masonry Association external site
