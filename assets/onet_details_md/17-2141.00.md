...
**Quick Facts:**
- SOC Code: 17-2141.00
- Also called: Application Engineer, Design Engineer, Equipment Engineer, Mechanical Design Engineer, Mechanical Designer, Mechanical Engineer, Product Development Engineer, Product Engineer, Project Engineer, Test Engineer
...
|------------|----------|------|
| 83 | Core | Read and interpret blueprints, technical drawings, schematics, or computer-generated reports. |
| 80 | Core | Research, design, evaluate, install, operate, or maintain mechanical products, equipment, systems or processes to meet requirements. |
| 79 | Core | Specify system components or direct modification of products to ensure conformance with engineering design, performance specifications, or environmental regulations. |
| 74 | Core | Confer with engineers or other personnel to implement operating procedures, resolve system malfunctions, or provide technical information. |
| 69 | Core | Investigate equipment failures or difficulties to diagnose faulty operation and recommend remedial actions. |
| 69 | Core | Recommend design modifications to eliminate machine or system malfunctions. |
| 65 | Core | Research and analyze customer design proposals, specifications, manuals, or other data to evaluate the feasibility, cost, or maintenance requirements of designs or applications. |
| 62 | Core | Provide technical customer service. |
| 62 | Core | Oversee installation, operation, maintenance, or repair to ensure that machines or equipment are installed and functioning according to specifications. |
| 62 | Core | Assist drafters in developing the structural design of products, using drafting tools or computer-assisted drafting equipment or software. |
| 61 | Core | Conduct research that tests or analyzes the feasibility, design, operation, or performance of equipment, components, or systems. |
| 59 | Core | Develop or test models of alternate designs or processing methods to assess feasibility, sustainability, operating condition effects, potential new applications, or necessity of modification. |
| 59 | Core | Provide feedback to design engineers on customer problems or needs. |
| 57 | Core | Write performance requirements for product development or engineering projects. |
| 55 | Core | Estimate costs or submit bids for engineering, construction, or extraction projects. |
| 53 | Core | Develop, coordinate, or monitor all aspects of production, including selection of manufacturing methods, fabrication, or operation of product designs. |
| 74 | Supplemental | Design integrated mechanical or alternative systems, such as mechanical cooling systems with natural ventilation systems, to improve energy efficiency. |
| 71 | Supplemental | Calculate energy losses for buildings, using equipment such as computers, combustion analyzers, or pressure gauges. |
| 67 | Supplemental | Recommend the use of utility or energy services that minimize carbon footprints. |
| 64 | Supplemental | Perform personnel functions, such as supervision of production workers, technicians, technologists, or other engineers. |
| 64 | Supplemental | Apply engineering principles or practices to emerging fields, such as robotics, waste management, or biomedical engineering. |
| 63 | Supplemental | Direct the installation, operation, maintenance, or repair of renewable energy equipment, such as heating, ventilating, and air conditioning (HVAC) or water systems. |
| 62 | Supplemental | Select or install combined heat units, power units, cogeneration equipment, or trigeneration equipment that reduces energy use or pollution. |
| 61 | Supplemental | Evaluate mechanical designs or prototypes for energy performance or environmental impact. |
| 56 | Supplemental | Study industrial processes to maximize the efficiency of equipment applications, including equipment placement. |
| 55 | Supplemental | Design test control apparatus or equipment or develop procedures for testing products. |
...
| 47 | Supplemental | Solicit new business. |

## Technology Skills

| Hot Technology | Examples |
|----------------|----------|
| Analytical or scientific software | MAYA Nastran; Minitab; ReliaSoft Weibull++ 6; The MathWorks MATLAB Hot Technology ; 20 more |
| Computer aided design CAD software | Autodesk AutoCAD Civil 3D Hot Technology ; Autodesk Revit ; Bentley MicroStation Hot Technology ; Dassault Systemes SolidWorks ; 15 more |
...
| Data base user interface and query software | Microsoft Access Hot Technology ; Microsoft SQL Server Hot Technology |
| Development environment software | Microsoft Visual Basic Hot Technology ; Microsoft Visual Basic for Applications VBA Hot Technology ; National Instruments LabVIEW; Verilog ; 6 more |
...
| Graphics or photo imaging software | Adobe Illustrator Hot Technology ; SmugMug Flickr; Trimble SketchUp Pro Hot Technology |
...
| Object or component oriented development software | C++ Hot Technology ; Perl Hot Technology ; Python ; R Hot Technology ; 1 more |
| Office suite software | Microsoft Office software |
| Operating system software | Shell script Hot Technology |
...
|---|---|
| 96 | Drafting, Laying Out, and Specifying Technical Devices, Parts, and Equipment — Providing documentation, detailed instructions, drawings, or specifications to tell others about how devices, parts, equipment, or structures are to be fabricated, constructed, assembled, modified, maintained, or used. |
...
|---|---|
| 88 | Design — Knowledge of design techniques, tools, and principles involved in production of precision technical plans, blueprints, drawings, and models. |
