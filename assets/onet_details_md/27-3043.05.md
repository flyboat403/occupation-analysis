...
**Quick Facts:**
- SOC Code: 27-3043.05
- Also called: Author, Creative Writer, Fiction Writer, Freelance Writer, Librettist, Lyricist, Nonfiction Writer, Novelist, Poet, Songwriter
...
|------------|----------|------|
| 93 | Core | Write fiction or nonfiction prose, such as short stories, novels, biographies, articles, descriptive or critical analyses, and essays. |
| 92 | Core | Develop factors such as themes, plots, characterizations, psychological analyses, historical environments, action, and dialogue to create material. |
| 91 | Core | Revise written material to meet personal standards and to satisfy needs of clients, publishers, directors, or producers. |
| 89 | Core | Choose subject matter and suitable form to express personal feelings and experiences or ideas, or to narrate stories or events. |
| 86 | Core | Prepare works in appropriate format for publication, and send them to publishers or producers. |
| 84 | Core | Conduct research to obtain factual information and authentic detail, using sources such as newspaper accounts, diaries, and interviews. |
| 81 | Core | Confer with clients, editors, publishers, or producers to discuss changes or revisions to written material. |
| 75 | Core | Plan project arrangements or outlines, and organize material accordingly. |
| 62 | Core | Follow appropriate procedures to get copyrights for completed work. |
| 50 | Core | Attend book launches and publicity events, or conduct public readings. |
| 84 | Supplemental | Write narrative, dramatic, lyric, or other types of poetry for publication. |
| 82 | Supplemental | Write words to fit musical compositions, including lyrics for operas, musical plays, and choral works. |
| 82 | Supplemental | Adapt text to accommodate musical requirements of composers and singers. |
| 60 | Supplemental | Write humorous material for publication, or for performances such as comedy routines, gags, and comedy shows. |
| 46 | Supplemental | Teach writing classes. |
| 43 | Supplemental | Collaborate with other writers on specific projects. |
...
| Office suite software | Microsoft Office software Hot Technology ; OpenOffice.org |
| Presentation software | Microsoft PowerPoint Hot Technology |
| Spreadsheet software | Microsoft Excel Hot Technology |
| Text to speech conversion software | Text to speech software |
| Video creation and editing software | YouTube |
| Web page creation and editing software | Facebook Hot Technology ; Red Sweater MarsEdit; Social media software; WordPress Hot Technology ; 3 more |
| Word processing software | Apple iWork Pages; AutoCrit Editing Wizard; Microsoft Word Hot Technology ; WriteWay Pro ; 11 more |
...
| 25 | Monitoring Processes, Materials, or Surroundings — Monitoring and reviewing information from materials, events, or the environment, to detect or assess problems. |
...
| 11 | Mathematics — Knowledge of arithmetic, algebra, geometry, calculus, statistics, and their applications. |
...
| Importance | Ability |
|---|---|
| 94 | Written Expression — The ability to communicate information and ideas in writing so others will understand. |
...
| 36 | Dependability — A tendency to be reliable, responsible, and consistent in meeting work-related obligations. |
| 34 | Attention to Detail — A tendency to be detail-oriented, organized, and thorough in completing work. |
...
- Recording Academy external site
...
- Songwriters Guild of America external site
