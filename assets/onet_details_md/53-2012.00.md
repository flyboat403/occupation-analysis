...
**Quick Facts:**
- SOC Code: 53-2012.00
- Also called: Captain, Charter Pilot, Check Airman, Commercial Helicopter Pilot, Commercial Pilot, EMS Helicopter Pilot (Emergency Medical Service Helicopter Pilot), First Officer, Helicopter Pilot, Line Pilot, Pilot
...
|------------|----------|------|
| 99 | Core | Check aircraft prior to flights to ensure that the engines, controls, instruments, and other systems are functioning properly. |
| 99 | Core | Co-pilot aircraft or perform captain's duties, as required. |
| 98 | Core | Consider airport altitudes, outside temperatures, plane weights, and wind speeds and directions to calculate the speed needed to become airborne. |
| 98 | Core | Use instrumentation to pilot aircraft when visibility is poor. |
| 96 | Core | Monitor engine operation, fuel consumption, and functioning of aircraft systems during flights. |
| 95 | Core | Order changes in fuel supplies, loads, routes, or schedules to ensure safety of flights. |
| 94 | Core | Contact control towers for takeoff clearances, arrival instructions, and other information, using radio equipment. |
| 91 | Core | Plan flights according to government and company regulations, using aeronautical charts and navigation instruments. |
| 91 | Core | Start engines, operate controls, and pilot airplanes to transport passengers, mail, or freight according to flight plans, regulations, and procedures. |
| 91 | Core | Check baggage or cargo to ensure that it has been loaded correctly. |
| 89 | Core | Obtain and review data such as load weights, fuel supplies, weather conditions, and flight schedules to determine flight plans and identify needed changes. |
| 85 | Core | Conduct in-flight tests and evaluations at specified altitudes and in all types of weather to determine the receptivity and other characteristics of equipment and systems. |
| 84 | Core | Choose routes, altitudes, and speeds that will provide the fastest, safest, and smoothest flights. |
| 83 | Core | Write specified information in flight records, such as flight times, altitudes flown, and fuel consumption. |
| 82 | Core | Coordinate flight activities with ground crews and air traffic control, and inform crew members of flight and test procedures. |
| 79 | Core | Perform minor aircraft maintenance and repair work, or arrange for major maintenance. |
| 78 | Core | Supervise other crew members. |
| 78 | Core | Request changes in altitudes or routes as circumstances dictate. |
| 74 | Core | File instrument flight plans with air traffic control so that flights can be coordinated with other air traffic. |
| 80 | Supplemental | Rescue and evacuate injured persons. |
| 77 | Supplemental | Instruct other pilots and student pilots in aircraft operations. |
| 70 | Supplemental | Fly with other pilots or pilot-license applicants to evaluate their proficiency. |
| 68 | Supplemental | Plan and formulate flight activities and test schedules and prepare flight evaluation reports. |
| 67 | Supplemental | Teach company regulations and procedures to other pilots. |
...
|---|---|
| 98 | Inspecting Equipment, Structures, or Materials — Inspecting equipment, structures, or materials to identify the cause of errors or other problems or defects. |
| 98 | Operating Vehicles, Mechanized Devices, or Equipment — Running, maneuvering, navigating, or driving vehicles or mechanized equipment, such as forklifts, passenger vehicles, aircraft, or watercraft. |
...
| 74 | Repairing and Maintaining Electronic Equipment — Servicing, repairing, calibrating, regulating, fine-tuning, or testing machines, devices, and equipment that operate primarily on the basis of electrical or electronic (not mechanical) principles. |
...
| Importance | Skill |
|---|---|
| 94 | Operation and Control — Controlling operations of equipment or systems. |
| 85 | Operations Monitoring — Watching gauges, dials, or other indicators to make sure a machine is working properly. |
...
| 66 | Time Sharing — The ability to shift back and forth between two or more activities or sources of information (such as speech, sounds, touch, or other sources). |
...
| 53 | Glare Sensitivity — The ability to see objects in the presence of a glare or bright lighting. |
...
- Airborne International Response Team external site
- Airborne Public Safety Association external site
- Aircraft Owners and Pilots Association external site
- Association for Uncrewed Vehicle Systems International external site
- AW Drones external site
- Civil Air Patrol external site
- Coalition of Airline Pilots Associations external site
- Experimental Aircraft Association external site
- Flight Safety Foundation external site
- Helicopter Association International external site
- International Civil Aviation Organization external site
- National Agricultural Aviation Association external site
- National Air Transportation Association external site
- National Business Aviation Association external site
- National EMS Pilots Association external site
- Ninety-Nines external site
- SAE International external site
- University Aviation Association external site
- Women and Drones external site
- Women in Aviation International external site

- Air Line Pilots Association, International external site
- Independent Pilots Association external site
