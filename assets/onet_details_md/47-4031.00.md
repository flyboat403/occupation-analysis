...
**Quick Facts:**
- SOC Code: 47-4031.00
- Also called: Fence Builder, Fence Contractor, Fence Erector, Fence Installer, Fence Laborer, Fence Mechanic, Fence Technician (Fence Tech), Gate Technician (Gate Tech), Wood Fence Erector
...
|------------|----------|------|
| 86 | Core | Establish the location for a fence, and gather information needed to ensure that there are no electric cables or water lines in the area. |
| 85 | Core | Set metal or wooden posts in upright positions in postholes. |
| 85 | Core | Measure and lay out fence lines and mark posthole positions, following instructions, drawings, or specifications. |
| 84 | Core | Align posts, by lines or sighting, and verify vertical alignment of posts, using plumb bobs or spirit levels. |
| 81 | Core | Attach rails or tension wire along bottoms of posts to form fencing frames. |
| 79 | Core | Dig postholes, using spades, posthole diggers, or power-driven augers. |
| 78 | Core | Attach fence rail supports to posts, using hammers and pliers. |
| 78 | Core | Assemble gates, and fasten gates into position, using hand tools. |
| 78 | Core | Mix and pour concrete around bases of posts, or tamp soil into postholes to embed posts. |
| 77 | Core | Make rails for fences, by sawing lumber or by cutting metal tubing to required lengths. |
| 77 | Core | Nail top and bottom rails to fence posts, or insert them in slots on posts. |
| 76 | Core | Discuss fencing needs with customers, and estimate and quote prices. |
| 73 | Core | Stretch wire, wire mesh, or chain link fencing between posts, and attach fencing to frames. |
| 73 | Core | Complete top fence rails of metal fences by connecting tube sections, using metal sleeves. |
| 72 | Core | Erect alternate panel, basket weave, and louvered fences. |
| 71 | Core | Insert metal tubing through rail supports. |
| 71 | Core | Nail pointed slats to rails to construct picket fences. |
| 67 | Core | Construct and repair barriers, retaining walls, trellises, and other types of fences, walls, and gates. |
| 63 | Core | Weld metal parts together, using portable gas welding equipment. |
| 67 | Supplemental | Blast rock formations and rocky areas with dynamite to facilitate posthole digging. |

## Technology Skills

| Hot Technology | Examples |
|----------------|----------|
| Computer aided design CAD software | Autodesk AutoCAD Hot Technology ; Cutlist Plus fx |
...
- American Fence Association external site
