...
**Quick Facts:**
- SOC Code: 25-1054.00
- Also called: Adjunct Professor, Assistant Professor, Associate Professor, Instructor, Physical Science Professor, Physics Instructor, Physics Lecturer, Physics Professor, Professor, Science Instructor
...
|------------|----------|------|
| 90 | Core | Evaluate and grade students' class work, laboratory work, assignments, and papers. |
...
| 84 | Core | Prepare and deliver lectures to undergraduate or graduate students on topics such as quantum mechanics, particle physics, and optics. |
...
| 78 | Core | Supervise students' laboratory work. |
...
| 75 | Core | Collaborate with colleagues to address teaching and research issues. |
| 67 | Core | Advise students on academic and vocational curricula and on career issues. |
| 67 | Core | Conduct research in a particular field of knowledge and publish findings in professional journals, books, or electronic media. |
| 62 | Core | Select and obtain materials and supplies, such as textbooks and laboratory equipment. |
| 61 | Core | Maintain and repair laboratory equipment. |
| 56 | Core | Perform administrative duties, such as serving as department head. |
| 54 | Core | Participate in student recruitment, registration, and placement activities. |
| 52 | Core | Serve on academic or administrative committees that deal with institutional policies, departmental matters, and academic issues. |
...
| 44 | Supplemental | Participate in campus and community events. |
...
|----------------|----------|
| Analytical or scientific software | Maplesoft Maple; The MathWorks MATLAB Hot Technology ; VASP Data Viewer; Wolfram Research Mathematica ; 7 more |
| Calendar and scheduling software |  |
| Computer aided design CAD software | Autodesk AutoCAD Hot Technology ; Mathsoft Mathcad |
...
| Development environment software | C Hot Technology ; Formula translation/translator FORTRAN; National Instruments LabVIEW; PLplot ; 5 more |
...
| Object or component oriented development software | C++ Hot Technology ; Perl Hot Technology |
| Office suite software | Microsoft Office software Hot Technology |
| Operating system software | Microsoft Windows |
| Optical character reader OCR or scanning software | Image scanning software |
| Presentation software | Microsoft PowerPoint Hot Technology |
| Spreadsheet software | Microsoft Excel Hot Technology |
| Word processing software | Collaborative editing software; Google Docs Hot Technology ; LaTeX; Microsoft Word Hot Technology |
...
| 87 | Physics — Knowledge and prediction of physical principles, laws, their interrelationships, and applications to understanding fluid, material, and atmospheric dynamics, and mechanical, electrical, atomic and sub-atomic structures and processes. |
...
- American Association of Physics Teachers external site
...
- Society of Physics Students external site

- International Astronomical Union external site
