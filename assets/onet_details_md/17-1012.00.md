...
**Quick Facts:**
- SOC Code: 17-1012.00
- Also called: AP BD+C (Accredited Professional in Building Design and Construction), Golf Course Architect, Land Planner, Landscape Architect, Landscape Designer, Landscape Planner, Park Planner, Planner, Professional Landscape Architect (PLA), Project Landscape Architect
...
|------------|----------|------|
| 96 | Core | Confer with clients, engineering personnel, or architects on landscape projects. |
| 88 | Core | Analyze data on conditions such as site location, drainage, or structure location for environmental reports or landscaping plans. |
| 85 | Core | Inspect landscape work to ensure compliance with specifications, evaluate quality of materials or work, or advise clients or construction personnel. |
| 85 | Core | Prepare site plans, specifications, or cost estimates for land development. |
| 84 | Core | Integrate existing land features or landscaping into designs. |
| 81 | Core | Collaborate with architects or related professionals on whole building design to maximize the aesthetic features of structures or surrounding land and to improve energy efficiency. |
| 79 | Core | Prepare graphic representations or drawings of proposed plans or designs. |
| 76 | Core | Inspect proposed sites to identify structural elements of land areas or other important site information, such as soil condition, existing landscaping, or the proximity of water management facilities. |
| 74 | Core | Collaborate with estimators to cost projects, create project plans, or coordinate bids from landscaping contractors. |
| 74 | Core | Create landscapes that minimize water consumption such as by incorporating drought-resistant grasses or indigenous plants. |
| 73 | Core | Develop planting plans to help clients garden productively or to achieve particular aesthetic effects. |
| 71 | Core | Manage the work of subcontractors to ensure quality control. |
| 71 | Core | Present project plans or designs to public stakeholders, such as government agencies or community groups. |
| 66 | Core | Develop marketing materials, proposals, or presentations to generate new work opportunities. |
| 65 | Core | Prepare conceptual drawings, graphics, or other visual representations of land areas to show predicted growth or development of land areas over time. |
| 63 | Core | Identify and select appropriate sustainable materials for use in landscape designs, such as recycled wood or recycled concrete boards for structural elements or recycled tires for playground bedding. |
| 63 | Core | Research latest products, technology, or design trends to stay current in the field. |
| 59 | Core | Design and integrate rainwater harvesting or gray and reclaimed water systems to conserve water into building or land designs. |
| 55 | Core | Provide follow-up consultations for clients to ensure landscape designs are maturing or developing as planned. |

## Technology Skills

| Hot Technology | Examples |
|----------------|----------|
| Computer aided design CAD software | Autodesk AutoCAD Civil 3D ; Autodesk Revit ; Bentley MicroStation Hot Technology ; Trimble SketchUp Pro ; 4 more |
...
- Landscape Architecture Foundation external site
...
- Council of Landscape Architectural Registration Boards external site
