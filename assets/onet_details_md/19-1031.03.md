...
**Quick Facts:**
- SOC Code: 19-1031.03
- Also called: Environmental Education Specialist, Environmental Educator, Interpretive Naturalist, Natural Resource Educator, Naturalist, Park Activities Coordinator, Park Guide, Park Interpretive Specialist, Park Naturalist, Park Ranger
...
|------------|----------|------|
| 91 | Core | Provide visitor services, such as explaining regulations, answering visitor requests, needs and complaints, and providing information about the park and surrounding areas. |
| 81 | Core | Assist with operations of general facilities, such as visitor centers. |
| 76 | Core | Confer with park staff to determine subjects and schedules for park programs. |
| 75 | Core | Conduct field trips to point out scientific, historic, and natural features of parks, forests, historic sites, or other attractions. |
| 72 | Core | Plan and organize public events at the park. |
| 72 | Core | Prepare and present illustrated lectures and interpretive talks about park features. |
| 71 | Core | Plan, organize and direct activities of seasonal staff members. |
| 71 | Core | Perform emergency duties to protect human life, government property, and natural features of park. |
| 71 | Core | Train staff on park programs. |
| 69 | Core | Develop environmental educational programs and curricula for schools. |
| 65 | Core | Construct historical, scientific, and nature visitor-center displays. |
| 64 | Core | Research stories regarding the area's natural history or environment. |
| 61 | Core | Prepare brochures and write newspaper articles. |
| 56 | Core | Compile and maintain official park photographic and information files. |
| 54 | Core | Take photographs and motion pictures for use in lectures and publications and to develop displays. |
| 53 | Core | Plan and develop audio-visual devices for public programs. |
| 52 | Core | Perform routine maintenance on park structures. |
| 60 | Supplemental | Provide care for park program animals. |
| 49 | Supplemental | Interview specialists in desired fields to obtain and develop data for park information programs. |
| 46 | Supplemental | Survey park to determine forest conditions and distribution and abundance of fauna and flora. |
...
| Electronic mail software | Email software; MicroFocus GroupWise; Microsoft Outlook Hot Technology |
...
|---|---|
| 98 | Performing for or Working Directly with the Public — Performing for people or dealing directly with the public. This includes serving customers in restaurants and stores, and receiving clients or guests. |
...
| 3 | Cautiousness — A tendency to be careful, deliberate, and risk-avoidant when making work-related decisions or doing work. |

### Professional Associations

- American Association for State and Local History external site
- Association of National Park Rangers external site
