...
|------------|----------|------|
| 85 | Core | Grade or level trench bases, using tamping machines or hand tools. |
| 83 | Core | Dig trenches to desired or required depths, by hand or using trenching tools. |
| 83 | Core | Cut pipes to required lengths. |
| 81 | Core | Install or use instruments such as lasers, grade rods, or transit levels. |
| 78 | Core | Cover pipes with earth or other materials. |
| 78 | Core | Connect pipe pieces and seal joints, using welding equipment, cement, or glue. |
| 78 | Core | Install or repair sanitary or stormwater sewer structures or pipe systems. |
| 78 | Core | Check slopes for conformance to requirements, using levels or lasers. |
| 77 | Core | Align and position pipes to prepare them for welding or sealing. |
| 76 | Core | Lay out pipe routes, following written instructions or blueprints and coordinating layouts with supervisors. |
| 76 | Core | Tap and drill holes into pipes to introduce auxiliary lines or devices. |
| 74 | Core | Operate mechanized equipment, such as pickup trucks, rollers, tandem dump trucks, front-end loaders, or backhoes. |
| 73 | Core | Train or supervise others in laying pipe. |
| 72 | Core | Locate existing pipes needing repair or replacement, using magnetic or radio indicators. |
