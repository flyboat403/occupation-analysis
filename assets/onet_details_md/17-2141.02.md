...
|------------|----------|------|
| 81 | Core | Conduct or direct system-level automotive testing. |
| 81 | Core | Provide technical direction to other engineers or engineering support personnel. |
| 80 | Core | Perform failure, variation, or root cause analyses. |
| 79 | Core | Calibrate vehicle systems, including control algorithms or other software systems. |
| 71 | Core | Design or analyze automobile systems in areas such as aerodynamics, alternate fuels, ergonomics, hybrid power, brakes, transmissions, steering, calibration, safety, or diagnostics. |
| 70 | Core | Prepare or present technical or project status reports. |
| 69 | Core | Conduct research studies to develop new concepts in the field of automotive engineering. |
| 69 | Core | Establish production or quality control standards. |
| 69 | Core | Alter or modify designs to obtain specified functional or operational performance. |
| 68 | Core | Research or implement green automotive technologies involving alternative fuels, electric or hybrid cars, or lighter or more fuel-efficient vehicles. |
| 68 | Core | Develop calibration methodologies, test methodologies, or tools. |
| 68 | Core | Create design alternatives for vehicle components, such as camless or dual-clutch engines or alternative air-conditioning systems, to increase fuel efficiency. |
| 68 | Core | Develop or implement operating methods or procedures. |
| 67 | Core | Develop engineering specifications or cost estimates for automotive design concepts. |
| 66 | Core | Conduct automotive design reviews. |
| 66 | Core | Design vehicles that use lighter materials, such as aluminum, magnesium alloy, or plastic, to improve fuel efficiency. |
| 66 | Core | Write, review, or maintain engineering documentation. |
| 65 | Core | Develop specifications for vehicles powered by alternative fuels or alternative power methods. |
| 65 | Core | Build models for algorithm or control feature verification testing. |
| 64 | Core | Coordinate production activities with other functional units, such as procurement, maintenance, or quality control. |
| 63 | Core | Design control systems or algorithms for purposes such as automotive energy management, emissions management, or increased operational safety or performance. |
| 61 | Core | Develop or integrate control feature requirements. |
| 57 | Core | Research computerized automotive applications, such as telemetrics, intelligent transportation systems, artificial intelligence, or automatic control. |
| 55 | Core | Read current literature, attend meetings or conferences, or talk with colleagues to stay abreast of new automotive technology or competitive products. |
| 55 | Core | Design vehicles for increased recyclability or use of natural, renewable, or recycled materials in vehicle construction. |
...
| Computer aided design CAD software | Autodesk AutoCAD ; Dassault Systemes CATIA In Demand ; Dassault Systemes SolidWorks ; Think3 ThinkDesign Engineering ; 9 more |
...
| Data base user interface and query software | International Material Data System IMDS; Structured query language SQL Hot Technology |
| Development environment software | C Hot Technology ; Microsoft .NET Framework Hot Technology ; Microsoft Visual Basic Scripting Edition VBScript; Microsoft Visual Studio Hot Technology ; 4 more |
...
| Graphics or photo imaging software | Adobe Photoshop Hot Technology ; Corel Painter; GNU Image Manipulation Program GIMP; Portalgraphics openCanvas ; 3 more |
| Industrial control software | Metrologic Group Metrolog XG |
| Object or component oriented development software | C# Hot Technology ; Oracle Java Hot Technology ; Perl Hot Technology ; Swift Hot Technology ; 4 more |
| Office suite software | Microsoft Office software |
| Operating system software | Linux Hot Technology ; Magellan Firmware; Microsoft Windows Hot Technology ; UNIX Hot Technology |
| Presentation software | Microsoft PowerPoint |
| Process mapping and design software | Microsoft Visio Hot Technology |
| Program testing software | Debugging software; JUnit Hot Technology ; Selenium Hot Technology ; TestNG |
| Project management software | Atlassian Confluence Hot Technology ; Atlassian JIRA Hot Technology ; Microsoft Project Hot Technology ; Siemens Teamcenter In Demand |
| Spreadsheet software | Microsoft Excel |
| Web platform development software | JavaScript Hot Technology ; JavaScript Object Notation JSON Hot Technology ; Node.js Hot Technology |
...
| 84 | Physics — Knowledge and prediction of physical principles, laws, their interrelationships, and applications to understanding fluid, material, and atmospheric dynamics, and mechanical, electrical, atomic and sub-atomic structures and processes. |
...
| 69 | Transportation — Knowledge of principles and methods for moving people or goods by air, rail, sea, or road, including the relative costs and benefits. |
...
- United States Council for Automotive Research external site
