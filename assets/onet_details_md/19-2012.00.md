...
**Quick Facts:**
- SOC Code: 19-2012.00
- Also called: Biophysics Scientist, Health Physicist, Medical Physicist, Physicist, Research Consultant, Research Physicist, Research Scientist, Scientist
...
|------------|----------|------|
| 83 | Core | Perform complex calculations as part of the analysis and evaluation of data, using computers. |
| 79 | Core | Analyze data from research conducted to detect and measure physical phenomena. |
| 76 | Core | Describe and express observations and conclusions in mathematical terms. |
| 75 | Core | Design computer simulations to model physical data so that it can be better understood. |
| 74 | Core | Write research proposals to receive funding. |
| 74 | Core | Teach physics to students. |
| 73 | Core | Report experimental results by writing papers for scientific journals or by presenting information at scientific conferences. |
| 71 | Supplemental | Observe the structure and properties of matter, and the transformation and propagation of energy, using equipment such as masers, lasers, and telescopes, to explore and identify the basic principles governing these phenomena. |
| 67 | Supplemental | Develop theories and laws on the basis of observation and experiments, and apply these theories and laws to problems in areas such as nuclear energy, optics, and aerospace technology. |
| 64 | Supplemental | Collaborate with other scientists in the design, development, and testing of experimental, industrial, or medical equipment, instrumentation, and procedures. |

## Technology Skills

| Hot Technology | Examples |
|----------------|----------|
| Analytical or scientific software | CERN Physics Analysis Workstation PAW; COMSOL Multiphysics; The MathWorks MATLAB Hot Technology ; Wolfram Research Mathematica ; 21 more |
| Cloud-based management software | OpenStack |
| Clustering software | VMware |
| Computer aided design CAD software | Autodesk AutoCAD Hot Technology ; Mathsoft Mathcad; RibbonSoft QCad |
| Configuration management software | Puppet Hot Technology |
| Data base management system software | SQLite |
| Data base user interface and query software | Amazon Web Services AWS software Hot Technology ; MySQL Hot Technology ; Oracle Database Hot Technology ; Structured query language SQL Hot Technology ; 2 more |
| Desktop publishing software | Scribus |
| Development environment software | C Hot Technology ; Eclipse IDE ; Microsoft Azure software Hot Technology ; Microsoft Visual Studio Hot Technology ; 7 more |
...
| Graphics or photo imaging software | Adobe Photoshop Hot Technology ; GNU Image Manipulation Program GIMP; Ploticus; xv ; 1 more |
| Music or sound editing software | Adobe Audition |
| Object or component oriented development software | C++ Hot Technology ; Oracle Java Hot Technology ; Perl Hot Technology ; Python ; 1 more |
...
|---|---|
| 98 | Physics — Knowledge and prediction of physical principles, laws, their interrelationships, and applications to understanding fluid, material, and atmospheric dynamics, and mechanical, electrical, atomic and sub-atomic structures and processes. |
...
- American Institute of Physics external site
...
- Physics Careers Resource external site
