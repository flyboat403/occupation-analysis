...
|------------|----------|------|
| 92 | Core | Respond to customer inquiries or complaints. |
| 91 | Core | Schedule guest appointments. |
| 89 | Core | Maintain client databases. |
| 85 | Core | Coordinate facility schedules to maximize usage and efficiency. |
| 80 | Core | Perform accounting duties, such as recording daily cash flow, preparing bank deposits, or generating financial statements. |
| 79 | Core | Monitor operations to ensure compliance with applicable health, safety, or hygiene standards. |
| 78 | Core | Plan or direct spa services and programs. |
| 78 | Core | Develop or implement marketing strategies. |
| 77 | Core | Sell products, services, or memberships. |
| 77 | Core | Recruit, interview, or hire employees. |
| 77 | Core | Assess employee performance and suggest ways to improve work. |
| 76 | Core | Inventory products and order new supplies. |
| 76 | Core | Establish spa budgets and financial goals. |
| 76 | Core | Inform staff of job responsibilities, performance expectations, client service standards, or corporate policies and guidelines. |
| 74 | Core | Train staff in the use or sale of products, programs, or activities. |
| 73 | Core | Participate in continuing education classes to maintain current knowledge of industry. |
| 70 | Core | Direct facility maintenance or repair. |
| 69 | Core | Verify staff credentials, such as educational and certification requirements. |
| 69 | Core | Schedule staff or supervise scheduling. |
| 68 | Core | Check spa equipment to ensure proper functioning. |
| 66 | Core | Develop staff service or retail goals and guide staff in goal achievement. |
...
| 84 | Resolving Conflicts and Negotiating with Others — Handling complaints, settling disputes, and resolving grievances and conflicts, or otherwise negotiating with others. |
...
- International SPA Association external site
- Professional Beauty Association external site

- Northeast Spa and Pool Association external site
