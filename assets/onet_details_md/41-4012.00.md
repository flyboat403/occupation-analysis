...
**Quick Facts:**
- SOC Code: 41-4012.00
- Also called: Account Representative, Customer Account Technician, Inside Salesperson, Outside Sales Representative, Route Sales Representative, Sales Consultant, Sales Professional, Sales Representative (Sales Rep), Salesman, Salesperson
...
|------------|----------|------|
| 84 | Core | Answer customers' questions about products, prices, availability, product uses, and credit terms. |
| 82 | Core | Recommend products to customers, based on customers' needs and interests. |
| 82 | Core | Estimate or quote prices, credit or contract terms, warranties, and delivery dates. |
| 81 | Core | Consult with clients after sales or contract signings to resolve problems and to provide ongoing support. |
| 79 | Core | Prepare sales contracts and order forms. |
| 79 | Core | Provide customers with product samples and catalogs. |
| 77 | Core | Monitor market conditions, product innovations, and competitors' products, prices, and sales. |
| 76 | Core | Perform administrative duties, such as preparing sales budgets and reports, keeping sales records, and filing expense account reports. |
| 74 | Core | Contact regular and prospective customers to demonstrate products, explain product features, and solicit orders. |
| 71 | Core | Identify prospective customers by using business directories, following leads from existing clients, participating in organizations and clubs, and attending trade shows and conferences. |
| 85 | Supplemental | Negotiate with retail merchants to improve product exposure, such as shelf positioning and advertising. |
| 85 | Supplemental | Check stock levels and reorder merchandise as necessary. |
| 85 | Supplemental | Plan, assemble, and stock product displays in retail stores, or make recommendations to retailers regarding product displays, promotional programs, and advertising. |
| 80 | Supplemental | Negotiate details of contracts and payments. |
| 75 | Supplemental | Prepare drawings, estimates, and bids that meet specific customer needs. |
| 74 | Supplemental | Obtain credit information about prospective customers. |
| 72 | Supplemental | Forward orders to manufacturers. |
| 66 | Supplemental | Arrange and direct delivery and installation of products and equipment. |
...
| Data base user interface and query software | Airtable; Blackboard software; Oracle Database Hot Technology ; Yardi software Hot Technology ; 4 more |
| Data mining software | Google Analytics Hot Technology |
| Desktop communications software | Eko; Skype |
| Desktop publishing software | Adobe InDesign Hot Technology ; Contract Central; Microsoft Publisher |
| Development environment software | Eclipse IDE Hot Technology ; Microsoft Visual Basic Hot Technology |
...
| Enterprise resource planning ERP software | Microsoft Dynamics; Oracle PeopleSoft Hot Technology ; SAP software Hot Technology ; SSA Global BPCS ; 6 more |
...
| Medical software | Epic Systems Hot Technology ; Healthcare common procedure coding system HCPCS; Medical condition coding software |
...
| Operating system software | Apple macOS Hot Technology ; Handheld computer device software; Microsoft Windows Hot Technology ; UNIX Hot Technology |
| Presentation software | Apple Keynote; Google Slides; Microsoft PowerPoint |
| Process mapping and design software | Microsoft Visio Hot Technology |
| Project management software | Google Classroom; Microsoft Project Hot Technology ; Microsoft Teams Hot Technology ; Oracle Primavera Enterprise Project Portfolio Management Hot Technology |
...
|---|---|
| 98 | Sales and Marketing — Knowledge of principles and methods for showing, promoting, and selling products or services. This includes marketing strategy and tactics, product demonstration, sales techniques, and sales control systems. |
