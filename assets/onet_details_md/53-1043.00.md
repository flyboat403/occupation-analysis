...
**Quick Facts:**
- SOC Code: 53-1043.00
- Also called: Cargo Manager, DC Supervisor (Distribution Center Supervisor), Dock Supervisor, Driver Manager, Fleet Manager, Shipping Manager, Street Supervisor, Trainmaster, Transportation Supervisor, Warehouse Supervisor
...
|------------|----------|------|
| 88 | Core | Enforce safety rules and regulations. |
| 79 | Core | Interpret transportation or tariff regulations, shipping orders, safety regulations, or company policies and procedures for workers. |
| 78 | Core | Resolve worker problems or collaborate with employees to assist in problem resolution. |
| 77 | Core | Confer with customers, supervisors, contractors, or other personnel to exchange information or to resolve problems. |
| 77 | Core | Plan work assignments and equipment allocations to meet transportation, operations or production goals. |
| 75 | Core | Examine, measure, or weigh cargo or materials to determine specific handling requirements. |
| 74 | Core | Explain and demonstrate work tasks to new workers or assign training tasks to experienced workers. |
| 74 | Core | Review orders, production schedules, blueprints, or shipping or receiving notices to determine work sequences and material shipping dates, types, volumes, or destinations. |
| 73 | Core | Drive vehicles or operate machines or equipment to complete work assignments or to assist workers. |
| 73 | Core | Inspect or test materials, stock, vehicles, equipment, or facilities to ensure that they are safe, free of defects, and consistent with specifications. |
| 73 | Core | Maintain or verify records of time, materials, expenditures, or crew activities. |
| 72 | Core | Requisition needed personnel, supplies, equipment, parts, or repair services. |
| 71 | Core | Recommend and implement measures to improve worker motivation, equipment performance, work methods, or customer services. |
| 71 | Core | Prepare, compile, and submit reports on work activities, operations, production, or work-related accidents. |
| 70 | Core | Dispatch personnel and vehicles in response to telephone or radio reports of emergencies. |
| 70 | Core | Monitor field work to ensure proper performance and use of materials. |
| 66 | Core | Recommend or implement personnel actions, such as employee selection, evaluation, rewards, or disciplinary actions. |
| 72 | Supplemental | Perform or schedule repairs or preventive maintenance of vehicles or other equipment. |
| 69 | Supplemental | Compute or estimate cash, payroll, transportation, personnel, or storage requirements. |
...
| Materials requirements planning logistics and supply chain software | Bill of lading software; UPS Logistics Technologies Roadnet Transportation Suite; Warehouse management system WMS In Demand ; XATA XATANET ; 16 more |
...
| 42 | Foreign Language — Knowledge of the structure and content of a foreign (non-English) language including the meaning and spelling of words, rules of composition and grammar, and pronunciation. |
