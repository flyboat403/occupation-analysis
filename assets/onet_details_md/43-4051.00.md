...
|------------|----------|------|
| 92 | Core | Confer with customers by telephone or in person to provide information about products or services, take or enter orders, cancel accounts, or obtain details of complaints. |
| 88 | Core | Keep records of customer interactions or transactions, recording details of inquiries, complaints, or comments, as well as actions taken. |
| 85 | Core | Check to ensure that appropriate changes were made to resolve customers' problems. |
| 81 | Core | Contact customers to respond to inquiries or to notify them of claim investigation results or any planned adjustments. |
| 80 | Core | Determine charges for services requested, collect deposits or payments, or arrange for billing. |
| 78 | Core | Complete contract forms, prepare change of address records, or issue service discontinuance orders, using computers. |
| 77 | Core | Refer unresolved customer grievances to designated departments for further investigation. |
| 80 | Supplemental | Resolve customers' service or billing complaints by performing activities such as exchanging merchandise, refunding money, or adjusting bills. |
| 76 | Supplemental | Review insurance policy terms to determine whether a particular loss is covered by insurance. |
| 72 | Supplemental | Solicit sales of new or additional services or products. |
| 66 | Supplemental | Compare disputed merchandise with original requisitions and information from invoices and prepare invoices for returned goods. |
| 66 | Supplemental | Obtain and examine all relevant information to assess validity of complaints and to determine possible causes, such as extreme weather conditions that could increase utility bills. |
| 54 | Supplemental | Recommend improvements in products, packaging, shipping, service, or billing methods and procedures to prevent future problems. |
...
| Customer relationship management CRM software | Blackbaud The Raiser's Edge; Salesforce software Hot Technology ; Salesforce.com Salesforce CRM; Telemation e-CRM ; 12 more |
| Data base reporting software | SAP Crystal Reports |
| Data base user interface and query software | Airtable; Microsoft Access Hot Technology ; Oracle Database Hot Technology ; Yardi software Hot Technology ; 6 more |
...
| Enterprise resource planning ERP software | Microsoft Dynamics; Oracle PeopleSoft Hot Technology ; Sage MAS 200 ERP; SAP software Hot Technology ; 4 more |
...
| Presentation software | Apple Keynote; Microsoft PowerPoint Hot Technology ; Poll Everywhere |
...
| Video conferencing software | FaceTime; Google Meet; LogMeIn GoToMeeting; Zoom Hot Technology |
