...
**Quick Facts:**
- SOC Code: 27-1011.00
- Also called: Art Director, Art Supervisor, Creative Director (CD Director), Creative Manager, Creative Services Director, Creative Services Manager, Design Director, Graphic Design and Art Production Manager, Group Art Supervisor, Presentation Director
...
|------------|----------|------|
| 90 | Core | Work with creative directors to develop design solutions. |
| 88 | Core | Present final layouts to clients for approval. |
| 84 | Core | Manage own accounts and projects, working within budget and scheduling requirements. |
| 84 | Core | Confer with creative, art, copywriting, or production department heads to discuss client requirements and presentation concepts and to coordinate creative activities. |
| 83 | Core | Confer with clients to determine objectives, budget, background information, and presentation approaches, styles, and techniques. |
| 81 | Core | Formulate basic layout design or presentation approach and specify material details, such as style and size of type, photographs, graphics, animation, video, and sound. |
| 81 | Core | Review and approve art materials, copy materials, and proofs of printed copy developed by staff members. |
| 79 | Core | Create custom illustrations or other graphic elements. |
| 77 | Core | Attend photo shoots and printing sessions to ensure that the products needed are obtained. |
| 76 | Core | Review illustrative material to determine if it conforms to standards and specifications. |
| 74 | Core | Hire, train, and direct staff members who develop design concepts into art layouts or who prepare layouts for printing. |
| 69 | Core | Research current trends and new technology, such as printing production techniques, computer software, and design trends. |
| 79 | Supplemental | Mark up, paste, and complete layouts and write typography instructions to prepare materials for typesetting or printing. |
| 73 | Supplemental | Conceptualize and help design interfaces for multimedia games, products, and devices. |
| 69 | Supplemental | Prepare detailed storyboards showing sequence and timing of story development for television production. |
| 67 | Supplemental | Negotiate with printers and estimators to determine what services will be performed. |
...
| Web page creation and editing software | Adobe Dreamweaver; Facebook Hot Technology ; Social media software; WordPress Hot Technology |
| Web platform development software | AJAX Hot Technology ; Cascading style sheets CSS Hot Technology ; Hypertext markup language HTML Hot Technology ; PHP Hot Technology ; 6 more |
...
| Impact | Work Style |
|---|---|
| 91 | Innovation — A tendency to be inventive, to be imaginative, and to adopt new perspectives on ways to accomplish work. |
