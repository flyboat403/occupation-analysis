...
**Quick Facts:**
- SOC Code: 27-4014.00
- Also called: Audio Engineer, Audio Operator, Mastering Engineer, Mixing Engineer, Mixing Technician (Mixing Tech), Music Producer, Recording Engineer, Sound Editor, Sound Engineer, Sound Technician (Sound Tech)
...
|------------|----------|------|
| 96 | Core | Confer with producers, performers, and others to determine and achieve the desired sound for a production, such as a musical recording or a film. |
| 95 | Core | Regulate volume level and sound quality during recording sessions, using control consoles. |
| 90 | Core | Record speech, music, and other sounds on recording media, using recording equipment. |
| 90 | Core | Separate instruments, vocals, and other sounds, and combine sounds during the mixing or postproduction stage. |
| 89 | Core | Set up, test, and adjust recording equipment for recording sessions and live performances. |
| 88 | Core | Report equipment problems and ensure that required repairs are made. |
| 87 | Core | Prepare for recording sessions by performing such activities as selecting and setting up microphones. |
| 86 | Core | Mix and edit voices, music, and taped sound effects for live performances and for prerecorded events, using sound mixing boards. |
| 80 | Core | Keep logs of recordings. |
| 73 | Core | Tear down equipment after event completion. |
| 72 | Core | Synchronize and equalize prerecorded dialogue, music, and sound effects with visual action of motion pictures or television productions, using control consoles. |
| 70 | Core | Reproduce and duplicate sound recordings from original recording media, using sound editing and duplication equipment. |
| 66 | Core | Convert video and audio recordings into digital formats for editing or archiving. |
| 52 | Supplemental | Create musical instrument digital interface programs for music projects, commercials, or film postproduction. |
...
| Operating system software | Apple macOS Hot Technology ; Linux Hot Technology ; Microsoft Windows Hot Technology ; UNIX Hot Technology ; 2 more |
...
- The Latin Recording Academy external site
