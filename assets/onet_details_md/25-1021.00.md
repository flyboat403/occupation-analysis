...
**Quick Facts:**
- SOC Code: 25-1021.00
- Also called: Assistant Professor, Associate Professor, Computer Information Systems Instructor (CIS Instructor), Computer Science Instructor, Computer Science Professor, Faculty Member, Information Technology Instructor (IT Instructor), Instructor, Lecturer, Professor
...
| 90 | Core | Compile, administer, and grade examinations or assign this work to others. |
| 87 | Core | Prepare and deliver lectures to undergraduate or graduate students on topics such as programming, data structures, and software design. |
| 85 | Core | Evaluate and grade students' class work, laboratory work, assignments, and papers. |
| 80 | Core | Maintain student attendance records, grades, and other required records. |
| 79 | Core | Keep abreast of developments in the field by reading current literature, talking with colleagues, and participating in professional conferences. |
...
| 76 | Core | Advise students on academic and vocational curricula and on career issues. |
| 74 | Core | Initiate, facilitate, and moderate classroom discussions. |
| 73 | Core | Develop and maintain Web sites for online courses. |
| 71 | Core | Participate in student recruitment, registration, and placement activities. |
| 67 | Core | Collaborate with colleagues to address teaching and research issues. |
...
| 81 | Supplemental | Direct research of other teachers or of graduate students working for advanced academic degrees. |
| 80 | Supplemental | Supervise undergraduate or graduate teaching, internship, and research work. |
| 78 | Supplemental | Conduct research in a particular field of knowledge and publish findings in professional journals, books, or electronic media. |
| 76 | Supplemental | Supervise students' laboratory work. |
| 69 | Supplemental | Write grant proposals to procure external research funding. |
| 69 | Supplemental | Perform administrative duties, such as serving as department head. |
| 62 | Supplemental | Maintain computer equipment used in instruction. |
| 55 | Supplemental | Compile bibliographies of specialized materials for outside reading assignments. |
| 50 | Supplemental | Provide professional consulting services to government or industry. |
| 48 | Supplemental | Act as advisers to student organizations. |
...
| Data base user interface and query software | Blackboard software; Database software; Microsoft Access Hot Technology |
| Development environment software | C Hot Technology ; Microsoft Visual Basic Hot Technology ; Programming languages; Software development tools ; 1 more |
...
| Object or component oriented development software | C# Hot Technology ; C++ ; Oracle Java ; Python ; 1 more |
...
| Web platform development software | Hypertext markup language HTML Hot Technology ; PHP Hot Technology |
...
|------------------------|----------|
| 81 | Social — Work involves helping, teaching, advising, assisting, or providing service to others. Social occupations are often associated with social, health care, personal service, teaching/education, or religious activities. Related occupations |
...
- Association for Computers and the Humanities external site
- Association for Computing Machinery external site
- Consortium for Computing Sciences in Colleges external site
...
- Special Interest Group on Computer Science Education external site
- United States Association for Computational Mechanics external site
