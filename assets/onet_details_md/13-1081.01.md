...
**Quick Facts:**
- SOC Code: 13-1081.01
- Also called: Acquisition Logistics Engineer, Logistics Engineer, Logistics Specialist, Reliability Engineer, Supportability Engineer, Systems Engineer
...
|------------|----------|------|
| 82 | Core | Identify cost-reduction or process-improvement logistic opportunities. |
| 81 | Core | Analyze or interpret logistics data involving customer service, forecasting, procurement, manufacturing, inventory, transportation, or warehousing. |
| 81 | Core | Prepare logistic strategies or conceptual designs for production facilities. |
| 74 | Core | Conduct logistics studies or analyses, such as time studies, zero-base analyses, rate analyses, network analyses, flow-path analyses, or supply chain analyses. |
| 74 | Core | Develop logistic metrics, internal analysis tools, or key performance indicators for business units. |
| 71 | Core | Identify or develop business rules or standard operating procedures to streamline operating processes. |
| 70 | Core | Interview key staff or tour facilities to identify efficiency-improvement, cost-reduction, or service-delivery opportunities. |
| 70 | Core | Apply logistics modeling techniques to address issues, such as operational process improvement or facility design or layout. |
| 70 | Core | Design plant distribution centers. |
| 70 | Core | Review contractual commitments, customer specifications, or related information to determine logistics or support requirements. |
| 69 | Core | Evaluate the use of inventory tracking technology, Web-based warehousing software, or intelligent conveyor systems to maximize plant or distribution center efficiency. |
| 69 | Core | Propose logistics solutions for customers. |
| 68 | Core | Develop or maintain cost estimates, forecasts, or cost models. |
| 67 | Core | Prepare or validate documentation on automated logistics or maintenance-data reporting or management information systems. |
| 66 | Core | Provide logistical facility or capacity planning analyses for distribution or transportation functions. |
| 66 | Core | Determine feasibility of designing new facilities or modifying existing facilities, based on factors such as cost, available space, schedule, technical requirements, or ergonomics. |
| 66 | Core | Design comprehensive supply chains that minimize environmental impacts or costs. |
| 66 | Core | Create models or scenarios to predict the impact of changing circumstances, such as fuel costs, road pricing, energy taxes, or carbon emissions legislation. |
| 63 | Core | Determine logistics support requirements, such as facility details, staffing needs, or safety or maintenance plans. |
| 63 | Core | Develop specifications for equipment, tools, facility layouts, or material-handling systems. |
| 62 | Core | Provide logistics technology or information for effective and efficient support of product, equipment, or system manufacturing or service. |
| 61 | Core | Evaluate effectiveness of current or future logistical processes. |
| 60 | Core | Direct the work of logistics analysts. |
| 58 | Core | Evaluate the use of technologies, such as global positioning systems (GPS), radio-frequency identification (RFID), route navigation software, or satellite linkup systems, to improve transportation efficiency. |
| 56 | Core | Determine requirements for compliance with environmental certification standards. |
| 54 | Core | Develop or document procedures to minimize or mitigate carbon output resulting from the movement of materials or products. |
| 52 | Core | Conduct environmental audits for logistics activities, such as storage, distribution, or transportation. |
| 51 | Core | Develop or document reverse logistics management processes to ensure maximal efficiency of product recycling, reuse, or final disposal. |
| 50 | Core | Review global, national, or regional transportation or logistics reports for ways to improve efficiency or minimize the environmental impact of logistics activities. |
| 43 | Supplemental | Assess the environmental impact or energy efficiency of logistics activities, using carbon mitigation software. |

## Technology Skills

| Hot Technology | Examples |
|----------------|----------|
| Analytical or scientific software | LOGSA COMPASS; Minitab; Reliass EAGLE; SAS Hot Technology ; 11 more |
| Business intelligence and data analysis software | IBM Cognos Impromptu; Microsoft Power BI Hot Technology ; Tableau Hot Technology |
...
| Development environment software | Microsoft Visual Basic Hot Technology ; Microsoft Visual Basic for Applications VBA Hot Technology ; Prolog |
...
- Analyze jobs using observation, survey, or interview techniques. Related occupations
...
- Develop sustainable business strategies or practices. Related occupations
...
| Importance | Skill |
|---|---|
| 91 | Systems Analysis — Determining how a system should work and how changes in conditions, operations, and the environment will affect outcomes. |
...
| 74 | Transportation — Knowledge of principles and methods for moving people or goods by air, rail, sea, or road, including the relative costs and benefits. |
...
| 61 | Economics and Accounting — Knowledge of economic and accounting principles and practices, the financial markets, banking, and the analysis and reporting of financial data. |
