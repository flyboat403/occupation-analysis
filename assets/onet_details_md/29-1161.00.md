...
|------------|----------|------|
| 100 | Core | Provide prenatal, intrapartum, postpartum, or newborn care to patients. |
| 100 | Core | Monitor fetal development by listening to fetal heartbeat, taking external uterine measurements, identifying fetal position, or estimating fetal size and weight. |
| 99 | Core | Document patients' health histories, symptoms, physical conditions, or other diagnostic information. |
| 99 | Core | Provide patients with direct family planning services, such as inserting intrauterine devices, dispensing oral contraceptives, and fitting cervical barriers, including cervical caps or diaphragms. |
| 98 | Core | Prescribe medications as permitted by state regulations. |
| 98 | Core | Develop and implement individualized plans for health care management. |
| 97 | Core | Explain procedures to patients, family members, staff members or others. |
| 96 | Core | Order and interpret diagnostic or laboratory tests. |
| 96 | Core | Initiate emergency interventions to stabilize patients. |
| 94 | Core | Document findings of physical examinations. |
| 94 | Core | Educate patients and family members regarding prenatal, intrapartum, postpartum, newborn, or interconception care. |
| 94 | Core | Perform physical examinations by taking vital signs, checking neurological reflexes, examining breasts, or performing pelvic examinations. |
| 93 | Core | Write information in medical records or provide narrative summaries to communicate patient information to other health care providers. |
| 92 | Core | Provide primary health care, including pregnancy and childbirth, to women. |
| 86 | Core | Consult with or refer patients to appropriate specialists when conditions exceed the scope of practice or expertise. |
| 85 | Core | Read current literature, talk with colleagues, or participate in professional organizations or conferences to keep abreast of developments in midwifery. |
| 81 | Core | Instruct student nurse midwives, medical students, or residents on the birthing process. |
| 77 | Core | Establish practice guidelines for specialty areas such as primary health care of women, care of the childbearing family, and newborn care. |
| 67 | Core | Plan, provide, or evaluate educational programs for nursing staff, health care teams, or the community. |
| 63 | Core | Conduct clinical research on topics such as maternal or infant health care, contraceptive methods, breastfeeding, and gynecological care. |
| 61 | Supplemental | Manage newborn care during the first weeks of life. |

## Technology Skills

| Hot Technology | Examples |
|----------------|----------|
| Medical software | digiChart OB-GYN; eClinicalWorks EHR software Hot Technology ; Epic Systems Hot Technology ; GE Healthcare Centricity EMR ; 17 more |
...
| 96 | Documenting/Recording Information — Entering, transcribing, recording, storing, or maintaining information in written or electronic/magnetic form. |
| 95 | Getting Information — Observing, receiving, and otherwise obtaining information from all relevant sources. |
| 92 | Identifying Objects, Actions, and Events — Identifying information by categorizing, estimating, recognizing differences or similarities, and detecting changes in circumstances or events. |
...
- American Society for Colposcopy and Cervical Pathology external site
- Association of Women's Health, Obstetric and Neonatal Nurses external site
- North American Menopause Society external site
