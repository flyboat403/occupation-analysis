...
**Quick Facts:**
- SOC Code: 17-2171.00
- Also called: Completion Engineer, Drilling Engineer, Engineer, Operations Engineer, Petroleum Engineer, Petroleum Production Engineer, Project Production Engineer, Project Reservoir Engineer, Reservoir Engineer, Reservoir Engineering Consultant
...
|------------|----------|------|
| 79 | Core | Specify and supervise well modification and stimulation programs to maximize oil and gas recovery. |
| 77 | Core | Monitor production rates, and plan rework processes to improve production. |
| 76 | Core | Maintain records of drilling and production operations. |
| 75 | Core | Analyze data to recommend placement of wells and supplementary processes to enhance production. |
| 75 | Core | Assist engineering and other personnel to solve operating problems. |
| 74 | Core | Direct and monitor the completion and evaluation of wells, well testing, or well surveys. |
| 74 | Core | Develop plans for oil and gas field drilling, and for product recovery and treatment. |
| 71 | Core | Assess costs and estimate the production capabilities and economic value of oil and gas wells, to evaluate the economic viability of potential drilling sites. |
| 69 | Core | Confer with scientific, engineering, and technical personnel to resolve design, research, and testing problems. |
| 67 | Core | Interpret drilling and testing information for personnel. |
| 66 | Core | Coordinate activities of workers engaged in research, planning, and development. |
| 66 | Core | Write technical reports for engineering and management personnel. |
| 62 | Core | Evaluate findings to develop, design, or test equipment or processes. |
| 78 | Supplemental | Test machinery and equipment to ensure that it is safe and conforms to performance specifications. |
| 74 | Supplemental | Assign work to staff to obtain maximum utilization of personnel. |
| 70 | Supplemental | Simulate reservoir performance for different recovery techniques, using computer models. |
| 69 | Supplemental | Design and implement environmental controls on oil and gas operations. |
| 68 | Supplemental | Supervise the removal of drilling equipment, the removal of any waste, and the safe return of land to structural stability when wells or pockets are exhausted. |
| 66 | Supplemental | Inspect oil and gas wells to determine that installations are completed. |
| 62 | Supplemental | Coordinate the installation, maintenance, and operation of mining and oil field equipment. |
| 60 | Supplemental | Take samples to assess the amount and quality of oil, the depth at which resources lie, and the equipment needed to properly extract them. |
| 52 | Supplemental | Design or modify mining and oil field machinery and tools, applying engineering principles. |
| 52 | Supplemental | Conduct engineering research experiments to improve or modify mining and oil machinery and operations. |

## Technology Skills

| Hot Technology | Examples |
|----------------|----------|
| Analytical or scientific software | Finite element analysis FEA software; Google Analytics Hot Technology ; SAS Hot Technology ; The MathWorks MATLAB Hot Technology ; 10 more |
...
| Data base user interface and query software | Landmark Graphics TOW/cs; Microsoft Access Hot Technology ; Oracle Database Hot Technology ; Structure query language SQL |
| Development environment software | Eclipse IDE Hot Technology ; Microsoft Visual Studio Hot Technology ; Software development tools |
...
| Object or component oriented development software | C# Hot Technology ; C++ Hot Technology ; Oracle Java Hot Technology ; R Hot Technology ; 1 more |
...
| 73 | Innovation — A tendency to be inventive, to be imaginative, and to adopt new perspectives on ways to accomplish work. |
...
| 25 | Social Orientation — A tendency to seek out, enjoy, and be energized by social interaction at work. |
...
- American Association of Drilling Engineers external site
...
- American Petroleum Institute external site
- American Society for Engineering Education external site
- Geological Society of America external site
- IADC external site
- Independent Petroleum Association of America external site
- National Society of Professional Engineers external site
- Society of Petroleum Engineers external site
- Society of Petroleum Evaluation Engineers external site
- Society of Petrophysicists and Well Log Analysts external site
