...
**Quick Facts:**
- SOC Code: 13-1051.00
- Also called: Acquisition Cost Estimator, Analyst, Construction Estimator, Cost Analyst, Cost Consultant, Cost Engineer, Cost Estimating Analyst, Cost Estimator, Estimating Specialist, Estimator
...
|------------|----------|------|
| 82 | Core | Analyze blueprints and other documentation to prepare time, cost, materials, and labor estimates. |
| 80 | Core | Confer with engineers, architects, owners, contractors, and subcontractors on changes and adjustments to cost estimates. |
| 80 | Core | Collect historical cost data to estimate costs for current or future products. |
| 78 | Core | Assess cost effectiveness of products, projects or services, tracking actual costs relative to bids as the project develops. |
| 75 | Core | Consult with clients, vendors, personnel in other departments, or construction foremen to discuss and formulate estimates and resolve issues. |
| 75 | Core | Establish and maintain tendering process, and conduct negotiations. |
| 75 | Core | Prepare estimates for use in selecting vendors or subcontractors. |
| 75 | Core | Prepare estimates used by management for purposes such as planning, organizing, and scheduling work. |
| 74 | Core | Set up cost monitoring and reporting systems and procedures. |
| 69 | Core | Review material and labor requirements to decide whether it is more cost-effective to produce or purchase components. |
| 68 | Core | Prepare cost and expenditure statements and other necessary documentation at regular intervals for the duration of the project. |
| 63 | Core | Conduct special studies to develop and establish standard hour and related cost data or to reduce cost. |
| 58 | Core | Visit site and record information about access, drainage and topography, and availability of utility services. |
| 54 | Core | Prepare and maintain a directory of suppliers, contractors and subcontractors. |

## Technology Skills

| Hot Technology | Examples |
|----------------|----------|
| Accounting software | Choice Job Cost; Cost accounting software; Intuit QuickBooks Hot Technology ; Sage 50 Accounting ; 1 more |
| Analytical or scientific software | ConEst Electrical Formulas; Construction Management Software ProEst; Procore software Hot Technology ; WinEstimator WinEst ; 3 more |
| Billing and invoicing software | ConEst T&amp;M Billing Manager |
| Computer aided design CAD software | Autodesk AutoCAD Hot Technology ; Autodesk Revit Hot Technology ; ConEst SureCount; Dassault Systemes CATIA ; 2 more |
...
| Data base user interface and query software | Assured Software JPP; Microsoft Access Hot Technology ; Sage 300 Construction and Real Estate; Xactware Xactimate ; 1 more |
| Document management software | Adobe Acrobat Hot Technology ; Laserfiche Avante |
...
| Project management software | Galorath SEER; HCSS HeavyJob; Microsoft Project Hot Technology ; Oracle Primavera Enterprise Project Portfolio Management Hot Technology ; 7 more |
...
- International Cost Estimating and Analysis Association external site
- Society of Cost Engineers external site
...
- American Society of Professional Estimators external site
