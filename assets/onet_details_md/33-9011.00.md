...
**Quick Facts:**
- SOC Code: 33-9011.00
- Also called: ACO (Animal Control Officer), Animal Attendant, Animal Cruelty Investigator, Animal Enforcement Officer, Animal Instructor Officer, Animal Ordinance Enforcement Officer, Animal Park Code Enforcement Officer, Animal Safety Officer, Animal Services Officer, Community Service Officer
...
|------------|----------|------|
| 95 | Core | Write reports of activities, and maintain files of impoundments and dispositions of animals. |
| 95 | Core | Investigate reports of animal attacks or animal cruelty, interviewing witnesses, collecting evidence, and writing reports. |
| 92 | Core | Examine animals for injuries or malnutrition, and arrange for any necessary medical treatment. |
| 91 | Core | Contact animal owners to inform them that their pets are at animal holding facilities. |
| 90 | Core | Educate the public about animal welfare, and animal control laws and regulations. |
| 88 | Core | Remove captured animals from animal-control service vehicles and place animals in shelter cages or other enclosures. |
| 88 | Core | Answer inquiries from the public concerning animal control operations. |
| 88 | Core | Capture and remove stray, uncontrolled, or abused animals from undesirable conditions, using nets, nooses, or tranquilizer darts as necessary. |
| 87 | Core | Prepare for prosecutions related to animal treatment, and give evidence in court. |
| 84 | Core | Supply animals with food, water, and personal care. |
| 83 | Core | Issue warnings or citations in connection with animal-related offenses, or contact police to report violations and request arrests. |
| 83 | Core | Euthanize rabid, unclaimed, or severely injured animals. |
| 82 | Core | Clean facilities and equipment such as dog pens and animal control trucks. |
| 72 | Core | Organize the adoption of unclaimed animals. |
| 72 | Core | Examine animal licenses, and inspect establishments housing animals for compliance with laws. |
| 64 | Supplemental | Train police officers in dog handling and training techniques for tracking, crowd control, and narcotics and bomb detection. |

## Technology Skills

| Hot Technology | Examples |
|----------------|----------|
| Data base user interface and query software | Animal Shelter Manager; ARK Software Ark Shelter Software; Microsoft Access Hot Technology ; TRAX Animal Control and Dog Warden Officer Software ; 4 more |
