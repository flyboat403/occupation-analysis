...
**Quick Facts:**
- SOC Code: 29-2081.00
- Also called: Certified Optician, Contact Lens Technician, Dispensing Optician, Licensed Dispensing Optician (LDO), Licensed Optician, Ophthalmic Dispenser, Optical Technician, Optician, Optometric Technician, Registered Optician
...
|------------|----------|------|
| 99 | Core | Measure clients' bridge and eye size, temple length, vertex distance, pupillary distance, and optical centers of eyes, using measuring devices. |
| 97 | Core | Verify that finished lenses are ground to specifications. |
| 95 | Core | Evaluate prescriptions in conjunction with clients' vocational and avocational visual requirements. |
| 95 | Core | Recommend specific lenses, lens coatings, and frames to suit client needs. |
| 95 | Core | Assist clients in selecting frames according to style and color, and ensure that frames are coordinated with facial and eye measurements and optical prescriptions. |
| 93 | Core | Maintain records of customer prescriptions, work orders, and payments. |
| 93 | Core | Heat, shape, or bend plastic or metal frames to adjust eyeglasses to fit clients, using pliers and hands. |
| 92 | Core | Show customers how to insert, remove, and care for their contact lenses. |
| 91 | Core | Determine clients' current lens prescriptions, when necessary, using lensometers or lens analyzers and clients' eyeglasses. |
| 91 | Core | Prepare work orders and instructions for grinding lenses and fabricating eyeglasses. |
| 89 | Core | Obtain a customer's previous record, or verify a prescription with the examining optometrist or ophthalmologist. |
| 89 | Core | Sell goods such as contact lenses, spectacles, sunglasses, and goods related to eyes, in general. |
| 87 | Core | Fabricate lenses to meet prescription specifications. |
| 86 | Core | Perform administrative duties, such as tracking inventory and sales, submitting patient insurance information, and performing simple bookkeeping. |
| 84 | Core | Assemble eyeglasses by cutting and edging lenses, and fitting the lenses into frames. |
| 82 | Core | Instruct clients in how to wear and care for eyeglasses. |
| 81 | Core | Supervise the training of student opticians. |
| 80 | Core | Order and purchase frames and lenses. |
| 71 | Core | Grind lens edges, or apply coatings to lenses. |
| 67 | Core | Repair damaged frames. |
| 63 | Core | Arrange and maintain displays of optical merchandise. |
...
| 89 | Selling or Influencing Others — Convincing others to buy merchandise/goods or to otherwise change their minds or actions. |
...
|---|---|
| 97 | Customer and Personal Service — Knowledge of principles and processes for providing customer and personal services. This includes customer needs assessment, meeting quality standards for services, and evaluation of customer satisfaction. |
...
| 39 | Biology — Knowledge of plant and animal organisms, their tissues, cells, functions, interdependencies, and interactions with each other and the environment. |
...
- Contact Lens Society of America external site
- Opticians Association of America external site
- United Opticians Association external site

- American Board of Opticianry and National Contact Lens Examiners external site
- National Academy of Opticianry external site
- Society to Advance Opticianry external site
