...
|------------|----------|------|
| 79 | Core | Identify operational requirements for new systems to inform selection of technological solutions. |
| 79 | Core | Integrate tags, readers, or software in radio frequency identification device (RFID) designs. |
| 77 | Core | Perform systems analysis or programming of radio frequency identification device (RFID) technology. |
| 73 | Core | Test radio frequency identification device (RFID) software to ensure proper functioning. |
| 71 | Core | Select appropriate radio frequency identification device (RFID) tags and determine placement locations. |
| 71 | Core | Perform site analyses to determine system configurations, processes to be impacted, or on-site obstacles to technology implementation. |
| 70 | Core | Perform acceptance testing on newly installed or updated systems. |
| 70 | Core | Determine means of integrating radio frequency identification device (RFID) into other applications. |
| 70 | Core | Provide technical support for radio frequency identification device (RFID) technology. |
| 70 | Core | Collect data about existing client hardware, software, networking, or key business processes to inform implementation of radio frequency identification device (RFID) technology. |
| 69 | Core | Install, test, or maintain radio frequency identification device (RFID) systems. |
| 69 | Core | Test tags or labels to ensure readability. |
| 69 | Core | Determine usefulness of new radio frequency identification device (RFID) technologies. |
| 68 | Core | Verify compliance of developed applications with architectural standards and established practices. |
| 67 | Core | Train users in details of system operation. |
| 67 | Core | Develop process flows, work instructions, or standard operating procedures for radio frequency identification device (RFID) systems. |
| 67 | Core | Read current literature, attend meetings or conferences, or talk with colleagues to stay abreast of industry research about new technologies. |
| 66 | Core | Document equipment or process details of radio frequency identification device (RFID) technology. |
| 65 | Core | Define and compare possible radio frequency identification device (RFID) solutions to inform selection for specific projects. |
| 59 | Core | Create simulations or models of radio frequency identification device (RFID) systems to provide information for selection and configuration. |
| 57 | Core | Analyze radio frequency identification device (RFID)-related supply chain data. |
...
| Analytical or scientific software | ANSYS simulation software In Demand ; The MathWorks MATLAB |
| Computer aided design CAD software | Dassault Systemes SolidWorks Hot Technology ; Field programmable gate array FPGA design software |
...
| Development environment software | C ; Microsoft Visual Basic Hot Technology ; Microsoft Visual Studio Hot Technology ; Ruby Hot Technology ; 3 more |
...
| Map creation software | MapInfo Professional In Demand |
| Network monitoring software | Forsk Atoll In Demand |
| Object or component oriented development software | C# Hot Technology ; C++ ; Oracle Java Hot Technology ; Perl Hot Technology ; 3 more |
| Office suite software | Microsoft Office software |
| Operating system software | Cygwin; Linux Hot Technology ; Magellan Firmware In Demand ; UNIX Hot Technology ; 1 more |
| Presentation software | Microsoft PowerPoint |
| Process mapping and design software | Microsoft Visio Hot Technology |
| Program testing software | FitNesse; JUnit Hot Technology ; Selenium Hot Technology ; Watir ; 5 more |
