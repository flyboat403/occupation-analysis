...
**Quick Facts:**
- SOC Code: 43-5011.01
- Also called: Air Export Agent, Air Export Coordinator, Export Coordinator, Freight Forwarder, GSA Coordinator (General Services Administration Coordinator), Import Agent, Ocean Export Specialist, Relocation Coordinator, Route Specialist
...
|------------|----------|------|
| 91 | Core | Negotiate shipping rates with freight carriers. |
| 88 | Core | Arrange for special transport of sensitive cargoes, such as livestock, food, or medical supplies. |
| 88 | Core | Arrange for applicable duties, taxes, or paperwork for customs clearance. |
| 88 | Core | Inform clients of factors such as shipping options, timelines, transfers, or regulations affecting shipments. |
| 88 | Core | Prepare shipping documentation, such as bills of lading, packing lists, dock receipts, or certificates of origin. |
| 87 | Core | Complete customs paperwork. |
| 86 | Core | Prepare invoices or cost quotations for freight transportation. |
| 85 | Core | Select shipment routes, based on nature of goods shipped, transit times, or security needs. |
| 85 | Core | Calculate weight, volume, or cost of goods to be moved. |
| 84 | Core | Arrange delivery or storage of goods at destinations. |
| 84 | Core | Arrange for transport, using a variety of modes, such as rail, short sea shipping, air, or roadways, to minimize carbon emissions or other environmental impacts. |
| 83 | Core | Determine efficient and cost-effective methods of moving goods from one location to another. |
| 83 | Core | Pay or arrange for payment of freight or insurance fees or other charges. |
| 82 | Core | Monitor or record locations of goods in transit. |
| 82 | Core | Keep records of goods dispatched or received. |
| 82 | Core | Reserve necessary space on ships, aircraft, trains, or trucks. |
| 81 | Core | Obtain or arrange cargo insurance. |
| 79 | Core | Consolidate loads with a common destination to reduce costs to individual shippers. |
| 78 | Core | Provide detailed port information to importers or exporters. |
| 78 | Core | Provide shipment status notification to exporters, consignees, or insurers. |
| 77 | Core | Verify proper packaging and labeling of exported goods. |
| 76 | Core | Verify adherence of documentation to customs, insurance, or regulatory requirements. |
| 74 | Core | Maintain current knowledge of relevant legislation, political situations, or other factors that could affect freight shipping. |
| 86 | Supplemental | Recommend or arrange appropriate merchandise packing methods, according to climate, terrain, weight, nature of goods, or costs. |
| 86 | Supplemental | Refer exporters to experts in areas such as trade financing, international marketing, government export requirements, international banking, or marine insurance. |
| 84 | Supplemental | Make arrangements with customs brokers to facilitate the passage of goods through customs. |
| 84 | Supplemental | Recommend shipping solutions to minimize cost or environmental impacts. |
| 80 | Supplemental | Review the environmental records of freight carriers to inform shipping decisions. |
| 80 | Supplemental | Analyze shipping routes to determine how to minimize environmental impact. |
| 78 | Supplemental | Consider environmental sustainability factors when determining merchandise packing methods. |
| 68 | Supplemental | Assist clients in obtaining insurance reimbursements. |
...
| Enterprise resource planning ERP software | Manufacturing resource planning MRP software; Oracle JD Edwards EnterpriseOne; SAP software Hot Technology |
...
| 90 | Administrative — Knowledge of administrative and office procedures and systems such as word processing, managing files and records, stenography and transcription, designing forms, and workplace terminology. |
...
| 47 | Foreign Language — Knowledge of the structure and content of a foreign (non-English) language including the meaning and spelling of words, rules of composition and grammar, and pronunciation. |
