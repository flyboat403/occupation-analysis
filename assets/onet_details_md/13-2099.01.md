...
**Quick Facts:**
- SOC Code: 13-2099.01
- Also called: Investment Portfolio Control Consultant, Investment Strategist, Portfolio Manager, Quantitative Analyst, Quantitative Equity Analyst, Quantitative Research Analyst, Quantitative Strategy Analyst, Research Analyst
...
|------------|----------|------|
| 85 | Core | Apply mathematical or statistical techniques to address practical issues in finance, such as derivative valuation, securities trading, risk management, or financial market regulation. |
| 79 | Core | Research or develop analytical tools to address issues such as portfolio construction or optimization, performance measurement, attribution, profit and loss measurement, or pricing models. |
| 78 | Core | Interpret results of financial analysis procedures. |
| 75 | Core | Develop core analytical capabilities or model libraries, using advanced statistical, quantitative, or econometric techniques. |
| 71 | Core | Define or recommend model specifications or data collection methods. |
| 66 | Core | Produce written summary reports of financial research results. |
| 66 | Core | Maintain or modify all financial analytic models in use. |
| 65 | Core | Provide application or analytical support to researchers or traders on issues such as valuations or data. |
| 64 | Core | Devise or apply independent models or tools to help verify results of analytical systems. |
| 61 | Core | Collaborate in the development or testing of new analytical software to ensure compliance with user requirements, specifications, or scope. |
| 61 | Core | Confer with other financial engineers or analysts on trading strategies, market dynamics, or trading system performance to inform development of quantitative techniques. |
| 59 | Core | Consult traders or other financial industry personnel to determine the need for new or improved analytical applications. |
| 58 | Core | Research new financial products or analytics to determine their usefulness. |
| 47 | Supplemental | Identify, track, or maintain metrics for trading system operations. |
| 46 | Supplemental | Develop methods of assessing or measuring corporate performance in terms of environmental, social, and governance (ESG) issues. |
| 46 | Supplemental | Collaborate with product development teams to research, model, validate, or implement quantitative structured solutions for new or expanded markets. |
| 46 | Supplemental | Prepare requirements documentation for use by software developers. |
| 38 | Supplemental | Develop solutions to help clients hedge carbon exposure or risk. |
| 36 | Supplemental | Develop tools to assess green technologies or green financial products, such as green hedge funds or social responsibility investment funds. |
| 33 | Supplemental | Assess the potential impact of climate change on business financial issues, such as damage repairs, insurance costs, or potential disruptions of daily activities. |
| 27 | Supplemental | Analyze pricing or risks of carbon trading products. |

## Technology Skills

| Hot Technology | Examples |
|----------------|----------|
| Analytical or scientific software | IBM SPSS Statistics Hot Technology ; SAS ; StataCorp Stata; The MathWorks MATLAB ; 1 more |
| Business intelligence and data analysis software | Microsoft Power BI Hot Technology ; MicroStrategy; Tableau |
| Data base management system software | Apache Hive Hot Technology |
| Data base user interface and query software | Amazon Web Services AWS software Hot Technology ; Microsoft Access Hot Technology ; Microsoft SQL Server Hot Technology ; Structured query language SQL |
| Data mining software | IBM Cognos Business Intelligence |
| Development environment software | Microsoft Azure software Hot Technology ; Microsoft Visual Basic Hot Technology ; Microsoft Visual Basic for Applications VBA ; Microsoft Visual Studio Hot Technology |
...
|---|---|
| 91 | Mathematics — Knowledge of arithmetic, algebra, geometry, calculus, statistics, and their applications. |
| 80 | Economics and Accounting — Knowledge of economic and accounting principles and practices, the financial markets, banking, and the analysis and reporting of financial data. |
...
| 64 | Innovation — A tendency to be inventive, to be imaginative, and to adopt new perspectives on ways to accomplish work. |
...
- Chicago Quantitative Alliance external site
...
- Society of Quantitative Analysts external site
