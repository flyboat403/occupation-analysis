...
**Quick Facts:**
- SOC Code: 51-4111.00
- Also called: Die Machinist, Die Repair Laborer, Die Repair Technician (Die Repair Tech), Jig and Fixture Repairer, Tool and Die Machinist, Tool and Die Maker, Tool and Fixture Specialist, Tool Maker, Tool Repairer, Trim Die Maker
...
|------------|----------|------|
| 89 | Core | Verify dimensions, alignments, and clearances of finished parts for conformance to specifications, using measuring instruments such as calipers, gauge blocks, micrometers, or dial indicators. |
| 84 | Core | Set up and operate conventional or computer numerically controlled machine tools such as lathes, milling machines, or grinders to cut, bore, grind, or otherwise shape parts to prescribed dimensions and finishes. |
| 80 | Core | Visualize and compute dimensions, sizes, shapes, and tolerances of assemblies, based on specifications. |
| 80 | Core | Study blueprints, sketches, models, or specifications to plan sequences of operations for fabricating tools, dies, or assemblies. |
| 78 | Core | Fit and assemble parts to make, repair, or modify dies, jigs, gauges, and tools, using machine tools, hand tools, or welders. |
| 78 | Core | Inspect finished dies for smoothness, contour conformity, and defects. |
| 76 | Core | Select metals to be used from a range of metals and alloys, based on properties such as hardness or heat tolerance. |
| 75 | Core | Lift, position, and secure machined parts on surface plates or worktables, using hoists, vises, v-blocks, or angle plates. |
| 75 | Core | File, grind, shim, and adjust different parts to properly fit them together. |
| 74 | Core | Smooth and polish flat and contoured surfaces of parts or tools, using scrapers, abrasive stones, files, emery cloths, or power grinders. |
| 74 | Core | Measure, mark, and scribe metal or plastic stock to lay out machining, using instruments such as protractors, micrometers, scribes, or rulers. |
| 73 | Core | Conduct test runs with completed tools or dies to ensure that parts meet specifications, making adjustments as necessary. |
| 69 | Core | Design jigs, fixtures, and templates for use as work aids in the fabrication of parts or products. |
| 68 | Core | Cut, shape, and trim blanks or blocks to specified lengths or shapes, using power saws, power shears, rules, and hand tools. |
| 67 | Core | Set up and operate drill presses to drill and tap holes in parts for assembly. |
| 67 | Supplemental | Develop and design new tools and dies, using computer-aided design software. |
| 65 | Supplemental | Set pyrometer controls of heat-treating furnaces and feed or place parts, tools, or assemblies into furnaces to harden. |
...
| 19 | Communicating with People Outside the Organization — Communicating with people outside the organization, representing the organization to customers, the public, government, and other external sources. This information can be exchanged in person, in writing, or by telephone or e-mail. |
