...
**Quick Facts:**
- SOC Code: 17-2051.00
- Also called: City Engineer, Civil Engineer, County Engineer, Design Engineer, Engineer, Geotechnical Engineer, Licensed Engineer, Project Engineer, Railroad Design Consultant, Structural Engineer
...
|------------|----------|------|
| 81 | Core | Direct engineering activities, ensuring compliance with environmental, safety, or other governmental regulations. |
| 75 | Core | Manage and direct the construction, operations, or maintenance activities at project site. |
| 75 | Core | Inspect project sites to monitor progress and ensure conformance to design specifications and safety or sanitation standards. |
| 73 | Core | Compute load and grade requirements, water flow rates, or material stress factors to determine design specifications. |
| 72 | Core | Plan and design transportation or hydraulic systems or structures, using computer-assisted design or drawing tools. |
| 68 | Core | Provide technical advice to industrial or managerial personnel regarding design, construction, program modifications, or structural repairs. |
| 67 | Core | Analyze survey reports, maps, drawings, blueprints, aerial photography, or other topographical or geologic data. |
| 67 | Core | Direct or participate in surveying to lay out installations or establish reference points, grades, or elevations to guide construction. |
| 64 | Core | Estimate quantities and cost of materials, equipment, or labor to determine project feasibility. |
| 63 | Core | Prepare or present public reports on topics such as bid proposals, deeds, environmental impact statements, or property and right-of-way descriptions. |
| 50 | Core | Design energy-efficient or environmentally sound civil structures. |
| 80 | Supplemental | Test soils or materials to determine the adequacy and strength of foundations, concrete, asphalt, or steel. |
| 64 | Supplemental | Identify environmental risks and develop risk management strategies for civil engineering projects. |
| 52 | Supplemental | Conduct studies of traffic patterns or environmental conditions to identify engineering problems and assess potential project impact. |
| 47 | Supplemental | Develop or implement engineering solutions to clean up industrial accidents or other contaminated sites. |
| 39 | Supplemental | Design or engineer systems to efficiently dispose of chemical, biological, or other toxic wastes. |

## Technology Skills

| Hot Technology | Examples |
|----------------|----------|
| Analytical or scientific software | HEC-HMS; Minitab; Procore software Hot Technology ; The MathWorks MATLAB Hot Technology ; 8 more |
| Business intelligence and data analysis software | Oracle Business Intelligence Enterprise Edition |
| Calendar and scheduling software | Scheduling software |
| Computer aided design CAD software | Autodesk AutoCAD Civil 3D ; Autodesk Revit ; Bentley MicroStation ; Dassault Systemes SolidWorks Hot Technology ; 16 more |
| Data base user interface and query software | Microsoft Access Hot Technology |
| Development environment software | C Hot Technology ; Microsoft Visual Basic Hot Technology ; National Instruments LabVIEW; Verilog ; 1 more |
...
| Geographic information system | ESRI ArcGIS software Hot Technology ; ESRI ArcInfo; ESRI ArcView; Geographic information system GIS software |
| Graphics or photo imaging software | Bentley GeoPak Bridge; Graphics software; SmugMug Flickr; Trimble SketchUp Pro Hot Technology |
...
| Project management software | Cost estimating software; Microsoft Project Hot Technology ; Oracle Primavera Enterprise Project Portfolio Management Hot Technology ; The Gordian Group PROGEN Online |
...
|---|---|
| 93 | Design — Knowledge of design techniques, tools, and principles involved in production of precision technical plans, blueprints, drawings, and models. |
| 92 | Engineering and Technology — Knowledge of the practical application of engineering science and technology. This includes applying principles, techniques, procedures, and equipment to the design and production of various goods and services. |
| 88 | Building and Construction — Knowledge of materials, methods, and the tools involved in the construction or repair of houses, buildings, or other structures such as highways and roads. |
| 87 | Mathematics — Knowledge of arithmetic, algebra, geometry, calculus, statistics, and their applications. |
...
- Earthquake Engineering Research Institute external site
- Institute of Transportation Engineers external site
- National Association of County Engineers external site
