...
**Quick Facts:**
- SOC Code: 49-1011.00
- Also called: Electrical and Instrumentation Supervisor (E and I Supervisor), Facilities Maintenance Supervisor, Facility Maintenance Supervisor, Maintenance Coordinator, Maintenance Foreman, Maintenance Manager, Maintenance Planner, Maintenance Superintendent, Maintenance Supervisor, Service Manager
...
| 72 | Core | Inspect and monitor work areas, examine tools and equipment, and provide employee safety training to prevent, detect, and correct unsafe conditions or violations of procedures and safety rules. |
| 72 | Core | Interpret specifications, blueprints, or job orders to construct templates and lay out reference points for workers. |
| 72 | Core | Monitor employees' work levels and review work performance. |
| 70 | Core | Perform skilled repair or maintenance operations, using equipment such as hand or power tools, hydraulic presses or shears, or welding equipment. |
| 69 | Core | Compute estimates and actual costs of factors such as materials, labor, or outside contractors. |
...
| 68 | Core | Requisition materials and supplies, such as tools, equipment, or replacement parts. |
| 68 | Core | Confer with personnel, such as management, engineering, quality control, customer, or union workers' representatives, to coordinate work activities, resolve employee grievances, or identify and review resource needs. |
| 67 | Core | Determine schedules, sequences, and assignments for work activities, based on work priority, quantity of equipment, and skill of personnel. |
| 66 | Core | Examine objects, systems, or facilities and analyze information to determine needed installations, services, or repairs. |
| 66 | Core | Counsel employees about work-related issues and assist employees to correct job-skill deficiencies. |
| 65 | Core | Recommend or initiate personnel actions, such as hires, promotions, transfers, discharges, or disciplinary measures. |
| 65 | Core | Investigate accidents or injuries and prepare reports of findings. |
| 63 | Core | Conduct or arrange for worker training in safety, repair, or maintenance techniques, operational procedures, or equipment use. |
| 62 | Core | Develop, implement, or evaluate maintenance policies and procedures. |
| 60 | Core | Meet with vendors or suppliers to discuss products used in repair work. |
| 69 | Supplemental | Participate in budget preparation and administration, coordinating purchasing and documentation and monitoring departmental expenditures. |
| 65 | Supplemental | Review, evaluate, accept, and coordinate completion of work bid from contractors. |
| 64 | Supplemental | Compile operational or personnel records, such as time and production records, inventory data, repair or maintenance statistics, or test results. |
| 59 | Supplemental | Develop or implement electronic maintenance programs or computer information management systems. |
| 52 | Supplemental | Design equipment configurations to meet personnel needs. |
...
| Data base user interface and query software | Database software; Microsoft Access Hot Technology ; Vehicle management software; Yardi software Hot Technology ; 1 more |
| Document management software | Microsoft SharePoint Hot Technology |
| Electronic mail software | Email software; IBM Notes; Microsoft Outlook |
| Enterprise resource planning ERP software | Microsoft Dynamics; Oracle JD Edwards EnterpriseOne; SAP software Hot Technology ; WorkTech MAXIMO ; 1 more |
...
| Project management software | ComputerEase construction accounting software; HCSS HeavyJob; Microsoft Project Hot Technology ; Oracle Primavera Enterprise Project Portfolio Management Hot Technology ; 1 more |
...
| 88 | Leadership Orientation — A tendency to lead, take charge, offer opinions, and provide direction at work. |
...
| 29 | Tolerance for Ambiguity — A tendency to be comfortable with ambiguity and uncertainty at work. |
...
- Automotive Training Managers Council external site
