...
**Quick Facts:**
- SOC Code: 13-2081.00
- Also called: City Tax Auditor, Collections Specialist, Revenue Agent, Revenue Collector, Revenue Officer, Revenue Specialist, Tax Collector, Tax Compliance Officer, Tax Examiner, Tax Examining Technician
...
|------------|----------|------|
| 90 | Core | Send notices to taxpayers when accounts are delinquent. |
| 85 | Core | Confer with taxpayers or their representatives to discuss the issues, laws, and regulations involved in returns, and to resolve problems with returns. |
| 84 | Core | Notify taxpayers of any overpayment or underpayment, and either issue a refund or request further payment. |
| 84 | Core | Maintain records for each case, including contacts, telephone numbers, and actions taken. |
| 80 | Core | Contact taxpayers by mail or telephone to address discrepancies and to request supporting documentation. |
| 79 | Core | Answer questions from taxpayers and assist them in completing tax forms. |
| 95 | Supplemental | Collect taxes from individuals or businesses according to prescribed laws and regulations. |
| 89 | Supplemental | Determine appropriate methods of debt settlement, such as offers of compromise, wage garnishment, or seizure and sale of property. |
| 89 | Supplemental | Check tax forms to verify that names and taxpayer identification numbers are correct, that computations have been performed correctly, or that amounts match those on supporting documentation. |
| 89 | Supplemental | Examine and analyze tax assets and liabilities to determine resolution of delinquent tax problems. |
| 87 | Supplemental | Impose payment deadlines on delinquent taxpayers and monitor payments to ensure that deadlines are met. |
| 83 | Supplemental | Direct service of legal documents, such as subpoenas, warrants, notices of assessment, and garnishments. |
| 80 | Supplemental | Review filed tax returns to determine whether claimed tax credits and deductions are allowed by law. |
| 80 | Supplemental | Maintain knowledge of tax code changes, and of accounting procedures and theory to properly evaluate financial information. |
| 76 | Supplemental | Investigate claims of inability to pay taxes by researching court information for the status of liens, mortgages, or financial statements, or by locating assets through third parties. |
| 76 | Supplemental | Review selected tax returns to determine the nature and extent of audits to be performed on them. |
| 72 | Supplemental | Examine accounting systems and records to determine whether accounting methods used were appropriate and in compliance with statutory provisions. |
| 70 | Supplemental | Participate in informal appeals hearings on contested cases from other agents. |
| 69 | Supplemental | Prepare briefs and assist in searching and seizing records to prepare charges and documentation for court cases. |
| 69 | Supplemental | Enter tax return information into computers for processing. |
| 66 | Supplemental | Secure a taxpayer's agreement to discharge a tax assessment or submit contested determinations to other administrative or judicial conferees for appeals hearings. |

## Technology Skills

| Hot Technology | Examples |
|----------------|----------|
| Accounting software | Automated tax system software; Fund accounting software; Intuit QuickBooks Hot Technology ; Tax software In Demand |
| Business intelligence and data analysis software | Alteryx software ; Microsoft Power BI Hot Technology |
