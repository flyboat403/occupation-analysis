...
**Quick Facts:**
- SOC Code: 11-2011.00
- Also called: Account Executive, Advertising Manager (Ad Manager), Advertising Sales Manager (Ad Sales Manager), Classified Advertising Manager (Classified Ad Manager), Communications Director, Communications Manager, Creative Services Director, Marketing and Promotions Manager, Promotions Director, Promotions Manager
...
|------------|----------|------|
| 78 | Core | Plan and prepare advertising and promotional material to increase sales of products or services, working with customers, company officials, sales departments, and advertising agencies. |
| 77 | Core | Inspect layouts and advertising copy, and edit scripts, audio, video, and other promotional material for adherence to specifications. |
| 73 | Core | Confer with department heads or staff to discuss topics such as contracts, selection of advertising media, or product to be advertised. |
| 72 | Core | Coordinate with the media to disseminate advertising. |
| 71 | Core | Coordinate activities of departments, such as sales, graphic arts, media, finance, and research. |
| 70 | Core | Plan and execute advertising policies and strategies for organizations. |
| 70 | Core | Direct, motivate, and monitor the mobilization of a campaign team to advance campaign goals. |
| 67 | Core | Prepare budgets and submit estimates for program costs as part of campaign plan development. |
| 65 | Core | Contact organizations to explain services and facilities offered. |
| 65 | Core | Monitor and analyze sales promotion results to determine cost effectiveness of promotion campaigns. |
| 64 | Core | Identify and develop contacts for promotional campaigns and industry programs that meet identified buyer targets, such as dealers, distributors, or consumers. |
| 64 | Core | Track program budgets, expenses, and campaign response rates to evaluate each campaign, based on program objectives and industry norms. |
| 56 | Core | Read trade journals and professional literature to stay informed on trends, innovations, and changes that affect media planning. |
| 72 | Supplemental | Manage sales team, including setting goals, providing incentives, and evaluating employee performance. |
| 70 | Supplemental | Prepare and negotiate advertising and sales contracts. |
| 67 | Supplemental | Formulate plans to extend business with established accounts and to transact business as agent for advertising accounts. |
| 66 | Supplemental | Train and direct workers engaged in developing and producing advertisements. |
| 65 | Supplemental | Assemble and communicate with a strong, diverse coalition of organizations or public figures, securing their cooperation, support, and action, to further campaign goals. |
| 63 | Supplemental | Provide presentation and product demonstration support during the introduction of new products and services to field staff and customers. |
| 61 | Supplemental | Represent company at trade association meetings to promote products. |
| 59 | Supplemental | Direct and coordinate product research and development. |
...
| Data base user interface and query software | Database software; Microsoft Access Hot Technology ; PaloAlto Advertising Plan Pro; Structure query language SQL ; 1 more |
| Desktop publishing software | Adobe InDesign Hot Technology ; Adobe PageMaker; Microsoft Publisher; Quark enterprise publishing software |
| Document management software | Adobe Acrobat Hot Technology ; Adobe Acrobat Reader; Data warehousing software; Microsoft SharePoint Hot Technology |
| Electronic mail software | Email software; IBM Lotus Notes; MailChimp; Microsoft Outlook |
| Enterprise application integration software | Extensible markup language XML Hot Technology ; Hootsuite |
| Enterprise resource planning ERP software | Brainworks; Microsoft Dynamics; SAP software Hot Technology |
...
| Project management software | Experience in Software Webplanner; Microsoft Project Hot Technology |
| Sales and marketing software | Google Ads; HubSpot software Hot Technology ; Marketo Marketing Automation Hot Technology ; Webtrends software |
| Spreadsheet software | Microsoft Excel |
| Video creation and editing software | Adobe After Effects Hot Technology ; Apple Final Cut Pro; Avid Media Composer; YouTube ; 3 more |
| Web page creation and editing software | Adobe Dreamweaver; Adobe Experience Manager (AEM); Facebook Hot Technology ; WordPress Hot Technology ; 3 more |
| Web platform development software | Drupal; Hypertext markup language HTML Hot Technology ; JavaScript Hot Technology |
...
|---|---|
| 92 | Sales and Marketing — Knowledge of principles and methods for showing, promoting, and selling products or services. This includes marketing strategy and tactics, product demonstration, sales techniques, and sales control systems. |
...
| 84 | Communications and Media — Knowledge of media production, communication, and dissemination techniques and methods. This includes alternative ways to inform and entertain via written, oral, and visual media. |
...
| 32 | Empathy — A tendency to show concern for others and be sensitive to others' needs and feelings at work. |
...
- Ad Council external site
- Advertising and Marketing Independent Network external site
...
- International News Media Association external site
- National Apartment Association external site
