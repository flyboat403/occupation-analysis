...
**Quick Facts:**
- SOC Code: 13-2011.00
- Also called: Accountant, Accounting Officer, Audit Partner, Auditor, Certified Public Accountant (CPA), Cost Accountant, Financial Auditor, General Accountant, Internal Auditor, Revenue Tax Specialist
...
|------------|----------|------|
| 90 | Core | Prepare detailed reports on audit findings. |
| 89 | Core | Report to management about asset utilization and audit results, and recommend changes in operations and financial activities. |
| 88 | Core | Collect and analyze data to detect deficient controls, duplicated effort, extravagance, fraud, or non-compliance with laws, regulations, and management policies. |
| 88 | Core | Inspect account books and accounting systems for efficiency, effectiveness, and use of accepted accounting procedures to record transactions. |
| 88 | Core | Supervise auditing of establishments, and determine scope of investigation required. |
| 83 | Core | Confer with company officials about financial and regulatory matters. |
| 83 | Core | Examine and evaluate financial and information systems, recommending controls to ensure system reliability and data integrity. |
| 81 | Core | Inspect cash on hand, notes receivable and payable, negotiable securities, and canceled checks to confirm records are accurate. |
| 81 | Core | Examine records and interview workers to ensure recording of transactions and compliance with laws and regulations. |
| 81 | Core | Prepare, examine, or analyze accounting records, financial statements, or other financial reports to assess accuracy, completeness, and conformance to reporting and procedural standards. |
| 81 | Core | Prepare adjusting journal entries. |
| 81 | Core | Review accounts for discrepancies and reconcile differences. |
| 79 | Core | Establish tables of accounts and assign entries to proper accounts. |
| 79 | Core | Examine inventory to verify journal and ledger entries. |
| 76 | Core | Analyze business operations, trends, costs, revenues, financial commitments, and obligations to project future revenues and expenses or to provide advice. |
| 76 | Core | Report to management regarding the finances of establishment. |
| 75 | Core | Develop, implement, modify, and document recordkeeping and accounting systems, making use of current computer technology. |
| 71 | Core | Evaluate taxpayer finances to determine tax liability, using knowledge of interest and discount rates, annuities, valuation of stocks and bonds, and amortization valuation of depletable assets. |
| 67 | Core | Examine whether the organization's objectives are reflected in its management activities, and whether employees understand the objectives. |
| 62 | Core | Audit payroll and personnel records to determine unemployment insurance premiums, workers' compensation coverage, liabilities, and compliance with tax laws. |
| 81 | Supplemental | Review taxpayer accounts, and conduct audits on-site, by correspondence, or by summoning taxpayer to office. |
| 79 | Supplemental | Compute taxes owed and prepare tax returns, ensuring compliance with payment, reporting, or other tax requirements. |
| 78 | Supplemental | Advise clients in areas such as compensation, employee health care benefits, the design of accounting or data processing systems, or long-range tax or estate plans. |
| 70 | Supplemental | Direct activities of personnel engaged in filing, recording, compiling, and transmitting financial records. |
| 67 | Supplemental | Conduct pre-implementation audits to determine if systems and programs under development will work as planned. |

## Technology Skills

| Hot Technology | Examples |
|----------------|----------|
| Accounting software | Intuit QuickBooks ; Sage 50 Accounting; SAP Concur Hot Technology ; Summit Software Summit Biofuels Accounting ; 36 more |
| Analytical or scientific software | Guidance Software EnCase Enterprise; IBM SPSS Statistics Hot Technology ; SAS Hot Technology ; WizSoft WizRule ; 2 more |
| Billing and invoicing software | Billing software; Choice Technologies PowerBill +; Client billing software; Invoice software |
| Business intelligence and data analysis software | Alteryx software Hot Technology ; IBM Cognos Impromptu; Oracle Business Intelligence Enterprise Edition; Tableau Hot Technology ; 1 more |
...
| Data base management system software | Apache Solr; Teradata Database Hot Technology |
| Data base reporting software | ADP Super Report Writer; SAP Crystal Reports |
| Data base user interface and query software | Microsoft SQL Server Hot Technology ; Oracle Database Hot Technology ; Structured query language SQL Hot Technology ; Yardi software Hot Technology ; 8 more |
| Data mining software | Data extraction software; WizSoft WizWhy |
| Desktop communications software | Eko |
| Desktop publishing software | Microsoft Publisher |
| Development environment software | eXtensible Business Reporting Language XBRL; Microsoft Visual Basic Hot Technology ; Microsoft Visual Basic for Applications VBA Hot Technology |
| Document management software | Adobe Acrobat Hot Technology ; Document management system software; Microsoft SharePoint Hot Technology ; Sage CPADocument Manager ; 2 more |
...
| Enterprise resource planning ERP software | Microsoft Dynamics; Oracle PeopleSoft Hot Technology ; SAP software ; Workday software Hot Technology ; 17 more |
| Enterprise system management software | IBM Power Systems software |
| Financial analysis software | Delphi Technology; Oracle E-Business Suite Financials; TopCAATs; Tropics workers' compensation software ; 52 more |
...
| Object or component oriented development software | R Hot Technology ; Swift Hot Technology |
...
|---|---|
| 91 | Economics and Accounting — Knowledge of economic and accounting principles and practices, the financial markets, banking, and the analysis and reporting of financial data. |
...
- American Accounting Association external site
- Eastern Association of College and University Business Officers external site
- Financial Management Association International external site
- Government Finance Officers Association external site
- Institute for Professionals in Taxation external site
...
- NorthEast Regional Council external site
- Southern Association of College and University Business Officers external site
- Western States Association of Tax Administrators external site
