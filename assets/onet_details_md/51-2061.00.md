...
**Quick Facts:**
- SOC Code: 51-2061.00
- Also called: Calibration Specialist, Calibrator, Clockmaker, Horologist, Time Stamp Assembler, Watch Technician, Watchmaker
...
|------------|----------|------|
| 88 | Core | Assemble and install components of timepieces to complete mechanisms, using watchmakers' tools and loupes. |
| 87 | Core | Observe operation of timepiece parts and subassemblies to determine accuracy of movement, and to diagnose causes of defects. |
| 82 | Core | Test operation and fit of timepiece parts and subassemblies, using electronic testing equipment, tweezers, watchmakers' tools, and loupes. |
| 79 | Core | Replace specified parts to repair malfunctioning timepieces, using watchmakers' tools, loupes, and holding fixtures. |
| 78 | Core | Disassemble timepieces such as watches, clocks, and chronometers so that repairs can be made. |
| 78 | Core | Clean and lubricate timepiece parts and assemblies, using solvents, buff sticks, and oil. |
| 74 | Core | Examine components of timepieces such as watches, clocks, or chronometers for defects, using loupes or microscopes. |
| 69 | Core | Bend parts, such as hairsprings, pallets, barrel covers, and bridges, to correct deficiencies in truing or endshake, using tweezers. |
| 89 | Supplemental | Change timing weights on balance wheels to correct deficient timing. |
| 88 | Supplemental | Adjust sizes or positioning of timepiece parts to achieve specified fit or function, using calipers, fixtures, and loupes. |
| 80 | Supplemental | Mount hairsprings and balance wheel assemblies between jaws of truing calipers. |
| 78 | Supplemental | Estimate spaces between collets and first inner coils to determine if spaces are within acceptable limits. |
| 77 | Supplemental | Bend inner coils of springs away from or toward collets, using tweezers, to locate centers of collets in centers of springs, and to correct errors resulting from faulty colleting of coils. |
| 75 | Supplemental | Turn wheels of calipers and examine springs, using loupes, to determine if center coils appear as perfect circles. |
| 72 | Supplemental | Examine and adjust hairspring assemblies to ensure horizontal and circular alignment of hairsprings, using calipers, loupes, and watchmakers' tools. |
| 71 | Supplemental | Review blueprints, sketches, or work orders to gather information about tasks to be completed. |
| 71 | Supplemental | Tighten or replace loose jewels, using watchmakers' tools. |
...
- Inspect timing devices. Related occupations
...
| 24 | English Language — Knowledge of the structure and content of the English language including the meaning and spelling of words, and rules of composition and grammar. |
...
- British Horological Institute external site
