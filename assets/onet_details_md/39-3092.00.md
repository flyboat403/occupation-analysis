...
**Quick Facts:**
- SOC Code: 39-3092.00
- Also called: Costume Draper, Costume Seamstress, Costumer, Draper, Dresser, Wardrobe Assistant, Wardrobe Attendant, Wardrobe Supervisor
...
|------------|----------|------|
| 80 | Core | Create worksheets for dressing lists, show notes, or costume checks. |
| 80 | Core | Provide dressing assistance to cast members or assign cast dressers to assist specific cast members with costume changes. |
| 77 | Core | Arrange costumes in order of use to facilitate quick-change procedures for performances. |
| 74 | Core | Design or construct costumes or send them to tailors for construction, major repairs, or alterations. |
| 74 | Core | Examine costume fit on cast members and sketch or write notes for alterations. |
| 74 | Core | Distribute costumes or related equipment and keep records of item status. |
| 74 | Core | Check the appearance of costumes on stage or under lights to determine whether desired effects are being achieved. |
| 71 | Core | Clean and press costumes before and after performances and perform any minor repairs. |
| 69 | Core | Collaborate with production designers, costume designers, or other production staff to discuss and execute costume design details. |
| 67 | Core | Monitor, maintain, or secure inventories of costumes, wigs, or makeup, providing keys or access to assigned directors, costume designers, or wardrobe mistresses/masters. |
| 62 | Core | Purchase, rent, or requisition costumes or other wardrobe necessities. |
| 58 | Core | Study books, pictures, or examples of period clothing to determine styles worn during specific periods in history. |
| 58 | Core | Return borrowed or rented items when productions are complete and return other items to storage. |
| 58 | Core | Review scripts or other production information to determine a story's locale or period, as well as the number of characters and required costumes. |
| 50 | Core | Inventory stock to determine types or conditions of available costuming. |
| 60 | Supplemental | Direct the work of wardrobe crews during dress rehearsals or performances. |
| 59 | Supplemental | Participate in the hiring, training, scheduling, or supervision of alteration workers. |
| 59 | Supplemental | Provide managers with budget recommendations and take responsibility for budgetary line items related to costumes, storage, or makeup needs. |
| 59 | Supplemental | Assign lockers to employees and maintain locker rooms, dressing rooms, wig rooms, or costume storage or laundry areas. |
| 42 | Supplemental | Recommend vendors and monitor their work. |
| 37 | Supplemental | Care for non-clothing items, such as flags, table skirts, or draperies. |
...
|---|---|
| 66 | Fine Arts — Knowledge of the theory and techniques required to compose, produce, and perform works of music, dance, visual arts, drama, and sculpture. |
...
- American Sewing Guild external site
- Costume Society of America external site
- International Costumers' Guild external site
