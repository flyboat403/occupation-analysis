...
**Quick Facts:**
- SOC Code: 51-4052.00
- Also called: Caster, Casting Machine Operator, Casting Operator, DC Caster (Direct Chill Caster), Die Cast Machine Operator, Die Casting Machine Operator, Iron Pourer, Melter, Metal Handler, Pourer
...
|------------|----------|------|
| 92 | Core | Pour and regulate the flow of molten metal into molds and forms to produce ingots or other castings, using ladles or hand-controlled mechanisms. |
| 92 | Core | Read temperature gauges and observe color changes, adjusting furnace flames, torches, or electrical heating units as necessary to melt metal to specifications. |
| 91 | Core | Remove solidified steel or slag from pouring nozzles, using long bars or oxygen burners. |
| 90 | Core | Examine molds to ensure they are clean, smooth, and properly coated. |
| 89 | Core | Collect samples, or signal workers to sample metal for analysis. |
| 88 | Core | Load specified amounts of metal and flux into furnaces or clay crucibles. |
| 86 | Core | Position equipment such as ladles, grinding wheels, pouring nozzles, or crucibles, or signal other workers to position equipment. |
| 86 | Core | Skim slag or remove excess metal from ingots or equipment, using hand tools, strainers, rakes, or burners, collecting scrap for recycling. |
| 66 | Core | Transport metal ingots to storage areas, using forklifts. |
| 91 | Supplemental | Assemble and embed cores in casting frames, using hand tools and equipment. |
| 89 | Supplemental | Turn valves to circulate water through cores, or spray water on filled molds to cool and solidify metal. |
| 88 | Supplemental | Pull levers to lift ladle stoppers and to allow molten steel to flow into ingot molds to specified heights. |
| 84 | Supplemental | Remove metal ingots or cores from molds, using hand tools, cranes, and chain hoists. |
| 82 | Supplemental | Repair and maintain metal forms and equipment, using hand tools, sledges, and bars. |
| 78 | Supplemental | Add metal to molds to compensate for shrinkage. |
| 73 | Supplemental | Stencil identifying information on ingots and pigs, using special hand tools. |
