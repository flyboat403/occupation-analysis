...
**Quick Facts:**
- SOC Code: 47-5022.00
- Also called: Backhoe Operator, Dragline Oiler, Dragline Operator, Equipment Operator, Excavator Operator, Heavy Equipment Operator, Loader Operator, Pit Operator, Track Hoe Operator
...
|------------|----------|------|
| 89 | Core | Move levers, depress foot pedals, and turn dials to operate power machinery, such as power shovels, stripping shovels, scraper loaders, or backhoes. |
| 89 | Core | Set up or inspect equipment prior to operation. |
| 86 | Core | Become familiar with digging plans, machine capabilities and limitations, and efficient and safe digging procedures in a given application. |
| 85 | Core | Observe hand signals, grade stakes, or other markings when operating machines so that work can be performed to specifications. |
| 81 | Core | Operate machinery to perform activities such as backfilling excavations, vibrating or breaking rock or concrete, or making winter roads. |
| 76 | Core | Receive written or oral instructions regarding material movement or excavation. |
| 75 | Core | Move materials over short distances, such as around a construction site, factory, or warehouse. |
| 73 | Core | Create or maintain inclines or ramps. |
| 71 | Core | Lubricate, adjust, or repair machinery and replace parts, such as gears, bearings, or bucket teeth. |
| 67 | Core | Handle slides, mud, or pit cleanings or maintenance. |
| 75 | Supplemental | Direct workers engaged in placing blocks or outriggers to prevent capsizing of machines when lifting heavy loads. |
| 75 | Supplemental | Measure and verify levels of rock or gravel, bases, or other excavated material. |
| 69 | Supplemental | Direct ground workers engaged in activities such as moving stakes or markers, or changing positions of towers. |
| 69 | Supplemental | Adjust dig face angles for varying overburden depths and set lengths. |
| 67 | Supplemental | Drive machines to work sites. |
| 63 | Supplemental | Perform manual labor to prepare or finish sites, such as shoveling materials by hand. |
