...
**Quick Facts:**
- SOC Code: 49-9062.00
- Also called: Biomedical Electronics Technician (Biomed Electronics Tech), Biomedical Engineering Technician (Biomed Engineering Tech), Biomedical Equipment Technician (BMET), Biomedical Technician (Biomed Tech), Dental Equipment Technician (Dental Equipment Tech), Durable Medical Equipment Technician (DME Tech), Medical Equipment Service Tech (Medical Equipment Service Technician), Repair Technician (Repair Tech), Service Technician (Service Tech), X-ray Service Engineer
...
|------------|----------|------|
| 91 | Core | Test or calibrate components or equipment, following manufacturers' manuals and troubleshooting techniques, using hand tools, power tools, or measuring devices. |
| 89 | Core | Perform preventive maintenance or service, such as cleaning, lubricating, or adjusting equipment. |
| 89 | Core | Inspect, test, or troubleshoot malfunctioning medical or related equipment, following manufacturers' specifications and using test and analysis instruments. |
| 85 | Core | Keep records of maintenance, repair, and required updates of equipment. |
| 85 | Core | Disassemble malfunctioning equipment and remove, repair, or replace defective parts, such as motors, clutches, or transformers. |
| 81 | Core | Examine medical equipment or facility's structural environment and check for proper use of equipment to protect patients and staff from electrical or mechanical hazards and to ensure compliance with safety regulations. |
| 79 | Core | Install medical equipment. |
| 78 | Core | Test, evaluate, and classify excess or in-use medical equipment and determine serviceability, condition, and disposition, in accordance with regulations. |
| 77 | Core | Plan and carry out work assignments, using blueprints, schematic drawings, technical manuals, wiring diagrams, or liquid or air flow sheets, following prescribed regulations, directives, or other instructions as required. |
| 74 | Core | Study technical manuals or attend training sessions provided by equipment manufacturers to maintain current knowledge. |
| 74 | Core | Explain or demonstrate correct operation or preventive maintenance of medical equipment to personnel. |
...
| 70 | Core | Repair shop equipment, metal furniture, or hospital equipment, including welding broken parts or replacing missing parts, or bring item into local shop for major repairs. |
| 69 | Core | Solder loose connections, using soldering iron. |
| 67 | Core | Compute power and space requirements for installing medical, dental, or related equipment and install units to manufacturers' specifications. |
| 63 | Core | Evaluate technical specifications to identify equipment or systems best suited for intended use and possible purchase, based on specifications, user needs, or technical requirements. |
| 65 | Supplemental | Contribute expertise to develop medical maintenance standard operating procedures. |
| 63 | Supplemental | Fabricate, dress down, or substitute parts or major new items to modify equipment to meet unique operational or research needs, working from job orders, sketches, modification orders, samples, or discussions with operating officials. |
| 61 | Supplemental | Supervise or advise subordinate personnel. |
| 59 | Supplemental | Make computations relating to load requirements of wiring or equipment, using algebraic expressions and standard formulas. |
...
|---|---|
| 90 | Repairing and Maintaining Electronic Equipment — Servicing, repairing, calibrating, regulating, fine-tuning, or testing machines, devices, and equipment that operate primarily on the basis of electrical or electronic (not mechanical) principles. |
...
- Calculate requirements for equipment installation or repair projects. Related occupations
...
| Importance | Skill |
|---|---|
| 81 | Repairing — Repairing machines or systems using the needed tools. |
...
| Impact | Work Style |
|---|---|
| 94 | Attention to Detail — A tendency to be detail-oriented, organized, and thorough in completing work. |
...
- National Association of Nephrology Technicians/Technologists external site
