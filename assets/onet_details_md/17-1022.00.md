...
**Quick Facts:**
- SOC Code: 17-1022.00
- Also called: City Surveyor, County Surveyor, Land Surveyor, Licensed Land Surveyor, Mine Surveyor, Professional Land Surveyor, Registered Land Surveyor, Staff Land Surveyor, State Surveyor, Surveyor
...
|------------|----------|------|
| 97 | Core | Direct or conduct surveys to establish legal boundaries for properties, based on legal deeds and titles. |
| 92 | Core | Prepare and maintain sketches, maps, reports, and legal descriptions of surveys to describe, certify, and assume liability for work performed. |
| 91 | Core | Write descriptions of property boundary surveys for use in deeds, leases, or other legal documents. |
| 89 | Core | Verify the accuracy of survey data, including measurements and calculations conducted at survey sites. |
| 88 | Core | Search legal records, survey records, and land titles to obtain information about property boundaries in areas to be surveyed. |
| 88 | Core | Record the results of surveys, including the shape, contour, location, elevation, and dimensions of land or land features. |
| 87 | Core | Prepare, or supervise preparation of, all data, charts, plots, maps, records, and documents related to surveys. |
...
| 84 | Core | Calculate heights, depths, relative positions, property lines, and other characteristics of terrain. |
| 81 | Core | Plan and conduct ground surveys designed to establish baselines, elevations, and other geodetic measurements. |
| 80 | Core | Establish fixed points for use in making maps, using geodetic and engineering instruments. |
| 80 | Core | Determine longitudes and latitudes of important features and boundaries in survey areas, using theodolites, transits, levels, and satellite-based global positioning systems (GPS). |
| 78 | Core | Train assistants and helpers, and direct their work in such activities as performing surveys or drafting maps. |
| 76 | Core | Coordinate findings with the work of engineering and architectural personnel, clients, and others concerned with projects. |
...
| 74 | Core | Testify as an expert witness in court cases on land survey issues, such as property boundaries. |
| 73 | Core | Adjust surveying instruments to maintain their accuracy. |
| 69 | Core | Develop criteria for survey methods and procedures. |
| 68 | Core | Survey bodies of water to determine navigable channels and to secure data for construction of breakwaters, piers, and other marine structures. |
| 63 | Core | Direct aerial surveys of specified geographical areas. |
| 59 | Core | Conduct research in surveying and mapping methods, using knowledge of photogrammetric map compilation and electronic data processing. |
| 58 | Supplemental | Locate and mark sites selected for geophysical prospecting activities, such as efforts to locate petroleum or other mineral products. |
| 47 | Supplemental | Determine specifications for equipment to be used for aerial photography, as well as altitudes from which to photograph terrain. |
| 33 | Supplemental | Develop criteria for the design and modification of survey instruments. |
...
| Geographic information system | Cadcorp desktop GIS; ESRI ArcGIS software Hot Technology ; Geographic information system GIS software; Geographic information system GIS systems ; 1 more |
...
- Western Federation of Professional Surveyors external site
