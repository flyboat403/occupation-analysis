...
**Quick Facts:**
- SOC Code: 19-4013.00
- Also called: Central Laboratory Technician (CLT), Food Science Tech (Food Science Technician), Laboratory Assistant (Lab Assistant), Laboratory Technician (Lab Tech), QA Lab Tech (Quality Assurance Lab Technician), QC Tech (Quality Assurance Technician), QC Tech (Quality Control Technician), Quality Analyst, Quality Assurance Analyst (QA Analyst), Quality Tech (Quality Technician)
...
|------------|----------|------|
| 92 | Core | Taste or smell foods or beverages to ensure that flavors meet specifications or to select samples with specific characteristics. |
| 88 | Core | Measure, test, or weigh bottles, cans, or other containers to ensure that hardness, strength, or dimensions meet specifications. |
| 86 | Core | Maintain records of testing results or other documents as required by state or other governing agencies. |
| 85 | Core | Monitor and control temperature of products. |
| 83 | Core | Analyze test results to classify products or compare results with standard tables. |
| 82 | Core | Record or compile test results or prepare graphs, charts, or reports. |
| 81 | Core | Perform regular maintenance of laboratory equipment by inspecting, calibrating, cleaning, or sterilizing. |
| 80 | Core | Examine chemical or biological samples to identify cell structures or to locate bacteria or extraneous material, using a microscope. |
| 79 | Core | Conduct standardized tests on food, beverages, additives, or preservatives to ensure compliance with standards and regulations regarding factors such as color, texture, or nutrients. |
| 73 | Core | Train newly hired laboratory personnel. |
| 73 | Core | Provide assistance to food scientists or technologists in research and development, production technology, or quality control. |
| 70 | Core | Supervise other food science technicians. |
| 69 | Core | Compute moisture or salt content, percentages of ingredients, formulas, or other product factors, using mathematical and chemical procedures. |
| 68 | Core | Order supplies needed to maintain inventories in laboratories or in storage facilities of food or beverage processing plants. |
| 81 | Supplemental | Prepare or incubate slides with cell cultures. |
| 74 | Supplemental | Mix, blend, or cultivate ingredients to make reagents or to manufacture food or beverage products. |
...
| Data base user interface and query software | Database software; Microsoft Access Hot Technology ; Microsoft SQL Server Hot Technology ; Structure query language SQL |
...
|---|---|
| 69 | Food Production — Knowledge of techniques and equipment for planting, growing, and harvesting food products (both plant and animal) for consumption, including storage/handling techniques. |
