...
**Quick Facts:**
- SOC Code: 51-2041.00
- Also called: Fabricator, Fitter, Layout Man, Metal Fabricator, Mill Beam Fitter, Ship Fitter, Small Parts Fabricator, Steel Fabricator, Structural Planner, Structural Steel Fitter
...
|------------|----------|------|
| 87 | Core | Verify conformance of workpieces to specifications, using squares, rulers, and measuring tapes. |
| 85 | Core | Study engineering drawings and blueprints to determine materials requirements and task sequences. |
| 85 | Core | Position, align, fit, and weld parts to form complete units or subunits, following blueprints and layout specifications, and using jigs, welding torches, and hand tools. |
| 82 | Core | Lay out and examine metal stock or workpieces to be processed to ensure that specifications are met. |
| 81 | Core | Tack-weld fitted parts together. |
| 80 | Core | Move parts into position, manually or with hoists or cranes. |
| 78 | Core | Set up and operate fabricating machines, such as brakes, rolls, shears, flame cutters, grinders, and drill presses, to bend, cut, form, punch, drill, or otherwise form and assemble metal components. |
| 77 | Core | Position or tighten braces, jacks, clamps, ropes, or bolt straps, or bolt parts in position for welding or riveting. |
| 75 | Core | Lift or move materials and finished products, using large cranes. |
| 75 | Core | Set up face blocks, jigs, and fixtures. |
| 73 | Core | Align and fit parts according to specifications, using jacks, turnbuckles, wedges, drift pins, pry bars, and hammers. |
| 72 | Core | Hammer, chip, and grind workpieces to cut, bend, and straighten metal. |
| 68 | Core | Locate and mark workpiece bending and cutting lines, allowing for stock thickness, machine and welding shrinkage, and other component specifications. |
| 64 | Core | Remove high spots and cut bevels, using hand files, portable grinders, and cutting torches. |
| 63 | Core | Smooth workpiece edges and fix taps, tubes, and valves. |
| 77 | Supplemental | Mark reference points onto floors or face blocks and transpose them to workpieces, using measuring devices, squares, chalk, and soapstone. |
| 70 | Supplemental | Design and construct templates and fixtures, using hand tools. |
| 67 | Supplemental | Direct welders to build up low spots or short pieces with weld. |
| 64 | Supplemental | Heat-treat parts, using acetylene torches. |
| 63 | Supplemental | Straighten warped or bent parts, using sledges, hand torches, straightening presses, or bulldozers. |
| 62 | Supplemental | Erect ladders and scaffolding to fit together large assemblies. |
| 61 | Supplemental | Preheat workpieces to make them malleable, using hand torches or furnaces. |
| 43 | Supplemental | Install boilers, containers, and other structures. |
...
- IPC external site
- Metal Treating Institute external site
