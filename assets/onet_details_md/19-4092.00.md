...
**Quick Facts:**
- SOC Code: 19-4092.00
- Also called: Crime Lab Analyst (Crime Laboratory Analyst), Crime Scene Analyst (CSA), Crime Scene Technician (Crime Scene Tech), Criminalist, CSI (Crime Scene Investigator), Evidence Technician (Evidence Tech), Forensic Science Examiner, Forensic Scientist, Forensic Specialist, Latent Print Examiner
...
|------------|----------|------|
| 98 | Core | Collect evidence from crime scenes, storing it in conditions that preserve its integrity. |
| 94 | Core | Keep records and prepare reports detailing findings, investigative methods, and laboratory techniques. |
| 92 | Core | Use photographic or video equipment to document evidence or crime scenes. |
| 88 | Core | Testify in court about investigative or analytical methods or findings. |
| 87 | Core | Use chemicals or other substances to examine latent fingerprint evidence and compare developed prints to those of known persons in databases. |
| 86 | Core | Measure and sketch crime scenes to document evidence. |
| 83 | Core | Visit morgues, examine scenes of crimes, or contact other sources to obtain evidence or information to be used in investigations. |
| 82 | Core | Train new technicians or other personnel on forensic science techniques. |
| 78 | Core | Operate and maintain laboratory equipment and apparatus. |
| 77 | Core | Collect impressions of dust from surfaces to obtain and identify fingerprints. |
| 74 | Core | Examine and analyze blood stain patterns at crime scenes. |
| 71 | Core | Analyze gunshot residue and bullet paths to determine how shootings occurred. |
| 71 | Core | Confer with ballistics, fingerprinting, handwriting, documents, electronics, medical, chemical, or metallurgical experts concerning evidence and its interpretation. |
| 61 | Core | Prepare solutions, reagents, or sample formulations needed for laboratory work. |
| 57 | Core | Examine footwear, tire tracks, or other types of impressions. |
| 78 | Supplemental | Examine physical evidence, such as hair, biological fluids, fiber, wood, or soil residues to obtain information about its source and composition. |
| 77 | Supplemental | Reconstruct crime scenes to determine relationships among pieces of evidence. |
| 76 | Supplemental | Determine types of bullets and specific weapons used in shootings. |
| 75 | Supplemental | Review forensic analysts' reports for technical merit. |
| 75 | Supplemental | Interpret laboratory findings or test results to identify and classify substances, materials, or other evidence collected at crime scenes. |
| 69 | Supplemental | Compare objects, such as tools, with impression marks to determine whether a specific object is responsible for a specific mark. |
| 67 | Supplemental | Identify and quantify drugs or poisons found in biological fluids or tissues, in foods, or at crime scenes. |
| 65 | Supplemental | Examine firearms to determine mechanical condition and legal status, performing restoration work on damaged firearms to obtain information, such as serial numbers. |
| 62 | Supplemental | Analyze data from computers or other digital media sources for evidence related to criminal activity. |

## Technology Skills

| Hot Technology | Examples |
|----------------|----------|
| Analytical or scientific software | DM2 Bills of Lading; Guidance Software EnCase Enterprise In Demand ; Laboratory information management system LIMS |
| Computer aided design CAD software | Computer aided design and drafting CADD software |
| Data base user interface and query software | Combined DNA Index System CODIS; Integrated Automated Fingerprint Identification System IAFIS; Microsoft Access Hot Technology ; National Crime Information Center (NCIC) database ; 3 more |
| Electronic mail software | IBM Notes; Microsoft Outlook |
| Graphics or photo imaging software | Adobe Photoshop Hot Technology ; DesignWare 3D EyeWitness; Graphics software; Midwest Information Systems PAX-it ; 7 more |
...
- Association of Forensic DNA Analysis and Administrators external site
...
- International Crime Scene Investigators Association external site
- Midwestern Association of Forensic Scientists external site
- The American Society of Crime Laboratory Directors external site

- Mid-Atlantic Association of Forensic Scientists external site
- Northeastern Association of Forensic Scientists external site
- Southern Association of Forensic Scientists external site
- Southwestern Association of Forensic Scientists external site

- American Board of Criminalistics external site
