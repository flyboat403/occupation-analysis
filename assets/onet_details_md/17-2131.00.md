...
**Quick Facts:**
- SOC Code: 17-2131.00
- Also called: Extrusion Engineer, Materials Development Engineer, Materials Engineer, Materials Research Engineer, Metallurgical Engineer, Metallurgist, Research Engineer, Test Engineer
...
|------------|----------|------|
| 83 | Core | Analyze product failure data and laboratory test results to determine causes of problems and develop solutions. |
| 80 | Core | Design and direct the testing or control of processing procedures. |
| 79 | Core | Monitor material performance, and evaluate its deterioration. |
| 78 | Core | Conduct or supervise tests on raw materials or finished products to ensure their quality. |
| 78 | Core | Evaluate technical specifications and economic factors relating to process or product design objectives. |
| 77 | Core | Modify properties of metal alloys, using thermal and mechanical treatments. |
| 76 | Core | Determine appropriate methods for fabricating and joining materials. |
| 76 | Core | Guide technical staff in developing materials for specific uses in projected products or devices. |
| 74 | Core | Review new product plans, and make recommendations for material selection, based on design objectives such as strength, weight, heat resistance, electrical conductivity, and cost. |
| 73 | Core | Supervise the work of technologists, technicians, and other engineers and scientists. |
| 72 | Core | Plan and implement laboratory operations to develop material and fabrication procedures that meet cost, product specification, and performance standards. |
| 70 | Core | Plan and evaluate new projects, consulting with other engineers and corporate executives, as necessary. |
| 69 | Core | Supervise production and testing processes in industrial settings, such as metal refining facilities, smelting or foundry operations, or nonmetallic materials production operations. |
| 66 | Core | Solve problems in a number of engineering fields, such as mechanical, chemical, electrical, civil, nuclear, and aerospace. |
| 64 | Core | Conduct training sessions on new material products, applications, or manufacturing methods for customers and their employees. |
| 61 | Core | Perform managerial functions, such as preparing proposals and budgets, analyzing labor costs, and writing reports. |
| 59 | Core | Present technical information at conferences. |
| 56 | Core | Replicate the characteristics of materials and their components, using computers. |
| 55 | Core | Design processing plants and equipment. |
| 54 | Core | Write for technical magazines, journals, and trade association publications. |
| 61 | Supplemental | Teach in colleges and universities. |

## Technology Skills

| Hot Technology | Examples |
|----------------|----------|
| Analytical or scientific software | ANSYS Multiphysics; Image analysis systems; Minitab; The MathWorks MATLAB Hot Technology ; 3 more |
...
| Data base user interface and query software | Microsoft Access Hot Technology ; MTS Testworks; Oracle Database Hot Technology ; QMC CM4D |
| Development environment software | Formula translation/translator FORTRAN; Microsoft Visual Basic Hot Technology ; National Instruments LabVIEW |
| Document management software | Microsoft SharePoint Hot Technology |
| Electronic mail software | IBM Notes; Microsoft Outlook Hot Technology |
| Enterprise resource planning ERP software | SAP software Hot Technology |
| Graphics or photo imaging software | Graphics software |
| Internet browser software | Web browser software |
| Object or component oriented development software | C++ Hot Technology ; Microsoft Visual Basic.NET; Python Hot Technology |
...
| 78 | Production and Processing — Knowledge of raw materials, production processes, quality control, costs, and other techniques for maximizing the effective manufacture and distribution of goods. |
