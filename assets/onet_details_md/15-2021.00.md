...
**Quick Facts:**
- SOC Code: 15-2021.00
- Also called: Agent-Based Modeler, Computational Mathematician, Computational Scientist, Cryptographer, Cryptographic Vulnerability Analyst, Mathematician, Research Computing Specialist, Research Scientist, Researcher
...
|------------|----------|------|
| 81 | Core | Mentor others on mathematical techniques. |
| 81 | Core | Maintain knowledge in the field by reading professional journals, talking with other mathematicians, and attending professional conferences. |
| 78 | Core | Develop new principles and new relationships between existing mathematical principles to advance mathematical science. |
| 78 | Core | Disseminate research by writing reports, publishing papers, or presenting at professional conferences. |
| 75 | Core | Assemble sets of assumptions, and explore the consequences of each set. |
| 74 | Core | Perform computations and apply methods of numerical analysis to data. |
| 72 | Core | Address the relationships of quantities, magnitudes, and forms through the use of numbers and symbols. |
| 70 | Core | Conduct research to extend mathematical knowledge in traditional areas, such as algebra, geometry, probability, and logic. |
| 67 | Core | Develop mathematical or statistical models of phenomena to be used for analysis or for computational simulation. |
| 67 | Core | Apply mathematical theories and techniques to the solution of practical problems in business, engineering, the sciences, or other fields. |
| 56 | Core | Develop computational methods for solving problems that occur in areas of science and engineering or that come from applications in business or industry. |
| 44 | Supplemental | Design, analyze, and decipher encryption systems designed to transmit military, political, financial, or law-enforcement-related information in code. |

## Technology Skills

| Hot Technology | Examples |
|----------------|----------|
| Analytical or scientific software | IBM SPSS Statistics Hot Technology ; Minitab; SAS Hot Technology ; The MathWorks MATLAB ; 48 more |
...
| Development environment software | C ; Formula translation/translator FORTRAN; Microsoft Visual Basic Hot Technology ; Microsoft Visual Studio Hot Technology |
| Electronic mail software | Microsoft Outlook Hot Technology |
| Enterprise application integration software | Extensible markup language XML Hot Technology |
| File versioning software | Version control software In Demand |
| Graphics or photo imaging software | Adobe Photoshop Hot Technology |
| Industrial control software | Chatbot software In Demand |
| Internet browser software | Web browser software |
| Metadata management software | Perforce software In Demand |
| Network security or virtual private network VPN management software | Vormetric Application Encryption |
| Object or component oriented development software | C# ; Oracle Java Hot Technology ; Perl Hot Technology ; R Hot Technology ; 3 more |
| Office suite software | Microsoft Office software |
| Operating system software | Apple macOS Hot Technology ; Bash Hot Technology ; Linux Hot Technology ; UNIX Hot Technology ; 1 more |
...
|---|---|
| 96 | Mathematics — Knowledge of arithmetic, algebra, geometry, calculus, statistics, and their applications. |
...
| 91 | Number Facility — The ability to add, subtract, multiply, or divide quickly and correctly. |
...
- Conference Board of the Mathematical Sciences external site
...
- National Association of Mathematicians external site
