...
**Quick Facts:**
- SOC Code: 29-2011.01
- Also called: Certified Cytogenetic Technologist, Clinical Cytogeneticist Scientist (CCS), Cytogenetic Technologist, Cytogenetics Clinical Laboratory Specialist (CG CLSp), Cytogenetics Technical Specialist, Cytogenetics Technologist, Molecular Genetics Technologist
...
|------------|----------|------|
| 100 | Core | Arrange and attach chromosomes in numbered pairs on karyotype charts, using standard genetics laboratory practices and nomenclature, to identify normal or abnormal chromosomes. |
| 100 | Core | Count numbers of chromosomes and identify the structural abnormalities by viewing culture slides through microscopes, light microscopes, or photomicroscopes. |
| 99 | Core | Examine chromosomes found in biological specimens to detect abnormalities. |
| 99 | Core | Apply prepared specimen and control to appropriate grid, run instrumentation, and produce analyzable results. |
| 98 | Core | Select appropriate culturing system or procedure based on specimen type and reason for referral. |
| 98 | Core | Analyze chromosomes found in biological specimens to aid diagnoses and treatments for genetic diseases such as congenital disabilities, fertility problems, and hematological disorders. |
| 98 | Core | Harvest cell cultures using substances such as mitotic arrestants, cell releasing agents, and cell fixatives. |
| 97 | Core | Summarize test results and report to appropriate authorities. |
| 97 | Core | Prepare biological specimens such as amniotic fluids, bone marrow, tumors, chorionic villi, and blood, for chromosome examinations. |
| 96 | Core | Select or prepare specimens and media for cell cultures using aseptic techniques, knowledge of medium components, or cell nutritional requirements. |
| 95 | Core | Input details of specimen processing, analysis, and technical issues into logs or laboratory information systems (LIS). |
| 95 | Core | Prepare slides of cell cultures following standard procedures. |
| 94 | Core | Input details of specimens into logs or computer systems. |
| 93 | Core | Select appropriate methods of preparation and storage of media to maintain potential of hydrogen (pH), sterility, or ability to support growth. |
| 91 | Core | Develop, implement, and monitor quality control and quality assurance programs to ensure accurate and precise test performance and reports. |
| 91 | Core | Stain slides to make chromosomes visible for microscopy. |
| 91 | Core | Describe chromosome, FISH and aCGH analysis results in International System of Cytogenetic Nomenclature (ISCN) language. |
| 91 | Core | Evaluate appropriateness of received specimens for requested tests. |
| 89 | Core | Create chromosome images using computer imaging systems. |
| 88 | Core | Recognize and report abnormalities in the color, size, shape, composition, or pattern of cells. |
| 88 | Core | Determine optimal time sequences and methods for manual or robotic cell harvests. |
| 87 | Core | Communicate to responsible parties unacceptable specimens and suggest remediation for future submissions. |
| 86 | Core | Select banding methods to permit identification of chromosome pairs. |
| 85 | Core | Maintain laboratory equipment such as photomicroscopes, inverted microscopes, and standard darkroom equipment. |
| 81 | Core | Identify appropriate methods of specimen collection, preservation, or transport. |
| 72 | Core | Archive case documentation and study materials as required by regulations and laws. |
| 70 | Core | Supervise subordinate laboratory staff. |
| 66 | Core | Develop and implement training programs for trainees, medical students, resident physicians or post-doctoral fellows. |
| 96 | Supplemental | Communicate test results or technical information to patients, physicians, family members, or researchers. |
| 93 | Supplemental | Extract, measure, dilute as appropriate, label, and prepare DNA for array analysis. |
...
|---|---|
| 80 | Biology — Knowledge of plant and animal organisms, their tissues, cells, functions, interdependencies, and interactions with each other and the environment. |
...
| 15 | Leadership Orientation — A tendency to lead, take charge, offer opinions, and provide direction at work. |
