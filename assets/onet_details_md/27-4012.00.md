...
**Quick Facts:**
- SOC Code: 27-4012.00
- Also called: Audio Engineer, Board Operator, Broadcast Engineer, Broadcast Maintenance Engineer, Broadcast Operations Engineer, Broadcast Technician, Control Operator, Production Engineer
...
|------------|----------|------|
| 88 | Core | Report equipment problems, ensure that repairs are made, and make emergency repairs to equipment when necessary and possible. |
| 86 | Core | Monitor and log transmitter readings. |
| 86 | Core | Maintain programming logs as required by station management and the Federal Communications Commission. |
| 86 | Core | Monitor strength, clarity, and reliability of incoming and outgoing signals, and adjust equipment as necessary to maintain quality broadcasts. |
| 84 | Core | Observe monitors and converse with station personnel to determine audio and video levels and to ascertain that programs are airing. |
| 82 | Core | Preview scheduled programs to ensure that signals are functioning and programs are ready for transmission. |
| 81 | Core | Play and record broadcast programs, using automation systems. |
| 78 | Core | Set up, operate, and maintain broadcast station computers and networks. |
| 76 | Core | Select sources from which programming will be received or through which programming will be transmitted. |
| 76 | Core | Install broadcast equipment, troubleshoot equipment problems, and perform maintenance or minor repairs, using hand tools. |
| 75 | Core | Substitute programs in cases where signals fail. |
| 74 | Core | Control audio equipment to regulate volume and sound quality during radio and television broadcasts. |
| 69 | Core | Design and modify equipment to employer specifications. |
| 77 | Supplemental | Record sound onto tape or film for radio or television, checking its quality and making adjustments where necessary. |
| 77 | Supplemental | Schedule programming or read television programming logs to determine which programs are to be recorded or aired. |
| 75 | Supplemental | Edit broadcast material electronically, using computers. |
| 75 | Supplemental | Develop employee work schedules. |
| 69 | Supplemental | Instruct trainees in use of television production equipment, filming of events, and copying and editing graphics or sound onto videotape. |
| 68 | Supplemental | Align antennae with receiving dishes to obtain the clearest signal for transmission of broadcasts from field locations. |
| 66 | Supplemental | Regulate the fidelity, brightness, and contrast of video transmissions, using video console control panels. |
| 65 | Supplemental | Make commercial dubs. |
| 64 | Supplemental | Determine the number, type, and approximate location of microphones needed for best sound recording or transmission quality, and position them appropriately. |
| 63 | Supplemental | Organize recording sessions and prepare areas, such as radio booths and television stations, for recording. |
| 62 | Supplemental | Set up and operate portable field transmission equipment outside the studio. |
| 61 | Supplemental | Give technical directions to other personnel during filming. |
| 59 | Supplemental | Prepare reports outlining past and future programs, including content. |
| 53 | Supplemental | Discuss production requirements with clients. |
...
| Video creation and editing software | Adobe After Effects Hot Technology ; Adobe Premiere Pro; Apple Final Cut Pro; Video encoder software ; 3 more |
...
| 80 | Telecommunications — Knowledge of transmission, broadcasting, switching, control, and operation of telecommunications systems. |
