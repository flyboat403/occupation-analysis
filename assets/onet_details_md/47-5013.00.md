...
|------------|----------|------|
| 89 | Core | Maintain and perform safety inspections on equipment and tools. |
| 88 | Core | Operate controls that raise derricks or level rigs. |
| 88 | Core | Listen to engines, rotary chains, or other equipment to detect faulty operations or unusual well conditions. |
| 85 | Core | Prepare reports of services rendered, tools used, or time required, for billing purposes. |
| 84 | Core | Install pressure-control devices onto wellheads. |
| 80 | Core | Confer with others to gather information regarding pipe or tool sizes or borehole conditions in wells. |
| 80 | Core | Operate pumps that circulate water, oil, or other fluids through wells to remove sand or other materials obstructing the free flow of oil. |
| 79 | Core | Drive truck-mounted units to well sites. |
| 77 | Core | Interpret instrument readings to ascertain the depth of obstruction. |
| 74 | Core | Thread cables through derrick pulleys, using hand tools. |
| 73 | Core | Select fishing methods or tools for removing obstacles such as liners, broken casing, screens, or drill pipe. |
| 69 | Core | Close and seal wells no longer in use. |
| 83 | Supplemental | Direct drilling crews performing activities such as assembling and connecting pipe, applying weights to drill pipes, or drilling around lodged obstacles. |
| 70 | Supplemental | Apply green technologies or techniques, such as the use of coiled tubing, slim-hole drilling, horizontal drilling, hydraulic fracturing, or gas lift systems. |
| 69 | Supplemental | Operate specialized equipment to remove obstructions by backing off or severing pipes by chemical or explosive action. |
| 67 | Supplemental | Perforate well casings or sidewalls of boreholes with explosive charges. |
| 62 | Supplemental | Examine unserviceable wells to determine actions to be taken to improve well conditions. |
| 57 | Supplemental | Monitor sound wave-generating or detecting mechanisms to determine well fluid levels. |
| 55 | Supplemental | Insert detection instruments into wells with obstructions. |
