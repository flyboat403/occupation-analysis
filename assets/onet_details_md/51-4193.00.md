...
**Quick Facts:**
- SOC Code: 51-4193.00
- Also called: Anodizer, Anodizing Line Operator, Chrome Plater, Coater Associate, Coater Operator, Electro Plater, Galvanizer, Line Operator, Machine Operator, Plater
...
|------------|----------|------|
| 91 | Core | Immerse workpieces in coating solutions or liquid metal or plastic for specified times. |
| 87 | Core | Adjust dials to regulate flow of current and voltage supplied to terminals to control plating processes. |
| 86 | Core | Inspect coated or plated areas for defects, such as air bubbles or uneven coverage. |
| 86 | Core | Set up, operate, or tend plating or coating machines to coat metal or plastic products with chromium, zinc, copper, cadmium, nickel, or other metal to protect or decorate surfaces. |
| 85 | Core | Observe gauges to ensure that machines are operating properly, making adjustments or stopping machines when problems occur. |
| 85 | Core | Remove objects from solutions at periodic intervals and observe objects to verify conformance to specifications. |
| 85 | Core | Maintain production records. |
| 81 | Core | Remove excess materials or impurities from objects, using air hoses or grinding machines. |
| 79 | Core | Examine completed objects to determine thicknesses of metal deposits, or measure thicknesses by using instruments such as micrometers. |
| 75 | Core | Rinse coated objects in cleansing liquids and dry them with cloths, centrifugal driers, or by tumbling in sawdust-filled barrels. |
| 80 | Supplemental | Determine sizes and compositions of objects to be plated, and amounts of electrical current and time required. |
| 80 | Supplemental | Test machinery to ensure that it is operating properly. |
| 80 | Supplemental | Measure or weigh materials, using rulers, calculators, and scales. |
| 79 | Supplemental | Measure, mark, and mask areas to be excluded from plating. |
| 78 | Supplemental | Immerse objects to be coated or plated into cleaning solutions, or spray objects with conductive solutions to prepare them for plating. |
| 78 | Supplemental | Read production schedules to determine setups of equipment and machines. |
| 78 | Supplemental | Suspend objects, such as parts or molds from cathode rods, or negative terminals, and immerse objects in plating solutions. |
| 77 | Supplemental | Suspend sticks or pieces of plating metal from anodes, or positive terminals, and immerse metal in plating solutions. |
| 75 | Supplemental | Adjust controls to set temperatures of coating substances and speeds of machines and equipment. |
| 74 | Supplemental | Monitor and measure thicknesses of electroplating on component parts to verify conformance to specifications, using micrometers. |
| 73 | Supplemental | Operate hoists to place workpieces onto machine feed carriages or spindles. |
| 73 | Supplemental | Position and feed materials into processing machines, by hand or by using automated equipment. |
| 73 | Supplemental | Position objects to be plated in frames, or suspend them from positive or negative terminals of power supplies. |
| 70 | Supplemental | Operate sandblasting equipment to roughen and clean surfaces of workpieces. |
| 69 | Supplemental | Clean and maintain equipment, using water hoses and scrapers. |
| 66 | Supplemental | Clean workpieces, using wire brushes. |
| 65 | Supplemental | Mix and test solutions, and turn valves to fill tanks with solutions. |
| 65 | Supplemental | Replace worn parts and adjust equipment components, using hand tools. |
| 65 | Supplemental | Place plated or coated materials on racks and transfer them to ovens to dry for specified periods of time. |
| 64 | Supplemental | Measure and set stops, rolls, brushes, and guides on automatic feeders and conveying equipment or coating machines, using micrometers, rules, and hand tools. |
| 63 | Supplemental | Position containers to receive parts, and load or unload materials in containers, using dollies or handtrucks. |
| 60 | Supplemental | Perform equipment maintenance, such as cleaning tanks and lubricating moving parts of conveyors. |
| 48 | Supplemental | Preheat workpieces in ovens. |
...
- National Association for Surface Finishing external site
