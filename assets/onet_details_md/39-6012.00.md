...
**Quick Facts:**
- SOC Code: 39-6012.00
- Also called: Activities Concierge, Chef Concierge, Club Concierge, Concierge, Conference Concierge, Front Desk Agent, Guest Service Agent, Hotel Concierge, Lobby Concierge, Service Concierge
...
|------------|----------|------|
| 90 | Core | Provide information about local features, such as shopping, dining, nightlife, or recreational destinations. |
| 83 | Core | Make reservations for patrons, such as for dinner, spa treatments, or golf tee times, and obtain tickets to special events. |
| 82 | Core | Provide directions to guests. |
| 79 | Core | Order flowers for guests. |
| 77 | Core | Make travel arrangements for sightseeing or other tours. |
| 76 | Core | Pick up and deliver items or run errands for guests. |
| 74 | Core | Plan special events, parties, or meetings, which may include booking musicians or celebrities. |
| 73 | Core | Book airline or train tickets, reserve rental cars, or arrange shuttle service for guests. |
| 72 | Core | Arrange childcare services for guests. |
| 68 | Core | Carry out unusual requests, such as searching for hard-to-find items or arranging for exotic services, such as hot-air balloon rides. |
| 68 | Core | Assist guests with special needs by providing equipment such as wheelchairs. |
| 66 | Core | Receive, store, or deliver luggage or mail. |
| 65 | Core | Perform office duties on a temporary basis when needed. |
| 60 | Core | Arrange for the replacement of items lost by travelers. |
| 59 | Core | Provide business services for guests, such as sending or receiving faxes or shipping packages. |
| 56 | Core | Arrange for interpreters or translators when patrons require such services. |
| 70 | Supplemental | Provide food and beverage services to guests. |
| 67 | Supplemental | Clean and tidy hotel lounge. |
...
| 72 | Assisting and Caring for Others — Providing personal assistance, medical attention, emotional support, or other personal care to others such as coworkers, customers, or patients. |
...
- Les Clefs d'Or USA external site
- National Association of Productivity and Organizing Professionals external site
- National Concierge Association external site
