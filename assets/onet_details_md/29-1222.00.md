...
**Quick Facts:**
- SOC Code: 29-1222.00
- Also called: Anatomic Pathologist, Cytopathologist, Dermatopathologist, Forensic Pathologist, Hematopathologist, Neuropathologist, Oral Pathologist, Pathologist, Surgical Pathologist
...
|------------|----------|------|
| 98 | Core | Examine microscopic samples to identify diseases or other abnormalities. |
| 98 | Core | Diagnose diseases or study medical conditions, using techniques such as gross pathology, histology, cytology, cytopathology, clinical chemistry, immunology, flow cytometry, or molecular biology. |
| 96 | Core | Write pathology reports summarizing analyses, results, and conclusions. |
| 92 | Core | Communicate pathologic findings to surgeons or other physicians. |
| 92 | Core | Identify the etiology, pathogenesis, morphological change, and clinical significance of diseases. |
| 85 | Core | Read current literature, talk with colleagues, or participate in professional organizations or conferences to keep abreast of developments in pathology. |
| 83 | Core | Consult with physicians about ordering and interpreting tests or providing treatments. |
| 82 | Core | Analyze and interpret results from tests, such as microbial or parasite tests, urine analyses, hormonal assays, fine needle aspirations (FNAs), and polymerase chain reactions (PCRs). |
| 76 | Core | Review cases by analyzing autopsies, laboratory findings, or case investigation reports. |
| 75 | Core | Manage medical laboratories. |
| 68 | Core | Develop or adopt new tests or instruments to improve diagnosis of diseases. |
| 67 | Core | Educate physicians, students, and other personnel in medical laboratory professions, such as medical technology, cytotechnology, or histotechnology. |
| 65 | Core | Plan and supervise the work of the pathology staff, residents, or visiting pathologists. |
| 60 | Core | Perform autopsies to determine causes of deaths. |
| 75 | Supplemental | Diagnose infections, such as Hepatitis B and Acquired Immune Deficiency Syndrome (AIDS), by conducting tests to detect the antibodies that patients' immune systems make to fight such infections. |
| 74 | Supplemental | Obtain specimens by performing procedures, such as biopsies or fine needle aspirations (FNAs) of superficial nodules. |
| 72 | Supplemental | Conduct genetic analyses of deoxyribonucleic acid (DNA) or chromosomes to diagnose small biopsies and cell samples. |
| 63 | Supplemental | Conduct research and present scientific findings. |
| 53 | Supplemental | Testify in depositions or trials as an expert witness. |

## Technology Skills

| Hot Technology | Examples |
|----------------|----------|
| Accounting software | Cerner Millennium ProFit; Healthvision MediAR; Sunquest Information Systems Sunquest Clinical Financials; XIFIN ; 6 more |
| Billing and invoicing software | Cortex Medical Management Systems Cortex Medical Billing; TELCOR Billing Information System |
...
| 23 | Empathy — A tendency to show concern for others and be sensitive to others' needs and feelings at work. |
