...
**Quick Facts:**
- SOC Code: 51-6052.00
- Also called: Alterations Expert, Alterations Sewer, Bridal Designer, Clothing Pattern Designer, Custom Dressmaker, Custom Sewer, Custom Tailor, Dressmaker, Seamstress, Tailor
...
|------------|----------|------|
| 84 | Core | Measure parts, such as sleeves or pant legs, and mark or pin-fold alteration lines. |
| 84 | Core | Remove stitches from garments to be altered, using rippers or razor blades. |
| 82 | Core | Sew garments, using needles and thread or sewing machines. |
| 82 | Core | Let out or take in seams in suits and other garments to improve fit. |
| 81 | Core | Measure customers, using tape measures, and record measurements. |
| 81 | Core | Fit and study garments on customers to determine required alterations. |
| 81 | Core | Trim excess material, using scissors. |
| 80 | Core | Assemble garment parts and join parts with basting stitches, using needles and thread or sewing machines. |
| 79 | Core | Make garment style changes, such as tapering pant legs, narrowing lapels, and adding or removing padding. |
| 79 | Core | Maintain garment drape and proportions as alterations are performed. |
| 78 | Core | Take up or let down hems to shorten or lengthen garment parts, such as sleeves. |
| 78 | Core | Repair or replace defective garment parts, such as pockets, zippers, snaps, buttons, and linings. |
| 77 | Core | Press garments, using hand irons or pressing machines. |
| 77 | Core | Fit, alter, repair, and make made-to-measure clothing, according to customers' and clothing manufacturers' specifications and fit, and applying principles of garment design, construction, and styling. |
| 76 | Core | Estimate how much a garment will cost to make, based on factors such as time and material requirements. |
| 75 | Core | Position patterns of garment parts on fabric, and cut fabric along outlines, using scissors. |
| 74 | Core | Record required alterations and instructions on tags, and attach them to garments. |
| 74 | Core | Confer with customers to determine types of material and garment styles desired. |
| 73 | Core | Examine tags on garments to determine alterations that are needed. |
| 73 | Core | Develop, copy, or adapt designs for garments, and design patterns to fit measurements, applying knowledge of garment design, construction, styling, and fabric. |
| 68 | Core | Put in padding and shaping materials. |
| 64 | Core | Sew buttonholes and attach buttons to finish garments. |
...
| 33 | Establishing and Maintaining Interpersonal Relationships — Developing constructive and cooperative working relationships with others, and maintaining them over time. |
...
| 33 | Monitoring Processes, Materials, or Surroundings — Monitoring and reviewing information from materials, events, or the environment, to detect or assess problems. |
...
- Association of Sewing and Design Professionals external site
- Fashion Group International external site

- Custom Tailors and Designers Association external site
