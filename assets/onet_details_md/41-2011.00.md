...
**Quick Facts:**
- SOC Code: 41-2011.00
- Also called: Cage Cashier, Cashier, Center Aisle Cashier, Central Aisle Cashier, Checker, Customer Assistant, Sales Associate, Store Attendant, Store Clerk, Toll Collector
...
|------------|----------|------|
| 94 | Core | Receive payment by cash, check, credit cards, vouchers, or automatic debits. |
| 93 | Core | Greet customers entering establishments. |
| 92 | Core | Issue receipts, refunds, credits, or change due to customers. |
| 88 | Core | Assist customers by providing information and resolving their complaints. |
| 87 | Core | Monitor checkout stations to ensure they have adequate cash available and are staffed appropriately. |
| 86 | Core | Establish or identify prices of goods, services, or admission, and tabulate bills, using calculators, cash registers, or optical price scanners. |
| 85 | Core | Answer incoming phone calls. |
| 85 | Core | Answer customers' questions, and provide information on procedures or policies. |
| 82 | Core | Request information or assistance, using paging systems. |
| 82 | Core | Help customers find the location of products. |
| 76 | Core | Process merchandise returns and exchanges. |
| 75 | Core | Maintain clean and orderly checkout areas, and complete other general cleaning duties, such as mopping floors and emptying trash cans. |
| 92 | Supplemental | Calculate total payments received during a time period, and reconcile this with total sales. |
| 90 | Supplemental | Count money in cash drawers at the beginning of shifts to ensure that amounts are correct and that there is adequate change. |
| 88 | Supplemental | Issue trading stamps, and redeem food stamps and coupons. |
| 85 | Supplemental | Post charges against guests' or patients' accounts. |
| 85 | Supplemental | Compute and record totals of transactions. |
| 85 | Supplemental | Weigh items sold by weight to determine prices. |
| 85 | Supplemental | Sort, count, and wrap currency and coins. |
| 84 | Supplemental | Keep periodic balance sheets of amounts and numbers of transactions. |
| 82 | Supplemental | Compile and maintain non-monetary reports and records. |
| 81 | Supplemental | Supervise others and provide on-the-job training. |
| 80 | Supplemental | Assist with duties in other areas of the store, such as monitoring fitting rooms or bagging and carrying out customers' items. |
| 80 | Supplemental | Sell tickets and other items to customers. |
| 79 | Supplemental | Stock shelves, sort and reshelve returned items, and mark prices on items and shelves. |
| 79 | Supplemental | Bag, box, wrap, or gift-wrap merchandise, and prepare packages for shipment. |
| 78 | Supplemental | Cash checks for customers. |
| 74 | Supplemental | Offer customers carry-out service at the completion of transactions. |
...
- Issue money, credit, or vouchers. Related occupations
...
- National Association of Sales Professionals external site
