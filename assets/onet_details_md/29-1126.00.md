...
**Quick Facts:**
- SOC Code: 29-1126.00
- Also called: Cardiopulmonary Rehabilitation Respiratory Therapist, Certified Respiratory Therapist (CRT), Registered Respiratory Therapist (RRT), Respiratory Care Practitioner (RCP), Respiratory Therapist (RT), Staff Respiratory Therapist, Staff Therapist
...
|------------|----------|------|
| 97 | Core | Provide emergency care, such as artificial respiration, external cardiac massage, or assistance with cardiopulmonary resuscitation. |
| 96 | Core | Monitor patient's physiological responses to therapy, such as vital signs, arterial blood gases, or blood chemistry changes, and consult with physician if adverse reactions occur. |
| 94 | Core | Set up and operate devices, such as mechanical ventilators, therapeutic gas administration apparatus, environmental control systems, or aerosol generators, following specified parameters of treatment. |
| 94 | Core | Work as part of a team of physicians, nurses, or other healthcare professionals to manage patient care by assisting with medical procedures or related duties. |
| 94 | Core | Maintain charts that contain patients' pertinent identification and therapy information. |
| 92 | Core | Read prescription, measure arterial blood gases, and review patient information to assess patient condition. |
| 91 | Core | Relay blood analysis results to a physician. |
| 91 | Core | Inspect, clean, test, and maintain respiratory therapy equipment to ensure equipment is functioning safely and efficiently, ordering repairs when necessary. |
| 90 | Core | Explain treatment procedures to patients to gain cooperation and allay fears. |
| 89 | Core | Make emergency visits to resolve equipment problems. |
| 89 | Core | Determine requirements for treatment, such as type, method and duration of therapy, precautions to be taken, or medication and dosages, compatible with physicians' orders. |
| 87 | Core | Enforce safety rules and ensure careful adherence to physicians' orders. |
| 85 | Core | Educate patients and their families about their conditions and teach appropriate disease management techniques, such as breathing exercises or the use of medications or respiratory equipment. |
| 82 | Core | Perform bronchopulmonary drainage and assist or instruct patients in performance of breathing exercises. |
| 80 | Core | Conduct tests, such as electrocardiograms (EKGs), stress testing, or lung capacity tests, to evaluate patients' cardiopulmonary functions. |
| 79 | Core | Perform pulmonary function and adjust equipment to obtain optimum results in therapy. |
| 77 | Core | Demonstrate respiratory care procedures to trainees or other healthcare personnel. |
| 77 | Core | Use a variety of testing techniques to assist doctors in cardiac or pulmonary research or to diagnose disorders. |
| 76 | Core | Transport patients to the hospital or within the hospital. |
| 74 | Core | Teach, train, supervise, or use the assistance of students, respiratory therapy technicians, or assistants. |
| 98 | Supplemental | Perform endotracheal intubation to maintain open airways for patients who are unable to breathe on their own. |
| 74 | Supplemental | Monitor cardiac patients, using electrocardiography devices, such as a holter monitor. |
...
| Medical software | eClinicalWorks EHR software Hot Technology ; Electronic medical record EMR software; HMS; MEDITECH software Hot Technology |
...
- American Lung Association external site
