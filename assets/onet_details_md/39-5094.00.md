...
**Quick Facts:**
- SOC Code: 39-5094.00
- Also called: Aesthetician, Clinical Esthetician, Electrologist, Esthetician, Facialist, Medical Esthetician, Skin Therapist, Skincare Specialist, Skincare Therapist, Spa Technician (Spa Tech)
...
|------------|----------|------|
| 100 | Core | Sterilize equipment and clean work areas. |
| 98 | Core | Cleanse clients' skin with water, creams, or lotions. |
| 97 | Core | Demonstrate how to clean and care for skin properly and recommend skin-care regimens. |
| 95 | Core | Determine which products or colors will improve clients' skin quality and appearance. |
| 93 | Core | Keep records of client needs and preferences and the services provided. |
| 92 | Core | Treat the facial skin to maintain and improve its appearance, using specialized techniques and products, such as peels and masks. |
| 91 | Core | Examine clients' skin, using magnifying lamps or visors when necessary, to evaluate skin condition and appearance. |
| 90 | Core | Perform simple extractions to remove blackheads. |
| 90 | Core | Select and apply cosmetic products, such as creams, lotions, and tonics. |
| 88 | Core | Stay abreast of latest industry trends, products, research, and treatments. |
| 85 | Core | Apply chemical peels to reduce fine lines and age spots. |
| 84 | Core | Refer clients to medical personnel for treatment of serious skin problems. |
| 83 | Core | Provide facial and body massages. |
| 79 | Core | Remove body and facial hair by applying wax. |
| 69 | Core | Tint eyelashes and eyebrows. |
| 90 | Supplemental | Collaborate with plastic surgeons and dermatologists to provide patients with preoperative and postoperative skin care. |
| 53 | Supplemental | Advise clients about colors and types of makeup and instruct them in makeup application techniques. |
| 42 | Supplemental | Sell makeup to clients. |
